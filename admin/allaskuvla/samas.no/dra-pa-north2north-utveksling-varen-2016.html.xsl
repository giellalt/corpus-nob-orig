...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://samas.no/nb/a/dra-pa-north2north-utveksling-varen-2016'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="go-north2north-exchange-spring-2016.html"/>
        ...
        <parallel_text xml:lang="sme" location="vuolgge-north2north-lonohallamii-giddat-2016.html"/>
