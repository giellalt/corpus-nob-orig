...
<xsl:variable name="filename" select="'http://www.regjeringen.no/Rpub/STM/20022003/010/PDFS/STM200220030010000DDDPDFS.pdf'"/>
...
<xsl:variable name="para_sme" select="'STM200220030010000SE_PDFS.pdf'"/>
