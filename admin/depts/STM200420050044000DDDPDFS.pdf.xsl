...
<xsl:variable name="filename" select="'STM200420050044000DDDPDFS.pdf'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'St.meld. nr. 44 (2004–2005)'"/>
...
<xsl:variable name="para_sme" select="'STM200420050044000SE_PDFS.pdf'"/>
...
<xsl:element name="p">
            ...
            <xsl:call-template name="globalTextReplace">
               ...
               <xsl:with-param name="target" select="'«‚ak„a»/str2/str3/'"/>
               <xsl:with-param name="replacement" select="'«Čakča»/rpl2/rpl3/'"/>
