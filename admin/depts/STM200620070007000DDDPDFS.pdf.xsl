...
<xsl:variable name="filename" select="'http://www.regjeringen.no/Rpub/STM/20062007/007/PDFS/STM200620070007000DDDPDFS.pdf'"/>
...
<xsl:variable name="para_sme" select="'STM200620070007000SE_PDFS.pdf'"/>
