...
<xsl:variable name="filename" select="'http://www.regjeringen.no/pages/2202892/PDFS/STM200820090043000DDDPDFS.pdf'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'St.meld. nr. 43 (2008–2009)'"/>
...
<xsl:variable name="para_sme" select="'STM200820090043000SE_PDFS.pdf'"/>
