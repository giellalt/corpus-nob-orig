...
<!-- variable filename contains the original name of the file (from submitter)-->
  <xsl:variable name="filename" select="'STM_TS007.pdf'"/>
  <xsl:variable name="title" select="'St.meld. nr. 7 (2006-2007)'"/>
  ...
  <xsl:variable name="place" select="'http://odin.dep.no/filarkiv/294471/STM-TS007.pdf'"/>
  ...
  <xsl:variable name="wordcount" select="'29286'"/>
...
<!-- Add the locations of the parallel files to the variables-->
  ...
  <xsl:variable name="para_sme" select="'STM_TS007SA.pdf'"/>
