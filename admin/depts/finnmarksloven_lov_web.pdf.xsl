...
<xsl:variable name="filename" select="'http://www.regjeringen.no/upload/JD/Vedlegg/finnmarksloven_lov_web.pdf'"/>
...
<xsl:variable name="para_sme" select="'finnmarkkulahka_lov_web.pdf'"/>
