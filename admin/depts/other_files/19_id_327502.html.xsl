...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.regjeringen.no/nb/dep/ad/dok/regpubl/stmeld/2001-2002/stmeld-nr-33-2001-2002-/19.html?id=327502'"/>
    <xsl:variable name="text_encoding" select="'UTF-8'"/>
    <xsl:variable name="title" select="'St.dieđ. nr. 33 2001– 2002, kap. 19'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="stm200120020033000se_pdts.pdf"/>
