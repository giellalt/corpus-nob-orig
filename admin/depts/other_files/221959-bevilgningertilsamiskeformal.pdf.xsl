...
<xsl:variable name="filename" select="'http://www.regjeringen.no/upload/kilde/krd/rus/2004/0032/ddd/pdfv/221959-bevilgningertilsamiskeformal.pdf'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="221961-samiskebevilgninger2005.pdf" xml:lang="sme"/>
</xsl:variable>
