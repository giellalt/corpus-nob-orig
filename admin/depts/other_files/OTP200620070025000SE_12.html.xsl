...
<xsl:variable name="filename" select="'http://www.regjeringen.no/pages/1929327/PDFS/OTP200620070025000DDDPDFS.pdf'"/>
...
<xsl:variable name="para_sme" select="'OTP200620070025000SE_12.html'"/>
