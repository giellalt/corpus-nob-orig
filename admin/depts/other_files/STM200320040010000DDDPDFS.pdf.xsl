...
<xsl:variable name="filename" select="'http://www.regjeringen.no/Rpub/STM/20032004/010/PDFS/STM200320040010000DDDPDFS.pdf'"/>
...
<xsl:variable name="para_sme" select="'STM200320040010000SE_PDFA.pdf'"/>
