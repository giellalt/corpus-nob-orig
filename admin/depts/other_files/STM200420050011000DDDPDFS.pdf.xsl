...
<xsl:variable name="filename" select="'http://www.regjeringen.no/Rpub/STM/20042005/011/PDFS/STM200420050011000DDDPDFS.pdf'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'St.meld. nr. 11 (2004–2005)'"/>
...
<xsl:variable name="para_sme" select="'STM200420050011000SE_PDFS.pdf'"/>
