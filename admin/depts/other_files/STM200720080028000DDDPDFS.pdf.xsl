...
<xsl:variable name="filename" select="'http://www.regjeringen.no/pages/2077889/PDFS/STM200720080028000DDDPDFS.pdf'"/>
...
<xsl:variable name="para_sme" select="'STM200720080028000SE_PDFS.pdf'"/>
