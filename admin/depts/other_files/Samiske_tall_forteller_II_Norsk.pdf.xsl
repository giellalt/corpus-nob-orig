...
<xsl:variable name="filename" select="'http://www.regjeringen.no/upload/AID/publikasjoner/rapporter_og_planer/2009/Samiske_tall_forteller_II_Norsk.pdf'"/>
...
<xsl:variable name="para_sme" select="'samiske_tall_forteller_ii_samisk.pdf'"/>
