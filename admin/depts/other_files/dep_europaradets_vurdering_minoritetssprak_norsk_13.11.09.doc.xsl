...
<xsl:variable name="filename" select="'dep_europaradets_vurdering_minoritetssprak_norsk_13.11.09.doc'"/>
...
<xsl:variable name="template_version" select="'$Revision: 93855 $'"/>
