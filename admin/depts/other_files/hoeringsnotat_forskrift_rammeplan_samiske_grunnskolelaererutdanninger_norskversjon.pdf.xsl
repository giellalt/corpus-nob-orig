...
<xsl:variable name="filename" select="'http://www.regjeringen.no/pages/2275837/Hoeringsnotat_forskrift_rammeplan_samiske_grunnskolelaererutdanninger_norskversjon.pdf'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="hoeringsnotat_forskrift_rammeplan_samiske_grunnskolelaererutdanninger_samiskversjon.pdf" xml:lang="sme"/>
</xsl:variable>
