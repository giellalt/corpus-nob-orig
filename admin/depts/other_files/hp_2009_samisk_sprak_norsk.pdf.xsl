...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.regjeringen.no/upload/FAD/Vedlegg/SAMI/HP_2009_samisk_sprak_norsk.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Handlingsplan for samiske språk'"/>
    <!--
    ...
    <xsl:variable name="wordcount" select="'28445'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="smj" location="hp_2009_samisk_sprak_lulesam.pdf"/>
    ...
    <xsl:variable name="bottom_margin" select="'all=10, 9=30, 14;17=18, 19=19, 20=20, 43=17, 67=50'"/>
