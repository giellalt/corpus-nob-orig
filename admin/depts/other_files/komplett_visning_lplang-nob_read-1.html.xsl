...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.udir.no/kl06/SAF2-03/Hele/Komplett_visning?lplang=nob&amp;read=1'"/>
    ...
    <parallel_text xml:lang="sma" location="komplett_visning_lplang-sma_read-1.html"/>
	<parallel_text xml:lang="sme" location="komplett_visning_lplang-sme_read-1.html"/></xsl:variable>
