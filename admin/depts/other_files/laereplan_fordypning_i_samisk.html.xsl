...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.udir.no/kl06/SFS2-01/Hele/Komplett_visning?read=1&amp;plang=nob'"/>
	...
	<parallel_text xml:lang="smj" location="laereplan_fordypning_i_samisk.rtf"/></xsl:variable>
