...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.udir.no/kl06/NOR3-03/Hele/Komplett_visning?lplang=nob&amp;read=1'"/>
    ...
    <parallel_text xml:lang="sma" location="laereplan_norsk_samiskfoerst.html"/>
	<parallel_text xml:lang="sme" location="laereplan_norsk_samiskfoerst.html"/></xsl:variable>
