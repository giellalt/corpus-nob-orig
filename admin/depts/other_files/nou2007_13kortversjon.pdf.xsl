...
<xsl:variable name="filename" select="'http://www.regjeringen.no/upload/JD/Vedlegg/Rapporter/NOU2007_13Kortversjon.pdf'"/>
<xsl:variable name="title" select="'NOU 2007: 13 Den nye sameretten'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="nou2007_13samiskkortversjon.pdf" xml:lang="sme"/>
</xsl:variable>
