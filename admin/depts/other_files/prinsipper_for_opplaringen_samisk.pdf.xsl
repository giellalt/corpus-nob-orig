...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.udir.no/globalassets/upload/larerplaner/fastsatte_lareplaner_for_kunnskapsloeftet/samiske/5/prinsipper_for_opplaringen_samisk.pdf'"/>
    ...
    <parallel_text xml:lang="sme" location="prinsipper_for_opplaringa_oahpahusa_prinsihpat_nordsamisk.pdf"/></xsl:variable>
