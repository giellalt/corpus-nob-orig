...
<xsl:variable name="filename" select="'http://www.regjeringen.no/upload/KUD/Samfunn_og_frivillighet/Tro-og_livssyn/PRM-52-10-Utvalg_for_gjennomgang_av_tros-og_livssynspolitikken-MANDAT.pdf'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="prm-52-10-utvalg_for_gjennomgang_av_tros-og_livssynspolitikken-mandat-samisk.pdf" xml:lang="sme"/>
</xsl:variable>
