...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'Prop. samiske formål_finkorrektur_til ADMA 16.09.2016.docx'"/>
    ...
    <xsl:variable name="note" select="'Received by e-mail from Hanne.Lauveng@kmd.dep.no on 2017-10-30'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="programkategori_1360_sami_2018_til_samisk_oversettelse.docx"/>
