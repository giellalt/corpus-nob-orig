...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="smj" location="reindrift_konvensjon_norge_sverige_lulesamisk_070710.pdf"/>
    ...
    <!--
        ...
        1;3;8=20, 4;5;7=10
    -->
    <xsl:variable name="right_margin" select="'all=49'"/>
    <xsl:variable name="left_margin" select="'all=0'"/>
    <xsl:variable name="top_margin" select="'all=0'"/>
    <xsl:variable name="bottom_margin" select="'all=0'"/>
