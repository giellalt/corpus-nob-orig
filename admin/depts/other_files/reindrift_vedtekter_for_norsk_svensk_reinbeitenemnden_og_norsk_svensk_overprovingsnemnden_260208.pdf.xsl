...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.regjeringen.no/upload/LMD/Vedlegg/Regelverk/Reindrift_Vedtekter_for_Norsk_svensk_reinbeitenemnden_og_Norsk_svensk_overprovingsnemnden_260208.pdf'"/>
    ...
    <language xml:lang="nob"/><language xml:lang="swe"/></xsl:variable>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="smj" location="reindrift_vedtekter_for_norsk_svensk_reinbeitenemnden_og_norsk_svensk_overprovingsnemnden_lulesamisk.pdf"/>
