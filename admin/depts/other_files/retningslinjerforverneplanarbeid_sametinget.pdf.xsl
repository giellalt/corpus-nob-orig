...
<xsl:variable name="filename" select="'http://www.regjeringen.no/Upload/MD/Vedlegg/Retningslinjer/retningslinjerforverneplanarbeid_sametinget.pdf'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="retningslinjerforverneplanarbeid_sametinget_samisk.pdf" xml:lang="sme"/>
</xsl:variable>
