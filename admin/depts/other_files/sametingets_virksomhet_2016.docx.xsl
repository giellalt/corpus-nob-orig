...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'Meld. St. Sametingets virksomhet 2016 (sendt Sametinget).docx'"/>
    ...
    <xsl:variable name="note" select="'Received by email from hanne.lauveng@kdm.dep.no on Sept 10th 2017'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="samedikki_jagi_2016_doaimma.docx"/>
