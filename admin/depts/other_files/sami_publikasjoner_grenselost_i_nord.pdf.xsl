...
<xsl:variable name="filename" select="'http://www.regjeringen.no/Upload/AID/temadokumenter/sami/sami_publikasjoner_grenselost_i_nord.pdf'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="273777-raportti_saami.pdf" xml:lang="sme"/>
</xsl:variable>
