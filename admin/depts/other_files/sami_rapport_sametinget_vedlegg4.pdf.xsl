...
<xsl:variable name="filename" select="'http://www.regjeringen.no/Upload/AID/temadokumenter/sami/sami_rapport_sametinget_Vedlegg4.pdf'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="sami_rapport_sametinget_vedlegg4_sa.pdf" xml:lang="sme"/>
</xsl:variable>
