...
<xsl:variable name="filename" select="'http://www.regjeringen.no/Upload/AID/temadokumenter/sami/sami_Rapport_sametingets_formelle_stilling.pdf'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="sami_rapport_sametingets_formelle_stilling_sa.pdf.pdf" xml:lang="sme"/>
</xsl:variable>
