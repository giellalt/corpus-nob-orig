...
<xsl:variable name="filename" select="'http://www.regjeringen.no/upload/AID/temadokumenter/sami/Publikasjoner/sami_rapporter_samisktegnsettogit_NO.pdf'"/>
...
<xsl:variable name="para_sme" select="'sami_rapporter_samisktegnsettogit_sa.pdf'"/>
