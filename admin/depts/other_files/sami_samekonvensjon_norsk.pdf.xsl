...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.regjeringen.no/Upload/AID/temadokumenter/sami/sami_samekonvensjon_norsk.pdf'"/>
    ...
    <language xml:lang="swe"/><language xml:lang="sme"/><language xml:lang="fin"/><language xml:lang="nob"/></xsl:variable>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="sami_samskonvensjonen_finsk_h-2183_f.pdf"/>
