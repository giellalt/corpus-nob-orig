...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/krd/pressesenter/pressemeldinger/2010/1-600-000-kroner-til-hogskolen-i-bodo.html?id=612731'"/>
<xsl:variable name="title" select="'1 600 000 kroner til Høgskolen i Bodø - regjeringen.no'"/>
...
<<<<<<< HEAD
<xsl:variable name="wordcount" select="'462'"/>
=======
<xsl:variable name="wordcount" select="'514'"/>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
...
<xsl:variable name="para_sme" select="'Bodeaju-allaskuvla---1-600-000-ruvnno-.html?id=612731'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="bodeaju-allaskuvla---1-600-000-ruvnno-_id_612731.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
