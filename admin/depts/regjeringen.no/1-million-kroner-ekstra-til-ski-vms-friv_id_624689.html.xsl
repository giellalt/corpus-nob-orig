...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/kud/pressesenter/pressemeldinger/2010/1-million-kroner-ekstra-til-ski-vms-friv.html?id=624689'"/>
<xsl:variable name="text_encoding" select="''"/>
<<<<<<< HEAD
<xsl:variable name="title" select="'1 miljon ruvnnu eanet Máilmmi čuoigangilvvuid eaktodáhtolašvuođaprošektii - regjeringen.no'"/>
=======
<xsl:variable name="title" select="'1 miljon ruvnnu eanet Máilmmi čuoigangilvvuid eaktodáhtolašvuođaprošektii  - regjeringen.no'"/>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
...
<xsl:variable name="para_sme" select="'a-nameoverskrift1-milajon-ruvnnu-eanet-m.html?id=624689'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="a-nameoverskrift1-milajon-ruvnnu-eanet-m_id_624689.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
