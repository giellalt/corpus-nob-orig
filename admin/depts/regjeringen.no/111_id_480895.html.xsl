...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ad/pressesenter/pressemeldinger/2007/111.html?id=480895'"/>
<xsl:variable name="title" select="'Eamiálbmotjulggaštus maid ON’a váldočoahkkin lea mearridan - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'377'"/>
...
<xsl:variable name="para_eng" select="'United-Nations-adopts-Declaration-on-Rig.html?id=480895'"/>
...
<xsl:variable name="para_sme" select="'Eamialbmotjulggatus-maid-ONa-valdooahkki.html?id=480895'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="united-nations-adopts-declaration-on-rig_id_480895.html" xml:lang="eng"/>
	<parallel_text location="eamialbmotjulggatus-maid-ona-valdooahkki_id_480895.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
