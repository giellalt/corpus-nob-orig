...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/md/dok/rundskriv/2009/ikraftsetting-plandel-plan-bygningslov/12-overgangsbestemmelser--34-2.html?id=571104'"/>
<xsl:variable name="title" select="'12. Sirdásannjuolggadusat - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'960'"/>
...
<xsl:variable name="para_sme" select="'12-Sirdasannjuolggadusat.html?id=571104'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="12-sirdasannjuolggadusat_id_571104.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
