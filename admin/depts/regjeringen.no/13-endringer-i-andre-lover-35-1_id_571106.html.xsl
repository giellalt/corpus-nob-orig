...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/md/dok/rundskriv/2009/ikraftsetting-plandel-plan-bygningslov/13-endringer-i-andre-lover-35-1.html?id=571106'"/>
<xsl:variable name="title" select="'13. Nuppástusat eará lágain - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'3021'"/>
...
<xsl:variable name="para_sme" select="'13-Nuppastusat-eara-lagain.html?id=571106'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="13-nuppastusat-eara-lagain_id_571106.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
