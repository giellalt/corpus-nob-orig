...
<xsl:variable name="filename" select="'http://www.regjeringen.no/nb/dep/ad/dok/regpubl/stmeld/2007-2008/stmeld-nr-28-2007-2008-/17.html?id=513062'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'16 Idrett'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="17_id_634197.html" xml:lang="sme"/>
</xsl:variable>
