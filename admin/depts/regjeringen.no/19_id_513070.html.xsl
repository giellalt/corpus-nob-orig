...
<xsl:variable name="filename" select="'http://www.regjeringen.no/nb/dep/ad/dok/regpubl/stmeld/2007-2008/stmeld-nr-28-2007-2008-/19.html?id=513070'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'18 Media'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="19_id_634205.html" xml:lang="sme"/>
</xsl:variable>
