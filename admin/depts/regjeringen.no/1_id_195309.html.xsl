...
<xsl:variable name="filename" select="'http://www.regjeringen.no/nb/dep/ad/dok/regpubl/stmeld/20002001/stmeld-nr-55-2000-2001-/1.html?id=195309'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'St.meld. nr. 55 (2000-2001)'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="1_id_458398.html" xml:lang="sme"/>
</xsl:variable>
