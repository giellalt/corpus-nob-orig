...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/md/dok/rundskriv/2009/ikraftsetting-plandel-plan-bygningslov/2-lovens-fellesbestemmelser.html?id=571084'"/>
<xsl:variable name="title" select="'2. Lága oktasašmearrádusat - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'2806'"/>
...
<xsl:variable name="para_sme" select="'2-Laga-oktasamearradusat.html?id=571084'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="2-laga-oktasamearradusat_id_571084.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
