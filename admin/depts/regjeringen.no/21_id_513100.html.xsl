...
<xsl:variable name="filename" select="'http://www.regjeringen.no/nb/dep/ad/dok/regpubl/stmeld/2007-2008/stmeld-nr-28-2007-2008-/21.html?id=513100'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'20 Ressursutnytting og verdiskapning i samiske områder'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="21_id_634235.html" xml:lang="sme"/>
</xsl:variable>
