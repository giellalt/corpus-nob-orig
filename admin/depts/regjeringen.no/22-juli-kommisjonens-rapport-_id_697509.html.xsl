...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/jd/aktuelt/taler_og_artikler/ministeren/taler-og-artikler-av-grete-faremo/2012/22-juli-kommisjonens-rapport-.html?id=697509'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Suoidnemánu 22.beaivve-kommišuvnna raporta - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'943'"/>
...
<xsl:variable name="para_sme" select="'suoidnemanu-22beaivve-kommiuvnna-raporta.html_id=697509'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="suoidnemanu-22beaivve-kommiuvnna-raporta_id_697509.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
