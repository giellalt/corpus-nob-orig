...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/oed/pressesenter/pressemeldinger/2012/22-konsesjonsrunde--stor-interesse-for-n.html?id=709231'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'22. konsešuvdnavuorru – stuora beroštupmi davvi áhpeguovlluide  - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'481'"/>
...
<xsl:variable name="para_sme" select="'22-konseuvdnavuorru--stuora-berotupmi-da.html_id=709231'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="22nd-licensing-round-great-interest-in-t_id_709231.html" xml:lang="eng"/>
	<parallel_text location="22-konseuvdnavuorru--stuora-berotupmi-da_id_709231.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
