...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/md/dok/rundskriv/2009/ikraftsetting-plandel-plan-bygningslov/3-kart-og-planregister.html?id=571085'"/>
<xsl:variable name="title" select="'3. Kárta ja plánaregisttar - regjeringen.no'"/>
...
<xsl:variable name="para_sme" select="'3-Karta-ja-planaregisttar.html?id=571085'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="3-karta-ja-planaregisttar_id_571085.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
