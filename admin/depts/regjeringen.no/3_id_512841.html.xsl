...
<xsl:variable name="filename" select="'http://www.regjeringen.no/nb/dep/ad/dok/regpubl/stmeld/2007-2008/stmeld-nr-28-2007-2008-/3.html?id=512841'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'2 Mangfold i det samiske samfunnet'"/>
...
<xsl:variable name="para_sme" select="'3.html_id=633976'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="3_id_633976.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> ad2e9f42a5 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
