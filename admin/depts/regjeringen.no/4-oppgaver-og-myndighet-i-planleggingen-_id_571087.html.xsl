...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/md/dok/rundskriv/2009/ikraftsetting-plandel-plan-bygningslov/4-oppgaver-og-myndighet-i-planleggingen-.html?id=571087'"/>
<xsl:variable name="title" select="'4. Bargamušat ja váldi plánemis - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'1626'"/>
...
<xsl:variable name="para_sme" select="'4-Bargamuat-ja-valdi-planemis.html?id=571087'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="4-bargamuat-ja-valdi-planemis_id_571087.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
