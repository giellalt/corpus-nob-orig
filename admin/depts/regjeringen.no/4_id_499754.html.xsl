...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/kud/dok/hoeringer/hoeringsdok/2008/horing---utkast-til-endringer-i-forskrif/-4.html?id=499754'"/>
...
<xsl:variable name="wordcount" select="'848'"/>
...
<xsl:variable name="para_sme" select="'horingsbrev.html?id=499754'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="horingsbrev_id_499754.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
