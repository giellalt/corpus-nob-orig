...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/md/dok/rundskriv/2009/ikraftsetting-plandel-plan-bygningslov/5-generelle-utredningskrav.html?id=571088'"/>
<xsl:variable name="title" select="'5. Oppalaš čielggadangáibádusat - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'1334'"/>
...
<xsl:variable name="para_sme" select="'5-Oppala-ielggadangaibadusat.html?id=571088'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="5-oppala-ielggadangaibadusat_id_571088.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
