...
<xsl:variable name="filename" select="'http://www.regjeringen.no/nb/dep/ad/dok/regpubl/stmeld/2007-2008/stmeld-nr-28-2007-2008-/5.html?id=512865'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'4 Diskriminering og likestilling'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="5_id_634000.html" xml:lang="sme"/>
</xsl:variable>
