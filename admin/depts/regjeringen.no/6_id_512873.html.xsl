...
<xsl:variable name="filename" select="'http://www.regjeringen.no/nb/dep/ad/dok/regpubl/stmeld/2007-2008/stmeld-nr-28-2007-2008-/6.html?id=512873'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'5 Velferdssamfunnet i et samisk perspektiv'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="6_id_634008.html" xml:lang="sme"/>
</xsl:variable>
