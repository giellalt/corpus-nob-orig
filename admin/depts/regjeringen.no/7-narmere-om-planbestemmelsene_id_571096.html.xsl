...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/md/dok/rundskriv/2009/ikraftsetting-plandel-plan-bygningslov/7-narmere-om-planbestemmelsene.html?id=571096'"/>
<xsl:variable name="title" select="'7. Dárkileappot plánamearrádusaid birra - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'3450'"/>
...
<xsl:variable name="para_sme" select="'7-Darkileappot-planamearradusaid-birra.html?id=571096'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="7-darkileappot-planamearradusaid-birra_id_571096.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
