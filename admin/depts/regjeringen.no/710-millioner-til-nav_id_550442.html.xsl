...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ad/pressesenter/pressemeldinger/2009/710-millioner-til-nav.html?id=550442'"/>
<xsl:variable name="title" select="'710 miljovnna NAV:i - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'571'"/>
...
<xsl:variable name="para_sme" select="'710-miljovnna-navi.html?id=550442'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="710-miljovnna-navi_id_550442.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
