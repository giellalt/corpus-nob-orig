...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/md/dok/rundskriv/2009/ikraftsetting-plandel-plan-bygningslov/8-midlertidig-forbud-mot-tiltak.html?id=571099'"/>
<xsl:variable name="title" select="'8. Gaskaboddasaš doaibmabidjogielddus - regjeringen.no'"/>
...
<xsl:variable name="para_sme" select="'8-Gaskaboddasa-doaibmabidjogielddus.html?id=571099'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="8-gaskaboddasa-doaibmabidjogielddus_id_571099.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
