...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ad/pressesenter/pressemeldinger/2007/86.html?id=476423'"/>
...
<xsl:variable name="wordcount" select="'433'"/>
...
<xsl:variable name="para_sme" select="'Nye.html?id=476423'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="nye_id_476423.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
