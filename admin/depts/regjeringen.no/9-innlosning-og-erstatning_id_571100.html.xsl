...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/md/dok/rundskriv/2009/ikraftsetting-plandel-plan-bygningslov/9-innlosning-og-erstatning.html?id=571100'"/>
<xsl:variable name="title" select="'9. Lonástus ja buhtadus - regjeringen.no'"/>
...
<xsl:variable name="para_sme" select="'9-Lonastus-ja-buhtadus.html?id=571100'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="9-lonastus-ja-buhtadus_id_571100.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
