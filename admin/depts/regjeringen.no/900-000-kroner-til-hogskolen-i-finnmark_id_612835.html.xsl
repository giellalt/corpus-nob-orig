...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/krd/pressesenter/pressemeldinger/2010/900-000-kroner-til-hogskolen-i-finnmark.html?id=612835'"/>
<xsl:variable name="title" select="'900 000 kroner til Høgskolen i Finnmark - regjeringen.no'"/>
...
<xsl:variable name="para_sme" select="'finnmarkku-allaskuvla.html?id=612835'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="finnmarkku-allaskuvla_id_612835.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
