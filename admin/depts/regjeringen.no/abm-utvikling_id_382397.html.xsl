...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/kud/dep/underliggende_etater/abm-utvikling.html?id=382397'"/>
<xsl:variable name="title" select="'AGV-ovdánahttin - regjeringen.no'"/>
...
<xsl:variable name="para_nno" select="'abm-utvikling.html?id=382397'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'AGV-ovdanahttin.html?id=382397'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="abm-utvikling_id_382397.html" xml:lang="nno"/>
	<parallel_text location="agv-ovdanahttin_id_382397.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
