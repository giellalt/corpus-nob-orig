...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/nhd/dep/org/avdelinger/administrasjonsavdelingen.html?id=1532'"/>
<xsl:variable name="title" select="'Hálddahusossodat - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'administrative-department.html?id=1532'"/>
...
<xsl:variable name="para_sme" select="'halddahusossodat.html?id=1532'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="administrative-department_id_1532.html" xml:lang="eng"/>
	<parallel_text location="halddahusossodat_id_1532.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
