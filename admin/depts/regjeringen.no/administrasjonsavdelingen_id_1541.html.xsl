...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fin/dep/org/avdelinger/administrasjonsavdelingen.html?id=1541'"/>
<xsl:variable name="title" select="'Hálldahussodat - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'the-department-of-administrative-affairs.html?id=1541'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'administrasjonsavdelinga.html?id=1541'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Halldahusodat.html?id=1541'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="the-department-of-administrative-affairs_id_1541.html" xml:lang="eng"/>
	<parallel_text location="administrasjonsavdelinga_id_1541.html" xml:lang="nno"/>
	<parallel_text location="halldahusodat_id_1541.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
