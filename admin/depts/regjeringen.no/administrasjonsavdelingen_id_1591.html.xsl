...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/dep/org/avdelinger/administrasjonsavdelingen.html?id=1591'"/>
...
<xsl:variable name="wordcount" select="'475'"/>
...
<xsl:variable name="para_sme" select="'halddahusossodat.html?id=1591'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="halddahusossodat_id_1591.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
