...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fkd/dep/org/avdelinger/administrasjonsenheten.html?id=85854'"/>
<xsl:variable name="title" select="'Hálddahusovttadat - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'280'"/>
...
<xsl:variable name="para_eng" select="'department-of-administration.html?id=85854'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Administrasjonseininga.html?id=85854'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Halddahusovttadat.html?id=85854'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="department-of-administration_id_85854.html" xml:lang="eng"/>
	<parallel_text location="administrasjonseininga_id_85854.html" xml:lang="nno"/>
	<parallel_text location="halddahusovttadat_id_85854.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
