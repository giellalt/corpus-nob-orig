...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/sd/dep/organisasjon/avdelinger/plan-_okonomi-_og_administrasjonsavdelin/administrativ-seksjon-as.html?id=332363'"/>
<xsl:variable name="title" select="'Hálddahuslaš sekšuvdna - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'203'"/>
...
<xsl:variable name="para_nno" select="'Administrativ-seksjon-AS.html?id=332363'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Halddahusla-sekuvdna.html?id=332363'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="administrativ-seksjon-as_id_332363.html" xml:lang="nno"/>
	<parallel_text location="halddahusla-sekuvdna_id_332363.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
