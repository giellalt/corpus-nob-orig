...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fin/dep/administrativ_ledelse.html?id=239'"/>
<xsl:variable name="title" select="'Hálddahuslaš jodihangoddi - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'Senior-administrative-staff.html?id=239'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Administrative-leiing.html?id=239'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Halddahusla-jodihangoddi.html?id=239'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="senior-administrative-staff_id_239.html" xml:lang="eng"/>
	<parallel_text location="administrative-leiing_id_239.html" xml:lang="nno"/>
	<parallel_text location="halddahusla-jodihangoddi_id_239.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
