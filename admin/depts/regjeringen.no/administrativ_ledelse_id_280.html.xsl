...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fkd/dep/administrativ_ledelse.html?id=280'"/>
...
<xsl:variable name="para_eng" select="'Senior-administrative-staff.html?id=280'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Administrativ-leiing.html?id=280'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Halddahusla-joihus.html?id=280'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="senior-administrative-staff_id_280.html" xml:lang="eng"/>
	<parallel_text location="administrativ-leiing_id_280.html" xml:lang="nno"/>
	<parallel_text location="halddahusla-joihus_id_280.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
