...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/bld/dep/administrativ_ledelse.html?id=321'"/>
...
<xsl:variable name="para_eng" select="'Administrative-leadership.html?id=321'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'administrativ-leiing.html?id=321'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Halddahusla-joihus.html?id=321'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="administrative-leadership_id_321.html" xml:lang="eng"/>
	<parallel_text location="administrativ-leiing_id_321.html" xml:lang="nno"/>
	<parallel_text location="halddahusla-joihus_id_321.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
