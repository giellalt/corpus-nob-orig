...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/dep/administrativ_ledelse.html?id=362'"/>
<xsl:variable name="title" select="'Halddahuslaš jođihangoddi - regjeringen.no'"/>
...
<xsl:variable name="para_nno" select="'Administrativ-leiing.html?id=362'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Halddahusla-joihangoddi.html?id=362'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="administrativ-leiing_id_362.html" xml:lang="nno"/>
	<parallel_text location="halddahusla-joihangoddi_id_362.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
