...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/kud/dep/administrativ_ledelse.html?id=568'"/>
...
<xsl:variable name="para_nno" select="'Administrativ-leiing.html?id=568'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Halddahusla-joihus-.html?id=568'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="administrativ-leiing_id_568.html" xml:lang="nno"/>
	<parallel_text location="halddahusla-joihus-_id_568.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
