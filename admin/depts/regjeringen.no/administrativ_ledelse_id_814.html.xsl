...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/sd/dep/administrativ_ledelse.html?id=814'"/>
<xsl:variable name="title" select="'Hálddahusnjunušgoddi - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'senior-administrative-staff.html?id=814'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'administrativ-leiing.html?id=814'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'halddahusnjunugoddi.html?id=814'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="senior-administrative-staff_id_814.html" xml:lang="eng"/>
	<parallel_text location="administrativ-leiing_id_814.html" xml:lang="nno"/>
	<parallel_text location="halddahusnjunugoddi_id_814.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
