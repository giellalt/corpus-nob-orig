...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ud/dep/administrativ_ledelse.html?id=856'"/>
...
<xsl:variable name="para_eng" select="'senior-administrative-staff-2.html?id=856'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Admnistrativ-leiing.html?id=856'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'halddahusla-njunugodd.html?id=856'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="senior-administrative-staff-2_id_856.html" xml:lang="eng"/>
	<parallel_text location="admnistrativ-leiing_id_856.html" xml:lang="nno"/>
	<parallel_text location="halddahusla-njunugodd_id_856.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
