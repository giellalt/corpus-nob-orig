...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/krd/dep/org/avdelinger/kommunikasjonsenheten/agnar-kaarbo.html?id=591105'"/>
<xsl:variable name="title" select="'Seniorráđđeaddi Agnar Kaarbø - regjeringen.no'"/>
...
<xsl:variable name="para_sme" select="'Seniorraeaddi-Agnar-Kaarbo.html?id=591105'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="seniorraeaddi-agnar-kaarbo_id_591105.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
