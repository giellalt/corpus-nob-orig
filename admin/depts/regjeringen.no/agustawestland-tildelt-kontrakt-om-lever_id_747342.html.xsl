...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/jd/pressesenter/pressemeldinger/20131/agustawestland-tildelt-kontrakt-om-lever.html?id=747342'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'AgustaWestland lea ožžon fálaldaga skáhput ođđa gádjunhelikopteriid - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'350'"/>
...
<xsl:variable name="para_sme" select="'agustawestland-lea-oon-falaldaga-skahput.html_id=747342'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="agustawestland-awarded-contract_id_747342.html" xml:lang="eng"/>
	<parallel_text location="agustawestland-lea-oon-falaldaga-skahput_id_747342.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
