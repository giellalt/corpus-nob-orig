...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/krd/kampanjer/valg/valgobservasjon/akkreditering-av-valgobservatorer.html?id=573464'"/>
<xsl:variable name="title" select="'Akkreditering av valgobservatører - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'accreditation-of-election-observers.html?id=573464'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="accreditation-of-election-observers_id_573464.html" xml:lang="eng"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
