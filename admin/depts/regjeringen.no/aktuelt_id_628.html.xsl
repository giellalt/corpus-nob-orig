...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/lmd/aktuelt.html?id=628'"/>
...
<xsl:variable name="wordcount" select="'724'"/>
...
<xsl:variable name="para_eng" select="'whats-new.html?id=628'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'aktuelt.html?id=628'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Aigeguovdil.html?id=628'"/>
