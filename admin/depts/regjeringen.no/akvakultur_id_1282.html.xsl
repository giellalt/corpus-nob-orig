...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fkd/tema/akvakultur.html?id=1282'"/>
<xsl:variable name="title" select="'Akvakultuvra - regjeringen.no'"/>
...
<xsl:variable name="para_nno" select="'havbruksnaringa.html?id=1282'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'akvakultuvra.html?id=1282'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="havbruksnaringa_id_1282.html" xml:lang="nno"/>
	<parallel_text location="akvakultuvra_id_1282.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
