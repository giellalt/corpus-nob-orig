...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/krd/dep/org/avdelinger/kommunikasjonsenheten/ams.html?id=446500'"/>
<xsl:variable name="title" select="'Nubbinjođiheaddji Anne Marit Schiong - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'head-of-information-anne-marit-schiong.html?id=446500'"/>
...
<xsl:variable name="para_sme" select="'Nubbinjoiheaddji-Anne-Marit-Schiong.html?id=446500'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="head-of-information-anne-marit-schiong_id_446500.html" xml:lang="eng"/>
	<parallel_text location="nubbinjoiheaddji-anne-marit-schiong_id_446500.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
