...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ad/dep/org/avdelinger/ams.html?id=972'"/>
<xsl:variable name="title" select="'Bargobiras- ja sihkkarvuođaossodat  - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'289'"/>
...
<xsl:variable name="para_eng" select="'the-working-environment-and-safety-depar.html?id=972'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Arbeidsmiljo--og-sikkerheitsavdelinga.html?id=972'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Bargobiras--ja-sihkkarvuoaossodat-.html?id=972'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="the-working-environment-and-safety-depar_id_972.html" xml:lang="eng"/>
	<parallel_text location="arbeidsmiljo--og-sikkerheitsavdelinga_id_972.html" xml:lang="nno"/>
	<parallel_text location="bargobiras--ja-sihkkarvuoaossodat-_id_972.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
