...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ad/dep/org/avdelinger/arba/analyse-_og_inntektspolitisk_seksjon.html?id=85772'"/>
<xsl:variable name="title" select="'Analysa- ja sisaboahtopolitihkalaš sekšuvdna (AS) - regjeringen.no'"/>
...
<xsl:variable name="para_sme" select="'Analysa--ja-sisaboahtopolitihkala-sekuvdna-AS.html?id=85772'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="analysa--ja-sisaboahtopolitihkala-sekuvdna-as_id_85772.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
