...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/kud/dep/org/avdelinger/medieavdelingen_/andre-medieseksjon-m2.html?id=551456'"/>
<xsl:variable name="title" select="'Sekšuvdna  M2 - regjeringen.no'"/>
...
<xsl:variable name="para_sme" select="'Sekuvdna--M2.html?id=551456'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="sekuvdna--m2_id_551456.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
