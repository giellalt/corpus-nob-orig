...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/bld/dok/andre.html?id=313732'"/>
<xsl:variable name="title" select="'Eará dokumeanttat - regjeringen.no'"/>
...
<xsl:variable name="para_nno" select="'Andre-dokument.html?id=313732'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Eara-dokumeanttat.html?id=313732'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="andre-dokument_id_313732.html" xml:lang="nno"/>
	<parallel_text location="eara-dokumeanttat_id_313732.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
