...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/md/dep/org/avdelinger/kommunikasjonsenheten/andreas_keus.html?id=85688'"/>
<xsl:variable name="title" select="'Diehtojuohkinráđđeaddi Andreas Keus - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'information-adviser-andreas-keus.html?id=85688'"/>
...
<xsl:variable name="para_sme" select="'Diehtojuohkinraeaddi-Anders-Keus.html?id=85688'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="information-adviser-andreas-keus_id_85688.html" xml:lang="eng"/>
	<parallel_text location="diehtojuohkinraeaddi-anders-keus_id_85688.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
