...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ad/dep/org/avdelinger/pks/anita-sletten.html?id=445790'"/>
<xsl:variable name="title" select="'Gulahallanráđđeaddi Anita Sletten - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'communications-adviser-anita-sletten.html?id=445790'"/>
...
<xsl:variable name="para_sme" select="'gulahallanraeaddi-anita-sletten.html?id=445790'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="communications-adviser-anita-sletten_id_445790.html" xml:lang="eng"/>
	<parallel_text location="gulahallanraeaddi-anita-sletten_id_445790.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
