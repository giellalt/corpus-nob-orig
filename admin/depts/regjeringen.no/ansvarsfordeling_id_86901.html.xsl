...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ad/tema/arbeidsmarkedspolitikk/midtspalte/ansvarsfordeling.html?id=86901'"/>
<xsl:variable name="title" select="'Ovddasvástádussuorggit ja váikkuhangaskaoamit - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'areas-of-responsibility-and-policy-instr.html?id=86901'"/>
...
<xsl:variable name="para_sme" select="'Ovddasvastadussuorggit-ja-vaikkuhangaskaoamit.html?id=86901'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="areas-of-responsibility-and-policy-instr_id_86901.html" xml:lang="eng"/>
	<parallel_text location="ovddasvastadussuorggit-ja-vaikkuhangaskaoamit_id_86901.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
