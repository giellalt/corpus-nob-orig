...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ad/dep/ansvarsomraader.html?id=190'"/>
...
<xsl:variable name="para_nno" select="'ansvarsomrade.html?id=190'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Ansvarsomrader.html?id=190'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="ansvarsomrade_id_190.html" xml:lang="nno"/>
	<parallel_text location="ansvarsomrader_id_190.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
