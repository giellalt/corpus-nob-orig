...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/dep/ansvarsomraader.html?id=364'"/>
...
<xsl:variable name="para_nno" select="'ansvarsomrade.html?id=364'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'ovdasiidu.html?id=364'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="ansvarsomrade_id_364.html" xml:lang="nno"/>
	<parallel_text location="ovdasiidu_id_364.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
