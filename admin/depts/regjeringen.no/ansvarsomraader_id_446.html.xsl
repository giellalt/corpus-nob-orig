...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/hod/dep/ansvarsomraader.html?id=446'"/>
<xsl:variable name="title" select="'Departemeantta ovddasvástádussuorggit - regjeringen.no'"/>
...
<xsl:variable name="para_sme" select="'departemeantta-ovddasvastadussuorggit.html?id=446'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="departemeantta-ovddasvastadussuorggit_id_446.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
