...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/kd/dep/ansvarsomraader.html?id=611'"/>
<xsl:variable name="title" select="'Ovddasvástádussuorggit - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'373'"/>
...
<xsl:variable name="para_eng" select="'areas-of-responsibilities.html?id=611'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'ansvarsomrade.html?id=611'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Ovddasvastadussuorggit.html?id=611'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="areas-of-responsibilities_id_611.html" xml:lang="eng"/>
	<parallel_text location="ansvarsomrade_id_611.html" xml:lang="nno"/>
	<parallel_text location="ovddasvastadussuorggit_id_611.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
