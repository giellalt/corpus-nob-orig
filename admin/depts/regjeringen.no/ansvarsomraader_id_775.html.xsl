...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/oed/dep/ansvarsomraader.html?id=775'"/>
...
<xsl:variable name="para_nno" select="'Ansvarsomrade.html?id=775'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Ovddasvastadussuorggit.html?id=775'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="ansvarsomrade_id_775.html" xml:lang="nno"/>
	<parallel_text location="ovddasvastadussuorggit_id_775.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
