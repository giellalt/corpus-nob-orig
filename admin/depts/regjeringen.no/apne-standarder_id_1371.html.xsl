...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/tema/ikt-politikk/apne-standarder.html?id=1371'"/>
<xsl:variable name="title" select="'Rabas standárddat - regjeringen.no'"/>
...
<xsl:variable name="para_sme" select="'Rabas-standarddat.html?id=1371'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="rabas-standarddat_id_1371.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
