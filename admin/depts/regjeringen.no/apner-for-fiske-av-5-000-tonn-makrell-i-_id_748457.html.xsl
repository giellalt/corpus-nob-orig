...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/nfd/pressesenter/pressemeldinger/2013/apner-for-fiske-av-5-000-tonn-makrell-i-.html?id=748457'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Vejolašvuohta bivdit 5 000 tonna makrealla Davvi-Norggas - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'380'"/>
...
<xsl:variable name="para_eng" select="'change-of-name-the-ministry-of-labour-an.html_id=748569'"/>
...
<xsl:variable name="para_sme" select="'vejolavuohta-bivdit-5-000-tonna-makreall.html_id=748457'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="change-of-name-the-ministry-of-labour-an.html_id=748569" xml:lang="eng"/>
	<parallel_text location="departementet-skiftar-namn.html_id=748569" xml:lang="nno"/>
	<parallel_text location="vejolavuohta-bivdit-5-000-tonna-makreall_id_748457.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
