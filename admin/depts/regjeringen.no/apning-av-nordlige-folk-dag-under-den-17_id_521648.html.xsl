...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ad/aktuelt/taler_artikler/politisk_ledelse/statssekretar-raimo-valle/2008/apning-av-nordlige-folk-dag-under-den-17.html?id=521648'"/>
<<<<<<< HEAD
<xsl:variable name="title" select="'Åpning av Nordlige folk dag under den 17. Riddu Riđđu festivalen - regjeringen.no'"/>
=======
...
=======
<xsl:variable name="wordcount" select="'578'"/>
<xsl:variable name="metadata" select="'uncomplete'"/>
...
<xsl:variable name="para_sme" select="'sahkavuorru-davvila-albmogiid-beaivvi-ra.html?id=521648'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="sahkavuorru-davvila-albmogiid-beaivvi-ra_id_521648.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
