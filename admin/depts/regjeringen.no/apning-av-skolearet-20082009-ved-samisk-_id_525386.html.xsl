...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ad/aktuelt/taler_artikler/politisk_ledelse/statssekretar-raimo-valle/2008/apning-av-skolearet-20082009-ved-samisk-.html?id=525386'"/>
<<<<<<< HEAD
<xsl:variable name="title" select="'Åpning av skoleåret 2008/2009 ved Samisk høgskole  - regjeringen.no'"/>
=======
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Sáhkavuorru Sámi allaskuvlla skuvlajagi 2008/2009 rahpamii Guovdageainnus borgemánu 28.beaivvi 2008 - regjeringen.no'"/>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
...
<<<<<<< HEAD
<xsl:variable name="wordcount" select="'2076'"/>
<xsl:variable name="metadata" select="'uncomplete'"/>
<xsl:variable name="template_version" select="'$Revision$'"/>
=======
<xsl:variable name="wordcount" select="'1685'"/>
<xsl:variable name="metadata" select="'uncomplete'"/>
...
<xsl:variable name="para_sme" select="'sahkavuorru-sami-allaskuvlla-skuvlajagi-.html?id=525386'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="sahkavuorru-sami-allaskuvlla-skuvlajagi-_id_525386.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
