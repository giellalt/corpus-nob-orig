...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/aktuelt/taler_og_artikler/av_ovrig_politisk_ledelse/taler-og-artikler-av-statssekretar-raimo/2010/Apning-av-Storfjord-spraksenter.html?id=593500'"/>
<xsl:variable name="title" select="'Åpning av Storfjord språksenter - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'2166'"/>
...
<xsl:variable name="para_sme" select="'Dearvvuoat-Omasvuona-giellaguovdda-rahpamis.html?id=593500'"/>
...
<!-- variable filename contains the original name of the file (from submitter)-->
  ...
  <xsl:variable name="title" select="'Dearvvuođat Omasvuona giellaguovddáš rahpamis - regjeringen.no'"/>
  <xsl:variable name="author1_fn" select="''"/>
  <xsl:variable name="author1_ln" select="''"/>
  <xsl:variable name="author1_gender" select="'unknown'"/>
  <xsl:variable name="author1_nat" select="''"/>
  ...
  <xsl:variable name="sub_name" select="''"/>
  <xsl:variable name="sub_email" select="'divvun@samediggi.no'"/>
  <xsl:variable name="wordcount" select="'728'"/>
  <xsl:variable name="metadata" select="'uncomplete'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="dearvvuoat-omasvuona-giellaguovdda-rahpamis_id_593500.html" xml:lang="sme"/>
</xsl:variable>
