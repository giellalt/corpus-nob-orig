...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/aktuelt/taler_og_artikler/av_ovrig_politisk_ledelse/taler-og-artikler-av-statssekretar-raimo/2010/Apningen-av-den-internasjonale-konferansen-Sameksistens-i-Arktis-.html?id=593056'"/>
<<<<<<< HEAD
<xsl:variable name="title" select="'Åpningen av den internasjonale konferansen ”Sameksistens i Arktis”  - regjeringen.no'"/>
=======
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Rahpansárdni riikkaidgaskasaš konfereanssas “Ovttaseallin Árktisas” - regjeringen.no'"/>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
...
<<<<<<< HEAD
<xsl:variable name="wordcount" select="'871'"/>
<xsl:variable name="metadata" select="'uncomplete'"/>
<xsl:variable name="template_version" select="'$Revision$'"/>
=======
<xsl:variable name="wordcount" select="'716'"/>
<xsl:variable name="metadata" select="'uncomplete'"/>
...
<xsl:variable name="para_sme" select="'Rahpansardni-riikkaidgaskasa-konfereanssas-Ovttaseallin-Arktisas.html?id=593056'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="rahpansardni-riikkaidgaskasa-konfereanssas-ovttaseallin-arktisas_id_593056.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
