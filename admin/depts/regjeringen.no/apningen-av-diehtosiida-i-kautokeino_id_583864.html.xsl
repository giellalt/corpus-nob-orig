...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/aktuelt/taler_og_artikler/av_ovrig_politisk_ledelse/taler-og-artikler-av-statssekretar-raimo/2009/apningen-av-diehtosiida-i-kautokeino.html?id=583864'"/>
<<<<<<< HEAD
<xsl:variable name="title" select="'Åpningen av Diehtosiida i Kautokeino - regjeringen.no'"/>
=======
...
<xsl:variable name="para_sme" select="'diehtosiidda-rahpan-guovdageainnus.html?id=583864'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="diehtosiidda-rahpan-guovdageainnus_id_583864.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
