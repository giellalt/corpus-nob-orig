...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ad/aktuelt/taler_artikler/politisk_ledelse/tidligere_statssekretar_berit_oskal_eira/2007/apningen-av-forskningsprosjektet-ealat--.html?id=451244'"/>
<<<<<<< HEAD
<xsl:variable name="title" select="'Åpningen av forskningsprosjektet EALÁT – 15. februar 2007 i Kautokeino   - regjeringen.no'"/>
=======
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'EALÁT – dutkanprošeavtta rahpan 15. 2.07 Guovdageainnus - regjeringen.no'"/>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
...
<<<<<<< HEAD
<xsl:variable name="wordcount" select="'787'"/>
<xsl:variable name="metadata" select="'uncomplete'"/>
<xsl:variable name="template_version" select="'$Revision$'"/>
=======
<xsl:variable name="wordcount" select="'605'"/>
<xsl:variable name="metadata" select="'uncomplete'"/>
...
<xsl:variable name="para_sme" select="'EALAT--dutkanproeavtta-rahpan-15-207-Guo.html?id=451244'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="ealat--dutkanproeavtta-rahpan-15-207-guo_id_451244.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
