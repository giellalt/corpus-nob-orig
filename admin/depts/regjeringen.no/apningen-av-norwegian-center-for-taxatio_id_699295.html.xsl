...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fin/aktuelt/taler_artikler/ministeren/taler-og-artikler-av-finansminister/2012/apningen-av-norwegian-center-for-taxatio.html?id=699295'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Norwegian Center for Taxation (NoCeT) ja Oslo Fiscal Studies (OFS) rahpan - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'882'"/>
...
<xsl:variable name="para_sme" select="'norwegian-center-for-taxation-nocet-ja-o.html_id=699295'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="norwegian-center-for-taxation-nocet-ja-o_id_699295.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
