...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ad/dep/org/avdelinger/arba.html?id=960'"/>
<xsl:variable name="title" select="'Bargomárkanossodat  - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'the-department-of-labour-market-affairs.html?id=960'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Arbeidsmarknadsavdelinga.html?id=960'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Bargomarkanossodat-.html?id=960'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="the-department-of-labour-market-affairs_id_960.html" xml:lang="eng"/>
	<parallel_text location="arbeidsmarknadsavdelinga_id_960.html" xml:lang="nno"/>
	<parallel_text location="bargomarkanossodat-_id_960.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
