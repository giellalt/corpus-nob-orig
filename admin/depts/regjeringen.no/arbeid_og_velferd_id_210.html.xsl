...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/tema/arbeid_og_velferd.html?id=210'"/>
<xsl:variable name="title" select="'Bargu ja čálgu - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'678'"/>
...
<xsl:variable name="para_eng" select="'engelsk-tema.html?id=210'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'arbeid-og-velferd-nynorsk.html?id=210'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'bargu-ja-algu.html?id=210'"/>
