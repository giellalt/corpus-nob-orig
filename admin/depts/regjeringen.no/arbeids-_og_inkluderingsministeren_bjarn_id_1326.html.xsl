...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dokumentarkiv/stoltenberg-ii/aid/andre-dokumenter/personer/2005/arbeids-_og_inkluderingsministeren_bjarn.html?id=1326'"/>
<xsl:variable name="title" select="'Ovddeš bargo- ja searvadahttinministtar Bjarne Håkon Hanssen - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'255'"/>
...
<xsl:variable name="para_eng" select="'minister-of-labour-and-social-inclusion-.html?id=1326'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'arbeids--og-inkluderingsminister-bjarne-.html?id=1326'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'bargo--ja-searvadahttinministtar-bjarne-.html?id=1326'"/>
...
<xsl:variable name="parallels">
	...
	<parallel_text location="arbeids--og-inkluderingsminister-bjarne-_id_1326.html" xml:lang="nno"/>
	<parallel_text location="bargo--ja-searvadahttinministtar-bjarne-_id_1326.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
