...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/dep/org/avdelinger/arbeidsgiverpolitisk_avdeling.html?id=1590'"/>
<xsl:variable name="title" select="'Bargoaddipolitihkalaš ossodat - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'Department-of-Employer-Policy.html?id=1590'"/>
...
<xsl:variable name="para_sme" select="'bargoaddipolitihkala-ossodat.html?id=1590'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="department-of-employer-policy_id_1590.html" xml:lang="eng"/>
	<parallel_text location="bargoaddipolitihkala-ossodat_id_1590.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
