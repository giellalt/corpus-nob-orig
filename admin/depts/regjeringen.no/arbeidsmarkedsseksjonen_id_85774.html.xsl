...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ad/dep/org/avdelinger/arba/arbeidsmarkedsseksjonen.html?id=85774'"/>
<xsl:variable name="title" select="'Bargomárkansekšuvdna (BMS) - regjeringen.no'"/>
...
<xsl:variable name="para_sme" select="'Bargomarkansekuvdna-BMS.html?id=85774'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="bargomarkansekuvdna-bms_id_85774.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
