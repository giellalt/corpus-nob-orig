...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ad/tema/arbeidsmarkedspolitikk/midtspalte/arbeidsmarkedstiltak.html?id=86897'"/>
<xsl:variable name="title" select="'Bargomárkandoaibmabijut - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'labour-market-measures.html?id=86897'"/>
...
<xsl:variable name="para_sme" select="'Bargomarkandoaibmabijut.html?id=86897'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="labour-market-measures_id_86897.html" xml:lang="eng"/>
	<parallel_text location="bargomarkandoaibmabijut_id_86897.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
