...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ad/tema/arbeidsmarkedspolitikk/midtspalte/arbeidsretting.html?id=85996'"/>
<xsl:variable name="title" select="'Barguioaččuheapmi    - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'work-orientation.html?id=85996'"/>
...
<xsl:variable name="para_sme" select="'Barguioauheapmi---.html?id=85996'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="work-orientation_id_85996.html" xml:lang="eng"/>
	<parallel_text location="barguioauheapmi---_id_85996.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
