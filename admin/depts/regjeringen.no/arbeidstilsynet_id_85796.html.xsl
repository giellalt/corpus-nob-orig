...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ad/dep/underliggende_etater/arbeidstilsynet.html?id=85796'"/>
<xsl:variable name="title" select="'Bargobearráigeahčču - regjeringen.no'"/>
...
<xsl:variable name="para_sme" select="'Bargobearraigeahu.html?id=85796'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="bargobearraigeahu_id_85796.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
