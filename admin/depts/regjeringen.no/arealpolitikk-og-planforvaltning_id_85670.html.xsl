...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/md/dep/org/avdelinger/regional_planlegging/arealpolitikk-og-planforvaltning.html?id=85670'"/>
<xsl:variable name="title" select="'Suohkana arealplánema sekšuvdna - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'235'"/>
...
<xsl:variable name="para_eng" select="'land-use-policy-municipal-planning.html?id=85670'"/>
...
<xsl:variable name="para_sme" select="'Suohkana-arealplanema-sekuvdna.html?id=85670'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="land-use-policy-municipal-planning_id_85670.html" xml:lang="eng"/>
	<parallel_text location="suohkana-arealplanema-sekuvdna_id_85670.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
