...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/nhd/dep/org/avdelinger/administrasjonsavdelingen/arkiv.html?id=86869'"/>
<xsl:variable name="title" select="'Arkiiva ja IKT - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'archives-and-ict.html?id=86869'"/>
...
<xsl:variable name="para_sme" select="'Arkiiva-ja-IKT.html?id=86869'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="archives-and-ict_id_86869.html" xml:lang="eng"/>
	<parallel_text location="arkiiva-ja-ikt_id_86869.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
