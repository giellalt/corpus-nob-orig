...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/kud/pressesenter/pressemeldinger/2010/arne-nordheims-komponistpris-til-ruben-s.html?id=614509'"/>
<xsl:variable name="title" select="'Arne Nordheims komponistpris til Ruben Sverre Gjertsen - regjeringen.no'"/>
...
<xsl:variable name="para_sme" select="'Arne-Nordheima-komponistabalkkaupmi-Ruben-Sverre-Gjertsenii.html?id=614509'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="arne-nordheima-komponistabalkkaupmi-ruben-sverre-gjertsenii_id_614509.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
