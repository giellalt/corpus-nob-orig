...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/md/dep/org/avdelinger/naturforvaltning/artsforvaltning_og_skog.html?id=51527'"/>
<xsl:variable name="title" select="'Luonddugáhttema ja fuođđohálddašeami sekšuvdna - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'section-for-forests-and-management-of-sp.html?id=51527'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="section-for-forests-and-management-of-sp_id_51527.html" xml:lang="eng"/>
	<parallel_text location="luonddugahttema-ja-fuoohalddaeami-sekuvdna_id_51527.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
