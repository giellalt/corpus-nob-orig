...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fin/pressesenter/pressemeldinger/2013/arveavgiften-fjernes-fra-2014.html?id=745266'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Árbedivat heaittihuvvo 2014 - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'559'"/>
...
<xsl:variable name="para_sme" select="'arbedivat-heaittihuvvo-2014.html_id=745266'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="arbedivat-heaittihuvvo-2014_id_745266.html" xml:lang="sme"/>
<parallel_text location="arveavgifta-vert-fjerna-fra-2014_id_745266.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
