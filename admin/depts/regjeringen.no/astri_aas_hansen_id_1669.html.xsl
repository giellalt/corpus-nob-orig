...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/jd/dep/politisk_ledelse/astri_aas_hansen.html?id=1669'"/>
<xsl:variable name="title" select="'Stáhtačálli Astri Aas-Hansen - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'State-Secretary-Astri-Aas-Hansen.html?id=1669'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Astri_Aas_Hansen.html?id=1669'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="state-secretary-astri-aas-hansen_id_1669.html" xml:lang="eng"/>
	<parallel_text location="astri_aas_hansen_id_1669.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
