...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ad/dep/org/avdelinger/aua.html?id=954'"/>
<xsl:variable name="title" select="'Hálddahus- ja ovddádusossodat - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'the-department-of-administration.html?id=954'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Administrasjons--og-utviklingsavdelinga.html?id=954'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Halddahus--ja-bueahttaossodat-.html?id=954'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="the-department-of-administration_id_954.html" xml:lang="eng"/>
	<parallel_text location="administrasjons--og-utviklingsavdelinga_id_954.html" xml:lang="nno"/>
	<parallel_text location="halddahus--ja-bueahttaossodat-_id_954.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
