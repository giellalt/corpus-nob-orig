...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="author1_ln" select="'Forsvarsdepartementet'"/>
    <!-- m, f or unknown -->
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="the-department-of-defence-policy-and-lon_id_1352.html"/>
        ...
        <parallel_text xml:lang="nno" location="avdeling-for-forsvarspolitikk-og-langtid_id_1352.html"/>
        <parallel_text xml:lang="nob" location=""/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location=""/>
        <parallel_text xml:lang="sme" location="suodjaluspolitihka-ja-guhkesaiggiplanema-ossodat_id_1352.html"/>
