...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fkd/dep/org/avdelinger/avdeling_for_havbruk_sjomat_og_marked.html?id=874'"/>
<xsl:variable name="title" select="'Mearradoalu, mearrabiepmu ja márkana ossodat - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'286'"/>
...
<xsl:variable name="para_eng" select="'department-of-aquaculture-seafood-and-ma.html?id=874'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'avdeling-for-havbruk-sjomat-og-marknad.html?id=874'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'mearradoalu-mearrabiepmu-ja-markana-osso.html?id=874'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="department-of-aquaculture-seafood-and-ma_id_874.html" xml:lang="eng"/>
	<parallel_text location="avdeling-for-havbruk-sjomat-og-marknad_id_874.html" xml:lang="nno"/>
	<parallel_text location="mearradoalu-mearrabiepmu-ja-markana-osso_id_874.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
