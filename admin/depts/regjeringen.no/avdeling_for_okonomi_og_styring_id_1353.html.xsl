...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fd/dep/org/avdelinger/avdeling_for_okonomi_og_styring.html?id=1353'"/>
<xsl:variable name="title" select="'Ekonomiija- ja stivrenossodat - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'the-department-for-finance-and-managemen.html?id=1353'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'avdeling-for-okonomi-og-styring.html?id=1353'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Ekonomiija--ja-stivrenossodat.html?id=1353'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="the-department-for-finance-and-managemen_id_1353.html" xml:lang="eng"/>
	<parallel_text location="avdeling-for-okonomi-og-styring_id_1353.html" xml:lang="nno"/>
	<parallel_text location="ekonomiija--ja-stivrenossodat_id_1353.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
