...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fd/dep/org/avdelinger/avdeling_for_personell_og_fellestjeneste.html?id=1383'"/>
<xsl:variable name="title" select="'Bargiid ja oktasašbálvalusaid ossodat - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'248'"/>
...
<xsl:variable name="para_eng" select="'The-Department-of-Personnel-and-General-.html?id=1383'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'avdeling-for-personell-og-fellestenester.html?id=1383'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'bargiid-ja-oktasabalvalusaid-ossodat.html?id=1383'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="the-department-of-personnel-and-general-_id_1383.html" xml:lang="eng"/>
	<parallel_text location="avdeling-for-personell-og-fellestenester_id_1383.html" xml:lang="nno"/>
	<parallel_text location="bargiid-ja-oktasabalvalusaid-ossodat_id_1383.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
