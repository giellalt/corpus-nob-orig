...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ud/dep/org/avdelinger/avdeling_for_sikkerhetspolitikk.html?id=1513'"/>
<xsl:variable name="title" select="'Sihkkarvuođa ja lagašguovlluid ossodat - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'security_policy.html?id=1513'"/>
...
<xsl:variable name="para_sme" select="'Sihkkarvuoa-ja-lagaguovlluid-ossodat.html?id=1513'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="security_policy_id_1513.html" xml:lang="eng"/>
	<parallel_text location="sihkkarvuoa-ja-lagaguovlluid-ossodat_id_1513.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
