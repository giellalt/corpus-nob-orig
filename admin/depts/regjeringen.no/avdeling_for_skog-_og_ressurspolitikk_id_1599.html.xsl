...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/lmd/dep/org/avdelinger/avdeling_for_skog-_og_ressurspolitikk_.html?id=1599'"/>
<xsl:variable name="title" select="'Vuovde- ja resurssapolitihkalaš ossodat  - regjeringen.no'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="vuovde--ja-resurssapolitihkala-ossodat-_id_1599.html" xml:lang="sme"/>
</xsl:variable>
