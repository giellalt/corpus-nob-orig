...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ad/dep/org/avdelinger.html?id=192'"/>
...
<xsl:variable name="wordcount" select="'331'"/>
...
<xsl:variable name="para_eng" select="'departments.html?id=192'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'avdelingar.html?id=192'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Ossodagat.html?id=192'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="departments_id_192.html" xml:lang="eng"/>
	<parallel_text location="avdelingar_id_192.html" xml:lang="nno"/>
	<parallel_text location="ossodagat_id_192.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
