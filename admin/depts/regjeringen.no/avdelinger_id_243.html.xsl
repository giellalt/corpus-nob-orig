...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fin/dep/org/avdelinger.html?id=243'"/>
...
<xsl:variable name="para_eng" select="'Departments.html?id=243'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Avdelingar.html?id=243'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Ossodagat.html?id=243'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="departments_id_243.html" xml:lang="eng"/>
	<parallel_text location="avdelingar_id_243.html" xml:lang="nno"/>
	<parallel_text location="ossodagat_id_243.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
