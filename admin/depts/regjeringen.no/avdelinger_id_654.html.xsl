...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/lmd/dep/org/avdelinger.html?id=654'"/>
...
<xsl:variable name="para_nno" select="'Avdelingar.html?id=654'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Ossodagat.html?id=654'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="avdelingar_id_654.html" xml:lang="nno"/>
	<parallel_text location="ossodagat_id_654.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
