...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/sd/dep/organisasjon/avdelinger.html?id=818'"/>
<xsl:variable name="title" select="'Ossodagat - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'215'"/>
...
<xsl:variable name="para_eng" select="'departments.html?id=818'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'avdelingar.html?id=818'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Ossodagat.html?id=818'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="departments_id_818.html" xml:lang="eng"/>
	<parallel_text location="avdelingar_id_818.html" xml:lang="nno"/>
	<parallel_text location="ossodagat_id_818.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
