...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/smk/dep/org/avdelinger.html?id=902'"/>
<xsl:variable name="title" select="'Avdelinger - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'Departments.html?id=902'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Avdelingar.html?id=902'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="departments_id_902.html" xml:lang="eng"/>
	<parallel_text location="avdelingar_id_902.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
