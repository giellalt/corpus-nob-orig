...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/dep/org/avdelinger/same--og-minoritetspolitisk-avdeling/avdelingsdirektor-bjorn-olav-megard.html?id=484727'"/>
<xsl:variable name="title" select="'Ossodatdirektora Bjørn Olav Megard - regjeringen.no'"/>
...
<xsl:variable name="para_sme" select="'ossodatdirektora-bjorn-olav-megard.html?id=484727'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="ossodatdirektora-bjorn-olav-megard_id_484727.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
