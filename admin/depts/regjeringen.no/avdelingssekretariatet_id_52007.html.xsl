...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/md/dep/org/avdelinger/naturforvaltning/avdelingssekretariatet.html?id=52007'"/>
...
<xsl:variable name="para_eng" select="'Department-Secretariat.html?id=52007'"/>
...
<xsl:variable name="para_sme" select="'Ossodatallingoddi.html?id=52007'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="department-secretariat_id_52007.html" xml:lang="eng"/>
	<parallel_text location="ossodatallingoddi_id_52007.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
