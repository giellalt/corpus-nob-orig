...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/md/pressesenter/pressemeldinger/2012/avgjorelse-av-klager-pa-vedtak-om-lisens.html?id=710331'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Mearrideapmi váidagiidda mat gustojit mearrádussii ahte lea lohpi liseansabivdit gumppiid Gaska-Norggas, Romssas ja Finnmárkkus - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'454'"/>
...
<xsl:variable name="para_nno" select="'lahku-nasjonalpark-er-oppretta.html_id=710329'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="'nannoesabpoe-klijmaraajvarimmieh-jih-voe.html_id=710557'"/>
<xsl:variable name="para_sme" select="'mearrideapmi-vaidagiidda-mat-gustojit-me.html_id=710331'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="mearrideapmi-vaidagiidda-mat-gustojit-me_id_710331.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
