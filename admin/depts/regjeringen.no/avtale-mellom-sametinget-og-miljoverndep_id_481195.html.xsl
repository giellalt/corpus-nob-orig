...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/md/dok/lover_regler/retningslinjer/2007/avtale-mellom-sametinget-og-miljoverndep.html?id=481195'"/>
<xsl:variable name="title" select="'Šiehtadus Sámedikki ja Birasgáhttendepartemeantta gaskka suodjalan­plána njuolggadusaid hárrái luonddusuodjalanlága mielde sámi guovlluin - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'1263'"/>
...
<xsl:variable name="para_sme" select="'iehtadus-Samedikki-ja-Birasgahttendepart.html?id=481195'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="iehtadus-samedikki-ja-birasgahttendepart_id_481195.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
