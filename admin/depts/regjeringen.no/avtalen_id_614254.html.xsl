...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/smk/pressesenter/pressemeldinger/2010/avtalen.html?id=614254'"/>
<xsl:variable name="title" select="'Avtalen om delelinjen undertegnet - regjeringen.no'"/>
...
=======
<xsl:variable name="wordcount" select="'611'"/>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
...
<xsl:variable name="para_eng" select="'treaty.html?id=614254'"/>
...
<xsl:variable name="para_sme" select="'murmanskkas.html?id=614254'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="treaty_id_614254.html" xml:lang="eng"/>
	<parallel_text location="murmanskkas_id_614254.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
