...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/smk/pressesenter/pressemeldinger/2010/avtalesignering.html?id=613684'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Undertegning av avtale mellom Norge og Russland - regjeringen.no'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="treaty-between-norway-and-russia-to-be-signed_id_613684.html"/>
        ...
        <parallel_text xml:lang="sme" location="norga-ja-ruoa-vuollaialliba-iehtadusa_id_613684.html"/>
