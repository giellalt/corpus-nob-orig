...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fkd/pressesenter/pressemeldinger/2012/avvikler-kystavgiften.html?id=701239'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Loahpaha riddodivada - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'367'"/>
...
<xsl:variable name="para_sme" select="'loahpaha-riddodivada.html_id=701239'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="loahpaha-riddodivada_id_701239.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
