...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/sd/dep/organisasjon/avdelinger/veg-_og_baneavdelingen/banseseksjonen-bs.html?id=332360'"/>
<xsl:variable name="title" select="'Bánasekšuvdna - regjeringen.no'"/>
...
<xsl:variable name="para_nno" select="'Banseseksjonen-BS.html?id=332360'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Banasekuvdna.html?id=332360'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="banseseksjonen-bs_id_332360.html" xml:lang="nno"/>
	<parallel_text location="banasekuvdna_id_332360.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
