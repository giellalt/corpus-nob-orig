...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/bld/tema/barn_og_ungdom.html?id=1015'"/>
<xsl:variable name="title" select="'Mánát ja nuorat - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'Children-and-youth.html?id=1015'"/>
...
<xsl:variable name="para_sme" select="'manat-ja-nuorat.html?id=1015'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="children-and-youth_id_1015.html" xml:lang="eng"/>
	<parallel_text location="manat-ja-nuorat_id_1015.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
