...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/bld/dep/barne--og-likestillingsminister-audun-ly.html?id=582256'"/>
<xsl:variable name="title" select="'Barne-, likestillings- og inkluderingsminister Audun Lysbakken - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'audun-lysbakken.html?id=582256'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'barne--likestillings--og-inkluderingsmin.html?id=582256'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="audun-lysbakken_id_582256.html" xml:lang="eng"/>
	<parallel_text location="barne--likestillings--og-inkluderingsmin_id_582256.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
