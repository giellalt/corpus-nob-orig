...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/kd/tema/barnehager.html?id=1029'"/>
<xsl:variable name="title" select="'Mánáidgárddit - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'kindergarden.html?id=1029'"/>
...
<xsl:variable name="para_sme" select="'manaidgarddit.html?id=1029'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="kindergarden_id_1029.html" xml:lang="eng"/>
	<parallel_text location="manaidgarddit_id_1029.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
