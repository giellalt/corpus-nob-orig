...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/bld/tema/barnevern.html?id=1058'"/>
<xsl:variable name="title" select="'Mánáidsuodjalus - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'Child-welfare.html?id=1058'"/>
...
<xsl:variable name="para_sme" select="'manaidsuodjalus.html?id=1058'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="child-welfare_id_1058.html" xml:lang="eng"/>
	<parallel_text location="manaidsuodjalus_id_1058.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
