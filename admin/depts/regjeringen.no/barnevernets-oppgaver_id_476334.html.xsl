...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/bld/tema/barnevern/barnevernets-oppgaver.html?id=476334'"/>
<xsl:variable name="title" select="'Mánáidsuodjalusa barggut - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'Child-welfare-service.html?id=476334'"/>
...
<xsl:variable name="para_sme" select="'manaidsuodjalusa-doaimmat.html?id=476334'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="child-welfare-service_id_476334.html" xml:lang="eng"/>
	<parallel_text location="manaidsuodjalusa-doaimmat_id_476334.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
