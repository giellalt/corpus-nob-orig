...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/jd/pressesenter/pressemeldinger/2014/bedre-hjelp-ved-barnebortforing.html?id=750199'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Buoret veahkki go mánát veagal fárrehuvvojit - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'632'"/>
...
<xsl:variable name="para_sme" select="'buoret-veahkki-go-manat-veagal-farrehuvv.html_id=750199'"/>
<xsl:variable name="para_smj" select="'nammada-viidat-ohkkejuvvon-referansajoav.html_id=750286'"/>
