...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ud/dep/org/avdelinger/avdeling_for_presse_kultur_og_informasjo/besoksseksjonen.html?id=87021'"/>
<xsl:variable name="title" select="'Galledansekšuvdna - regjeringen.no'"/>
...
<xsl:variable name="para_sme" select="'Galledansekuvdna.html?id=87021'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="galledansekuvdna_id_87021.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
