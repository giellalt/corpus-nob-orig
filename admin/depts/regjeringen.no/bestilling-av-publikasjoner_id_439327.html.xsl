...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dok/bestilling-av-publikasjoner.html?id=439327'"/>
<xsl:variable name="title" select="'Prentosiid diŋgon - regjeringen.no'"/>
...
<xsl:variable name="para_nno" select="'bestilling-av-publikasjonar.html?id=439327'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'prentosiid-digon.html?id=439327'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="bestilling-av-publikasjonar_id_439327.html" xml:lang="nno"/>
	<parallel_text location="prentosiid-digon_id_439327.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
