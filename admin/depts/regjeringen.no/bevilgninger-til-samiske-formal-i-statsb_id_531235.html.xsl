...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ad/pressesenter/pressemeldinger/2008/bevilgninger-til-samiske-formal-i-statsb.html?id=531235'"/>
<xsl:variable name="title" select="'Juolludeamit sámi ulbmiliidda 2009 stáhtabušeahtas  - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'720'"/>
...
<xsl:variable name="para_sme" select="'juolludeamit-sami-ulbmiliidda-2009-staht.html?id=531235'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="juolludeamit-sami-ulbmiliidda-2009-staht_id_531235.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
