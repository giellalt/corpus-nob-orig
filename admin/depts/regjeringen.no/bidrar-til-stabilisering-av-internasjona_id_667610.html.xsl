...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="norway-contributes-to-safeguarding-europ_id_667610.html"/>
        ...
        <parallel_text xml:lang="sme" location="aigu-sihkkarastit-eurohpala-ekonomiija-_id_667610.html"/>
