...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/smk/pressesenter/pressemeldinger/2011/bidrar-til-stabilisering-av-internasjona.html?id=667610'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Áigu sihkkarastit eurohpalaš ekonomiija  - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'270'"/>
...
<xsl:variable name="para_eng" select="'norway-contributes-to-safeguarding-europ.html_id=667610'"/>
...
<xsl:variable name="para_sme" select="'aigu-sihkkarastit-eurohpala-ekonomiija-.html_id=667610'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="norway-contributes-to-safeguarding-europ_id_667610.html" xml:lang="eng"/>
	<parallel_text location="aigu-sihkkarastit-eurohpala-ekonomiija-_id_667610.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
