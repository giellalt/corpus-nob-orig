...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ad/pressesenter/bildearkiv.html?id=194'"/>
...
<xsl:variable name="wordcount" select="'182'"/>
...
<xsl:variable name="para_eng" select="'picture-archive.html?id=194'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'bildearkiv.html?id=194'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'govvavuorka-.html?id=194'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="picture-archive_id_194.html" xml:lang="eng"/>
	<parallel_text location="bildearkiv_id_194.html" xml:lang="nno"/>
	<parallel_text location="govvavuorka-_id_194.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
