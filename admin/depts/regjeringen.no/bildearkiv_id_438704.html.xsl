...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fkd/dep/politisk_ledelse/vidar_ulriksen__statssekretar_ap/bildearkiv.html?id=438704'"/>
<xsl:variable name="title" select="'Govvavuorká - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'Picture-archive.html?id=438704'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Biletarkiv.html?id=438704'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Govvavuorka.html?id=438704'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="picture-archive_id_438704.html" xml:lang="eng"/>
	<parallel_text location="biletarkiv_id_438704.html" xml:lang="nno"/>
	<parallel_text location="govvavuorka_id_438704.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
