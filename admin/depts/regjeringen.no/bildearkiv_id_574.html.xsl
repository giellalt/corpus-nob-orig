...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/kud/pressesenter/bildearkiv.html?id=574'"/>
...
<xsl:variable name="para_nno" select="'Biletarkiv.html?id=574'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Govvaarkiiva.html?id=574'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="biletarkiv_id_574.html" xml:lang="nno"/>
	<parallel_text location="govvaarkiiva_id_574.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
