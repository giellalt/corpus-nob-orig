...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/sd/dep/politisk_ledelse/politisk-radgiver-sigrid-brattabo-handeg/Bilder-av-politisk-radgiver-Sigrid-Brattabo-Handegard.html?id=592867'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="photo-gallery---political-adviser-sigrid-brattabo-handegard_id_592867.html"/>
        ...
        <parallel_text xml:lang="nno" location="bilete-av-politisk-radgjevar-sigrid-brattabo-handegard_id_592867.html"/>
        <parallel_text xml:lang="nob" location=""/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location=""/>
        <parallel_text xml:lang="sme" location="govvavuorka---politihkala-raeaddi-sigrid-brattabo-handegard_id_592867.html"/>
