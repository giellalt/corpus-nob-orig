...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/sd/dep/magnhild-meltveit-kleppa/bilder-av-samferdselsminister-magnhild-m.html?id=582332'"/>
...
<xsl:variable name="wordcount" select="'177'"/>
...
<xsl:variable name="para_eng" select="'photo-gallery---minister-of-transport-an.html?id=582332'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'bilder-av-samferdselsminister-magnhild-m.html?id=582332'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'govvavuorka---johtalusministtar-magnhild.html?id=582332'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="photo-gallery---minister-of-transport-an_id_582332.html" xml:lang="eng"/>
	<parallel_text location="bilder-av-samferdselsminister-magnhild-m_id_582332.html" xml:lang="nno"/>
	<parallel_text location="govvavuorka---johtalusministtar-magnhild_id_582332.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
