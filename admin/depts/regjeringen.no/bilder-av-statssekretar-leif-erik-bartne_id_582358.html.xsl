...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/sd/dep/politisk_ledelse/statssekretar-lars-erik-bartnes/bilder-av-statssekretar-leif-erik-bartne.html?id=582358'"/>
<xsl:variable name="title" select="'Govvavuorká - Stáhtačálli Lars Erik Bartnes - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'photo-gallery---state-secretary-lars-eri.html?id=582358'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'bilder-av-statssekretar-lars-erik-bartne.html?id=582358'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'govvavuorka---stahtaalli-lars-erik-bartn.html?id=582358'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="photo-gallery---state-secretary-lars-eri_id_582358.html" xml:lang="eng"/>
	<parallel_text location="bilder-av-statssekretar-lars-erik-bartne_id_582358.html" xml:lang="nno"/>
	<parallel_text location="govvavuorka---stahtaalli-lars-erik-bartn_id_582358.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
