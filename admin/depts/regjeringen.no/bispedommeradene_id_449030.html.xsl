...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/dep/underliggende-etater/bispedommeradene.html?id=449030'"/>
<xsl:variable name="title" select="'Bismagodderáđit - regjeringen.no'"/>
...
<xsl:variable name="para_sme" select="'bismagodderait.html?id=449030'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="bismagodderait_id_449030.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
