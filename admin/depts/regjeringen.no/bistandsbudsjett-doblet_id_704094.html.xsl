...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ud/pressesenter/pressemeldinger/2012/bistandsbudsjett-doblet.html?id=704094'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Ovddidanbušeahtta duppalastojuvvon ovcci jagis - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'736'"/>
...
<xsl:variable name="para_eng" select="'aidbudget2013.html_id=704094'"/>
...
<xsl:variable name="para_sme" select="'ovddidanbuseahta.html_id=704094'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="aidbudget2013_id_704094.html" xml:lang="eng"/>
	<parallel_text location="ovddidanbuseahta_id_704094.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
