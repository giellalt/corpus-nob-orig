...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ad/dep/org/avdelinger/boa.html?id=973'"/>
<xsl:variable name="title" select="'Bušeahtta- ja ekonomiijaossodat   - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'the-department-of-finance.html?id=973'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Budsjett--og-okonomiavdelinga.html?id=973'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Bueahtta--ja-ekonomiijaossodat--.html?id=973'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="the-department-of-finance_id_973.html" xml:lang="eng"/>
	<parallel_text location="budsjett--og-okonomiavdelinga_id_973.html" xml:lang="nno"/>
	<parallel_text location="bueahtta--ja-ekonomiijaossodat--_id_973.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
