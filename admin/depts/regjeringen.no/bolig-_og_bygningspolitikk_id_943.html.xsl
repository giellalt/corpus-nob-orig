...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/krd/tema/bolig-_og_bygningspolitikk.html?id=943'"/>
<xsl:variable name="title" select="'Ássan- ja huksenpolitihkka - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'Housing-and-building-policy.html?id=943'"/>
...
<xsl:variable name="para_sme" select="'Assan--ja-huksenpolitihkka.html?id=943'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="housing-and-building-policy_id_943.html" xml:lang="eng"/>
	<parallel_text location="assan--ja-huksenpolitihkka_id_943.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
