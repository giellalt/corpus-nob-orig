...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/tema/bolig_og_eiendom.html?id=211'"/>
<xsl:variable name="title" select="'Viessu ja opmodat - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'491'"/>
...
<xsl:variable name="para_eng" select="'housing-and-property.html?id=211'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'bustad-og-eigedom.html?id=211'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'viessu-ja-opmodat.html?id=211'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="housing-and-property_id_211.html" xml:lang="eng"/>
	<parallel_text location="bustad-og-eigedom_id_211.html" xml:lang="nno"/>
	<parallel_text location="viessu-ja-opmodat_id_211.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
