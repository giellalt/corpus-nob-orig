...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/tema/ikt-politikk/bredband.html?id=1372'"/>
<xsl:variable name="title" select="'Šuđggabáddi - regjeringen.no'"/>
...
<xsl:variable name="para_nno" select="'Breiband.html?id=1372'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'uggabaddi.html?id=1372'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="breiband_id_1372.html" xml:lang="nno"/>
	<parallel_text location="uggabaddi_id_1372.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
