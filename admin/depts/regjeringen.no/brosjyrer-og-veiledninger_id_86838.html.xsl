...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/lmd/tema/reindrift/brosjyrer-og-veiledninger.html?id=86838'"/>
<xsl:variable name="title" select="'Almmuhusat - regjeringen.no'"/>
...
<xsl:variable name="para_nno" select="'Rettleiingar-og-brosjyrar.html?id=86838'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Almmuhusat.html?id=86838'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="rettleiingar-og-brosjyrar_id_86838.html" xml:lang="nno"/>
	<parallel_text location="almmuhusat_id_86838.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
