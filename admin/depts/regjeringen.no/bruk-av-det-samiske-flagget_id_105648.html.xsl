...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ad/dok/rapporter_planer/rapporter/2001/bruk-av-det-samiske-flagget.html?id=105648'"/>
<xsl:variable name="title" select="'Sámi leavgga geavaheapmi - regjeringen.no'"/>
...
<xsl:variable name="para_sme" select="'sami-leavgga-geavaheapmi.html?id=105648'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="sami-leavgga-geavaheapmi_id_105648.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
