...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/tema/samepolitikk/bruk_av_samisk_sprak/bruk-av-samisk-sprak-i-offentlig-forvalt.html?id=86942'"/>
<xsl:variable name="title" select="'Sámegiela geavaheapmi almmolaš hálddahusas - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'the-use-of-the-sami-language-in-the-publ.html?id=86942'"/>
...
<xsl:variable name="para_sme" select="'Samegiela-geavaheapmi-almmola-halddahusa.html?id=86942'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="the-use-of-the-sami-language-in-the-publ_id_86942.html" xml:lang="eng"/>
	<parallel_text location="samegiela-geavaheapmi-almmola-halddahusa_id_86942.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
