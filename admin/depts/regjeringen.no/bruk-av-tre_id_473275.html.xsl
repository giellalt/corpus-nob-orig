...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/lmd/tema/skogbruk_og_bioenergi/bruk-av-tre.html?id=473275'"/>
<xsl:variable name="title" select="'Muorrageavaheapmi - regjeringen.no'"/>
...
<xsl:variable name="para_sme" select="'muorrageavaheapmi.html?id=473275'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="muorrageavaheapmi_id_473275.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
