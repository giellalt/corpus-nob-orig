...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/tema/samepolitikk/bruk_av_samisk_sprak.html?id=24388'"/>
<xsl:variable name="title" select="'Sámegiela geavaheapmi - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'use-of-the-sami-languages.html?id=24388'"/>
...
<xsl:variable name="para_sme" select="'Samegiela-geavaheapmi.html?id=24388'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="use-of-the-sami-languages_id_24388.html" xml:lang="eng"/>
	<parallel_text location="samegiela-geavaheapmi_id_24388.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
