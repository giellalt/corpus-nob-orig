...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/bld/dep/org/avdelinger/bua.html?id=81'"/>
<xsl:variable name="title" select="'Mánáid- ja nuoraidossodat  - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'263'"/>
...
<xsl:variable name="para_eng" select="'Department-Of-Children-and-Youth-Policy.html?id=81'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Barne--og-ungdomsavdelinga-.html?id=81'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Manaid--ja-nuoraidossodat-.html?id=81'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="department-of-children-and-youth-policy_id_81.html" xml:lang="eng"/>
	<parallel_text location="barne--og-ungdomsavdelinga-_id_81.html" xml:lang="nno"/>
	<parallel_text location="manaid--ja-nuoraidossodat-_id_81.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
