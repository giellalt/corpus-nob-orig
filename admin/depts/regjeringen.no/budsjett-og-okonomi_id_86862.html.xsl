...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/nhd/dep/org/avdelinger/administrasjonsavdelingen/budsjett-og-okonomi.html?id=86862'"/>
<xsl:variable name="title" select="'Bušeahtta ja ekonomiija - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'budgeting-and-finance.html?id=86862'"/>
...
<xsl:variable name="para_sme" select="'Bueahtta-ja-ekonomiija.html?id=86862'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="budgeting-and-finance_id_86862.html" xml:lang="eng"/>
	<parallel_text location="bueahtta-ja-ekonomiija_id_86862.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
