...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/md/dep/org/avdelinger/organisasjon_okonomi/budsjett_og_regnskap.html?id=85626'"/>
<xsl:variable name="title" select="'Bušeahtta- ja rehketdoallosekšuvdna - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'211'"/>
...
<xsl:variable name="para_eng" select="'Section-for-Finance-and-Accounting-.html?id=85626'"/>
...
<xsl:variable name="para_sme" select="'Bueahtta--ja-rehketdoallosekuvdna.html?id=85626'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="section-for-finance-and-accounting-_id_85626.html" xml:lang="eng"/>
	<parallel_text location="bueahtta--ja-rehketdoallosekuvdna_id_85626.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
