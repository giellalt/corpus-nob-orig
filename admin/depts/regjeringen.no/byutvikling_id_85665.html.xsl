...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/md/dep/org/avdelinger/regional_planlegging/byutvikling.html?id=85665'"/>
<xsl:variable name="title" select="'Gávpotovddidan, regiunála, areála- ja geasehanpolitihkka sekšuvdna - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'urban-development.html?id=85665'"/>
...
<xsl:variable name="para_sme" select="'Gavpotovddidan-regiunala-areala--ja-geasehanpolitihkka-sekuvdna.html?id=85665'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="urban-development_id_85665.html" xml:lang="eng"/>
	<parallel_text location="gavpotovddidan-regiunala-areala--ja-geasehanpolitihkka-sekuvdna_id_85665.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
