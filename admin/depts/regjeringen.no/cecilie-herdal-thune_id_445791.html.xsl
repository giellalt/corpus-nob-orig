...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ad/dep/org/avdelinger/pks/cecilie-herdal-thune.html?id=445791'"/>
<xsl:variable name="title" select="'1. konsuleanta Cecilie Herdal Thune - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'higher-executive-officer-cecilie-herdal-.html?id=445791'"/>
...
<xsl:variable name="para_sme" select="'1-konsuleanta-cecilie-herdal-thune.html?id=445791'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="higher-executive-officer-cecilie-herdal-_id_445791.html" xml:lang="eng"/>
	<parallel_text location="1-konsuleanta-cecilie-herdal-thune_id_445791.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
