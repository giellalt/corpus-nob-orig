...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/smk/pressesenter/pressemeldinger/2012/co2.html?id=698862'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Industriija CO2-buhtadusortnet - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'595'"/>
...
<xsl:variable name="para_sme" select="'industriija-co2-buhtadusortnet.html_id=698862'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="co2_id_698862.html" xml:lang="eng"/>
