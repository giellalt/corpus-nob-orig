...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fd/dep/org/avdelinger/controllerenhet.html?id=85707'"/>
<xsl:variable name="title" select="'Siskkáldas dárkkisteapmi - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'191'"/>
...
<xsl:variable name="para_eng" select="'the-national-armaments-director.html?id=85707'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'controllereining.html?id=85707'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'controller-ovttadat.html?id=85707'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="the-national-armaments-director_id_85707.html" xml:lang="eng"/>
	<parallel_text location="controllereining_id_85707.html" xml:lang="nno"/>
	<parallel_text location="controller-ovttadat_id_85707.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
