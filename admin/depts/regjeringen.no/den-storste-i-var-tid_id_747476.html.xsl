...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/smk/pressesenter/pressemeldinger/2013/den-storste-i-var-tid.html?id=747476'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Máilbmi lea massán iežas stuorimus politihkalaš ovdagova - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'the-greatest-leader-of-our-time.html_id=747476'"/>
...
<xsl:variable name="para_sme" select="'mailbmi-lea-massan-ieas-stuorimus-politi.html_id=747476'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="the-greatest-leader-of-our-time_id_747476.html" xml:lang="eng"/>
	<parallel_text location="mailbmi-lea-massan-ieas-stuorimus-politi_id_747476.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
