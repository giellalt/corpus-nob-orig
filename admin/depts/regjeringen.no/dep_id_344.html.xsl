...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/dep.html?id=344'"/>
...
<xsl:variable name="para_eng" select="'about-the-ministry.html?id=344'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'om-departementet.html?id=344'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'departemeanta.html?id=344'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="about-the-ministry_id_344.html" xml:lang="eng"/>
	<parallel_text location="om-departementet_id_344.html" xml:lang="nno"/>
	<parallel_text location="departemeanta_id_344.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
