...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/jd/dep.html?id=468'"/>
...
<xsl:variable name="para_eng" select="'About-the-Ministry-of-Justice-and-the-Po.html?id=468'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Om-departementet.html?id=468'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Justisdepartementta-birra.html?id=468'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="about-the-ministry-of-justice-and-the-po_id_468.html" xml:lang="eng"/>
	<parallel_text location="om-departementet_id_468.html" xml:lang="nno"/>
	<parallel_text location="justisdepartementta-birra_id_468.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
