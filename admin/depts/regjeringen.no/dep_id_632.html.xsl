...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/lmd/dep.html?id=632'"/>
...
<xsl:variable name="para_eng" select="'the-ministry-of-agriculture-and-food.html?id=632'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'om-departementet.html?id=632'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Departemeantta-birra.html?id=632'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="the-ministry-of-agriculture-and-food_id_632.html" xml:lang="eng"/>
	<parallel_text location="om-departementet_id_632.html" xml:lang="nno"/>
	<parallel_text location="departemeantta-birra_id_632.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
