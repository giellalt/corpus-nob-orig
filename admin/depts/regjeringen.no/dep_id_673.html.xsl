...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/md/dep.html?id=673'"/>
...
<xsl:variable name="para_eng" select="'About-the-Ministry.html?id=673'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Om-departementet.html?id=673'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Departemeanta-birra.html?id=673'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="about-the-ministry_id_673.html" xml:lang="eng"/>
	<parallel_text location="om-departementet_id_673.html" xml:lang="nno"/>
	<parallel_text location="departemeanta-birra_id_673.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
