...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/oed/dep.html?id=755'"/>
...
<xsl:variable name="para_eng" select="'The-Ministey.html?id=755'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Om-departementet.html?id=755'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Departemeanta.html?id=755'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="the-ministey_id_755.html" xml:lang="eng"/>
	<parallel_text location="om-departementet_id_755.html" xml:lang="nno"/>
	<parallel_text location="departemeanta_id_755.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
