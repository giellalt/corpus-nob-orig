...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/smk/dep.html?id=880'"/>
...
<xsl:variable name="para_eng" select="'The-Office-of-the-Prime-Minister.html?id=880'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="the-office-of-the-prime-minister_id_880.html" xml:lang="eng"/>
	<parallel_text location="statsministerens-kontor-2_id_880.html" xml:lang="nno"/>
	<parallel_text location="stahtaministara-kantuvra_id_880.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
