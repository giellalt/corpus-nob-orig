...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/dep/underliggende-etater/departementenes-servicesenter-dss.html?id=440427'"/>
<xsl:variable name="title" select="'Departemeanttaid bálvalusguovddáš (DBG) - regjeringen.no'"/>
...
<xsl:variable name="para_sme" select="'departemeanttaid-balvalusguovdda-dbg.html?id=440427'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="departemeanttaid-balvalusguovdda-dbg_id_440427.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
