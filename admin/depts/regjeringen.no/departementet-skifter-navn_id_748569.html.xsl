...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/asd/aktuelt/nyheter/2013/departementet-skifter-navn.html?id=748569'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Departemeantta namma rievdá - regjeringen.no'"/>
...
<xsl:variable name="para_sme" select="'departemeantta-namma-rievda.html_id=748569'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="change-of-name-the-ministry-of-labour-an_id_748569.html" xml:lang="eng"/>
	<parallel_text location="departementet-skiftar-namn_id_748569.html" xml:lang="nno"/>
