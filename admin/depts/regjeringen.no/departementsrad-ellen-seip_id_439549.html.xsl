...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ad/dep/administrativ_ledelse/departementsrad-ellen-seip.html?id=439549'"/>
<xsl:variable name="title" select="'Departemeantaráđđi Ellen Seip - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'Secretary-General-Ellen-Seip.html?id=439549'"/>
...
<xsl:variable name="para_sme" select="'Departemeantarai-Ellen-Seip.html?id=439549'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="secretary-general-ellen-seip_id_439549.html" xml:lang="eng"/>
	<parallel_text location="departemeantarai-ellen-seip_id_439549.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
