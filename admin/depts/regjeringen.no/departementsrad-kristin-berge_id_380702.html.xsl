...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/kud/dep/administrativ_ledelse/departementsrad-kristin-berge.html?id=380702'"/>
<xsl:variable name="title" select="'Departemeantaráđđi Kristin Berge - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'secretary-general-kristin-berge.html?id=380702'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'departementsrad-kristin-berge.html?id=380702'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'departemeantarai-helge-m-sonneland.html?id=380702'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="secretary-general-kristin-berge_id_380702.html" xml:lang="eng"/>
	<parallel_text location="departementsrad-kristin-berge_id_380702.html" xml:lang="nno"/>
	<parallel_text location="departemeantarai-helge-m-sonneland_id_380702.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
