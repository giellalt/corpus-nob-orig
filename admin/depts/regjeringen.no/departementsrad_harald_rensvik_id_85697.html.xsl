...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/md/dep/administrativ_ledelse/departementsrad_harald_rensvik.html?id=85697'"/>
<xsl:variable name="title" select="'Departemeantaráđđi Harald Rensvik - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'secretary-general-harald-rensvik.html?id=85697'"/>
...
<xsl:variable name="para_sme" select="'Departemeantarai-Harald-Rensvik.html?id=85697'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="secretary-general-harald-rensvik_id_85697.html" xml:lang="eng"/>
	<parallel_text location="departemeantarai-harald-rensvik_id_85697.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
