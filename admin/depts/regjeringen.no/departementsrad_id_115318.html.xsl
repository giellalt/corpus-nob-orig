...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fkd/dep/administrativ_ledelse/departementsrad.html?id=115318'"/>
<xsl:variable name="title" select="'Departemeantaráđđi Jørn Krog - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'Secretary-General.html?id=115318'"/>
...
<xsl:variable name="para_sme" select="'Departemeantarai-Jorn-Krog.html?id=115318'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="secretary-general_id_115318.html" xml:lang="eng"/>
	<parallel_text location="departemeantarai-jorn-krog_id_115318.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
