...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/dep/underliggende-etater/det-praktisk-teologiske-seminar.html?id=449033'"/>
<xsl:variable name="title" select="'Praktihkalaš-teologalaš seminára - regjeringen.no'"/>
...
<xsl:variable name="para_sme" select="'praktihkala-teologala-seminara.html?id=449033'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="praktihkala-teologala-seminara_id_449033.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
