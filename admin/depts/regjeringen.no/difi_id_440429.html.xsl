...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/dep/underliggende-etater/difi.html?id=440429'"/>
<xsl:variable name="title" select="'Hálddahus- ja DGT-direktoráhta - regjeringen.no'"/>
...
<xsl:variable name="para_sme" select="'halddahus--ja-dgt-direktorahta.html?id=440429'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="halddahus--ja-dgt-direktorahta_id_440429.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
