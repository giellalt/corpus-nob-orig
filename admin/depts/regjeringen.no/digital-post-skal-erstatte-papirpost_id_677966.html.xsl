...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/pressesenter/pressemeldinger/2012/digital-post-skal-erstatte-papirpost.html?id=677966'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Digitálapoasta báberpoastta sajis - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'461'"/>
...
<xsl:variable name="para_nno" select="'digital-post-skal-erstatte-papirpost.html_id=677966'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'digitalapoasta-baberpoastta-sajis.html_id=677966'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="digital-post-skal-erstatte-papirpost_id_677966.html" xml:lang="nno"/>
	<parallel_text location="digitalapoasta-baberpoastta-sajis_id_677966.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
