...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/aktuelt/nyheter/2010/Digitale-sprakverktoy-nodvendig-for-a-overleve.html?id=605543'"/>
<xsl:variable name="title" select="'Digitála giellareaiddut leat dehálačča giela ceavzimii - regjeringen.no'"/>
...
<xsl:variable name="para_nno" select="'Digitale-sprakverktoy-nodvendig-for-a-overleve.html?id=605543'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="digitale-sprakverktoy-nodvendig-for-a-overleve_id_605543.html" xml:lang="nno"/>
	<parallel_text location="digitala-giellareaiddut-leat-dehalaa-giela-ceavzimii_id_605543.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
