...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ud/dep/org/avdelinger/avdeling_for_presse_kultur_og_informasjo/diplomatseksjonen.html?id=87020'"/>
<xsl:variable name="title" select="'Diplomáhtasekšuvdna - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'section-for-diplomatic-relations.html?id=87020'"/>
...
<xsl:variable name="para_sme" select="'Diplomahtasekuvdna.html?id=87020'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="section-for-diplomatic-relations_id_87020.html" xml:lang="eng"/>
	<parallel_text location="diplomahtasekuvdna_id_87020.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
