...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/md/dep/underliggende-etater/direktoratet_for_naturforvaltning.html?id=85704'"/>
<xsl:variable name="title" select="'Luondduhálddašan direktoráhta - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'432'"/>
...
<xsl:variable name="para_eng" select="'The-Directorate-for-Nature-Management.html?id=85704'"/>
...
<xsl:variable name="para_sme" select="'Luondduhalddaan-direktorahta.html?id=85704'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="the-directorate-for-nature-management_id_85704.html" xml:lang="eng"/>
	<parallel_text location="luondduhalddaan-direktorahta_id_85704.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
