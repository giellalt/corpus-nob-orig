...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/smk/aktuelt/nyheter/2012/diskuterte-innbyggerdialog.html?id=684707'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Divaštallat ássiidgulahallama birra  - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'233'"/>
...
<xsl:variable name="para_eng" select="'dialogue-with-citizens-on-the-agenda.html_id=684707'"/>
...
<xsl:variable name="para_sme" select="'divatallat-assiidgulahallama-birra-.html_id=684707'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="dialogue-with-citizens-on-the-agenda_id_684707.html" xml:lang="eng"/>
	<parallel_text location="divatallat-assiidgulahallama-birra-_id_684707.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
