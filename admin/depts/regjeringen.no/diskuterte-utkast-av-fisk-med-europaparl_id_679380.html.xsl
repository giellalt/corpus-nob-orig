...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fkd/pressesenter/pressemeldinger/2012/diskuterte-utkast-av-fisk-med-europaparl.html?id=679380'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Digaštalle guolástusárvalusa Eurohpá parlameanttain - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'discussed-fish-discards-with-the-europea.html_id=679380'"/>
...
<xsl:variable name="para_sme" select="'digatalle-guolastusarvalusa-eurohpa-parl.html_id=679380'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="discussed-fish-discards-with-the-europea_id_679380.html" xml:lang="eng"/>
	<parallel_text location="digatalle-guolastusarvalusa-eurohpa-parl_id_679380.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
