...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/md/dok.html?id=270420'"/>
...
<xsl:variable name="para_eng" select="'documents-and-publications.html?id=270420'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'dokument.html?id=270420'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Dokumeanttat.html?id=270420'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="documents-and-publications_id_270420.html" xml:lang="eng"/>
	<parallel_text location="dokument_id_270420.html" xml:lang="nno"/>
	<parallel_text location="dokumeanttat_id_270420.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
