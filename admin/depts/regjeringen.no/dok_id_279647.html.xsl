...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/lmd/dok.html?id=279647'"/>
<xsl:variable name="title" select="'Dokumeanttat  - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'Documents.html?id=279647'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'dokument.html?id=279647'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Dokumeanttat-.html?id=279647'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="documents_id_279647.html" xml:lang="eng"/>
	<parallel_text location="dokument_id_279647.html" xml:lang="nno"/>
	<parallel_text location="dokumeanttat-_id_279647.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
