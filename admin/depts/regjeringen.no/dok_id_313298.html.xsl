...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/kd/dok.html?id=313298'"/>
...
<xsl:variable name="para_eng" select="'Documents.html?id=313298'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Dokument.html?id=313298'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="documents_id_313298.html" xml:lang="eng"/>
	<parallel_text location="dokument_id_313298.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
