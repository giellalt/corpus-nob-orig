...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dokumentarkiv.html?id=115322'"/>
<xsl:variable name="title" select="'Dokumeantavuorká - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'archive.html?id=115322'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'dokumentarkiv.html?id=115322'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'dokumeantavuorka.html?id=115322'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="dokumentarkiv_id_115322.html" xml:lang="nno"/>
	<parallel_text location="dokumeantavuorka_id_115322.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
