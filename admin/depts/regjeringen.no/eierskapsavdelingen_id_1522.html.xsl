...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/nhd/dep/org/avdelinger/eierskapsavdelingen.html?id=1522'"/>
<xsl:variable name="title" select="'Eaiggáduššanossodat  - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'ownership-department.html?id=1522'"/>
...
<xsl:variable name="para_sme" select="'eaiggaduanossodat-.html?id=1522'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="ownership-department_id_1522.html" xml:lang="eng"/>
	<parallel_text location="eaiggaduanossodat-_id_1522.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
