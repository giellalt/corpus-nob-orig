...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/sd/dep/organisasjon/avdelinger/plan-_okonomi-_og_administrasjonsavdelin/ekspedisjonssjef-anders-buttedahl.html?id=332366'"/>
<xsl:variable name="title" select="'Ekspedišuvdnahoavda Anders Buttedahl - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'153'"/>
...
<xsl:variable name="para_eng" select="'director-general-anders-buttedal.html?id=332366'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'ekspedisjonssjef-anders-buttedahl.html?id=332366'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Ekspediuvdnahoavda-Anders-Buttedahl.html?id=332366'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="director-general-anders-buttedal_id_332366.html" xml:lang="eng"/>
	<parallel_text location="ekspedisjonssjef-anders-buttedahl_id_332366.html" xml:lang="nno"/>
	<parallel_text location="ekspediuvdnahoavda-anders-buttedahl_id_332366.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
