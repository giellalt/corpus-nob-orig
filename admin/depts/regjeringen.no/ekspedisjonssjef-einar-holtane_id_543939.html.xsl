...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/md/dep/org/avdelinger/kulturminneforvaltning/ekspedisjonssjef-einar-holtane.html?id=543939'"/>
<xsl:variable name="title" select="'Ekspedišuvdnahoavda Einar Holtane - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'171'"/>
...
<xsl:variable name="para_eng" select="'director-general-einar-holtane.html?id=543939'"/>
...
<xsl:variable name="para_sme" select="'ekspediuvdnahoavda-einar-holtane.html?id=543939'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="director-general-einar-holtane_id_543939.html" xml:lang="eng"/>
	<parallel_text location="ekspediuvdnahoavda-einar-holtane_id_543939.html" xml:lang="sme"/>
<parallel_text location="ekspediuvdnahoavda-einar-holtane_id_543939.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
