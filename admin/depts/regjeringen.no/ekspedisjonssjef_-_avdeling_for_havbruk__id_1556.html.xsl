...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fkd/dep/org/avdelinger/avdeling_for_havbruk_sjomat_og_marked/ekspedisjonssjef_-_avdeling_for_havbruk_.html?id=1556'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Ekspedišuvdnahoavda – Mearraávkkástallan, mearrabiebmu ja márkan Magnor Nerheim - regjeringen.no'"/>
    <!--
    ...
    <xsl:variable name="wordcount" select="'205'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="Director-General--Department-of-Aquaculture-Seafood-and-Markets.html?id=1556"/>
        ...
        <parallel_text xml:lang="nno" location="ekspedisjonssjef---avdeling-for-havbruk-.html?id=1556"/>
        <parallel_text xml:lang="nob" location=""/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location=""/>
        <parallel_text xml:lang="sme" location="Ekspediuvdnahoavda--Mearraavkkastallan-mearrabiebmu-ja-markan-.html?id=1556"/>
