...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fkd/dep/org/avdelinger/ressurs-_og_havavdelingen/ekspedisjonssjef_-_ressurs-_og_havavdeli.html?id=1583'"/>
...
<xsl:variable name="wordcount" select="'197'"/>
...
<xsl:variable name="para_eng" select="'director-general---department-of-marine-.html?id=1583'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'ekspedisjonssjef---ressurs--og-havavdeli.html?id=1583'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'ekspediuvdnahoavda--ressursa--ja-mearrao.html?id=1583'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="director-general---department-of-marine-_id_1583.html" xml:lang="eng"/>
	<parallel_text location="ekspedisjonssjef---ressurs--og-havavdeli_id_1583.html" xml:lang="nno"/>
	<parallel_text location="ekspediuvdnahoavda--ressursa--ja-mearrao_id_1583.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
