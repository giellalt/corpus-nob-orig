...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/hod/kampanjer/samhandlingsreformen/ekspertgruppa.html?id=524785'"/>
<xsl:variable name="title" select="'Ekspeartalávdegotti miellahtut - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'790'"/>
...
<xsl:variable name="para_eng" select="'team-of-experts.html?id=524785'"/>
...
<xsl:variable name="para_sme" select="'medlemmene-i-ekspertgruppa.html?id=524785'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="team-of-experts_id_524785.html" xml:lang="eng"/>
	<parallel_text location="medlemmene-i-ekspertgruppa_id_524785.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
