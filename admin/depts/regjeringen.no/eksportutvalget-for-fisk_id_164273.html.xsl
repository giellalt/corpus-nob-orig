...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fkd/dep/tilknyttede-virksomheter/eksportutvalget-for-fisk.html?id=164273'"/>
<xsl:variable name="title" select="'Guoli olggosfievrredanlávdegotti  - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'225'"/>
...
<xsl:variable name="para_eng" select="'The-Norwegian-Seafood-Export-Council-.html?id=164273'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Eksportutvalet-for-fisk-.html?id=164273'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Guoli-olggosfievrredanlavdegottis-.html?id=164273'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="the-norwegian-seafood-export-council-_id_164273.html" xml:lang="eng"/>
	<parallel_text location="eksportutvalet-for-fisk-_id_164273.html" xml:lang="nno"/>
	<parallel_text location="guoli-olggosfievrredanlavdegottis-_id_164273.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
