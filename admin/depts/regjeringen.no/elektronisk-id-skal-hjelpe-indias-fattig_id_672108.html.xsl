...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/aktuelt/nyheter/2012/elektronisk-id-skal-hjelpe-indias-fattig.html?id=672108'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Elektrovnnalaš ID galgá veahkehit  India gefiid - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'480'"/>
...
<xsl:variable name="para_sme" select="'elektrovnnala-id-galga-veahkehit--india-.html_id=672108'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="elektrovnnala-id-galga-veahkehit--india-_id_672108.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
