...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/smk/pressesenter/pressemeldinger/2011/endring-i-regjeringen.html?id=635250'"/>
...
<xsl:variable name="para_sme" select="'nuppastusat-raehusas.html_id=635250'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="change-in-the-government-_id_635250.html" xml:lang="eng"/>
	<parallel_text location="nuppastusat-raehusas_id_635250.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
