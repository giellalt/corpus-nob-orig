...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/smk/pressesenter/pressemeldinger/2012/endringer_regjeringen.html?id=699575'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Nuppástusat ráđđehusas - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'425'"/>
...
<xsl:variable name="para_sme" select="'nuppastusat-raehusas.html_id=699575'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="changes-in-the-government2_id_699575.html" xml:lang="eng"/>
