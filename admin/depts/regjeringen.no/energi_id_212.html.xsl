...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/tema/energi.html?id=212'"/>
<xsl:variable name="title" select="'Energiija - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'energy.html?id=212'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Energi.html?id=212'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Energiija.html?id=212'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="energy_id_212.html" xml:lang="eng"/>
	<parallel_text location="energi_id_212.html" xml:lang="nno"/>
	<parallel_text location="energiija_id_212.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
