...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/pressesenter/pressemeldinger/2010/enighet-i-det-statlige-lonnsoppgjoret.html?id=605732'"/>
<xsl:variable name="title" select="'Ovttamielalašvuohta bálkášiehtadallamis - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'684'"/>
...
<xsl:variable name="para_nno" select="'Semje-i-det-statlege-lonnsoppgjeret.html?id=605732'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Ovttamielalavuohta-balkaiehtadallamis.html?id=605732'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="semje-i-det-statlege-lonnsoppgjeret_id_605732.html" xml:lang="nno"/>
	<parallel_text location="ovttamielalavuohta-balkaiehtadallamis_id_605732.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
