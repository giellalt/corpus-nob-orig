...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/smk/pressesenter/pressemeldinger/2010/Enighet-mellom-Norge-og-Russland-i-delelinjeforhandlingene-.html?id=601940'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Norge ja Ruošša ovttaoaiavilis juohkinlinnjášiehtadallamiin - regjeringen.no'"/>
    <!--
        Information of the first author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author1_fn" select="''"/>
    <xsl:variable name="author1_ln" select="'Statsministerens kontor'"/>
    <!-- m, f or unknown -->
    ...
    <xsl:variable name="wordcount" select="'499'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="agreement-reached-between-norway-and-the-russian-federation-in-the-negotiations-on-maritime-delimitation_id_601940.html"/>
        ...
        <parallel_text xml:lang="sme" location="norge-ja-ruoa-ovttaoaiavilis-juohkinlinnjaiehtadallamiin_id_601940.html"/>
