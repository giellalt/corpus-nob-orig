...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/smk/pressesenter/pressemeldinger/2008/enighet-om-nasjonal-klimadugnad.html?id=496872'"/>
<xsl:variable name="title" select="'Nationála dálkkádatlotnolasbarggu soahpamuš - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'601'"/>
...
<xsl:variable name="para_eng" select="'Broad-agreement-to-boost-national-climat.html?id=496872'"/>
...
<xsl:variable name="para_sme" select="'-Nationala-dalkkadatlotnolasbarggu-soahp.html?id=496872'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="broad-agreement-to-boost-national-climat_id_496872.html" xml:lang="eng"/>
