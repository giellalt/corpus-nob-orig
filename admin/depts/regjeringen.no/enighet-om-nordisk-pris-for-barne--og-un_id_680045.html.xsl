...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/kud/pressesenter/pressemeldinger/2012/enighet-om-nordisk-pris-for-barne--og-un.html?id=680045'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Ovttamielalašvuohta ásahit davviriikkalaš bálkkašumi mánáide  ja nuoraide - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'364'"/>
...
<xsl:variable name="para_eng" select="'agreement-on-nordic-award-for-children-a.html_id=680045'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'statsrekneskapen-for-2011-lagt-fram.html_id=680308'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="'rihpestimmie-co2-tekonoligijejarngeste-m.html_id=681066'"/>
<xsl:variable name="para_sme" select="'ovttamielalavuohta-asahit-davviriikkala-.html_id=680045'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="agreement-on-nordic-award-for-children-a_id_680045.html" xml:lang="eng"/>
	<parallel_text location="ovttamielalavuohta-asahit-davviriikkala-_id_680045.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
