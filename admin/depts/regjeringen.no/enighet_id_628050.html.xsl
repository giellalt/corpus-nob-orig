...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/smk/pressesenter/pressemeldinger/2010/enighet.html?id=628050'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Illudahtti go jokse ovttamielalašvuođa Cancunas - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'Norway-welcomes-agreement-in-Cancun.html?id=628050'"/>
...
<xsl:variable name="para_sme" select="'cancunas.html?id=628050'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="norway-welcomes-agreement-in-cancun_id_628050.html" xml:lang="eng"/>
	<parallel_text location="cancunas_id_628050.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
