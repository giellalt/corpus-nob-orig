...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ud/dep/org/avdelinger/europaavdelingen/eosefta.html?id=85977'"/>
<xsl:variable name="title" select="'EES/EFTA-sekšuvdna, dás maiddái EES-čállingoddi - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'eea_efta.html?id=85977'"/>
...
<xsl:variable name="para_sme" select="'EESEFTA-sekuvdna-das-maiddai-EES-allingoddi.html?id=85977'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="eea_efta_id_85977.html" xml:lang="eng"/>
	<parallel_text location="eesefta-sekuvdna-das-maiddai-ees-allingoddi_id_85977.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
