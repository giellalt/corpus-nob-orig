...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fin/pressesenter/pressemeldinger/2013/et-budsjett-for-verdiskaping-og-en-bedre.html?id=745264'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Bušeahtta, mii ovddida árvoráhkadeami ja buoret árgabeaivvi - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'834'"/>
...
<xsl:variable name="para_sme" select="'bueahtta-mii-ovddida-arvorahkadeami-ja-b.html_id=745264'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="amendments-to-the-2014-fiscal-budget_id_745264.html" xml:lang="eng"/>
	<parallel_text location="bueahtta-mii-ovddida-arvorahkadeami-ja-b_id_745264.html" xml:lang="sme"/>
<parallel_text location="eit-budsjett-for-verdiskaping-og-ein-bet_id_745264.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
