...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fd/pressesenter/pressemeldinger/2010/--et-godt-men-stramt-forsvarsbudsjett.html?id=619069'"/>
<xsl:variable name="title" select="'- Buorre, muhto čavgadis suodjalusbušeahtta - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'1313'"/>
...
<xsl:variable name="para_sme" select="'---buorre-muhto-avgadis-suodjalusbueahtt.html?id=619069'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="more-housing-support-for-families-with-children--_id_619669.html" xml:lang="eng"/>
	<parallel_text location="buorre-muhto-avgadis-suodjalusbueahtt_id_619069.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
