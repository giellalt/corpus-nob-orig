...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/kd/tema/livslang-laring/etter--og-videreutdanning.html?id=592069'"/>
<xsl:variable name="title" select="'Etter- og videreutdanning - regjeringen.no'"/>
