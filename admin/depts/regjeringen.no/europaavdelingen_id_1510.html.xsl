...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ud/dep/org/avdelinger/europaavdelingen.html?id=1510'"/>
<xsl:variable name="title" select="'Eurohpá ja gávpeossodat - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'department_european.html?id=1510'"/>
...
<xsl:variable name="para_sme" select="'Eurohpa-ja-gavpeossodat.html?id=1510'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="department_european_id_1510.html" xml:lang="eng"/>
	<parallel_text location="eurohpa-ja-gavpeossodat_id_1510.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
