...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/krd/tema/regional-_og_distriktspolitikk/internasjonalt-samarbeid-om-distrikts--o/europapolitisk-forum.html?id=528603'"/>
<xsl:variable name="title" select="'Eurohpápolitihkalaš forum   - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'274'"/>
...
<xsl:variable name="para_eng" select="'forum-for-european-policy.html?id=528603'"/>
...
<xsl:variable name="para_sme" select="'eurohpapolitihkala-forum--.html?id=528603'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="forum-for-european-policy_id_528603.html" xml:lang="eng"/>
	<parallel_text location="eurohpapolitihkala-forum--_id_528603.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
