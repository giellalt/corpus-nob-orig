...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ud/dep/org/avdelinger/europaavdelingen/europapolitisk_seksjon.html?id=85978'"/>
<xsl:variable name="title" select="'Eurohpápolitihka sekšuvdna  - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'european_policy.html?id=85978'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="european_policy_id_85978.html" xml:lang="eng"/>
	<parallel_text location="eurohpapolitihka-sekuvdna-_id_85978.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
