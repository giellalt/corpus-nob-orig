...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad.html?id=339'"/>
<xsl:variable name="title" select="'Ođasmahttin-, hálddahus- ja girkodepartemeanta - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'677'"/>
...
<xsl:variable name="para_eng" select="'fad.html?id=339'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'fad.html?id=339'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'fad.html?id=339'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="fad_id_339.html" xml:lang="eng"/>
	<parallel_text location="fad_id_339.html" xml:lang="nno"/>
	<parallel_text location="fad_id_339.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
