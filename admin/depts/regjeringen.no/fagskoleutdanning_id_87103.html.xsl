...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/kd/tema/fagskoleutdanning.html?id=87103'"/>
<xsl:variable name="title" select="'Fágaskuvlaoahppu - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'Tertiary-Vocational-Education-.html?id=87103'"/>
...
<xsl:variable name="para_sme" select="'fagaskuvlaoahppu.html?id=87103'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="tertiary-vocational-education-_id_87103.html" xml:lang="eng"/>
	<parallel_text location="fagaskuvlaoahppu_id_87103.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
