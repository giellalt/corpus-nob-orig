...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/tema/familie_og_oppvekst.html?id=213'"/>
<xsl:variable name="title" select="'Bearaš ja bajásšaddan - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'682'"/>
...
<xsl:variable name="para_eng" select="'families-and-upbringing.html?id=213'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'familie-og-oppvekst.html?id=213'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'beara-ja-bajasaddan.html?id=213'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="families-and-upbringing_id_213.html" xml:lang="eng"/>
	<parallel_text location="familie-og-oppvekst_id_213.html" xml:lang="nno"/>
	<parallel_text location="beara-ja-bajasaddan_id_213.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
