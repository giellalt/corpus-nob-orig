...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/krd/dok/hoeringer/ferdigbehandlet.html?id=1943'"/>
<xsl:variable name="title" select="'Gárvvisin meannuduvvon áššit - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'185'"/>
...
<xsl:variable name="para_nno" select="'Ferdigbehandla-saker.html?id=1943'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'SE_Ferdigbehandlede-saker.html?id=1943'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="ferdigbehandla-saker_id_1943.html" xml:lang="nno"/>
	<parallel_text location="se_ferdigbehandlede-saker_id_1943.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
