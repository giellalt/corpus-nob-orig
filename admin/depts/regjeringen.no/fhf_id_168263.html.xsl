...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fkd/dep/tilknyttede-virksomheter/fhf.html?id=168263'"/>
<xsl:variable name="title" select="'FHF - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'217'"/>
...
<xsl:variable name="para_eng" select="'the-fishery-and-aquaculture-industry-res.html?id=168263'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Forskingsfondet-til-fiskeri--og-havbruksnaringa-.html?id=168263'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'FHF.html?id=168263'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="the-fishery-and-aquaculture-industry-res_id_168263.html" xml:lang="eng"/>
	<parallel_text location="forskingsfondet-til-fiskeri--og-havbruksnaringa-_id_168263.html" xml:lang="nno"/>
	<parallel_text location="fhf_id_168263.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
