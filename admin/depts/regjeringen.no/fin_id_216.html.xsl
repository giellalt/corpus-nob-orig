...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fin.html?id=216'"/>
<xsl:variable name="title" select="'Ruhtadandepartemeanta - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'fin.html?id=216'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'fin.html?id=216'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'fin.html?id=216'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="fin_id_216.html" xml:lang="eng"/>
	<parallel_text location="fin_id_216.html" xml:lang="nno"/>
	<parallel_text location="fin_id_216.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
