...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fin/dep/org/avdelinger/finansavdelingen.html?id=1544'"/>
<xsl:variable name="title" select="'Ruhtadanossodat - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'302'"/>
...
<xsl:variable name="para_eng" select="'The-Financial-Markets-Department.html?id=1544'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Finansavdelinga.html?id=1544'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Ruhtadanossodat.html?id=1544'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="the-financial-markets-department_id_1544.html" xml:lang="eng"/>
	<parallel_text location="finansavdelinga_id_1544.html" xml:lang="nno"/>
	<parallel_text location="ruhtadanossodat_id_1544.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
