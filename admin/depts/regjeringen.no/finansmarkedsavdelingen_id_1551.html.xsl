...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fin/dep/org/avdelinger/finansmarkedsavdelingen.html?id=1551'"/>
<xsl:variable name="title" select="'Ruhtadanmárkanossodat - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'financial_markets_department.html?id=1551'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Finansmarknadsavdelinga.html?id=1551'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Ruhtadanmarkanossodat.html?id=1551'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="financial_markets_department_id_1551.html" xml:lang="eng"/>
	<parallel_text location="finansmarknadsavdelinga_id_1551.html" xml:lang="nno"/>
	<parallel_text location="ruhtadanmarkanossodat_id_1551.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
