...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ad/pressesenter/pressemeldinger/2011/finnmark-og-oslo-har-redusert-sykefravar.html?id=667571'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Finnmárkkus ja Oslos lea buozalmasjávkan eanemusat njiedjan ČB-áigodagas - regjeringen.no'"/>
...
<xsl:variable name="para_sme" select="'finnmarkkus-ja-oslos-lea-buozalmasjavkan.html_id=667571'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="norway-contributes-to-safeguarding-europ.html_id=667610" xml:lang="eng"/>
	<parallel_text location="finnmarkkus-ja-oslos-lea-buozalmasjavkan_id_667571.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
