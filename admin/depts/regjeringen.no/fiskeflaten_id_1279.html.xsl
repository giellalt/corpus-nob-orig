...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fkd/tema/fiske_og_fangst/fiskeflaten.html?id=1279'"/>
<xsl:variable name="title" select="'Bivdofanashivvodat - regjeringen.no'"/>
...
<xsl:variable name="para_nno" select="'fiskeflaten.html?id=1279'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'bivdofanashivvodat.html?id=1279'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="fiskeflaten_id_1279.html" xml:lang="nno"/>
	<parallel_text location="bivdofanashivvodat_id_1279.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
