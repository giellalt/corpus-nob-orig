...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fkd/aktuelt/nyheter/2010/fiskeri--og-kystdepartementet-far-ansvar.html?id=610278'"/>
<xsl:variable name="title" select="'Guolástus- ja riddodepartemeanta oažžu ovddasvástádusa “BarentsWatch” ásaheames - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'426'"/>
...
<xsl:variable name="para_eng" select="'the-ministry-of-fisheries-and-coastal-af.html?id=610278'"/>
...
<xsl:variable name="para_sme" select="'guolastus--ja-riddodepartemeanta-oau-ovd.html?id=610278'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="the-ministry-of-fisheries-and-coastal-af_id_610278.html" xml:lang="eng"/>
	<parallel_text location="guolastus--ja-riddodepartemeanta-oau-ovd_id_610278.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
