...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fkd/dep/underliggende-etater/fiskeridirektoratet.html?id=1507'"/>
<xsl:variable name="title" select="'Guolástusdirektoráhta - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'265'"/>
...
<xsl:variable name="para_eng" select="'The-Directorate-of-Fisheries.html?id=1507'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Fiskeridirektoratet.html?id=1507'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Guolastusdirektorahta.html?id=1507'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="the-directorate-of-fisheries_id_1507.html" xml:lang="eng"/>
	<parallel_text location="fiskeridirektoratet_id_1507.html" xml:lang="nno"/>
	<parallel_text location="guolastusdirektorahta_id_1507.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
