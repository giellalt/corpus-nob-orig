...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fkd/dep/tilknyttede-virksomheter/fiskeriforskning.html?id=163831'"/>
<xsl:variable name="title" select="'Norgga Guolástus- og mearradutkaninstituhtta  - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'the-norwegian-institute-of-fisheries-and.html?id=163831'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'fiskeriforsking.html?id=163831'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Norgga-Guolastus--og-mearradutkaninstituhtta-.html?id=163831'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="the-norwegian-institute-of-fisheries-and_id_163831.html" xml:lang="eng"/>
	<parallel_text location="fiskeriforsking_id_163831.html" xml:lang="nno"/>
	<parallel_text location="norgga-guolastus--og-mearradutkaninstituhtta-_id_163831.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
