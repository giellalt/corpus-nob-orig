...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fkd.html?id=257'"/>
<xsl:variable name="title" select="'Guolástus- ja riddodepartemeanta - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'675'"/>
...
<xsl:variable name="para_eng" select="'fkd.html?id=257'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'fkd.html?id=257'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'fkd.html?id=257'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="fkd_id_257.html" xml:lang="eng"/>
	<parallel_text location="fkd_id_257.html" xml:lang="nno"/>
	<parallel_text location="fkd_id_257.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
