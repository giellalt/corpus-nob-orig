...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/pressesenter/pressemeldinger/2012/flere-nye-prester---lavt-sykefravar.html?id=671798'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Eanet ođđa báhpat – unnán buohcanjávkan - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'603'"/>
...
<xsl:variable name="para_nno" select="'fleire-nye-prestar---lagt-sjukefravar.html_id=671798'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="'giske-eun-jielemeministerh-gaavnesji.html_id=672425'"/>
<xsl:variable name="para_sme" select="'eanet-oa-bahpat--unnan-buohcanjavkan.html_id=671798'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="fleire-nye-prestar---lagt-sjukefravar_id_671798.html" xml:lang="nno"/>
	<parallel_text location="eanet-oa-bahpat--unnan-buohcanjavkan_id_671798.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
