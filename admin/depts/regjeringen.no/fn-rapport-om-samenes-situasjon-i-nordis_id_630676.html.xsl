...
<<<<<<< HEAD
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/pressesenter/pressemeldinger/2010/fn-rapport-om-samenes-situasjon-i-nordis.html?id=630676'"/>
=======
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/pressesenter/pressemeldinger/2011/fn-rapport-om-samenes-situasjon-i-nordis.html?id=630676'"/>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'ON-raporta sámiid dili birra davviriikkain - regjeringen.no'"/>
...
=======
<xsl:variable name="wordcount" select="'474'"/>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
...
<xsl:variable name="para_sme" select="'ON-raporta-samiid-dili-birra-davviriikkain.html?id=630676'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="on-raporta-samiid-dili-birra-davviriikka_id_630676.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
