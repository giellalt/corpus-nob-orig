...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/hod/tema/folkehelse.html?id=10877'"/>
<xsl:variable name="title" select="'Álbmotdearvvašvuohta - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'the-department-of-public-health.html?id=10877'"/>
...
<xsl:variable name="para_sme" select="'albmotdearvvavuohta.html?id=10877'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="the-department-of-public-health_id_10877.html" xml:lang="eng"/>
	<parallel_text location="albmotdearvvavuohta_id_10877.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
