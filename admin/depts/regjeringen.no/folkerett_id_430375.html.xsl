...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ud/tema/folkerett.html?id=430375'"/>
<xsl:variable name="title" select="'Álbmotriekti - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'civil--rights.html?id=430375'"/>
...
<xsl:variable name="para_sme" select="'folkerett_samisk.html?id=430375'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="civil--rights_id_430375.html" xml:lang="eng"/>
	<parallel_text location="folkerett_samisk_id_430375.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
