...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/krd/kampanjer/valg/for-partierlister.html?id=547643'"/>
<xsl:variable name="title" select="'For partier/lister - regjeringen.no'"/>
