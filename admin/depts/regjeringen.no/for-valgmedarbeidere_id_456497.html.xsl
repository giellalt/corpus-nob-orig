...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/krd/kampanjer/valg/for-valgmedarbeidere.html?id=456497'"/>
<xsl:variable name="title" select="'For valgmedarbeidere - regjeringen.no'"/>
