...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/bld/dep/org/avdelinger/for.html?id=83'"/>
<xsl:variable name="title" select="'Golaheaddjiossodat - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'Department-of-Consumer-Affairs.html?id=83'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Forbrukaravdelinga.html?id=83'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Golaheaddjiossodat.html?id=83'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="department-of-consumer-affairs_id_83.html" xml:lang="eng"/>
	<parallel_text location="forbrukaravdelinga_id_83.html" xml:lang="nno"/>
	<parallel_text location="golaheaddjiossodat_id_83.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
