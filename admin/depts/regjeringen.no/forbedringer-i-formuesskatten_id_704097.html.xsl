...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fin/pressesenter/pressemeldinger/2012/forbedringer-i-formuesskatten.html?id=704097'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Opmodatvearu buorideapmi - regjeringen.no'"/>
...
<xsl:variable name="para_nno" select="'forbetringar-i-formuesskatten.html_id=704097'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="forbetringar-i-formuesskatten_id_704097.html" xml:lang="nno"/>
	<parallel_text location="opmodatvearu-buorideapmi_id_704097.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
