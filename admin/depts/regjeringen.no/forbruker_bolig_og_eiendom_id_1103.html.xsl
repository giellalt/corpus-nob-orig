...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/lmd/tema/mat/forbruker_bolig_og_eiendom.html?id=1103'"/>
<xsl:variable name="title" select="'Borramušpolitihkka ja geavaheaddjit - regjeringen.no'"/>
...
<xsl:variable name="para_nno" select="'matpolitikk-og-forbrukarane.html?id=1103'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'borramupolitihkka-ja-geavaheaddjit.html?id=1103'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="matpolitikk-og-forbrukarane_id_1103.html" xml:lang="nno"/>
	<parallel_text location="borramupolitihkka-ja-geavaheaddjit_id_1103.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
