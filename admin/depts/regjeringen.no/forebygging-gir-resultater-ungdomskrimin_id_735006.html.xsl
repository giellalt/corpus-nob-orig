...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/jd/pressesenter/pressemeldinger/20131/forebygging-gir-resultater-ungdomskrimin.html?id=735006'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Heerredimmie illedahkh vadta: Noerekrimininaliteete vaanene - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'1256'"/>
...
<xsl:variable name="para_sme" select="'heerredimmie-illedahkh-vadta-noerekrimin.html_id=735006'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="heerredimmie-illedahkh-vadta-noerekrimin_id_735006.html" xml:lang="sme"/>
