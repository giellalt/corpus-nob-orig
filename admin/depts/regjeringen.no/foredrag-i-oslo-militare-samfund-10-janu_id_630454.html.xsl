...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fd/aktuelt/taler_artikler/ministeren/taler-og-artikler-av-forsvarsminister-gr/2011/foredrag-i-oslo-militare-samfund-10-janu.html?id=630454'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Logaldallan Oslo Militære Samfund báikkis - regjeringen.no'"/>
...
<<<<<<< HEAD
<xsl:variable name="wordcount" select="'3961'"/>
=======
<xsl:variable name="wordcount" select="'3964'"/>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
...
<xsl:variable name="para_sme" select="'logaldallan-oslo-militare-samfund-baikki.html?id=630454'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="logaldallan-oslo-militare-samfund-baikki_id_630454.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
