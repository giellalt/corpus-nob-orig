...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/kmd/pressesenter/pressemeldinger/2014/forenkler-kommunikasjonen-med-innbyggere.html?id=750734'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Álkit gulahallan ássiiguin ja ealáhuseallimiin - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'911'"/>
...
<xsl:variable name="para_sme" select="'alkit-gulahallan-assiiguin-ja-ealahuseal.html_id=750734'"/>
...
<xsl:variable name="parallels">
	...
	<parallel_text location="alkit-gulahallan-assiiguin-ja-ealahuseal_id_750734.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
