...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/kud/pressesenter/pressemeldinger/2012/forenkling-i-soknad-om-momskompensasjon-.html?id=674431'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Jagi 2012 lassiárvovearu buhtadusa ohcan álkiduvvo - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'246'"/>
...
<xsl:variable name="para_eng" select="'election-day-set-for-9-september-2013.html_id=675958'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'mange-vil-delta-i-bustadprosjekt-i-distr.html_id=675122'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'jagi-2012-lassiarvovearu-buhtadusa-ohcan.html_id=674431'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="jagi-2012-lassiarvovearu-buhtadusa-ohcan_id_674431.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
