...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/krd/kampanjer/valg/stortingsvalg/forhandsstemme.html?id=457115'"/>
...
<xsl:variable name="para_eng" select="'how-to-vote-in-advance.html?id=457115'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="how-to-vote-in-advance_id_457115.html" xml:lang="eng"/>
	<parallel_text location="royste-pa-forehand_id_457115.html" xml:lang="nno"/>
	<parallel_text location="na-don-jienastat-ovddalgihtii_id_457115.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
