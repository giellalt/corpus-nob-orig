...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fin/dep/org/avdelinger/formuesforvaltning.html?id=87100'"/>
...
<xsl:variable name="para_eng" select="'the-asset-management-department.html?id=87100'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'avdeling-for-formuesforvaltning-aff.html?id=87100'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Opmodagaid-halddaanossodat-.html?id=87100'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="the-asset-management-department_id_87100.html" xml:lang="eng"/>
	<parallel_text location="avdeling-for-formuesforvaltning-aff_id_87100.html" xml:lang="nno"/>
	<parallel_text location="opmodagaid-halddaanossodat-_id_87100.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
