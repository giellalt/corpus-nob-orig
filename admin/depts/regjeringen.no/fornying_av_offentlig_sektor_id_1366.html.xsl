...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/tema/fornying_av_offentlig_sektor.html?id=1366'"/>
<xsl:variable name="title" select="'Almmolaš suorggi ođasmahttin - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'Reforming-and-regenerating-the-public-se.html?id=1366'"/>
...
<xsl:variable name="para_sme" select="'Almmola-suorggi-oasmahttin.html?id=1366'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="reforming-and-regenerating-the-public-se_id_1366.html" xml:lang="eng"/>
	<parallel_text location="almmola-suorggi-oasmahttin_id_1366.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
