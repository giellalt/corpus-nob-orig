...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fd/pressesenter/pressemeldinger/2010/forsker-pa-veteraner.html?id=612242'"/>
<xsl:variable name="title" select="'Forsker på veteraner - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'526'"/>
...
<xsl:variable name="para_sme" select="'Dutka-veteranaid.html?id=612242'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="dutka-veteranaid_id_612242.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
