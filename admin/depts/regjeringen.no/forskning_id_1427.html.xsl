...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/kd/tema/forskning.html?id=1427'"/>
<xsl:variable name="title" select="'Dutkan - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'research.html?id=1427'"/>
...
<xsl:variable name="para_sme" select="'dutkan.html?id=1427'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="research_id_1427.html" xml:lang="eng"/>
	<parallel_text location="dutkan_id_1427.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
