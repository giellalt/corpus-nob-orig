...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fkd/dep/tilknyttede-virksomheter/forskningsradet.html?id=164556'"/>
<xsl:variable name="title" select="'Norgga duktanráđđi (Norges forskningsråd) - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'232'"/>
...
<xsl:variable name="para_eng" select="'The-Research-Council-of-Norway-.html?id=164556'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Forskingsradet.html?id=164556'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Norgga-duktanrai-Norges-forskningsrad.html?id=164556'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="the-research-council-of-norway-_id_164556.html" xml:lang="eng"/>
	<parallel_text location="forskingsradet_id_164556.html" xml:lang="nno"/>
	<parallel_text location="norgga-duktanrai-norges-forskningsrad_id_164556.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
