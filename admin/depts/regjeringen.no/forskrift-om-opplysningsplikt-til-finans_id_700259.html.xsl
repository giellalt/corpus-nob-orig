...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fin/aktuelt/nyheter/2012/forskrift-om-opplysningsplikt-til-finans.html?id=700259'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Láhkaásahus Ruhtadanportála dieđihangeatnegasvuođaid birra - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'401'"/>
...
<xsl:variable name="para_eng" select="'report-on-cost-benefit-analysis.html_id=701024'"/>
...
<xsl:variable name="para_sme" select="'lahkaasahus-ruhtadanportala-dieihangeatn.html_id=700259'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="report-on-cost-benefit-analysis.html_id=701024" xml:lang="eng"/>
	<parallel_text location="lahkaasahus-ruhtadanportala-dieihangeatn_id_700259.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
