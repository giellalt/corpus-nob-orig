...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ad/dok/lover_regler/forskrifter/2008/forskrift-om-valg-til-sametinget.html?id=542923'"/>
<xsl:variable name="title" select="'Láhkaásahus sámediggeválgga birra  - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'7992'"/>
...
<xsl:variable name="para_sme" select="'lahkaasahus-samediggevalgga-birra-.html?id=542923'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="lahkaasahus-samediggevalgga-birra-_id_542923.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
