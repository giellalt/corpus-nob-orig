...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/krd/dok/lover_regler/forskrifter/2005/forskrift-om-valg-til-sametinget.html?id=92502'"/>
<xsl:variable name="title" select="'Láhkaáhus sámediggeválgga birra - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'6696'"/>
...
<xsl:variable name="para_sme" select="'Lahkaahus-samediggevalgga-birra.html?id=92502'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="lahkaahus-samediggevalgga-birra_id_92502.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
