...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/krd/dok/lover_regler/forskrifter.html?id=541'"/>
...
<xsl:variable name="para_nno" select="'Forskrifter.html?id=541'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Lahkaasahusat.html?id=541'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="forskrifter_id_541.html" xml:lang="nno"/>
	<parallel_text location="lahkaasahusat_id_541.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
