...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/lmd/dok/lover_regler/forskrifter.html?id=664'"/>
...
<xsl:variable name="para_nno" select="'forskrifter.html?id=664'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Lahkaasahusat.html?id=664'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="forskrifter_id_664.html" xml:lang="nno"/>
	<parallel_text location="lahkaasahusat_id_664.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
