...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/md/dok/lover_regler/forskrifter.html?id=705'"/>
<xsl:variable name="title" select="'Láhkaásahusat - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'1033'"/>
...
<xsl:variable name="para_eng" select="'regulations.html?id=705'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'forskrifter.html?id=705'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'lahkaasahusat.html?id=705'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="regulations_id_705.html" xml:lang="eng"/>
	<parallel_text location="forskrifter_id_705.html" xml:lang="nno"/>
	<parallel_text location="lahkaasahusat_id_705.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
