...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ad/pressesenter/pressemeldinger/2008/forslag-om-endringer-i-sametingets-valgo.html?id=505115'"/>
<xsl:variable name="title" select="'Árvalus Sámedikki válgaortnega rievdadusaid birra - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'363'"/>
...
<xsl:variable name="para_sme" select="'arvalus-samedikki-valgaortnega-rievdadus.html?id=505115'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="arvalus-samedikki-valgaortnega-rievdadus_id_505115.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
