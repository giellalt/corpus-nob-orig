...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fd/pressesenter/pressemeldinger/20141/forste-last-av-kjemiske-vapen-fra-syria.html?id=748879'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Syrias fievrredit vuosttaš guorpmi kemihkalaš vearjjuid - regjeringen.no'"/>
...
<xsl:variable name="para_sme" select="'syrias-fievrredit-vuostta-guorpmi-kemihk.html_id=748879'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="first-load-of-chemical-weapons-has-left-_id_748879.html" xml:lang="eng"/>
	<parallel_text location="syrias-fievrredit-vuostta-guorpmi-kemihk_id_748879.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
