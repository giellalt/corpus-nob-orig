...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/kud/dep/org/avdelinger/medieavdelingen_/forste-medieseksjon-m1.html?id=551455'"/>
<xsl:variable name="title" select="'Sekšuvdna M1 - regjeringen.no'"/>
...
<xsl:variable name="para_nno" select="'Seksjon-M1.html?id=551455'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Sekuvdna-M1.html?id=551455'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="seksjon-m1_id_551455.html" xml:lang="nno"/>
	<parallel_text location="sekuvdna-m1_id_551455.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
