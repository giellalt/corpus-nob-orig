...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/lmd/pressesenter/pressemeldinger/2012/forsterker-importvernet-for-utvalgte-lan.html?id=701321'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Nanne importasuodjaleami dihto eanandoallogálvvuin - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'690'"/>
...
<xsl:variable name="para_eng" select="'changes-to-border-protection-for-selecte.html_id=701321'"/>
...
<xsl:variable name="para_sme" select="'buoret-ja-eanet-eanandoallu-ruaid-ovddas.html_id=701321'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="changes-to-border-protection-for-selecte_id_701321.html" xml:lang="eng"/>
	<parallel_text location="buoret-ja-eanet-eanandoallu-ruaid-ovddas_id_701321.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
