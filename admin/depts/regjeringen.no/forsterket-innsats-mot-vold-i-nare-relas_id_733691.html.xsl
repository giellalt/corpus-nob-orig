...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/jd/pressesenter/pressemeldinger/20131/forsterket-innsats-mot-vold-i-nare-relas.html?id=733691'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Bargat veahkaválddi eastadit lagas relašuvnnain - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'629'"/>
...
<xsl:variable name="para_sme" select="'bargat-veahkavalddi-eastadit-lagas-relau.html_id=733691'"/>
