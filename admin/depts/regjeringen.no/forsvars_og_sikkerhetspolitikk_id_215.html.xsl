...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/tema/forsvars_og_sikkerhetspolitikk.html?id=215'"/>
<xsl:variable name="title" select="'Servodat sihkkarvuohta ja suodjalus - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'949'"/>
...
<xsl:variable name="para_eng" select="'Civil-protection-and-defence.html?id=215'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'samfunntryggleik-og-forsvar.html?id=215'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Servodat-sihkkarvuohta-ja-suodjalus.html?id=215'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="civil-protection-and-defence_id_215.html" xml:lang="eng"/>
	<parallel_text location="samfunntryggleik-og-forsvar_id_215.html" xml:lang="nno"/>
	<parallel_text location="servodat-sihkkarvuohta-ja-suodjalus_id_215.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
