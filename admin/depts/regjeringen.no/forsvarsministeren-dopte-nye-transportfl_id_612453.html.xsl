...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fd/aktuelt/taler_artikler/ministeren/taler-og-artikler-av-forsvarsminister-gr/2010/forsvarsministeren-dopte-nye-transportfl.html?id=612453'"/>
<<<<<<< HEAD
<xsl:variable name="title" select="'Forsvarsministeren døpte nye transportfly - regjeringen.no'"/>
=======
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Suodjalusministtar gásttašii ođđa geasehangirdiid - regjeringen.no'"/>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
...
<<<<<<< HEAD
<xsl:variable name="wordcount" select="'962'"/>
<xsl:variable name="metadata" select="'uncomplete'"/>
<xsl:variable name="template_version" select="'$Revision$'"/>
=======
<xsl:variable name="wordcount" select="'748'"/>
<xsl:variable name="metadata" select="'uncomplete'"/>
...
<xsl:variable name="para_sme" select="'Suodjalusministtar-gasttaii-oa-geasehangirdiid.html?id=612453'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="suodjalusministtar-gasttaii-oa-geasehangirdiid_id_612453.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
