...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/kud/pressesenter/pressemeldinger/2010/Fortsatt-fastpris-pa-skjonnlitteratur-og-sakprosa.html?id=609524'"/>
<xsl:variable name="title" select="'Fortsatt fastpris på skjønnlitteratur og sakprosa - regjeringen.no'"/>
...
<<<<<<< HEAD
<xsl:variable name="wordcount" select="'391'"/>
=======
<xsl:variable name="wordcount" select="'390'"/>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
...
<xsl:variable name="para_sme" select="'Bisova-vuoohaddi-appagirjjalavuoa-ja-aeprosa-ektui.html?id=609524'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="bisova-vuoohaddi-appagirjjalavuoa-ja-aeprosa-ektui_id_609524.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
