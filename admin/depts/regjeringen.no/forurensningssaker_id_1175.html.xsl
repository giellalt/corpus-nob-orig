...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/md/dep/org/avdelinger/forurensningssaker.html?id=1175'"/>
<xsl:variable name="title" select="'Nuoskkidanáššiid ossodat - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'department-for-environmental-data-pollut.html?id=1175'"/>
...
<xsl:variable name="para_sme" select="'Nuoskkidanaiid-ossodat.html?id=1175'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="department-for-environmental-data-pollut_id_1175.html" xml:lang="eng"/>
	<parallel_text location="nuoskkidanaiid-ossodat_id_1175.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
