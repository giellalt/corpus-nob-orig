...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/kd/tema/livslang-laring/framtidas-kompetansebehov.html?id=592070'"/>
<xsl:variable name="title" select="'Framtidas kompetansebehov - regjeringen.no'"/>
