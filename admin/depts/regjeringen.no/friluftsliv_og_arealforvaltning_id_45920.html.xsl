...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/md/dep/org/avdelinger/naturforvaltning/friluftsliv_og_arealforvaltning.html?id=45920'"/>
<xsl:variable name="title" select="'Olgoáibmodoaimmaid ja areálahálddašeami sekšuvdna - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'section-for-outdoor-recreation-and-land-.html?id=45920'"/>
...
<xsl:variable name="para_sme" select="'Olgoaibmodoaimmaid-ja-arealahalddaeami-sekuvdna.html?id=45920'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="section-for-outdoor-recreation-and-land-_id_45920.html" xml:lang="eng"/>
	<parallel_text location="olgoaibmodoaimmaid-ja-arealahalddaeami-sekuvdna_id_45920.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
