...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/tema/samfunnssikkerhet/fugleinfluensa.html?id=1123'"/>
<xsl:variable name="title" select="'Loddeinflueansa - regjeringen.no'"/>
...
<xsl:variable name="para_nno" select="'Fugleinfluensa.html?id=1123'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Loddeinflueansa.html?id=1123'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="fugleinfluensa_id_1123.html" xml:lang="nno"/>
	<parallel_text location="loddeinflueansa_id_1123.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
