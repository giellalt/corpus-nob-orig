...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/jd/tema/lovarbeid/gangen-i-lovgivningsarbeidet.html?id=445792'"/>
<xsl:variable name="title" select="'Gangen i lovgivningsarbeidet - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'Legislative-procedure.html?id=445792'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="legislative-procedure_id_445792.html" xml:lang="eng"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
