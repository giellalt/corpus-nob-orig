...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/smk/aktuelt/taler_og_artikler/statsministeren/statsminister_jens_stoltenberg/2012/gaver-til-kong-harald-og-dronning-sonja.html?id=672443'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Gonagasskeaŋkkát 75 jagi - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'646'"/>
...
<xsl:variable name="para_sme" select="'gonagasskeakkat-75-jagi.html_id=672443'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="speech-in-connection-with-the-government_id_672443.html" xml:lang="eng"/>
	<parallel_text location="gonagasskeakkat-75-jagi_id_672443.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
