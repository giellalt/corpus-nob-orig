...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/lmd/tema/genmodifiserte_organismer.html?id=1274'"/>
<xsl:variable name="title" select="'Genalaččat heivehuvvon organismmat - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'326'"/>
...
<xsl:variable name="para_nno" select="'genmodifiserte-organismar.html?id=1274'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'genalaat-heivehuvvon-organismmat.html?id=1274'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="genmodifiserte-organismar_id_1274.html" xml:lang="nno"/>
	<parallel_text location="genalaat-heivehuvvon-organismmat_id_1274.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
