...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ad/pressesenter/pressemeldinger/2008/gir-800-000-kroner-til-samekonferanse.html?id=509548'"/>
<xsl:variable name="title" select="'Addá 800 000 ruvnno sámekonferánsii  - regjeringen.no'"/>
...
<xsl:variable name="para_sme" select="'adda-800-000-ruvnno-samekonferansii--2.html?id=509548'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="adda-800-000-ruvnno-samekonferansii--2_id_509548.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
