...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/aktuelt/taler_og_artikler/minister/taler-og-artikler-av-fornyings--og-kirke/2010/god-dialog-mellom-regjeringen-og-sametin.html?id=612422'"/>
<<<<<<< HEAD
<xsl:variable name="title" select="'God dialog mellom Regjeringen og Sametinget - regjeringen.no'"/>
=======
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Buorre gulahallan gaskal Ráđđehusa ja Sámedikki - regjeringen.no'"/>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
...
<<<<<<< HEAD
<xsl:variable name="wordcount" select="'947'"/>
...
<xsl:variable name="para_sme" select="'Buorre-gulahallan-gaskal-Raehusa-ja-Samedikki.html?id=612422'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="buorre-gulahallan-gaskal-raehusa-ja-samedikki_id_612422.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
