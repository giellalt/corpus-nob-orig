...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fin/pressesenter/pressemeldinger/2012/god-utvikling-i-norsk-okonomi.html?id=682404'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Norgga ekonomiija ovdána bures - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'1447'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="revised-national-budget-2012_id_682404.html" xml:lang="eng"/>
	<parallel_text location="norgga-ekonomiija-ovdana-bures_id_682404.html" xml:lang="sme"/>
<parallel_text location="god-utvikling-i-norsk-okonomi_id_682404.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
