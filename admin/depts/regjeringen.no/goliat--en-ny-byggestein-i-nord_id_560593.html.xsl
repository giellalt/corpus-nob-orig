...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/oed/pressesenter/pressemeldinger/2009/goliat--en-ny-byggestein-i-nord.html?id=560593'"/>
<xsl:variable name="title" select="'Goliat – ođđa huksengeađgi davvin - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'goliat--an-important-part-of-the-develop.html?id=560593'"/>
...
<xsl:variable name="para_sme" select="'goliat--oa-huksengeagi-davvin.html?id=560593'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="goliat--an-important-part-of-the-develop_id_560593.html" xml:lang="eng"/>
	<parallel_text location="goliat--oa-huksengeagi-davvin_id_560593.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
