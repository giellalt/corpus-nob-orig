...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/tema/samepolitikk/bruk_av_samisk_sprak/gollegiella.html?id=86929'"/>
<xsl:variable name="title" select="'Gollegiella - regjeringen.no'"/>
...
<xsl:variable name="para_sme" select="'gollegiella.html?id=86929'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="gollegiella_id_86929.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
