...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ad/pressesenter/pressemeldinger/2008/--gratulerer-med-dagen-alle-samer.html?id=499276'"/>
<xsl:variable name="title" select="'- Lihku beivviin, buot sápmelaččat! - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'374'"/>
...
<xsl:variable name="para_sme" select="'--Lihku-beivviin-buot-sapmelaat.html?id=499276'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="lihku-beivviin-buot-sapmelaat_id_499276.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
