...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/pressesenter/pressemeldinger/2012/gratulerer-med-verdens-urfolksdag.html?id=697230'"/>
...
<xsl:variable name="para_sme" select="'savvat-buori-algoalbmotbeaivvi.html_id=697230'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="savvat-buori-algoalbmotbeaivvi_id_697230.html" xml:lang="sme"/>
<parallel_text location="gratulerer-med-verdas-urfolksdag_id_697230.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
