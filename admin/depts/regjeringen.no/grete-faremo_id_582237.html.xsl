...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fd/dep/grete-faremo.html?id=582237'"/>
<xsl:variable name="title" select="'Suodjalusministtar Grete Faremo - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'466'"/>
...
<xsl:variable name="para_eng" select="'grete-faremo.html?id=582237'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'grete-faremo.html?id=582237'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'suodjalusministtar-grete-faremo.html?id=582237'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="grete-faremo_id_582237.html" xml:lang="eng"/>
	<parallel_text location="grete-faremo_id_582237.html" xml:lang="nno"/>
	<parallel_text location="suodjalusministtar-grete-faremo_id_582237.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
