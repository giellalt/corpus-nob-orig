...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ad/dep/org/avdelinger/pks/gro-orsal.html?id=445778'"/>
<xsl:variable name="title" select="'Seniorráđđeaddi Gro Ørsal - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'senior-adviser-gro-orsal.html?id=445778'"/>
...
<xsl:variable name="para_sme" select="'seniorraeaddi-gro-orsal.html?id=445778'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="senior-adviser-gro-orsal_id_445778.html" xml:lang="eng"/>
	<parallel_text location="seniorraeaddi-gro-orsal_id_445778.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
