...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fkd/pressesenter/pressemeldinger/2012/gronn-vekst-i-lakseoppdrett.html?id=707527'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Ruoná ovdáneapmi luossabiebmanealáhusas - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'new-directorate-environment.html_id=707555'"/>
...
<xsl:variable name="para_sme" select="'ruona-ovdaneapmi-luossabiebmanealahusas.html_id=707527'"/>
<xsl:variable name="para_smj" select="'raddidus-ajggu-tjadadit-politiguoradalla.html_id=708095'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="ruona-ovdaneapmi-luossabiebmanealahusas_id_707527.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
