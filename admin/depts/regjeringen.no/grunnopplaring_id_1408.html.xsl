...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/kd/tema/grunnopplaring.html?id=1408'"/>
<xsl:variable name="title" select="'Vuođđoskuvla - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'compulsory-education.html?id=1408'"/>
...
<xsl:variable name="para_sme" select="'vuooskuvla.html?id=1408'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="compulsory-education_id_1408.html" xml:lang="eng"/>
	<parallel_text location="vuooskuvla_id_1408.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
