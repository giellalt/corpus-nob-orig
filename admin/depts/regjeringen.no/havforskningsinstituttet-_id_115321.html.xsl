...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fkd/dep/underliggende-etater/havforskningsinstituttet-.html?id=115321'"/>
<xsl:variable name="title" select="'Mearraduktaninstituhtta (Havforskningsinstituttet)  - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'The-Institute-of-Marine-Research.html?id=115321'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Havforskingsinstituttet.html?id=115321'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Mearraduktaninstituhtta-Havforskningsinstituttet-.html?id=115321'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="the-institute-of-marine-research_id_115321.html" xml:lang="eng"/>
	<parallel_text location="havforskingsinstituttet_id_115321.html" xml:lang="nno"/>
	<parallel_text location="mearraduktaninstituhtta-havforskningsinstituttet-_id_115321.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
