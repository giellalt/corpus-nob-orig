...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/tema/helse.html?id=917'"/>
<xsl:variable name="title" select="'Dearvvašvuohta ja fuolahus - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'669'"/>
...
<xsl:variable name="para_eng" select="'Health-and-care.html?id=917'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Helse-og-omsorg.html?id=917'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Dearvvavuohta-ja-fuolahus.html?id=917'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="health-and-care_id_917.html" xml:lang="eng"/>
	<parallel_text location="helse-og-omsorg_id_917.html" xml:lang="nno"/>
	<parallel_text location="dearvvavuohta-ja-fuolahus_id_917.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
