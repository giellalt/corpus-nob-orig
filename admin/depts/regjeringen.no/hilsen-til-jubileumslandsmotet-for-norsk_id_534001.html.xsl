...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ad/aktuelt/taler_artikler/politisk_ledelse/statssekretar-raimo-valle/2008/hilsen-til-jubileumslandsmotet-for-norsk.html?id=534001'"/>
<<<<<<< HEAD
<xsl:variable name="title" select="'Hilsen til jubileumslandsmøtet for Norske Samers Riksforbund - regjeringen.no'"/>
=======
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Norgga Sámiid Riikkasearvvi ávvučoahkkin - regjeringen.no'"/>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
...
<<<<<<< HEAD
<xsl:variable name="wordcount" select="'766'"/>
...
<xsl:variable name="para_sme" select="'norgga-samiid-riikkasearvvi-avvuoahkkin.html?id=534001'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="norgga-samiid-riikkasearvvi-avvuoahkkin_id_534001.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
