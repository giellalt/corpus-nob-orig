...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ad/aktuelt/taler_artikler/politisk_ledelse/statssekretar-raimo-valle/2009/hilsningstale-pa-samefolkets-dag-.html?id=545394'"/>
<<<<<<< HEAD
<xsl:variable name="title" select="'Hilsningstale på samefolkets dag  - regjeringen.no'"/>
=======
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Dearvvuohtasárdni 2009 guovvamánu 6. beaivvi - regjeringen.no'"/>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
...
<<<<<<< HEAD
<xsl:variable name="wordcount" select="'808'"/>
<xsl:variable name="metadata" select="'uncomplete'"/>
<xsl:variable name="template_version" select="'$Revision$'"/>
=======
<xsl:variable name="wordcount" select="'592'"/>
<xsl:variable name="metadata" select="'uncomplete'"/>
...
<xsl:variable name="para_sme" select="'dearvvuohtasardni-2009-guovvamanu-6-beai.html?id=545394'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="dearvvuohtasardni-2009-guovvamanu-6-beai_id_545394.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
