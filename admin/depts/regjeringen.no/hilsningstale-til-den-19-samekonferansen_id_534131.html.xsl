...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ad/aktuelt/taler_artikler/politisk_ledelse/statssekretar-raimo-valle/2008/hilsningstale-til-den-19-samekonferansen.html?id=534131'"/>
<<<<<<< HEAD
<xsl:variable name="title" select="'Hilsningstale til den 19. samekonferansen i Rovaniemi  - regjeringen.no'"/>
=======
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Dearvvahansárdni 19. sámekonferánsii Roavvenjárggas  - regjeringen.no'"/>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
...
<<<<<<< HEAD
<xsl:variable name="wordcount" select="'791'"/>
<xsl:variable name="metadata" select="'uncomplete'"/>
<xsl:variable name="template_version" select="'$Revision$'"/>
=======
<xsl:variable name="wordcount" select="'615'"/>
<xsl:variable name="metadata" select="'uncomplete'"/>
...
<xsl:variable name="para_sme" select="'dearvvahansardni-19-samekonferansii-roav.html?id=534131'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="dearvvahansardni-19-samekonferansii-roav_id_534131.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
