...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ad/aktuelt/taler_artikler/politisk_ledelse/statssekretar-raimo-valle/2008/hilsningstale-ved-presentasjon-av-de-nye.html?id=522265'"/>
<<<<<<< HEAD
<xsl:variable name="title" select="'Hilsningstale ved presentasjon av de nye samiske veiviserne 2008-2009 - regjeringen.no'"/>
=======
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Dearvvahansárdni oahpásmahtidettiin áigodaga 2008-2009 ođđa sámi ofelaččaid - regjeringen.no'"/>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
...
<<<<<<< HEAD
<xsl:variable name="wordcount" select="'645'"/>
<xsl:variable name="metadata" select="'uncomplete'"/>
<xsl:variable name="template_version" select="'$Revision$'"/>
=======
<xsl:variable name="wordcount" select="'506'"/>
<xsl:variable name="metadata" select="'uncomplete'"/>
...
<xsl:variable name="para_sme" select="'dearvvahansardni-oahpasmahtidettiin-aigo.html?id=522265'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="dearvvahansardni-oahpasmahtidettiin-aigo_id_522265.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
