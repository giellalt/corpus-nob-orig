...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/smk/dep/historie.html?id=85907'"/>
<xsl:variable name="title" select="'Historjá - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'Historical-background.html?id=85907'"/>
...
<xsl:variable name="para_sme" select="'Historja.html?id=85907'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="historical-background_id_85907.html" xml:lang="eng"/>
	<parallel_text location="historja_id_85907.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
