...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ad/dep/org/historikk.html?id=193'"/>
...
<xsl:variable name="para_sme" select="'Historihkka.html?id=193'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="historihkka_id_193.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
