...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/bld/dep/org/historikk.html?id=326'"/>
<xsl:variable name="title" select="'Historihkka  - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'500'"/>
...
<xsl:variable name="para_eng" select="'History-of-the-Ministry-of-Children-and-.html?id=326'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'historia-til-barne--og-likestillingsdepa.html?id=326'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Historja.html?id=326'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="history-of-the-ministry-of-children-and-_id_326.html" xml:lang="eng"/>
	<parallel_text location="historia-til-barne--og-likestillingsdepa_id_326.html" xml:lang="nno"/>
	<parallel_text location="historja_id_326.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
