...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/kd/dep/org/historikk.html?id=614'"/>
...
<xsl:variable name="wordcount" select="'247'"/>
...
<xsl:variable name="para_eng" select="'history.html?id=614'"/>
...
<xsl:variable name="para_sme" select="'Historihkka.html?id=614'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="history_id_614.html" xml:lang="eng"/>
	<parallel_text location="historihkka_id_614.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
