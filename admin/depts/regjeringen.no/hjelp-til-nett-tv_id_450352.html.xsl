...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/Om-nettstedet/Hjelp/hjelp-til-nett-tv.html?id=450352'"/>
<xsl:variable name="title" select="'Hjelp til Nett-TV - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'1301'"/>
