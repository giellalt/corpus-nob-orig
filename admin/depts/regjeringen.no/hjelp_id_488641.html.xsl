...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/Om-nettstedet/Hjelp.html?id=488641'"/>
<xsl:variable name="title" select="'Hjelp - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'128'"/>
...
<xsl:variable name="para_eng" select="'Help.html?id=488641'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Hjelp.html?id=488641'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="help_id_488641.html" xml:lang="eng"/>
	<parallel_text location="hjelp_id_488641.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
