...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/oed/pressesenter/pressemeldinger/2007/Hjemfall-Regjeringen-sikrer-offentlig-ei.html?id=477332'"/>
<xsl:variable name="title" select="'Maŋásmáhcaheapmi: Ráđđehus sihkkarasta almmolaš oamasteami čáhcefápmui - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'422'"/>
...
<xsl:variable name="para_eng" select="'The-right-of-reversion--The-Government-s.html?id=477332'"/>
...
<xsl:variable name="para_sme" select="'Maasmahcaheapmi-Raehus-sihkkarasta-almmo.html?id=477332'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="the-right-of-reversion--the-government-s_id_477332.html" xml:lang="eng"/>
	<parallel_text location="maasmahcaheapmi-raehus-sihkkarasta-almmo_id_477332.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
