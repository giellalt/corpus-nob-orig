...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="author1_ln" select="'Olje- og energidepartementet'"/>
    <!-- m, f or unknown -->
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="the-right-of-reversion--the-government-s_id_477332.html"/>
        ...
        <parallel_text xml:lang="sme" location="maasmahcaheapmi-raehus-sihkkarasta-almmo_id_477332.html"/>
