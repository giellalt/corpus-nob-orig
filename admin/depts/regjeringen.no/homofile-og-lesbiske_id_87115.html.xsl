...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/bld/tema/homofile-og-lesbiske.html?id=87115'"/>
<xsl:variable name="title" select="'Lesbbat, homofiilat, bifiillat, tránssat  - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'homosexuality.html?id=87115'"/>
...
<xsl:variable name="para_sme" select="'lesbbat-homofiilat-bifiillat-transsat-.html?id=87115'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="homosexuality_id_87115.html" xml:lang="eng"/>
	<parallel_text location="lesbbat-homofiilat-bifiillat-transsat-_id_87115.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
