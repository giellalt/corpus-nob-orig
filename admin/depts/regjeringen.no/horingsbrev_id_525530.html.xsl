...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ad/dok/hoeringer/hoeringsdok/2008/sametingsvalget---forskrift-om-valg-til-/horingsbrev.html?id=525530'"/>
...
<xsl:variable name="wordcount" select="'1097'"/>
...
<xsl:variable name="para_sme" select="'gulaskuddanreive.html?id=525530'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="gulaskuddanreive_id_525530.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
