...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/kd/dok/hoeringer/hoeringsdok/2009/horing--forskrift-om-rammeplan-for-samis/horingsbrev.html?id=588789'"/>
<xsl:variable name="title" select="'Gulaskuddanreivve - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'554'"/>
...
<xsl:variable name="para_sme" select="'gulaskuddanreivve.html?id=588789'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="gulaskuddanreivve_id_588789.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
