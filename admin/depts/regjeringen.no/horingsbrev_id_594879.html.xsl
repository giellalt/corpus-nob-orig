...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/dok/horinger/horingsdokumenter/2009/Horing---forslag-om-endring-av-vedtektene-til-Internasjonalt-reindriftssenter/Horingsbrev.html?id=594879'"/>
<xsl:variable name="title" select="'Gulaskuddanreive - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'784'"/>
...
<xsl:variable name="para_sme" select="'Riikkaidgaskasa-boazodoalloguovdda--evttohus-rievdadit-njuolggadusaid---gulaskuddan-.html?id=594879'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="riikkaidgaskasa-boazodoalloguovdda--evttohus-rievdadit-njuolggadusaid---gulaskuddan-_id_594879.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
