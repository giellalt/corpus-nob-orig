...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/oed/pressesenter/pressemeldinger/2012/hoye-inntekter-og-videre-satsing-pa-petr.html?id=701048'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Alla dietnasat ja joatkkaáŋgiruššan Petroleum-suorggis - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'493'"/>
...
<xsl:variable name="para_eng" select="'substantial-revenues-and-continued-inves.html_id=701048'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'68-milliardar-kroner-meir-til-kommunesek.html_id=701320'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="'raavrevijhke-saemien-gielen-reeremedajve.html_id=704691'"/>
<xsl:variable name="para_sme" select="'alla-dietnasat-ja-joatkkaagiruan-petrole.html_id=701048'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="substantial-revenues-and-continued-inves_id_701048.html" xml:lang="eng"/>
	<parallel_text location="alla-dietnasat-ja-joatkkaagiruan-petrole_id_701048.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
