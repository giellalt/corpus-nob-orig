...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/kd/tema/hoyere_utdanning.html?id=1415'"/>
<xsl:variable name="title" select="'Alit oahppu - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'Higher-Education.html?id=1415'"/>
...
<xsl:variable name="para_sme" select="'alit-oahppu.html?id=1415'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="higher-education_id_1415.html" xml:lang="eng"/>
	<parallel_text location="alit-oahppu_id_1415.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
