...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/jd/pressesenter/pressemeldinger/2012/humlegard-blir-ny-politidirektor-.html?id=708441'"/>
...
<xsl:variable name="para_smj" select="'humlegard-sjadda-ada-politidirektorra-.html_id=708441'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="humlegard-sjadda-ada-politidirektorra-_id_708441.html" xml:lang="smj"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
