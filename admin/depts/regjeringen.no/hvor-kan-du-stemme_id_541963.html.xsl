...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/krd/kampanjer/valg/stortingsvalg/hvor-kan-du-stemme.html?id=541963'"/>
<xsl:variable name="title" select="'Gos beasat jienastit? - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'275'"/>
...
<xsl:variable name="para_eng" select="'where-can-you-cast-your-vote.html?id=541963'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'kvar-kan-du-royste.html?id=541963'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'gos-beasat-jienastit.html?id=541963'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="where-can-you-cast-your-vote_id_541963.html" xml:lang="eng"/>
	<parallel_text location="kvar-kan-du-royste_id_541963.html" xml:lang="nno"/>
	<parallel_text location="gos-beasat-jienastit_id_541963.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
