...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/aktuelt/nyheter/2010/hvordan-kan-vi-gjore-norge-til-et-bedre-.html?id=625042'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Movt sáhttit dagahit Norgga buoret orrunriikan? - regjeringen.no'"/>
...
=======
<xsl:variable name="wordcount" select="'334'"/>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
...
<xsl:variable name="para_nno" select="'12-millionar-kroner-til-tiltak-mot-speleproblem.html?id=625285'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'movt-sahttit-dagahit-norgga-buoret-orrun.html?id=625042'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="12-millionar-kroner-til-tiltak-mot-speleproblem.html_id=625285" xml:lang="nno"/>
	<parallel_text location="movt-sahttit-dagahit-norgga-buoret-orrun_id_625042.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
