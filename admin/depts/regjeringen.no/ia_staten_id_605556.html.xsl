...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/tema/lonns-_og_personalpolitikk/ia_staten.html?id=605556'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Searvadeaddji bargoeallin stáhtas - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'483'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="searvadeaddji-bargoeallin-stahtas_id_605556.html" xml:lang="sme"/>
</xsl:variable>
