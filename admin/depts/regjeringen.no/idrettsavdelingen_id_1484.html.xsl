...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/kud/dep/org/avdelinger/idrettsavdelingen.html?id=1484'"/>
<xsl:variable name="title" select="'Falástallanossodat - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'The-Department-of-Sport.html?id=1484'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Idrettsavdelinga.html?id=1484'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'valatallanossodat.html?id=1484'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="the-department-of-sport_id_1484.html" xml:lang="eng"/>
	<parallel_text location="idrettsavdelinga_id_1484.html" xml:lang="nno"/>
	<parallel_text location="valatallanossodat_id_1484.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
