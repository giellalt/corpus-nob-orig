...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/tema/ikt-politikk.html?id=1367'"/>
<xsl:variable name="title" select="'IKT-politikka - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'ict-policyenorway.html?id=1367'"/>
...
<xsl:variable name="para_sme" select="'IKT-politikka.html?id=1367'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="ict-policyenorway_id_1367.html" xml:lang="eng"/>
	<parallel_text location="ikt-politikka_id_1367.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
