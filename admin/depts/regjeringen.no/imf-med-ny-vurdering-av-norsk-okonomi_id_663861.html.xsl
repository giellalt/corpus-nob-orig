...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fin/pressesenter/pressemeldinger/2011/imf-med-ny-vurdering-av-norsk-okonomi.html?id=663861'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'IMF ođđa norgga ekonomiija árvvoštallan - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'503'"/>
...
<xsl:variable name="para_eng" select="'imf-presents-its-views-on-the-norwegian-.html_id=663861'"/>
...
<xsl:variable name="para_sme" select="'imf-oa-norgga-ekonomiija-arvvotallan.html_id=663861'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="imf-presents-its-views-on-the-norwegian-_id_663861.html" xml:lang="eng"/>
	<parallel_text location="imf-oa-norgga-ekonomiija-arvvotallan_id_663861.html" xml:lang="sme"/>
<parallel_text location="imf-med-ny-vurdering-av-norsk-okonomi_id_663861.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
