...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fkd/dep/org/avdelinger/infomasjonsenheten.html?id=85853'"/>
...
<xsl:variable name="para_eng" select="'department-of-information-and-communicat.html?id=85853'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Kommunikasjonseinga.html?id=85853'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Gulahallanovttadat.html?id=85853'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="department-of-information-and-communicat_id_85853.html" xml:lang="eng"/>
	<parallel_text location="kommunikasjonseinga_id_85853.html" xml:lang="nno"/>
	<parallel_text location="gulahallanovttadat_id_85853.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
