...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/dep/org/avdelinger/kommunikasjonsenheten/informasjonsradgiver-ann-kristin-lindaas.html?id=439589'"/>
...
<xsl:variable name="para_eng" select="'communication-adviser-ann-kristin-lindaa.html?id=439589'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="communication-adviser-ann-kristin-lindaa_id_439589.html" xml:lang="eng"/>
	<parallel_text location="senior-gulahallanravvejeaddji-ann-kristi_id_439589.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
