...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fkd/dep/org/avdelinger/infomasjonsenheten/informasjonsradgiver-halvard-wensel.html?id=410090'"/>
<xsl:variable name="title" select="'Gulahalliráđđeaddi Halvard Wensel - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'information-advisor.html?id=410090'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'kommunikasjonsradgjevar.html?id=410090'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Kommunikasjonsradgiver-Halvard-Wensel.html?id=410090'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="information-advisor_id_410090.html" xml:lang="eng"/>
	<parallel_text location="kommunikasjonsradgjevar_id_410090.html" xml:lang="nno"/>
	<parallel_text location="kommunikasjonsradgiver-halvard-wensel_id_410090.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
