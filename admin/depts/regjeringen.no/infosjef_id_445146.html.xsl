...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ud/dep/org/avdelinger/infoteam/infosjef.html?id=445146'"/>
<xsl:variable name="title" select="'Diehtojuohkinhoavda Trond Viken - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'trv.html?id=445146'"/>
...
<xsl:variable name="para_sme" select="'diehtojuohkinhoavda.html?id=445146'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="trv_id_445146.html" xml:lang="eng"/>
	<parallel_text location="diehtojuohkinhoavda_id_445146.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
