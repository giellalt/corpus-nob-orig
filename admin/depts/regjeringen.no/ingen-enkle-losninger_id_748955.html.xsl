...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fd/aktuelt/taler_artikler/ministeren/taler-og-artikler-av-forsvarsminister-in/2014/ingen-enkle-losninger.html?id=748955'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Eai leat álkes čovdosat - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'1019'"/>
...
<xsl:variable name="para_sme" select="'eai-leat-alkes-ovdosat.html_id=748955'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="eai-leat-alkes-ovdosat_id_748955.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
