...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/krd/dep/org/avdelinger/kommunikasjonsenheten/ingvild-dahl-dornes.html?id=556003'"/>
<xsl:variable name="title" select="'Seniorráđđeaddi Ingvild Dahl Dørnes - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'175'"/>
...
<xsl:variable name="para_eng" select="'senior-communications-officer-ingvild-da.html?id=556003'"/>
...
<xsl:variable name="para_sme" select="'Seniorraeaddi-Ingvild-Dahl-Dornes.html?id=556003'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="senior-communications-officer-ingvild-da_id_556003.html" xml:lang="eng"/>
	<parallel_text location="seniorraeaddi-ingvild-dahl-dornes_id_556003.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
