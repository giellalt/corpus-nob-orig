...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/tema/lonns-_og_personalpolitikk/inkluderende-arbeidsliv-i-staten.html?id=86968'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Šláddjiivuohta stáhtas - regjeringen.no'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="laddjiivuohta-stahtas_id_86968.html" xml:lang="sme"/>
</xsl:variable>
