...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/lmd/tema/landbruk_og_naringsutvikling/inn-pa-tunet-2.html?id=582133'"/>
<xsl:variable name="title" select="'Šilljui (“Inn på tunet”) - regjeringen.no'"/>
...
<xsl:variable name="para_sme" select="'illjui-inn-pa-tunet.html?id=582133'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="illjui-inn-pa-tunet_id_582133.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
