...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/pressesenter/pressemeldinger/2013/innbyggerne-mer-tilfreds-med-offentlige-.html?id=729971'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Ássit leat dál eambbo duhtavaččat almmolaš bálvalusaiguin   - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'1810'"/>
...
<xsl:variable name="para_sme" select="'assit-leat-dal-eambbo-duhtavaat-almmola-.html_id=729971'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="assit-leat-dal-eambbo-duhtavaat-almmola-_id_729971.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
