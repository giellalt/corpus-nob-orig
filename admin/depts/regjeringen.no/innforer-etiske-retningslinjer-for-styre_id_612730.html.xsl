...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/hod/pressesenter/pressemeldinger/2010/innforer-etiske-retningslinjer-for-styre.html?id=612730'"/>
<xsl:variable name="title" select="'Innfører etiske retningslinjer for styremedlemmer i helseforetak - regjeringen.no'"/>
...
=======
<xsl:variable name="wordcount" select="'312'"/>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
...
<xsl:variable name="para_sme" select="'Alggaha-ehtala-njuolggadusaid-dearvvavuoadoaimmahagaid-stivramiellahtuid-varas.html?id=612730'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="alggaha-ehtala-njuolggadusaid-dearvvavuoadoaimmahagaid-stivramiellahtuid-varas_id_612730.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
