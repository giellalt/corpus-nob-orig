...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ad/aktuelt/taler_artikler/politisk_ledelse/statssekretar-raimo-valle/2008/innlegg-pa-lulesamisk-foreldre--og-sprak.html?id=527032'"/>
<<<<<<< HEAD
<xsl:variable name="title" select="'Innlegg på lulesamisk foreldre- og språkkonferanse - regjeringen.no'"/>
=======
...
<xsl:variable name="parallels">
	<parallel_text location="julevsame-ajgat--ja-giellakonferanssa_id_527032.html" xml:lang="smj"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
