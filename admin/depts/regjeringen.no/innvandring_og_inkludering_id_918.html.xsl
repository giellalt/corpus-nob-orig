...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/tema/innvandring_og_inkludering.html?id=918'"/>
<xsl:variable name="title" select="'Sisafárren ja searvadahttin - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'Immigration-and-social-inclusion.html?id=918'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Innvandring-og-inkludering.html?id=918'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Sisafarren-ja-searvadahttin.html?id=918'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="immigration-and-social-inclusion_id_918.html" xml:lang="eng"/>
	<parallel_text location="innvandring-og-inkludering_id_918.html" xml:lang="nno"/>
	<parallel_text location="sisafarren-ja-searvadahttin_id_918.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
