...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/jd/dep/org/avdelinger/innvandringsavdelingen.html?id=589391'"/>
<xsl:variable name="title" select="'Sisafárrenossodat  - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'258'"/>
...
<xsl:variable name="para_eng" select="'the-department-of-migration.html?id=589391'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'innvandringsavdelinga.html?id=589391'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'sisafarrenossodat-.html?id=589391'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="the-department-of-migration_id_589391.html" xml:lang="eng"/>
	<parallel_text location="innvandringsavdelinga_id_589391.html" xml:lang="nno"/>
	<parallel_text location="sisafarrenossodat-_id_589391.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
