...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/bld/dep/org/avdelinger/integrerings--og-mangfoldsavdelingen.html?id=589415'"/>
<xsl:variable name="title" select="'Searvadahttin- ja girjáivuođaossodat  - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'the-department-of-integration-and-divers.html?id=589415'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'integrerings--og-mangfaldsavdelinga.html?id=589415'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'searvadahttin--ja-girjaivuoaossodat-.html?id=589415'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="the-department-of-integration-and-divers_id_589415.html" xml:lang="eng"/>
	<parallel_text location="integrerings--og-mangfaldsavdelinga_id_589415.html" xml:lang="nno"/>
	<parallel_text location="searvadahttin--ja-girjaivuoaossodat-_id_589415.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
