...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/krd/tema/regional-_og_distriktspolitikk/internasjonalt-samarbeid-om-distrikts--o.html?id=517331'"/>
<xsl:variable name="title" select="'Riikkaidgaskasaš ovttasbargu guovllu- ja regionálapolitihkas - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'international-cooperation-on-rural-and-r.html?id=517331'"/>
...
<xsl:variable name="para_sme" select="'riikkaidgaskasa-ovttasbargu-guovllu--ja-.html?id=517331'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="international-cooperation-on-rural-and-r_id_517331.html" xml:lang="eng"/>
	<parallel_text location="riikkaidgaskasa-ovttasbargu-guovllu--ja-_id_517331.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
