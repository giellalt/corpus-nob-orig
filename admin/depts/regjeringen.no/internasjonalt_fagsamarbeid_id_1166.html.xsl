...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/tema/internasjonalt/internasjonalt_fagsamarbeid.html?id=1166'"/>
<xsl:variable name="title" select="'Riikkaidgaskasaš fágaovttasbargu - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'580'"/>
...
<xsl:variable name="para_eng" select="'International-cooperation.html?id=1166'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Internasjonalt-fagsamarbeid.html?id=1166'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Riikkaidgaskasa-fagaovttasbargu.html?id=1166'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="international-cooperation_id_1166.html" xml:lang="eng"/>
	<parallel_text location="internasjonalt-fagsamarbeid_id_1166.html" xml:lang="nno"/>
	<parallel_text location="riikkaidgaskasa-fagaovttasbargu_id_1166.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
