...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/tema/internasjonalt.html?id=919'"/>
<xsl:variable name="title" select="'Riikkaidgaskasaččat - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'International-relations.html?id=919'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Internasjonalt.html?id=919'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Riikkaidgaskasaat.html?id=919'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="international-relations_id_919.html" xml:lang="eng"/>
	<parallel_text location="internasjonalt_id_919.html" xml:lang="nno"/>
	<parallel_text location="riikkaidgaskasaat_id_919.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
