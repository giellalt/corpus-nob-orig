...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/md/dep/org/avdelinger/internasjonalt_samarbeid.html?id=1203'"/>
<xsl:variable name="title" select="'Gaskariikkalaš ovttasbargoossodat - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'department-for-international-cooperation.html?id=1203'"/>
...
<xsl:variable name="para_sme" select="'Gaskariikkala-ovttasbargoossodat.html?id=1203'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="department-for-international-cooperation_id_1203.html" xml:lang="eng"/>
	<parallel_text location="gaskariikkala-ovttasbargoossodat_id_1203.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
