...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/kd/tema/internasjonalt_samarbeid_om_utdanning_og.html?id=1192'"/>
<xsl:variable name="title" select="'Riikkaidgaskasaš oahppo- ja dutkanovttasbargu - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'International-Collaboration-on-Education.html?id=1192'"/>
...
<xsl:variable name="para_sme" select="'riikkaidgaskasa-oahppo--ja-dutkanovttasb.html?id=1192'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="international-collaboration-on-education_id_1192.html" xml:lang="eng"/>
	<parallel_text location="riikkaidgaskasa-oahppo--ja-dutkanovttasb_id_1192.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
