...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/tema/samepolitikk/internasjonalt_urfolksarbeid.html?id=24393'"/>
<xsl:variable name="title" select="'Riikkaidgaskasaš álgoálbmotbargu - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'international-efforts-in-relation-to-ind.html?id=24393'"/>
...
<xsl:variable name="para_sme" select="'Riikkaidgaskasa-algoalbmotbargu.html?id=24393'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="international-efforts-in-relation-to-ind_id_24393.html" xml:lang="eng"/>
	<parallel_text location="riikkaidgaskasa-algoalbmotbargu_id_24393.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
