...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/md/dep/org/avdelinger/organisasjon_okonomi/internforvaltning.html?id=85629'"/>
<xsl:variable name="title" select="'Siskkaldashálddašansekšuvdna - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'Section-for-Internal-Services-.html?id=85629'"/>
...
<xsl:variable name="para_sme" select="'Siskkaldashalddaansekuvdna.html?id=85629'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="section-for-internal-services-_id_85629.html" xml:lang="eng"/>
	<parallel_text location="siskkaldashalddaansekuvdna_id_85629.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
