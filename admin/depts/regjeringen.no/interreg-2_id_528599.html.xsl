...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/krd/tema/regional-_og_distriktspolitikk/internasjonalt-samarbeid-om-distrikts--o/interreg-2.html?id=528599'"/>
<xsl:variable name="title" select="'Oassálastin EU territoriála ovttasbarggus (Interreg)  - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'interreg.html?id=528599'"/>
...
<xsl:variable name="para_sme" select="'oassalastin-eu-territoriala-ovttasbarggu.html?id=528599'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="interreg_id_528599.html" xml:lang="eng"/>
	<parallel_text location="oassalastin-eu-territoriala-ovttasbarggu_id_528599.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
