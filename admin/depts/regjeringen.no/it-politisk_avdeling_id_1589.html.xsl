...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/dep/org/avdelinger/it-politisk_avdeling.html?id=1589'"/>
<xsl:variable name="title" select="'DGT- ja ođasmahttinossodat  - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'department-of-ict-policy-and-public-sect.html?id=1589'"/>
...
<xsl:variable name="para_sme" select="'it-politihkala-ossodat.html?id=1589'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="department-of-ict-policy-and-public-sect_id_1589.html" xml:lang="eng"/>
	<parallel_text location="it-politihkala-ossodat_id_1589.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
