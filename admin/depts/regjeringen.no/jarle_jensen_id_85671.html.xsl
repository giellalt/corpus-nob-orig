...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/md/dep/org/avdelinger/regional_planlegging/jarle_jensen.html?id=85671'"/>
<xsl:variable name="title" select="'Ekspedišuvdnahoavda Jarle Jensen - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'deputy-director-general-jarle-jensen.html?id=85671'"/>
...
<xsl:variable name="para_sme" select="'ekspediuvdnahoavda-jarle-jensen.html?id=85671'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="deputy-director-general-jarle-jensen_id_85671.html" xml:lang="eng"/>
	<parallel_text location="ekspediuvdnahoavda-jarle-jensen_id_85671.html" xml:lang="sme"/>
<parallel_text location="ekspediuvdnahoavda-jarle-jensen_id_85671.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
