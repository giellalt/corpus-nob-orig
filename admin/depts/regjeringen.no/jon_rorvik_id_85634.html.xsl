...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/md/dep/org/avdelinger/organisasjon_okonomi/jon_rorvik.html?id=85634'"/>
<xsl:variable name="title" select="'Ekspedišuvdnahoavda Jon Rørvik - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'173'"/>
...
<xsl:variable name="para_eng" select="'director-general-jon-rorvik.html?id=85634'"/>
...
<xsl:variable name="para_sme" select="'Ekspediuvdnahoavda-Jon-Rorvik.html?id=85634'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="director-general-jon-rorvik_id_85634.html" xml:lang="eng"/>
	<parallel_text location="ekspediuvdnahoavda-jon-rorvik_id_85634.html" xml:lang="sme"/>
<parallel_text location="ekspediuvdnahoavda-jon-rorvik_id_85634.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
