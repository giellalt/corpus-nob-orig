...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/lmd/tema/jordbruk.html?id=1286'"/>
...
<xsl:variable name="para_nno" select="'jordbruk.html?id=1286'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'eanadoallu.html?id=1286'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="jordbruk_id_1286.html" xml:lang="nno"/>
	<parallel_text location="eanadoallu_id_1286.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
