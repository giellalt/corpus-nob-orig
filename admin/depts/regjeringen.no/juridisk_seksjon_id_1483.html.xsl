...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/kud/dep/org/avdelinger/medieavdelingen_/juridisk_seksjon.html?id=1483'"/>
<xsl:variable name="title" select="'Sekšuvdna M4 - regjeringen.no'"/>
...
<xsl:variable name="para_nno" select="'Seksjon-M4.html?id=1483'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Juridihkala-sekuvdna.html?id=1483'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="seksjon-m4_id_1483.html" xml:lang="nno"/>
	<parallel_text location="juridihkala-sekuvdna_id_1483.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
