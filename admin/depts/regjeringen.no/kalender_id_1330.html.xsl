...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://regjeringen.no/nb/aktuelt/kalender.html?id=1330'"/>
    ...
    <xsl:variable name="wordcount" select="'831'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="Calendar.html?id=1330"/>
        ...
        <parallel_text xml:lang="nno" location="Kalender.html?id=1330"/>
