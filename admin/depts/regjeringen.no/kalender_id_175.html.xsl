...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ad/aktuelt/kalender.html?id=175'"/>
...
<xsl:variable name="para_nno" select="'kalender.html?id=175'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="kalender_id_175.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
