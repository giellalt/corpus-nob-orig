...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/bld/aktuelt/kalender.html?id=308'"/>
<xsl:variable name="title" select="'Mánáid- ja dásseárvodepartemeantta kaleanddar - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'calendar-for-the-ministry-of-children-an.html?id=308'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'kalender.html?id=308'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Manaid--ja-dassearvodepartemeantta-kaleanddar.html?id=308'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="calendar-for-the-ministry-of-children-an_id_308.html" xml:lang="eng"/>
	<parallel_text location="kalender_id_308.html" xml:lang="nno"/>
	<parallel_text location="manaid--ja-dassearvodepartemeantta-kaleanddar_id_308.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
