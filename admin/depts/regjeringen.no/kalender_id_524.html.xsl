...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/krd/pressesenter/kalender.html?id=524'"/>
<xsl:variable name="title" select="'Kaleanddar - regjeringen.no'"/>
...
<xsl:variable name="para_nno" select="'kalender.html?id=524'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Kaleanddar.html?id=524'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="kalender_id_524.html" xml:lang="nno"/>
	<parallel_text location="kaleanddar_id_524.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
