...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/kud/pressesenter/kalender.html?id=565'"/>
<xsl:variable name="title" select="'Kalenddar - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'113'"/>
...
<xsl:variable name="para_nno" select="'Kalender.html?id=565'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Kalenddar.html?id=565'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="kalender_id_565.html" xml:lang="nno"/>
	<parallel_text location="kalenddar_id_565.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
