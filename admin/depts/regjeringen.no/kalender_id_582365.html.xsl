...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/krd/dep/kommunal--og-regionalminister-liv-signe-/kalender.html?id=582365'"/>
<xsl:variable name="title" select="'Gielda- ja guovloministara Liv Signe Navarsete kaleanddar - regjeringen.no'"/>
...
<xsl:variable name="para_nno" select="'kalender-for-kommunal--og-regionalminist.html?id=582365'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'gielda--ja-guovloministara-liv-signe-nav.html?id=582365'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="kalender-for-kommunal--og-regionalminist_id_582365.html" xml:lang="nno"/>
	<parallel_text location="gielda--ja-guovloministara-liv-signe-nav_id_582365.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
