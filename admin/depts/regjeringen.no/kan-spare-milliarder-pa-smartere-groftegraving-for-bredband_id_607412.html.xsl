...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/pressesenter/pressemeldinger/2010/Kan-spare-milliarder-pa-smartere-groftegraving-for-bredband.html?id=607412'"/>
<xsl:variable name="title" select="'Kan spare milliarder på smartere grøftegraving for bredbånd - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'545'"/>
...
<xsl:variable name="para_nno" select="'Kan-spare-milliardar-pa-smartare-groftegraving-for-breiband.html?id=607412'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="kan-spare-milliardar-pa-smartare-groftegraving-for-breiband_id_607412.html" xml:lang="nno"/>
	<parallel_text location="vejola-seastit-miljarddaid-jos-goaivu-eara-vugiid-mielde-goivvohagaid--govdafierpmadahkii_id_607412.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
