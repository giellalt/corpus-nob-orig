...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/md/tema/planlegging_plan-_og_bygningsloven/kart--og-planforskriften-.html?id=570324'"/>
<xsl:variable name="title" select="'Kart- og planforskriften, spesifikasjon, tegneregler m.v.  - regjeringen.no'"/>
...
<xsl:variable name="para_nno" select="'kart--og-planforskriften-.html?id=570324'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="kart--og-planforskriften-_id_570324.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
