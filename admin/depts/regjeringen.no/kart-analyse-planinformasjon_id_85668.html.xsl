...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/md/dep/org/avdelinger/regional_planlegging/kart-analyse-planinformasjon.html?id=85668'"/>
<xsl:variable name="title" select="'Geográfalaš diehtojuohkin sekšuvdna - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'spatial-information-analysis.html?id=85668'"/>
...
<xsl:variable name="para_sme" select="'Geografala-diehtojuohkin-sekuvdna.html?id=85668'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="spatial-information-analysis_id_85668.html" xml:lang="eng"/>
