...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/tema/kirke.html?id=1217'"/>
<xsl:variable name="title" select="'Girku - regjeringen.no'"/>
...
<xsl:variable name="para_nno" select="'kyrkje.html?id=1217'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Girku.html?id=1217'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="kyrkje_id_1217.html" xml:lang="nno"/>
	<parallel_text location="girku_id_1217.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
