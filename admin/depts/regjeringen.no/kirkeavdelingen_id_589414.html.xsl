...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/dep/org/avdelinger/kirkeavdelingen.html?id=589414'"/>
<xsl:variable name="title" select="'Girkoossodat - regjeringen.no'"/>
...
<xsl:variable name="para_sme" select="'girkoossodat.html?id=589414'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="girkoossodat_id_589414.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
