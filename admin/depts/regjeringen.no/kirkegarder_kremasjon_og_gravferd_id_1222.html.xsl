...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/tema/kirke/kirkegarder_kremasjon_og_gravferd.html?id=1222'"/>
<xsl:variable name="title" select="'Girkogárddit, kremašuvnnat ja hávdádeamit - regjeringen.no'"/>
...
<xsl:variable name="para_nno" select="'kyrkjegardar-kremasjon-og-gravferd.html?id=1222'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="kyrkjegardar-kremasjon-og-gravferd_id_1222.html" xml:lang="nno"/>
	<parallel_text location="girkogarddit-kremauvnnat-ja-havdadeamit_id_1222.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
