...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/dep/underliggende-etater/kirkeradet.html?id=449327'"/>
<xsl:variable name="title" select="'Girkoráđđi - regjeringen.no'"/>
...
<xsl:variable name="para_nno" select="'kyrkjeradet.html?id=449327'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Girkorai.html?id=449327'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="kyrkjeradet_id_449327.html" xml:lang="nno"/>
	<parallel_text location="girkorai_id_449327.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
