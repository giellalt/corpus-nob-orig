...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/md/dep/org/avdelinger/forurensningssaker/kjemikalier_og_avfall.html?id=85643'"/>
<xsl:variable name="title" select="'Kemikála- ja doapparsekšuvdna - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'section-for-hazardous-substances-and-and.html?id=85643'"/>
...
<xsl:variable name="para_sme" select="'Kemikala--ja-doapparsekuvdna.html?id=85643'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="section-for-hazardous-substances-and-and_id_85643.html" xml:lang="eng"/>
	<parallel_text location="kemikala--ja-doapparsekuvdna_id_85643.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
