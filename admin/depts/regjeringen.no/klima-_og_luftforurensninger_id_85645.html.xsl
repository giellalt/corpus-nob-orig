...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/md/dep/org/avdelinger/forurensningssaker/klima-_og_luftforurensninger.html?id=85645'"/>
<xsl:variable name="title" select="'Dálkkádat- ja áibmosekšuvdna - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'section-for-climate-change.html?id=85645'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="section-for-climate-change_id_85645.html" xml:lang="eng"/>
	<parallel_text location="dalkkadat--ja-aibmosekuvdna_id_85645.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
