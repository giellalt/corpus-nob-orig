...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/smk/pressesenter/pressemeldinger/2009/klima-og-afghanistan-sentrale-tema-i-sto.html?id=588197'"/>
<xsl:variable name="title" select="'Dálkkádat ja Afghanistána ledje guovdilis áššit Stoltenberga ja Obama čoahkkimis - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'468'"/>
...
<xsl:variable name="para_eng" select="'climate-change-and-afghanistan-topics-at.html?id=588197'"/>
...
<xsl:variable name="para_sme" select="'dalkkadat-ja-afghanistana-ledje-guovdili.html?id=588197'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="climate-change-and-afghanistan-topics-at_id_588197.html" xml:lang="eng"/>
	<parallel_text location="dalkkadat-ja-afghanistana-ledje-guovdili_id_588197.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
