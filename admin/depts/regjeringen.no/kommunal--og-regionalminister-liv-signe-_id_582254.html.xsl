...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/krd/dep/kommunal--og-regionalminister-liv-signe-.html?id=582254'"/>
<xsl:variable name="title" select="'Gielda- ja guovloministtar Liv Signe Navarsete - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'283'"/>
...
<xsl:variable name="para_eng" select="'minister-of-local-government-and-regiona.html?id=582254'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'kommunal--og-regionalminister-liv-signe-.html?id=582254'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'gielda--ja-guovloministtar-liv-signe-nav.html?id=582254'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="minister-of-local-government-and-regiona_id_582254.html" xml:lang="eng"/>
	<parallel_text location="kommunal--og-regionalminister-liv-signe-_id_582254.html" xml:lang="nno"/>
	<parallel_text location="gielda--ja-guovloministtar-liv-signe-nav_id_582254.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
