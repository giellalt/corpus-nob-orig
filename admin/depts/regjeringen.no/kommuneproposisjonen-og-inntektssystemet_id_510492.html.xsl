...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/krd/tema/kommuneokonomi/kommuneproposisjonen-og-inntektssystemet.html?id=510492'"/>
<xsl:variable name="title" select="'Kommuneproposisjonen for 2011 - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'409'"/>
