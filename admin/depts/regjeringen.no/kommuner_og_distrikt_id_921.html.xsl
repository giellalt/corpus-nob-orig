...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/tema/kommuner_og_distrikt.html?id=921'"/>
<xsl:variable name="title" select="'Gielddat ja guovllut - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'Municipalities-and-regions.html?id=921'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Kommunar-og-distrikt.html?id=921'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Gielddat-ja-guovllut.html?id=921'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="municipalities-and-regions_id_921.html" xml:lang="eng"/>
	<parallel_text location="kommunar-og-distrikt_id_921.html" xml:lang="nno"/>
	<parallel_text location="gielddat-ja-guovllut_id_921.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
