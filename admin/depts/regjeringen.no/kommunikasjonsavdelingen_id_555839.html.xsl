...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/sd/dep/organisasjon/avdelinger/kommunikasjonsavdelingen.html?id=555839'"/>
<xsl:variable name="title" select="'Dieđihanovttadat - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'communications-department.html?id=555839'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'kommunikasjonsavdelinga.html?id=555839'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'dieihanovttadat.html?id=555839'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="communications-department_id_555839.html" xml:lang="eng"/>
	<parallel_text location="kommunikasjonsavdelinga_id_555839.html" xml:lang="nno"/>
	<parallel_text location="dieihanovttadat_id_555839.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
