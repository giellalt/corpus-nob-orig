...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fd/dep/org/avdelinger/kommunikasjonsenhet.html?id=521818'"/>
<xsl:variable name="title" select="'Gulahallanovttadat - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'195'"/>
...
<xsl:variable name="para_eng" select="'the-ministry-of-defence-communication-un.html?id=521818'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'kommunikasjonseining.html?id=521818'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'gulahallanovttadat.html?id=521818'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="the-ministry-of-defence-communication-un_id_521818.html" xml:lang="eng"/>
	<parallel_text location="kommunikasjonseining_id_521818.html" xml:lang="nno"/>
	<parallel_text location="gulahallanovttadat_id_521818.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
