...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/krd/dep/org/avdelinger/kommunikasjonsenheten.html?id=1708'"/>
<xsl:variable name="title" select="'Kommunikasjonsenheten - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'The-Communication-Unit.html?id=1708'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Kommunikasjonseininga.html?id=1708'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="the-communication-unit_id_1708.html" xml:lang="eng"/>
	<parallel_text location="kommunikasjonseininga_id_1708.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
