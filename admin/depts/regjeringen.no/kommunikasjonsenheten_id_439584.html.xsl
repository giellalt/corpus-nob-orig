...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/dep/org/avdelinger/kommunikasjonsenheten.html?id=439584'"/>
...
<xsl:variable name="para_eng" select="'communication-unit.html?id=439584'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'kommunikasjonseininga.html?id=439584'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'gulahallanovttadat.html?id=439584'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="communication-unit_id_439584.html" xml:lang="eng"/>
	<parallel_text location="kommunikasjonseininga_id_439584.html" xml:lang="nno"/>
	<parallel_text location="gulahallanovttadat_id_439584.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
