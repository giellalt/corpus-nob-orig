...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/md/dep/org/avdelinger/kommunikasjonsenheten.html?id=85684'"/>
<xsl:variable name="title" select="'Preassa- ja diehtojuohkinossodat - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'press-and-information-unit.html?id=85684'"/>
...
<xsl:variable name="para_sme" select="'Preassa--ja-diehtojuohkinossodat.html?id=85684'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="press-and-information-unit_id_85684.html" xml:lang="eng"/>
	<parallel_text location="preassa--ja-diehtojuohkinossodat_id_85684.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
