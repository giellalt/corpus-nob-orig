...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/bld/dep/org/avdelinger/kommunikasjonsenheten.html?id=87086'"/>
<xsl:variable name="title" select="'Diehtojuohkinčállingoddi  - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'210'"/>
...
<xsl:variable name="para_eng" select="'information-secretariat.html?id=87086'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'informasjonssekretariatet.html?id=87086'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'diehtojuohkinallingoddi-.html?id=87086'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="information-secretariat_id_87086.html" xml:lang="eng"/>
	<parallel_text location="informasjonssekretariatet_id_87086.html" xml:lang="nno"/>
	<parallel_text location="diehtojuohkinallingoddi-_id_87086.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
