...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/smk/dep/org/avdelinger/kommunikasjonsseksjonen/kommunikasjonsradgiver-arvid-samland.html?id=503357'"/>
<xsl:variable name="title" select="'Diehtojuohkinráđđeaddi Arvid Samland - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'communication-officer-arvid-samland.html?id=503357'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Kommunikasjonsradgjevar-Arvid-Samland.html?id=503357'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'diehtojuohkinraeaddi-arvid-samland.html?id=503357'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="communication-officer-arvid-samland_id_503357.html" xml:lang="eng"/>
	<parallel_text location="kommunikasjonsradgjevar-arvid-samland_id_503357.html" xml:lang="nno"/>
	<parallel_text location="diehtojuohkinraeaddi-arvid-samland_id_503357.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
