...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fkd/dep/org/avdelinger/infomasjonsenheten/kommunikasjonsradgiver-karin-johansen.html?id=439360'"/>
<xsl:variable name="title" select="'Gulahalliráđđeaddi Karin Johansen - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'Communication-Advisor.html?id=439360'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Kommunikasjonsradgjevar-Karin-Johansen.html?id=439360'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Diehtojuohkinraeaddi.html?id=439360'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="communication-advisor_id_439360.html" xml:lang="eng"/>
	<parallel_text location="kommunikasjonsradgjevar-karin-johansen_id_439360.html" xml:lang="nno"/>
	<parallel_text location="diehtojuohkinraeaddi_id_439360.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
