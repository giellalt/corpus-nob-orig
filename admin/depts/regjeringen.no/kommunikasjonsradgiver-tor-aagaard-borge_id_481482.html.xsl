...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/smk/dep/org/avdelinger/kommunikasjonsseksjonen/kommunikasjonsradgiver-tor-aagaard-borge.html?id=481482'"/>
<xsl:variable name="title" select="'Diehtojuohkinráđđeaddi Tor Aagaard Borgersen - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'156'"/>
...
<xsl:variable name="para_eng" select="'communication-officer-tor-aagaard-borger.html?id=481482'"/>
...
<xsl:variable name="para_sme" select="'diehtojuohkinraeaddi-tor-aagaard-borgers.html?id=481482'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="communication-officer-tor-aagaard-borger_id_481482.html" xml:lang="eng"/>
	<parallel_text location="diehtojuohkinraeaddi-tor-aagaard-borgers_id_481482.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
