...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/dep/org/avdelinger/kommunikasjonsenheten/kommunikasjonsradgiver-tor-audun-gram.html?id=592722'"/>
<xsl:variable name="title" select="'Gulahallanrávvejeaddji Tor Audun Gram - regjeringen.no'"/>
...
<xsl:variable name="para_sme" select="'Gulahallanravvejeaddji-Tor-Audun-Gram.html?id=592722'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="gulahallanravvejeaddji-tor-audun-gram_id_592722.html" xml:lang="sme"/>
<parallel_text location="tor-audun-gram_id_592722.html" xml:lang="eng"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
