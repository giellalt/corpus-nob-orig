...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fkd/dep/org/avdelinger/infomasjonsenheten/kommunikasjonsradgiver.html?id=542676'"/>
<xsl:variable name="title" select="'Gulahalliráđđeaddi Frødis Tornøe - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'242'"/>
...
<xsl:variable name="para_eng" select="'communication-advisor-frodis-tornoe.html?id=542676'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'kommunikasjonsradgjevar-froydis-tornoe.html?id=542676'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'gulahalliraeaddi-frodis-tornoe.html?id=542676'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="communication-advisor-frodis-tornoe_id_542676.html" xml:lang="eng"/>
	<parallel_text location="kommunikasjonsradgjevar-froydis-tornoe_id_542676.html" xml:lang="nno"/>
	<parallel_text location="gulahalliraeaddi-frodis-tornoe_id_542676.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
