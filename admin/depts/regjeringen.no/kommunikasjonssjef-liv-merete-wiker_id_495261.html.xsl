...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/krd/dep/org/avdelinger/kommunikasjonsenheten/kommunikasjonssjef-liv-merete-wiker.html?id=495261'"/>
<xsl:variable name="title" select="'Gulahallanhoavda Liv Merete Wiker - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'head-of-information.html?id=495261'"/>
...
<xsl:variable name="para_sme" select="'Gulahallanhoavda-Liv-Merete-Wiker.html?id=495261'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="head-of-information_id_495261.html" xml:lang="eng"/>
	<parallel_text location="gulahallanhoavda-liv-merete-wiker_id_495261.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
