...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ud/dep/org/avdelinger/kompetanse_ressurser.html?id=1531'"/>
<xsl:variable name="title" select="'Gelbbolašvuođa- ja resursaossodat - regjeringen.no'"/>
...
<xsl:variable name="para_sme" select="'Gelbbolavuoa--ja-resursaossodat.html?id=1531'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="gelbbolavuoa--ja-resursaossodat_id_1531.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
