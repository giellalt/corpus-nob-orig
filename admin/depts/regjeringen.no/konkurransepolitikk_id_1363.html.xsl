...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/tema/konkurransepolitikk.html?id=1363'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Gilvalanpolitihkka - regjeringen.no'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="competition-policy_id_1363.html" xml:lang="eng"/>
	<parallel_text location="gilvalanpolitihkka_id_1363.html" xml:lang="sme"/>
</xsl:variable>
