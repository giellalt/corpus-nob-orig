...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/dep/org/avdelinger/konkurransepolitisk_avdeling.html?id=1588'"/>
<xsl:variable name="title" select="'Gilvopolitihkalaš ossodat - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'548'"/>
...
<xsl:variable name="para_eng" select="'department-of-competition-policy.html?id=1588'"/>
...
<xsl:variable name="para_sme" select="'gilvopolitihkala-ossodat.html?id=1588'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="department-of-competition-policy_id_1588.html" xml:lang="eng"/>
	<parallel_text location="gilvopolitihkala-ossodat_id_1588.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
