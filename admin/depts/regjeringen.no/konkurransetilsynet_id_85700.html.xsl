...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/dep/underliggende-etater/konkurransetilsynet.html?id=85700'"/>
<xsl:variable name="title" select="'Gilvobearráigeahčču - regjeringen.no'"/>
...
<xsl:variable name="para_sme" select="'gilvobearraigeahu.html?id=85700'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="gilvobearraigeahu_id_85700.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
