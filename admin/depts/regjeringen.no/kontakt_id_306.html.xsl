...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/bld/dep/kontakt.html?id=306'"/>
...
<xsl:variable name="para_eng" select="'contact.html?id=306'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'kontakt-bld.html?id=306'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Oktavuohtadiehtojuohkin.html?id=306'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="contact_id_306.html" xml:lang="eng"/>
	<parallel_text location="kontakt-bld_id_306.html" xml:lang="nno"/>
	<parallel_text location="oktavuohtadiehtojuohkin_id_306.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
