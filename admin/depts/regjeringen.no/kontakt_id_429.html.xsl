...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/hod/dep/kontakt.html?id=429'"/>
<xsl:variable name="title" select="'Kontakt - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'519'"/>
...
<xsl:variable name="para_eng" select="'Contact-information.html?id=429'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Kontakt.html?id=429'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="contact-information_id_429.html" xml:lang="eng"/>
	<parallel_text location="kontakt_id_429.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
