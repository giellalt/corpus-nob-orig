...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/md/dep/kontakt.html?id=676'"/>
...
<xsl:variable name="para_eng" select="'contact-information.html?id=676'"/>
...
<xsl:variable name="para_sme" select="'Oktavuohtadiehtojuohkin.html?id=676'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="contact-information_id_676.html" xml:lang="eng"/>
	<parallel_text location="oktavuohtadiehtojuohkin_id_676.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
