...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/oed/dep/kontakt.html?id=758'"/>
...
<xsl:variable name="para_eng" select="'Contact.html?id=758'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'kontakt.html?id=758'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'gulahallandieut.html?id=758'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="contact_id_758.html" xml:lang="eng"/>
	<parallel_text location="kontakt_id_758.html" xml:lang="nno"/>
	<parallel_text location="gulahallandieut_id_758.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
