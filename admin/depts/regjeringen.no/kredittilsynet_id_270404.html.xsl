...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fin/dep/underliggende_etater/kredittilsynet.html?id=270404'"/>
<xsl:variable name="title" select="'Kredihttabearráigeahčču - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'the-financial-supervisory-authority.html?id=270404'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'kredittilsynet.html?id=270404'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Kredihttabearraigeahu.html?id=270404'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="the-financial-supervisory-authority_id_270404.html" xml:lang="eng"/>
	<parallel_text location="kredittilsynet_id_270404.html" xml:lang="nno"/>
	<parallel_text location="kredihttabearraigeahu_id_270404.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
