...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/tema/lov_og_rett/kriminalitet_og_overgrep.html?id=1261'"/>
<xsl:variable name="title" select="'Vearredagolašvuohta ja veahkaválddálašvuohta - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'339'"/>
...
<xsl:variable name="para_eng" select="'Crime-and-abuse.html?id=1261'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Kriminalitet-og-overgrep.html?id=1261'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Vearredagolavuohta-ja-veahkavalddalavuoh.html?id=1261'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="crime-and-abuse_id_1261.html" xml:lang="eng"/>
	<parallel_text location="kriminalitet-og-overgrep_id_1261.html" xml:lang="nno"/>
	<parallel_text location="vearredagolavuohta-ja-veahkavalddalavuoh_id_1261.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
