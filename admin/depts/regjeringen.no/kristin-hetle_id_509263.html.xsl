...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ad/dep/org/avdelinger/pks/kristin-hetle.html?id=509263'"/>
<xsl:variable name="title" select="'Gulahallanhoavda Kristin Hetle - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'kristin-hetle.html?id=509263'"/>
...
<xsl:variable name="para_sme" select="'gulahallanhoavda-kristin-hetle.html?id=509263'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="kristin-hetle_id_509263.html" xml:lang="eng"/>
	<parallel_text location="gulahallanhoavda-kristin-hetle_id_509263.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
