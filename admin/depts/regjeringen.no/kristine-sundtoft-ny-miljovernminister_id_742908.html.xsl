...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/md/pressesenter/pressemeldinger/2013/kristine-sundtoft-ny-miljovernminister.html?id=742908'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Tine Sundtoft ođđa dálkkádat- ja birasgáhttenministtar - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'tine-sundtoft-new-climate-and-environmen.html_id=742908'"/>
...
<xsl:variable name="para_sme" select="'tine-sundtoft-birasgahttenministtar.html_id=742908'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="tine-sundtoft-new-climate-and-environmen_id_742908.html" xml:lang="eng"/>
