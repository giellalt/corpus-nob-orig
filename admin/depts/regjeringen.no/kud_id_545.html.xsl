...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/kud.html?id=545'"/>
<xsl:variable name="title" select="'Kulturdepartemeanta  - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'710'"/>
...
<xsl:variable name="para_eng" select="'kkd.html?id=545'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'kud.html?id=545'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'kkd.html?id=545'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="kkd_id_545.html" xml:lang="eng"/>
	<parallel_text location="kud_id_545.html" xml:lang="nno"/>
	<parallel_text location="kkd_id_545.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
