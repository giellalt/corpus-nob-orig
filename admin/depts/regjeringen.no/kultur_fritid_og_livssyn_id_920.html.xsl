...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/tema/kultur_fritid_og_livssyn.html?id=920'"/>
<xsl:variable name="title" select="'Kultuvra, astoáigi ja eallinoaidnu - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'651'"/>
...
<xsl:variable name="para_eng" select="'Culture-leisure-and-belief-systems.html?id=920'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'kultur-fritid-og-livssyn.html?id=920'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Kultuvra-astoaigi-ja-eallinoaidnu.html?id=920'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="culture-leisure-and-belief-systems_id_920.html" xml:lang="eng"/>
	<parallel_text location="kultur-fritid-og-livssyn_id_920.html" xml:lang="nno"/>
	<parallel_text location="kultuvra-astoaigi-ja-eallinoaidnu_id_920.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
