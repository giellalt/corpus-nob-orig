...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/kud/pressesenter/pressemeldinger/2013/kulturdepartementet-nedsetter-utrednings.html?id=748000'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Kulturdepartemeanta nammada čielggadanjoavkku mii galgá guorahallat Norgga kulturráđi - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'648'"/>
...
<xsl:variable name="para_eng" select="'the-ministry-of-the-environment-becomes-.html_id=748447'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'departementet-skiftar-namn.html_id=748569'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'kulturdepartemeanta-nammada-ielggadanjoa.html_id=748000'"/>
...
<xsl:variable name="parallels">
	...
	<parallel_text location="fjordfiskenemnda-blir-oppretta_id_747988.html" xml:lang="nno"/>
	<parallel_text location="kulturdepartemeanta-nammada-ielggadanjoa_id_748000.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
