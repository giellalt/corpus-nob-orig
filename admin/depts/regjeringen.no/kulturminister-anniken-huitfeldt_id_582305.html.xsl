...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/kud/dep/kulturminister-anniken-huitfeldt.html?id=582305'"/>
<xsl:variable name="title" select="'Kulturministtar Anniken Huitfeldt - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'424'"/>
...
<xsl:variable name="para_eng" select="'minister-of-culture-anniken-huitfeldt.html?id=582305'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'kulturminister-anniken-huitfeldt.html?id=582305'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'kulturministtar-anniken-huitfeldt.html?id=582305'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="minister-of-culture-anniken-huitfeldt_id_582305.html" xml:lang="eng"/>
	<parallel_text location="kulturminister-anniken-huitfeldt_id_582305.html" xml:lang="nno"/>
	<parallel_text location="kulturministtar-anniken-huitfeldt_id_582305.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
