...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/kud/aktuelt/nyheter/2012/kulturministeren-apnet-nytt-digitaliseri.html?id=675089'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Kulturministtar rabai ođđa digitaliserenguovddáža - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'new-building-for-digitization-opened-in-.html_id=675089'"/>
...
<xsl:variable name="para_sme" select="'kulturministtar-rabai-oa-digitaliserengu.html_id=675089'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="new-building-for-digitization-opened-in-_id_675089.html" xml:lang="eng"/>
	<parallel_text location="kulturministtar-rabai-oa-digitaliserengu_id_675089.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
