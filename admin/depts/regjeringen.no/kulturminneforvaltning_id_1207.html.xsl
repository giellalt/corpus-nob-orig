...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/md/dep/org/avdelinger/kulturminneforvaltning.html?id=1207'"/>
<xsl:variable name="title" select="'Kulturmuitohálddašeami ossodat - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'department-for-cultural-heritage-managem.html?id=1207'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Avdeling-for-kulturminneforvaltning.html?id=1207'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Kulturmuitohalddaeami-ossodat.html?id=1207'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="department-for-cultural-heritage-managem_id_1207.html" xml:lang="eng"/>
	<parallel_text location="avdeling-for-kulturminneforvaltning_id_1207.html" xml:lang="nno"/>
	<parallel_text location="kulturmuitohalddaeami-ossodat_id_1207.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
