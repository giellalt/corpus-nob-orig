...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/kud/dep/org/avdelinger/kulturvernavdelingen.html?id=590159'"/>
<xsl:variable name="title" select="'Kultursuodjalusossodat - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'187'"/>
...
<xsl:variable name="para_eng" select="'Cultural-Heritage-Department.html?id=590159'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'kulturvernavdelinga-.html?id=590159'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'kultursuodjalusossodat.html?id=590159'"/>
...
<xsl:variable name="parallels">
	...
	<parallel_text location="kulturvernavdelinga-_id_590159.html" xml:lang="nno"/>
	<parallel_text location="kultursuodjalusossodat_id_590159.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
