...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/kd/pressesenter/pressemeldinger/2006/-kunnskap-er-selve-navet-i-nordomradestr.html?id=436825'"/>
...
<xsl:variable name="wordcount" select="'464'"/>
...
<xsl:variable name="para_eng" select="'Knowledge-is-at-the-core-of-the-High-North-strategy.html?id=436825'"/>
...
<xsl:variable name="para_sme" select="'---Mahttu-lea-ie-namma-davveguovlostrate.html?id=436825'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="knowledge-is-at-the-core-of-the-high-north-strategy_id_436825.html" xml:lang="eng"/>
	<parallel_text location="mahttu-lea-ie-namma-davveguovlostrate_id_436825.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
