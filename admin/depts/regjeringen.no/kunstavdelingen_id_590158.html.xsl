...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/kud/dep/org/avdelinger/kunstavdelingen.html?id=590158'"/>
<xsl:variable name="title" select="'Dáiddaossodat - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'Department-for-the-Arts.html?id=590158'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'kunstavdelinga.html?id=590158'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'daiddaossodat.html?id=590158'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="department-for-the-arts_id_590158.html" xml:lang="eng"/>
	<parallel_text location="kunstavdelinga_id_590158.html" xml:lang="nno"/>
	<parallel_text location="daiddaossodat_id_590158.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
