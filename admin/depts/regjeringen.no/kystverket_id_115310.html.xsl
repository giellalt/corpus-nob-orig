...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fkd/dep/underliggende-etater/kystverket.html?id=115310'"/>
<xsl:variable name="title" select="'Riddodoaimmahat (Kystverket) - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'the-norwegian-national-coastal-administr.html?id=115310'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'kystverket.html?id=115310'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Riddodoaimmahat-Kystverket.html?id=115310'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="the-norwegian-national-coastal-administr_id_115310.html" xml:lang="eng"/>
	<parallel_text location="kystverket_id_115310.html" xml:lang="nno"/>
	<parallel_text location="riddodoaimmahat-kystverket_id_115310.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
