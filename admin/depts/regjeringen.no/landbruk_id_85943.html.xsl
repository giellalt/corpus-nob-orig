...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/tema/mat_fiskeri_og_landbruk/landbruk.html?id=85943'"/>
<xsl:variable name="title" select="'Eanadoallu - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'agriculture.html?id=85943'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Landbruk.html?id=85943'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Eanadoallu.html?id=85943'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="agriculture_id_85943.html" xml:lang="eng"/>
	<parallel_text location="landbruk_id_85943.html" xml:lang="nno"/>
	<parallel_text location="eanadoallu_id_85943.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
