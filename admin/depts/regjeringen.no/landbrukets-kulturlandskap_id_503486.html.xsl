...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/lmd/tema/landbrukets-miljo--og-arealpolitikk/landbrukets-kulturlandskap.html?id=503486'"/>
<xsl:variable name="title" select="'Eanadoalu kultureanadat - regjeringen.no'"/>
...
<xsl:variable name="para_sme" select="'eanadoalu-kultureanadat.html?id=503486'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="eanadoalu-kultureanadat_id_503486.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
