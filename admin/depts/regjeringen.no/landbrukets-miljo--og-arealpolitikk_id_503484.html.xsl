...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/lmd/tema/landbrukets-miljo--og-arealpolitikk.html?id=503484'"/>
<xsl:variable name="title" select="'Eanadoalu biras- ja eanapolitihkka - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'310'"/>
...
<xsl:variable name="para_nno" select="'landbruket-sin-miljo--og-arealpolitikk.html?id=503484'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'eanadoalu-biras--ja-eanapolitihkka.html?id=503484'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="landbruket-sin-miljo--og-arealpolitikk_id_503484.html" xml:lang="nno"/>
	<parallel_text location="eanadoalu-biras--ja-eanapolitihkka_id_503484.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
