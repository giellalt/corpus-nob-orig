...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/lmd/aktuelt/svar_stortinget/sporretime/2012/landbruks--og-matministerens-innlegg-i-2.html?id=685869'"/>
...
<xsl:variable name="wordcount" select="'1156'"/>
...
<xsl:variable name="para_sme" select="'eanandoallo--ja-biebmoministara-sahkavuo.html_id=685869'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="eanandoallo--ja-biebmoministara-sahkavuo_id_685869.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
