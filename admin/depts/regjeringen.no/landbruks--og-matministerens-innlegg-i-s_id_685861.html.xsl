...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/lmd/aktuelt/svar_stortinget/sporretime/2012/landbruks--og-matministerens-innlegg-i-s.html?id=685861'"/>
...
<xsl:variable name="wordcount" select="'816'"/>
...
<xsl:variable name="para_sme" select="'eanandoallo--ja-biebmoministara-sahkav-2.html_id=685861'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="eanandoallo--ja-biebmoministara-sahkav-2_id_685861.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
