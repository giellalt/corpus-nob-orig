...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fd/dep/org/avdelinger/ledelsens_sekretariat.html?id=85699'"/>
<xsl:variable name="title" select="'Jođihangotti čállingoddi - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'183'"/>
...
<xsl:variable name="para_eng" select="'the-executive-secretariat.html?id=85699'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'sekretariat-for-leiinga.html?id=85699'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'njunnoiid-allingoddi.html?id=85699'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="the-executive-secretariat_id_85699.html" xml:lang="eng"/>
	<parallel_text location="sekretariat-for-leiinga_id_85699.html" xml:lang="nno"/>
	<parallel_text location="njunnoiid-allingoddi_id_85699.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
