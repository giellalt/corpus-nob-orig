...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/krd/kampanjer/valg/stortingsvalg/legitimasjon.html?id=541951'"/>
<xsl:variable name="title" select="'Legitimašuvdna - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'proof-of-identity-id.html?id=541951'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'legitimasjon.html?id=541951'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'legitimauvdna.html?id=541951'"/>
...
<xsl:variable name="parallels">
	...
	<parallel_text location="legitimasjon_id_541951.html" xml:lang="nno"/>
	<parallel_text location="legitimauvdna_id_541951.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
