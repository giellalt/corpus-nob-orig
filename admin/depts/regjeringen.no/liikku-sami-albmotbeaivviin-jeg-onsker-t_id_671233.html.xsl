...
>>>>>>> ad2e9f42a5 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)

<!-- Add the metainformation manually -->
<!-- variable filename contains the original name of the file (from submitter)-->
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/lmd/aktuelt/taler_artikler/ministeren/landbruks--og-matminister-lars-peder-bre/2012/liikku-sami-albmotbeaivviin-jeg-onsker-t.html?id=671233'"/>
...
<xsl:variable name="para_sme" select="'lihkku-sami-albmotbeivviin-.html_id=671233'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="lihkku-sami-albmotbeivviin-_id_671233.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> ad2e9f42a5 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
