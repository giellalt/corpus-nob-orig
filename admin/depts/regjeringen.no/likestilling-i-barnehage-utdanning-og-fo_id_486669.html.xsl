...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/kd/tema/likestilling-i-barnehage-utdanning-og-fo.html?id=486669'"/>
<xsl:variable name="title" select="'Dásseárvu mánáidgárddis, oahpahusas ja dutkamis - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'209'"/>
...
<xsl:variable name="para_eng" select="'gender-equality-.html?id=486669'"/>
...
<xsl:variable name="para_sme" select="'dassearvu-manaidgarddis-oahpahusas-ja-du.html?id=486669'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="gender-equality-_id_486669.html" xml:lang="eng"/>
	<parallel_text location="dassearvu-manaidgarddis-oahpahusas-ja-du_id_486669.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
