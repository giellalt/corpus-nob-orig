...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/lmd/tema/likestilling_i_landbruket.html?id=955'"/>
<xsl:variable name="title" select="'Dásseárvu eanadoalus - regjeringen.no'"/>
...
<xsl:variable name="para_nno" select="'likestilling-i-landbruket.html?id=955'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'dassearvu-eanadoalus.html?id=955'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="likestilling-i-landbruket_id_955.html" xml:lang="nno"/>
	<parallel_text location="dassearvu-eanadoalus_id_955.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
