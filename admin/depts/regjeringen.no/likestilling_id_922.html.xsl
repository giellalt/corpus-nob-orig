...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/tema/likestilling.html?id=922'"/>
<xsl:variable name="title" select="'Dásseárvu - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'361'"/>
...
<xsl:variable name="para_eng" select="'Equality.html?id=922'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Likestilling.html?id=922'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Dassearvu.html?id=922'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="equality_id_922.html" xml:lang="eng"/>
	<parallel_text location="likestilling_id_922.html" xml:lang="nno"/>
	<parallel_text location="dassearvu_id_922.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
