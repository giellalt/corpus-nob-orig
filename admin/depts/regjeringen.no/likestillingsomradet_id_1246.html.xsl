...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/bld/tema/likestillingsomradet.html?id=1246'"/>
<xsl:variable name="title" select="'Dásseárvu sohkabeliid gaskkas - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'equality.html?id=1246'"/>
...
<xsl:variable name="para_sme" select="'dassearvu-sohkabeliid-gaskkas.html?id=1246'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="equality_id_1246.html" xml:lang="eng"/>
	<parallel_text location="dassearvu-sohkabeliid-gaskkas_id_1246.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
