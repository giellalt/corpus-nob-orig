...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fkd/dep/lisbeth-berg-hansen.html?id=582211'"/>
<xsl:variable name="title" select="'Guolástus- ja riddoministar Lisbeth Berg-Hansen - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'384'"/>
...
<xsl:variable name="para_eng" select="'minister-of-fisheries-and-coastal-affair.html?id=582211'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'fiskeri--og-kystminister-lisbeth-berg-ha.html?id=582211'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'guolastus--ja-riddoministar-lisbeth-berg.html?id=582211'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="minister-of-fisheries-and-coastal-affair_id_582211.html" xml:lang="eng"/>
	<parallel_text location="fiskeri--og-kystminister-lisbeth-berg-ha_id_582211.html" xml:lang="nno"/>
	<parallel_text location="guolastus--ja-riddoministar-lisbeth-berg_id_582211.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
