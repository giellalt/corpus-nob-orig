...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/kd/tema/livslang-laring.html?id=592615'"/>
<xsl:variable name="title" select="'Livslang læring - regjeringen.no'"/>
