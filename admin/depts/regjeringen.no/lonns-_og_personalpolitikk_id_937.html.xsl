...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/tema/lonns-_og_personalpolitikk.html?id=937'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Bálká- ja bargoveahkapolitihkka - regjeringen.no'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="wage-and-personnel-policy-_id_937.html" xml:lang="eng"/>
	<parallel_text location="balka--ja-bargoveahkapolitihkka_id_937.html" xml:lang="sme"/>
</xsl:variable>
