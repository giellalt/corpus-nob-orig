...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/kd/dok/rundskriv/2006/lov-17-juni-2005-nr-64-om-barnehager-bar.html?id=109624'"/>
<xsl:variable name="title" select="'Mánáidgárdeláhka - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'130'"/>
...
<xsl:variable name="para_sme" select="'manaidgardelahka.html?id=109624'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="manaidgardelahka_id_109624.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
