...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/tema/lov_og_rett.html?id=923'"/>
<xsl:variable name="title" select="'Láhka ja riekti - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'Law-and-order.html?id=923'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Lov-og-rett.html?id=923'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Lahka-ja-riekti.html?id=923'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="law-and-order_id_923.html" xml:lang="eng"/>
	<parallel_text location="lov-og-rett_id_923.html" xml:lang="nno"/>
	<parallel_text location="lahka-ja-riekti_id_923.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
