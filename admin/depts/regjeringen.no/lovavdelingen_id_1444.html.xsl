...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/jd/dep/org/avdelinger/lovavdelingen.html?id=1444'"/>
<xsl:variable name="title" select="'Láhkaossodat  - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'201'"/>
...
<xsl:variable name="para_eng" select="'The-Legislation-Department.html?id=1444'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Lovavdelinga.html?id=1444'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Lahkaossodat-.html?id=1444'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="the-legislation-department_id_1444.html" xml:lang="eng"/>
	<parallel_text location="lovavdelinga_id_1444.html" xml:lang="nno"/>
	<parallel_text location="lahkaossodat-_id_1444.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
