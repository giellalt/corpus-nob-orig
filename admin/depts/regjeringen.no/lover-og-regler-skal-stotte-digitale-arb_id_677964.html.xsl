...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/pressesenter/pressemeldinger/2012/lover-og-regler-skal-stotte-digitale-arb.html?id=677964'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Lágat ja njuolggadusat galget doarjut digitála bargovugiid - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'476'"/>
...
<xsl:variable name="para_eng" select="'public-administration-to-be-fully-digita.html_id=677967'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'lover-og-reglar-skal-stotte-digitale-arb.html_id=677964'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'lagat-ja-njuolggadusat-galget-doarjut-di.html_id=677964'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="lover-og-reglar-skal-stotte-digitale-arb_id_677964.html" xml:lang="nno"/>
	<parallel_text location="lagat-ja-njuolggadusat-galget-doarjut-di_id_677964.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
