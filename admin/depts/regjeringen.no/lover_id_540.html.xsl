...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/krd/dok/lover_regler/lover.html?id=540'"/>
...
<xsl:variable name="para_eng" select="'Acts.html?id=540'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Lover.html?id=540'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Lagat.html?id=540'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="acts_id_540.html" xml:lang="eng"/>
	<parallel_text location="lover_id_540.html" xml:lang="nno"/>
	<parallel_text location="lagat_id_540.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
