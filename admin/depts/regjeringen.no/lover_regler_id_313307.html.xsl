...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/lmd/dok/lover_regler.html?id=313307'"/>
<xsl:variable name="title" select="'Lágat ja njuolggadusat  - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'249'"/>
...
<xsl:variable name="para_eng" select="'Acts-and-regulations.html?id=313307'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Lover-og-reglar.html?id=313307'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Lagat-ja-njuolggadusat-.html?id=313307'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="acts-and-regulations_id_313307.html" xml:lang="eng"/>
	<parallel_text location="lover-og-reglar_id_313307.html" xml:lang="nno"/>
	<parallel_text location="lagat-ja-njuolggadusat-_id_313307.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
