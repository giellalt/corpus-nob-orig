...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/kd/dok/lover_regler.html?id=313564'"/>
<xsl:variable name="title" select="'Lover og regler - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'Legislation.html?id=313564'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Lover-og-reglar.html?id=313564'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="legislation_id_313564.html" xml:lang="eng"/>
	<parallel_text location="lover-og-reglar_id_313564.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
