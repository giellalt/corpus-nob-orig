...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dok/lover_regler.html?id=438754'"/>
...
<xsl:variable name="para_eng" select="'Laws.html?id=438754'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Laws.html?id=438754'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'lagat-ja-njuolggadusat-.html?id=438754'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="laws_id_438754.html" xml:lang="eng"/>
	<parallel_text location="laws_id_438754.html" xml:lang="nno"/>
	<parallel_text location="lagat-ja-njuolggadusat-_id_438754.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
