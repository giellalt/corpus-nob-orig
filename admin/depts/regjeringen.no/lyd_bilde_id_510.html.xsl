...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/krd/lyd_bilde.html?id=510'"/>
<xsl:variable name="title" select="'Jietna ja govva - regjeringen.no'"/>
...
<xsl:variable name="para_sme" select="'jietna-ja-govva.html?id=510'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="jietna-ja-govva_id_510.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
