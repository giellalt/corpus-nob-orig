...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/kd/lyd_bilde.html?id=592'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Lyd og bilde - regjeringen.no'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="lyd-og-bilete_id_592.html" xml:lang="nno"/>
</xsl:variable>
