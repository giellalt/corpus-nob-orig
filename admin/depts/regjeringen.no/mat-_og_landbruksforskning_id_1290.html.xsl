...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/lmd/tema/mat-_og_landbruksforskning.html?id=1290'"/>
<xsl:variable name="title" select="'Eanadoallo- ja borramušdutkan - regjeringen.no'"/>
...
<xsl:variable name="para_nno" select="'landbruks--og-matforsking.html?id=1290'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'eanadoallo--ja-borramudutkan.html?id=1290'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="landbruks--og-matforsking_id_1290.html" xml:lang="nno"/>
	<parallel_text location="eanadoallo--ja-borramudutkan_id_1290.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
