...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/pressesenter/pressemeldinger/2011/mat-makt-og-avmakt.html?id=640269'"/>
    ...
    <xsl:variable name="wordcount" select="'617'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="food-power-and-impotence.html_id=640269"/>
        ...
        <parallel_text xml:lang="sme" location="borramu-fapmu-ja-famuhisvuohta.html_id=640269"/>
