...
<xsl:variable name="para_eng" select="'food-power-and-impotence.html_id=640269'"/>
...
<xsl:variable name="para_sme" select="'borramu-fapmu-ja-famuhisvuohta.html_id=640269'"/>
