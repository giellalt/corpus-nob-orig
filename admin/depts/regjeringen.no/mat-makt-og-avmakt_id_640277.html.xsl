...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/lmd/aktuelt/nyheter/2011/april-11/mat-makt-og-avmakt.html?id=640277'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Borramuš, fápmu ja fámuhisvuohta - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'1557'"/>
...
<xsl:variable name="para_eng" select="'food-power-and-impotence.html_id=640277'"/>
...
<xsl:variable name="para_sme" select="'borramu-fapmu-ja-famuhisvuohta.html_id=640277'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="food-power-and-impotence_id_640277.html" xml:lang="eng"/>
	<parallel_text location="borramu-fapmu-ja-famuhisvuohta_id_640277.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
