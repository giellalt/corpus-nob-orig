...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/tema/mat_fiskeri_og_landbruk.html?id=924'"/>
<xsl:variable name="title" select="'Biebmu, guolástus ja eanadoallu - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'729'"/>
...
<xsl:variable name="para_eng" select="'Food-fisheries-and-agriculture.html?id=924'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Mat-fiskeri-og-landbruk.html?id=924'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Biebmu-guolastus-ja-eanadoallu.html?id=924'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="food-fisheries-and-agriculture_id_924.html" xml:lang="eng"/>
	<parallel_text location="mat-fiskeri-og-landbruk_id_924.html" xml:lang="nno"/>
	<parallel_text location="biebmu-guolastus-ja-eanadoallu_id_924.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
