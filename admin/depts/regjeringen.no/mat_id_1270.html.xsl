...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/lmd/tema/mat.html?id=1270'"/>
<xsl:variable name="title" select="'Borramuš - regjeringen.no'"/>
...
<xsl:variable name="para_nno" select="'mat.html?id=1270'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'borramu.html?id=1270'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="mat_id_1270.html" xml:lang="nno"/>
	<parallel_text location="borramu_id_1270.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
