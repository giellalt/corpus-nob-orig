...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fkd/dep/tilknyttede-virksomheter/mattilsynet.html?id=163326'"/>
...
<xsl:variable name="para_eng" select="'The-Norwegian-Food-Safety-Authority.html?id=163326'"/>
