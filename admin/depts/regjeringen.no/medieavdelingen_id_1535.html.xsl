...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/kud/dep/org/avdelinger/medieavdelingen_.html?id=1535'"/>
<xsl:variable name="title" select="'Mediaossodat - regjeringen.no'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="department-of-media-policy-and-copyright-_id_1535.html" xml:lang="eng"/>
	<parallel_text location="medieavdelinga_id_1535.html" xml:lang="nno"/>
	<parallel_text location="mediaossodat_id_1535.html" xml:lang="sme"/>
</xsl:variable>
