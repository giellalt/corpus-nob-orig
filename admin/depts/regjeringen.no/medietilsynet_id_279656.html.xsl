...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/kud/dep/underliggende_etater/medietilsynet.html?id=279656'"/>
<xsl:variable name="title" select="'Mediabearráigeahčču - regjeringen.no'"/>
...
<xsl:variable name="para_nno" select="'medietilsynet.html?id=279656'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Mediabearraigeahu.html?id=279656'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="medietilsynet_id_279656.html" xml:lang="nno"/>
	<parallel_text location="mediabearraigeahu_id_279656.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
