...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/bld/tema/barnevern/melde-til-barnevernet.html?id=537079'"/>
<xsl:variable name="title" select="'Dieđihit mánáidsuodjalussii - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'call-child-welfare.html?id=537079'"/>
...
<xsl:variable name="para_sme" select="'dieihit-manaidsuodjalussii.html?id=537079'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="call-child-welfare_id_537079.html" xml:lang="eng"/>
	<parallel_text location="dieihit-manaidsuodjalussii_id_537079.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
