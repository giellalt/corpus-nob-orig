...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/smk/dok/melding-om-rikets-tilstand.html?id=87168'"/>
<xsl:variable name="title" select="'Dieđáhus riikka dilis - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'181'"/>
...
<xsl:variable name="para_eng" select="'The-Report-on-the-State-of-the-Realm.html?id=87168'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Melding-om-tilstanden-til-riket.html?id=87168'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Dieahus-riikka-dilis.html?id=87168'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="the-report-on-the-state-of-the-realm_id_87168.html" xml:lang="eng"/>
	<parallel_text location="melding-om-tilstanden-til-riket_id_87168.html" xml:lang="nno"/>
	<parallel_text location="dieahus-riikka-dilis_id_87168.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
