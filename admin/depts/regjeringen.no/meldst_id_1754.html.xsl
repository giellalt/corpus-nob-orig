...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dok/regpubl/meldst.html?id=1754'"/>
...
<xsl:variable name="para_nno" select="'meldst.html?id=1754'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'stuorradiggedieahusat.html?id=1754'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="meldst_id_1754.html" xml:lang="nno"/>
	<parallel_text location="stuorradiggedieahusat_id_1754.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
