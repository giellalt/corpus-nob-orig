...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ud/tema/menneskerettigheter.html?id=1160'"/>
<xsl:variable name="title" select="'Olmmošvuoigatvuođat - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'human-rights.html?id=1160'"/>
...
<xsl:variable name="para_sme" select="'mr_samisk.html?id=1160'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="human-rights_id_1160.html" xml:lang="eng"/>
	<parallel_text location="mr_samisk_id_1160.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
