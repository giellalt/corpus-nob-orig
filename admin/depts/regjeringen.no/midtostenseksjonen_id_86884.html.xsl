...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ud/dep/org/avdelinger/regavdelingen/midtostenseksjonen.html?id=86884'"/>
<xsl:variable name="title" select="'Gaska-Nuortta sekšuvdna - regjeringen.no'"/>
...
<xsl:variable name="para_sme" select="'Gaska-Nuortta-sekuvdna.html?id=86884'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="gaska-nuortta-sekuvdna_id_86884.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
