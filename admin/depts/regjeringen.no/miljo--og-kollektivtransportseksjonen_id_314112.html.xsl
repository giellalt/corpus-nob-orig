...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/sd/dep/organisasjon/avdelinger/transportavdelingen/miljo--og-kollektivtransportseksjonen.html?id=314112'"/>
<xsl:variable name="title" select="'Luodda- ja mearrajohtolatsekšuvdna - regjeringen.no'"/>
...
<xsl:variable name="para_nno" select="'Miljo--og-kollektivtransportseksjonen.html?id=314112'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Luodda--ja-mearrajohtolatsekuvdna.html?id=314112'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="miljo--og-kollektivtransportseksjonen_id_314112.html" xml:lang="nno"/>
	<parallel_text location="luodda--ja-mearrajohtolatsekuvdna_id_314112.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
