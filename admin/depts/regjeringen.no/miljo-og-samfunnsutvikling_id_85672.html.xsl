...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/md/dep/org/avdelinger/regional_planlegging/miljo-og-samfunnsutvikling.html?id=85672'"/>
<xsl:variable name="title" select="'Birasčielggadansekšuvdna - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'environmental-assessment-community-devel.html?id=85672'"/>
...
<xsl:variable name="para_sme" select="'Birasielggadansekuvdna.html?id=85672'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="environmental-assessment-community-devel_id_85672.html" xml:lang="eng"/>
	<parallel_text location="birasielggadansekuvdna_id_85672.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
