...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/tema/miljo.html?id=925'"/>
<xsl:variable name="title" select="'Biras - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'The-environment.html?id=925'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Miljo.html?id=925'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Biras.html?id=925'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="the-environment_id_925.html" xml:lang="eng"/>
	<parallel_text location="miljo_id_925.html" xml:lang="nno"/>
	<parallel_text location="biras_id_925.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
