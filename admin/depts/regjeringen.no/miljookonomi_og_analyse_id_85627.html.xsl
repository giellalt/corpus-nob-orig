...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/md/dep/org/avdelinger/organisasjon_okonomi/miljookonomi_og_analyse.html?id=85627'"/>
<xsl:variable name="title" select="'Birasekonomiija ja analysa sekušuvdna - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'230'"/>
...
<xsl:variable name="para_eng" select="'Section-for-Environmental-Economics-and-Analysis-.html?id=85627'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="section-for-environmental-economics-and-analysis-_id_85627.html" xml:lang="eng"/>
	<parallel_text location="birasekonomiija-ja-analysa-sekuuvdna_id_85627.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
