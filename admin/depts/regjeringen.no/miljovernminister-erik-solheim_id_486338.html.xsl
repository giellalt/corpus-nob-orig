...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/md/dep/miljovernminister-erik-solheim.html?id=486338'"/>
<xsl:variable name="title" select="'Biras- ja ovddidanministtar Erik Solheim - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'389'"/>
...
<xsl:variable name="para_eng" select="'minister-of-the-environment-and-developm.html?id=486338'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="minister-of-the-environment-and-developm_id_486338.html" xml:lang="eng"/>
	<parallel_text location="miljovern--og-utviklingsminister-erik-so_id_486338.html" xml:lang="nno"/>
	<parallel_text location="miljo--og-utviklingsminister-erik-solhei_id_486338.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
