...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/pressesenter/pressemeldinger/2010/MinID-suksess-krever-13-millioner-kroner-mer.html?id=604472'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'MuID-menestus gáibida 13 milliuvnna ruvdnosaš lasáhusa - regjeringen.no'"/>
    <!--
    ...
    <xsl:variable name="wordcount" select="'368'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="eid-success-creates-demand-for-more-government-funding_id_604472.html"/>
        ...
        <parallel_text xml:lang="nno" location="minid-suksess-krev-13-millionar-kroner-meir_id_604472.html"/>
        <parallel_text xml:lang="nob" location=""/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location=""/>
        <parallel_text xml:lang="sme" location="minid-menestus-gaibida-13-milliuvnna-ruvdnosa-lasahusa_id_604472.html"/>
