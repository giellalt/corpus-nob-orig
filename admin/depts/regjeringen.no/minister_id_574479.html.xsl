...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/aktuelt/taler_og_artikler/minister.html?id=574479'"/>
...
<xsl:variable name="wordcount" select="'1968'"/>
...
<xsl:variable name="para_nno" select="'minister.html?id=574479'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="minister_id_574479.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
