...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/lmd/aktuelt/taler_artikler/ministeren.html?id=518473'"/>
...
<xsl:variable name="wordcount" select="'2866'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="speeches-and-articles-by-the-minister_id_518473.html" xml:lang="eng"/>
	<parallel_text location="taler-og-artiklar-av-ministeren_id_518473.html" xml:lang="nno"/>
</xsl:variable>
