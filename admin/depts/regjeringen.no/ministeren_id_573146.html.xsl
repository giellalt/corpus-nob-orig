...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fd/aktuelt/taler_artikler/ministeren.html?id=573146'"/>
<xsl:variable name="title" select="'Ministerens taler og artikler - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'1686'"/>
...
<xsl:variable name="para_eng" select="'minister.html?id=573146'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'ministaren.html?id=573146'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="minister_id_573146.html" xml:lang="eng"/>
	<parallel_text location="ministaren_id_573146.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
