...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/smk/aktuelt/taler_og_artikler/statsministeren/statsminister_jens_stoltenberg/2012/minnemarkering-pa-holocaustdagen.html?id=670621'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Sárdni Holocaustbeaivvi muitobottus - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'speech-on-international-holocaust-rememb.html_id=670621'"/>
...
<xsl:variable name="para_sme" select="'a.html_id=670621'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="speech-on-international-holocaust-rememb_id_670621.html" xml:lang="eng"/>
	<parallel_text location="a_id_670621.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
