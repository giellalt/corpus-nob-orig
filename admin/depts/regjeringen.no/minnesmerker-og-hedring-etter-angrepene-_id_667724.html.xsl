...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/kud/pressesenter/pressemeldinger/2011/minnesmerker-og-hedring-etter-angrepene-.html?id=667724'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Muitobáccit ja gudnejahttimat maŋŋil suoidnemánu 22.beaivve fallehemiid - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'memorials-and-honours-after-the-22-july-.html_id=667724'"/>
...
<xsl:variable name="para_sme" select="'muitobaccit-ja-gudnejahttimat-mail-suoid.html_id=667724'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="memorials-and-honours-after-the-22-july-_id_667724.html" xml:lang="eng"/>
	<parallel_text location="muitobaccit-ja-gudnejahttimat-mail-suoid_id_667724.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
