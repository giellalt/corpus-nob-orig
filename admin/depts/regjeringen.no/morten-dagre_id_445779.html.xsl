...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ad/dep/org/avdelinger/pks/morten-dagre.html?id=445779'"/>
<xsl:variable name="title" select="'Seniorráđđeaddi Morten Dagre - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'senior-adviser-morten-dagre.html?id=445779'"/>
...
<xsl:variable name="para_sme" select="'seniorraeaddi-morten-dagre.html?id=445779'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="senior-adviser-morten-dagre_id_445779.html" xml:lang="eng"/>
	<parallel_text location="seniorraeaddi-morten-dagre_id_445779.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
