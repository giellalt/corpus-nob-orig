...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/pressesenter/pressemeldinger/2010/motes-med-respekt-men-saksbehandlingstid.html?id=624695'"/>
...
<<<<<<< HEAD
<xsl:variable name="wordcount" select="'868'"/>
=======
<xsl:variable name="wordcount" select="'867'"/>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
...
<xsl:variable name="parallels">
	<parallel_text location="moter-respekt-men-saksbehandlingstida-er-for-lang_id_624695.html" xml:lang="nno"/>
	<parallel_text location="deaivvaduvvot-aktejumiin-muhto-aemeannud_id_624695.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
