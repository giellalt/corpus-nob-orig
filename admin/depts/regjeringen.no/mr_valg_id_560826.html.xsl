...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ud/tema/menneskerettigheter/mr_valg.html?id=560826'"/>
<xsl:variable name="title" select="'Norgga miellahttovuohta ON:a olmmošvuoigatvuođaráđis - regjeringen.no'"/>
...
<xsl:variable name="para_sme" select="'rad_samisk.html?id=560826'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="rad_samisk_id_560826.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
