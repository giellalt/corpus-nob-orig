...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/md/dep/org/avdelinger/internasjonalt_samarbeid/multilateralt_samarbeid_miljofora.html?id=85657'"/>
<xsl:variable name="title" select="'Globála ovttasbarggu sekšuvdna  - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'section-for-multilateral-cooperation.html?id=85657'"/>
...
<xsl:variable name="para_sme" select="'Globala-ovttasbarggu-sekuvdna-.html?id=85657'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="section-for-multilateral-cooperation_id_85657.html" xml:lang="eng"/>
	<parallel_text location="globala-ovttasbarggu-sekuvdna-_id_85657.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
