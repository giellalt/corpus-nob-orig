...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/aktuelt/nyheter/2011/--na-er-vi-i-gang.html?id=633339'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'- Dál mii leat jođus - regjeringen.no'"/>
...
<<<<<<< HEAD
<xsl:variable name="wordcount" select="'369'"/>
=======
...
<xsl:variable name="para_sme" select="'--dal-mii-leat-jous.html?id=633339'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="dal-mii-leat-jous_id_633339.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
