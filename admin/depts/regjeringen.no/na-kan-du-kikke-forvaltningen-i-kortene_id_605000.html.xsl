...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/pressesenter/pressemeldinger/2010/Na-kan-du-kikke-forvaltningen-i-kortene.html?id=605000'"/>
<xsl:variable name="title" select="'Dál don beasat diehtit maid hálddahus bargá - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'434'"/>
...
<xsl:variable name="para_eng" select="'Every-citizen-now-able-to-look-public-authorities-in-the-cards.html?id=605000'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'No-kan-du-kike-forvaltninga-i-korta.html?id=605000'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Dal-don-beasat-diehtit-maid-halddahus-barga.html?id=605000'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="every-citizen-now-able-to-look-public-authorities-in-the-cards_id_605000.html" xml:lang="eng"/>
