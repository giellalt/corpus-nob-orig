...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/tema/naringsliv.html?id=926'"/>
<xsl:variable name="title" select="'Ealáhuseallin - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'681'"/>
...
<xsl:variable name="para_eng" select="'Business-and-industry.html?id=926'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Naringsliv.html?id=926'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Ealahuseallin.html?id=926'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="business-and-industry_id_926.html" xml:lang="eng"/>
	<parallel_text location="naringsliv_id_926.html" xml:lang="nno"/>
	<parallel_text location="ealahuseallin_id_926.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
