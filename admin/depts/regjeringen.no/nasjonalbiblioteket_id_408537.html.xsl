...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/kud/dep/underliggende_etater/nasjonalbiblioteket.html?id=408537'"/>
<xsl:variable name="title" select="'Našunálagirjerájus - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'145'"/>
...
<xsl:variable name="para_nno" select="'nasjonalbiblioteket.html?id=408537'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Naunalagirjerajus.html?id=408537'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="nasjonalbiblioteket_id_408537.html" xml:lang="nno"/>
	<parallel_text location="naunalagirjerajus_id_408537.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
