...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/tema/nasjonale_minoriteter.html?id=1404'"/>
<xsl:variable name="title" select="'Nationála unnitlogut - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'national-minorities.html?id=1404'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Nasjonale-minoritetar.html?id=1404'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Nationala-unnitlogut.html?id=1404'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="national-minorities_id_1404.html" xml:lang="eng"/>
	<parallel_text location="nasjonale-minoritetar_id_1404.html" xml:lang="nno"/>
	<parallel_text location="nationala-unnitlogut_id_1404.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
