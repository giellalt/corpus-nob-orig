...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/kd/tema/hoyere_utdanning/nasjonalt-kvalifikasjonsrammeverk.html?id=564809'"/>
<xsl:variable name="title" select="'Kvalifikasjonsrammeverket - regjeringen.no'"/>
