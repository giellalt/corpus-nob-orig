...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/kd/tema/livslang-laring/Nasjonalt-kvalifikasjonsrammeverk.html?id=601327'"/>
<xsl:variable name="title" select="'Nasjonalt kvalifikasjonsrammeverk - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'1159'"/>
