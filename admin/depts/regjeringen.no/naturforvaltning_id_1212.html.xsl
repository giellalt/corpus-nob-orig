...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/md/dep/org/avdelinger/naturforvaltning.html?id=1212'"/>
<xsl:variable name="title" select="'Luondduhálddašanossodat - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'department-for-nature-management.html?id=1212'"/>
...
<xsl:variable name="para_sme" select="'Luondduhalddaanossodat.html?id=1212'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="department-for-nature-management_id_1212.html" xml:lang="eng"/>
	<parallel_text location="luondduhalddaanossodat_id_1212.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
