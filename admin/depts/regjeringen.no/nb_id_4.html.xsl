...
<xsl:variable name="filename" select="'http://regjeringen.no/nb.html?id=4'"/>
<xsl:variable name="title" select="'Ráđđehus.no - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'en.html?id=4'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'nn.html?id=4'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'se.html?id=4'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="en_id_4.html" xml:lang="eng"/>
	<parallel_text location="nn_id_4.html" xml:lang="nno"/>
	<parallel_text location="se_id_4.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
