...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/bld/tema/nedsatt_funksjonsevne.html?id=987'"/>
<xsl:variable name="title" select="'Vuoliduvvon doaibmannávccat - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'352'"/>
...
<xsl:variable name="para_eng" select="'disabled-people.html?id=987'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Funksjonshemma.html?id=987'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'vuoliduvvon-doaibmannavccat.html?id=987'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="disabled-people_id_987.html" xml:lang="eng"/>
	<parallel_text location="funksjonshemma_id_987.html" xml:lang="nno"/>
	<parallel_text location="vuoliduvvon-doaibmannavccat_id_987.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
