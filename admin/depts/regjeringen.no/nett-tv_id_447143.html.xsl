...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/lyd_bilde/nett-tv.html?id=447143'"/>
<xsl:variable name="title" select="'Nett-TV - regjeringen.no'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="nett-tv_id_447143.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
