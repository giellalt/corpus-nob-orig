...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/nhd.html?id=709'"/>
<xsl:variable name="title" select="'Ealáhus-ja gávpedepartemeanta - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'nhd.html?id=709'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'nhd.html?id=709'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'nhd.html?id=709'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="nhd_id_709.html" xml:lang="eng"/>
	<parallel_text location="nhd_id_709.html" xml:lang="nno"/>
	<parallel_text location="nhd_id_709.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
