...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fkd/dep/underliggende-etater/nifes.html?id=163068'"/>
<xsl:variable name="title" select="'NIFES - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'218'"/>
...
<xsl:variable name="para_eng" select="'the-national-institute-of-nutrition-and-.html?id=163068'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Nasjonalt-institutt-for-ernarings--og-sj.html?id=163068'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'nifes.html?id=163068'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="the-national-institute-of-nutrition-and-_id_163068.html" xml:lang="eng"/>
	<parallel_text location="nasjonalt-institutt-for-ernarings--og-sj_id_163068.html" xml:lang="nno"/>
	<parallel_text location="nifes_id_163068.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
