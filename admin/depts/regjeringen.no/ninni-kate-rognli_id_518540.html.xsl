...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/dep/org/avdelinger/same--og-minoritetspolitisk-avdeling/ninni-kate-rognli.html?id=518540'"/>
<xsl:variable name="title" select="'Ossodatdirektora Ninni Kate Rognli - regjeringen.no'"/>
...
<xsl:variable name="para_sme" select="'ossodatdirektora-ninni-kate-rognli.html?id=518540'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="ossodatdirektora-ninni-kate-rognli_id_518540.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
