...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/smk/pressesenter/pressemeldinger/2010/nord.html?id=615757'"/>
<xsl:variable name="title" select="'Rekordsatsing på nordområdene - regjeringen.no'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="sami_id_615757.html" xml:lang="sme"/>
<parallel_text location="great-demand-for-loans-from-the-norwegia_id_615293.html" xml:lang="eng"/>
</xsl:variable>
