...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ud/dep/org/avdelinger/avdeling_for_sikkerhetspolitikk/nord_ressurser.html?id=85981'"/>
<xsl:variable name="title" select="'Davviguovlluid, resurssaid ja Ruošša ossodat - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'212'"/>
...
<xsl:variable name="para_eng" select="'polar_affairs.html?id=85981'"/>
...
<xsl:variable name="para_sme" select="'Davviguovlluid-resurssaid-ja-Ruoa-ossodat.html?id=85981'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="polar_affairs_id_85981.html" xml:lang="eng"/>
	<parallel_text location="davviguovlluid-resurssaid-ja-ruoa-ossodat_id_85981.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
