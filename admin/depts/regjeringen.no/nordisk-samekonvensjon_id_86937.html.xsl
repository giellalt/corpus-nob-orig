...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/tema/samepolitikk/nordisk_samisk_samarbeid/nordisk-samekonvensjon.html?id=86937'"/>
<xsl:variable name="title" select="'Davviriikkalaš sámekonvenšuvdna - regjeringen.no'"/>
...
<xsl:variable name="para_sme" select="'Davviriikkala-samekonvenuvdna.html?id=86937'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="davviriikkala-samekonvenuvdna_id_86937.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
