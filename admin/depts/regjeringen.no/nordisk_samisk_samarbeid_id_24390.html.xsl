...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/tema/samepolitikk/nordisk_samisk_samarbeid.html?id=24390'"/>
...
<xsl:variable name="para_eng" select="'nordic-sami-cooperation.html?id=24390'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="nordic-sami-cooperation_id_24390.html" xml:lang="eng"/>
	<parallel_text location="davviriikkala-sami-ovttasbargu_id_24390.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
