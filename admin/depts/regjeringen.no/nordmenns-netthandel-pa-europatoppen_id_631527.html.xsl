...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/aktuelt/nyheter/2011/nordmenns-netthandel-pa-europatoppen.html?id=631527'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Norgalaččaid neahttagávppašeapmi  Eurohpá njunnošis - regjeringen.no'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="47-million-kroner-announced-for-bulyst-r_id_631540.html"/>
        ...
        <parallel_text xml:lang="nno" location="47-millionar-kroner-til-bulyst-2011_id_631540.html"/>
        <parallel_text xml:lang="nob" location=""/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location=""/>
        <parallel_text xml:lang="sme" location="norgalaaid-neahttagavppaeapmi--eurohpa-njunnois_id_631527.html"/>
