...
<xsl:variable name="para_sme" select="'Norgalaaid-neahttagavppaeapmi--Eurohpa-njunnois.html?id=631527'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="norgalaaid-neahttagavppaeapmi--eurohpa-njunnois_id_631527.html" xml:lang="sme"/>
