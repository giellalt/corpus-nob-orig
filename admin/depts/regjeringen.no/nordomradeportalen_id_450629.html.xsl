...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ud/kampanjer/nordomradeportalen.html?id=450629'"/>
<xsl:variable name="title" select="'Davviguovlouskádat - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'high-north.html?id=1154'"/>
...
<xsl:variable name="para_sme" select="'nord_samisk.html?id=1154'"/>
