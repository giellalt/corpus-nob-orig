...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/pressesenter/pressemeldinger/2010/norge--en-digital-nasjon-i-verdenstoppen.html?id=610574'"/>
<xsl:variable name="title" select="'Norge - en digital nasjon i verdenstoppen - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'448'"/>
...
<xsl:variable name="para_sme" select="'Norga--digitala-riika-mailmmenjunnois.html?id=610574'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="norga--digitala-riika-mailmmenjunnois_id_610574.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
