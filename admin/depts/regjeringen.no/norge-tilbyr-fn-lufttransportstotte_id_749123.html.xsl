...
<xsl:variable name="para_eng" select="'norway-offers-un-airlift-support.html_id=749123'"/>
...
<xsl:variable name="para_sme" select="'norga-falla-oni-aibmofievrredandoarjaga.html_id=749123'"/>
