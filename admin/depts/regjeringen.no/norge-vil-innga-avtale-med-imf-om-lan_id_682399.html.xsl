...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fin/pressesenter/pressemeldinger/2012/norge-vil-innga-avtale-med-imf-om-lan.html?id=682399'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Norga áigu dahkat loatnasoahpamuša IMF:in - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'541'"/>
...
<xsl:variable name="para_eng" select="'norway-asks-parliament-to-approve-imf-lo.html_id=682399'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="norway-asks-parliament-to-approve-imf-lo_id_682399.html" xml:lang="eng"/>
	<parallel_text location="norga-aigu-dahkat-loatnasoahpamua-imfin_id_682399.html" xml:lang="sme"/>
<parallel_text location="noreg-vil-innga-avtale-med-imf-om-lan_id_682399.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
