...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/krd/kampanjer/valg/valgobservasjon/Norges-oppfolging-av-OSSEs-Election-Assessment-Mission-rapport.html?id=608279'"/>
<<<<<<< HEAD
<xsl:variable name="title" select="'Norges oppfølging av OSSE's Election Assessment Mission rapport - regjeringen.no'"/>
=======
<xsl:variable name="title" select="'Norges oppfølging av OSSE’s Election Assessment Mission rapport - regjeringen.no'"/>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
...
<xsl:variable name="para_eng" select="'The-Norwegian-follow-up-of-OSCEs-Election-Assessment-Mission-report.html?id=608279'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="the-norwegian-follow-up-of-osces-election-assessment-mission-report_id_608279.html" xml:lang="eng"/>
	<parallel_text location="norges-oppfolging-av-osses-election-assessment-mission-rapport_id_608279.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
