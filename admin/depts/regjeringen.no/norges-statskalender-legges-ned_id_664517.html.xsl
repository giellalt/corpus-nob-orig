...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/pressesenter/pressemeldinger/2011/norges-statskalender-legges-ned.html?id=664517'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Norgga stáhtakaleanddar heaittihuvvo - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'315'"/>
...
<xsl:variable name="para_nno" select="'noregs-statskalender-blir-lagt-ned.html_id=664517'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'norgga-stahtakaleanddar-heaittihuvvo.html_id=664517'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="noregs-statskalender-blir-lagt-ned_id_664517.html" xml:lang="nno"/>
	<parallel_text location="norgga-stahtakaleanddar-heaittihuvvo_id_664517.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
