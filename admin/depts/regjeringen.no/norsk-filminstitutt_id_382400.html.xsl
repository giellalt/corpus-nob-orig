...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/kud/dep/underliggende_etater/norsk-filminstitutt.html?id=382400'"/>
<xsl:variable name="title" select="'Norgga filbmainstituhtta  - regjeringen.no'"/>
...
<xsl:variable name="para_nno" select="'norsk-filminstitutt.html?id=382400'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="norsk-filminstitutt_id_382400.html" xml:lang="nno"/>
	<parallel_text location="norgga-filbmainstituhtta-_id_382400.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
