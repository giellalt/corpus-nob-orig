...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fd/aktuelt/nyheter/2012/norsk-fregatt-skal-lede-natos-maritime-s.html?id=704821'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Norgga fregáhtta galgá jođihit NATO mearraveaga - regjeringen.no'"/>
...
<xsl:variable name="para_sme" select="'norgga-fregahtta-galga-joihit-nato-mearr.html_id=704821'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="norwegian-frigate-to-lead-nato-maritime-_id_704821.html" xml:lang="eng"/>
	<parallel_text location="norgga-fregahtta-galga-joihit-nato-mearr_id_704821.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
