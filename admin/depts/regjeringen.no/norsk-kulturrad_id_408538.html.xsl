...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/kud/dep/underliggende_etater/norsk-kulturrad.html?id=408538'"/>
<xsl:variable name="title" select="'Norgga Kulturráđđi  - regjeringen.no'"/>
...
<xsl:variable name="para_nno" select="'norsk-kulturrad.html?id=408538'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Norgga-Kulturrai-.html?id=408538'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="norsk-kulturrad_id_408538.html" xml:lang="nno"/>
	<parallel_text location="norgga-kulturrai-_id_408538.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
