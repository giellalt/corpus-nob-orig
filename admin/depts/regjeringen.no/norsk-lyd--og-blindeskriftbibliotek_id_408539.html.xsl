...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/kud/dep/underliggende_etater/norsk-lyd--og-blindeskriftbibliotek.html?id=408539'"/>
<xsl:variable name="title" select="'Norgga jietna- ja čálmmehemiidčálagirjerájus  - regjeringen.no'"/>
...
<xsl:variable name="para_nno" select="'norsk-lyd--og-blindeskriftbibliotek.html?id=408539'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="norsk-lyd--og-blindeskriftbibliotek_id_408539.html" xml:lang="nno"/>
	<parallel_text location="norgga-jietna--ja-almmehemiidalagirjerajus-_id_408539.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
