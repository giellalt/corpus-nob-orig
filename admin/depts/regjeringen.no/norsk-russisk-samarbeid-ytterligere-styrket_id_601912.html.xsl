...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/smk/pressesenter/pressemeldinger/2010/Norsk-russisk-samarbeid-ytterligere-styrket.html?id=601912'"/>
<xsl:variable name="title" select="'Norgga-ruošša ovttasbargu nannejuvvo vel eambbo - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'518'"/>
...
<xsl:variable name="para_sme" select="'Norgga-ruoa-ovttasbargu-nannejuvvo-vel-eambbo.html?id=601912'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="norgga-ruoa-ovttasbargu-nannejuvvo-vel-eambbo_id_601912.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
