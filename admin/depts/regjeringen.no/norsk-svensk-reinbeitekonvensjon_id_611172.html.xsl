...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/lmd/tema/reindrift/norsk-svensk-reinbeitekonvensjon.html?id=611172'"/>
<xsl:variable name="title" select="'Norsk-svensk reinbeitekonvensjon - regjeringen.no'"/>
