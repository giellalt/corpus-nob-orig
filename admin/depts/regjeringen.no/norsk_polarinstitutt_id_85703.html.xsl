...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/md/dep/underliggende-etater/norsk_polarinstitutt.html?id=85703'"/>
<xsl:variable name="title" select="'Norgga Polarinstituhtta - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'the-norwegian-polar-institute.html?id=85703'"/>
...
<xsl:variable name="para_sme" select="'Norgga-Polarinstituhtta.html?id=85703'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="the-norwegian-polar-institute_id_85703.html" xml:lang="eng"/>
	<parallel_text location="norgga-polarinstituhtta_id_85703.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
