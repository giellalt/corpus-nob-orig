...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/lmd/dok/nou-er.html?id=1998'"/>
<xsl:variable name="title" select="'Norgga almmolaš čielggadeamit - regjeringen.no'"/>
...
<xsl:variable name="para_nno" select="'NOU-ar.html?id=1998'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'NA.html?id=1998'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="nou-ar_id_1998.html" xml:lang="nno"/>
	<parallel_text location="na_id_1998.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
