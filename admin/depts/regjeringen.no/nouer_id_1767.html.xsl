...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dok/nouer.html?id=1767'"/>
<xsl:variable name="title" select="'NAČ-at - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'223'"/>
...
<xsl:variable name="para_eng" select="'norwegian-official-reports.html?id=1767'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'NOU-ar.html?id=1767'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'NA-at.html?id=1767'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="norwegian-official-reports_id_1767.html" xml:lang="eng"/>
	<parallel_text location="nou-ar_id_1767.html" xml:lang="nno"/>
	<parallel_text location="na-at_id_1767.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
