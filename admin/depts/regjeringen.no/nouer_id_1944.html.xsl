...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/krd/dok/nouer.html?id=1944'"/>
...
<xsl:variable name="para_nno" select="'NOU-ar.html?id=1944'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'NA-at.html?id=1944'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="nou-ar_id_1944.html" xml:lang="nno"/>
	<parallel_text location="na-at_id_1944.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
