...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/lmd/tema/nternasjonalt_samarbeid_om_mat_og_landbr.html?id=1185'"/>
<xsl:variable name="title" select="'Riikkaidgaskasaš ovttasbargu eanadoalus ja borramušsuorggis - regjeringen.no'"/>
...
<xsl:variable name="para_nno" select="'internasjonalt-samarbeid-om-landbruk-og-.html?id=1185'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'riikkaidgaskasa-ovttasbargu-eanadoalus-j.html?id=1185'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="internasjonalt-samarbeid-om-landbruk-og-_id_1185.html" xml:lang="nno"/>
	<parallel_text location="riikkaidgaskasa-ovttasbargu-eanadoalus-j_id_1185.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
