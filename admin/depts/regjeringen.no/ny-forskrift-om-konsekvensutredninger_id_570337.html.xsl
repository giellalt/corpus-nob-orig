...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/md/tema/planlegging_plan-_og_bygningsloven/ny-forskrift-om-konsekvensutredninger.html?id=570337'"/>
<xsl:variable name="title" select="'Forskrift om konsekvensutredninger - regjeringen.no'"/>
