...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/aktuelt/nyheter/2010/ny-rapport-om-det-samiske-samfunnet.html?id=616348'"/>
<xsl:variable name="title" select="'Ny rapport om det samiske samfunnet - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'398'"/>
...
<xsl:variable name="para_sme" select="'Oa-raporta-sami-servodaga-birra.html?id=616348'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="oa-raporta-sami-servodaga-birra_id_616348.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
