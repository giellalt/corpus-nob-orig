...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/smk/pressesenter/pressemeldinger/2009/nye-byggesteiner-i-nord.html?id=548806'"/>
<xsl:variable name="title" select="'Ođđa huksengeađggit davvin - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'moving-forwards-in-the-high-north.html?id=548806'"/>
...
<xsl:variable name="para_sme" select="'oa-huksengeaggit-davvin.html?id=548806'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="moving-forwards-in-the-high-north_id_548806.html" xml:lang="eng"/>
	<parallel_text location="oa-huksengeaggit-davvin_id_548806.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
