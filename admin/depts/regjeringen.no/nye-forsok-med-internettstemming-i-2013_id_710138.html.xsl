...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/krd/pressesenter/pressemeldinger/2012/nye-forsok-med-internettstemming-i-2013.html?id=710138'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Ođđa geahččaleamit interneahttajienastemiin 2013:s - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'1020'"/>
...
<xsl:variable name="para_eng" select="'new-pilot-with-internet-voting-in-2013.html_id=710138'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'det-blir-enklare-a-forehandsstemme.html_id=710339'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'oa-geahaleamit-interneahttajienastemiin-.html_id=710138'"/>
