...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/smk/pressesenter/pressemeldinger/2009/nye-tiltak-for-naringsliv-og-husholdning.html?id=545250'"/>
<xsl:variable name="title" select="'Ođđa doaibmabijut ealáhusaide ja dállodoaluide - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'722'"/>
...
<xsl:variable name="para_eng" select="'norway-presents-new-measures-for-industr.html?id=545250'"/>
...
<xsl:variable name="para_sme" select="'oa-doaibmabijut-ealahusaide-ja-dallodoal.html?id=545250'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="norway-presents-new-measures-for-industr_id_545250.html" xml:lang="eng"/>
	<parallel_text location="oa-doaibmabijut-ealahusaide-ja-dallodoal_id_545250.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
