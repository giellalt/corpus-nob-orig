...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/aktuelt/nyheter.html?id=1170'"/>
...
<xsl:variable name="wordcount" select="'2029'"/>
...
<xsl:variable name="para_eng" select="'news.html?id=1170'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'nyheiter.html?id=1170'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'oddasat.html?id=1170'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="news_id_1170.html" xml:lang="eng"/>
	<parallel_text location="nyheiter_id_1170.html" xml:lang="nno"/>
	<parallel_text location="oddasat_id_1170.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
