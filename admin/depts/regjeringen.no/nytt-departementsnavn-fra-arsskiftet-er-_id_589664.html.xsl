...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/kud/pressesenter/pressemeldinger/2010/nytt-departementsnavn-fra-arsskiftet-er-.html?id=589664'"/>
<xsl:variable name="title" select="'Ođđa departemeantanamma ođđajagi rájes lea Kulturdepartemeanta - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'the-new-name-for-the-ministry-is-the-min.html?id=589664'"/>
...
<xsl:variable name="para_sme" select="'oa-departemeantanamma-oajagi-rajes-lea-k.html?id=589664'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="the-new-name-for-the-ministry-is-the-min_id_589664.html" xml:lang="eng"/>
	<parallel_text location="oa-departemeantanamma-oajagi-rajes-lea-k_id_589664.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
