...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fkd/pressesenter/pressemeldinger/2006/nytt-isgaende-forskningsfartoy.html?id=437117'"/>
<xsl:variable name="title" select="'Ođđa jiekŋagierdi dutkanskiipa - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'New-ice-class-research-vessel-2.html?id=437117'"/>
...
<xsl:variable name="para_sme" select="'Oa-jiekagierdi-dutkanskiipa.html?id=437117'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="new-ice-class-research-vessel-2_id_437117.html" xml:lang="eng"/>
	<parallel_text location="oa-jiekagierdi-dutkanskiipa_id_437117.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
