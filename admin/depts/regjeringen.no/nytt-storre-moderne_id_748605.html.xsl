...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/kmd/pressesenter/pressemeldinger/2014/nytt-storre-moderne.html?id=748605'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Ođđaseabbo, stuorit ja ođđaáigásaš - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'524'"/>
...
<xsl:variable name="para_eng" select="'new-bigger-and-modern1.html_id=748605'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'nytt-storre-og-moderne1.html_id=748605'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'oaseabbo-stuorit-ja-oaaigasa1.html_id=748605'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="new-bigger-and-modern1_id_748605.html" xml:lang="eng"/>
	<parallel_text location="nytt-storre-og-moderne1_id_748605.html" xml:lang="nno"/>
	<parallel_text location="oaseabbo-stuorit-ja-oaaigasa1_id_748605.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
