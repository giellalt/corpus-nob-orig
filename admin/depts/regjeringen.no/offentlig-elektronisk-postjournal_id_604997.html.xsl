...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/aktuelt/Offentlig-elektronisk-postjournal.html?id=604997'"/>
<xsl:variable name="title" select="'Almmolaš elektrovnnalaš poastajournála - regjeringen.no'"/>
...
<xsl:variable name="para_nno" select="'Offentleg-elektronisk-postjournal.html?id=604997'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="offentleg-elektronisk-postjournal_id_604997.html" xml:lang="nno"/>
	<parallel_text location="byogkeles-elektronihken-paastejournale_id_604997.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
