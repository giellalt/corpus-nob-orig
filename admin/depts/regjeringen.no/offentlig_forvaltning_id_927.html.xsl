...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/tema/offentlig_forvaltning.html?id=927'"/>
<xsl:variable name="title" select="'Almmolaš hálddahus - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'647'"/>
...
<xsl:variable name="para_eng" select="'Public-administration.html?id=927'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Offentleg-forvaltning.html?id=927'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Almmola-halddahus.html?id=927'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="public-administration_id_927.html" xml:lang="eng"/>
	<parallel_text location="offentleg-forvaltning_id_927.html" xml:lang="nno"/>
	<parallel_text location="almmola-halddahus_id_927.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
