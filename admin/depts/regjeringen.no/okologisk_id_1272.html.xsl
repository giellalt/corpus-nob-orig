...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/lmd/tema/okologisk.html?id=1272'"/>
<xsl:variable name="title" select="'Ekologalaš borramušbuvttadeapmi - regjeringen.no'"/>
...
<xsl:variable name="para_nno" select="'okologisk-matproduksjon.html?id=1272'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'ekologala-borramubuvttadeapmi.html?id=1272'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="okologisk-matproduksjon_id_1272.html" xml:lang="nno"/>
	<parallel_text location="ekologala-borramubuvttadeapmi_id_1272.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
