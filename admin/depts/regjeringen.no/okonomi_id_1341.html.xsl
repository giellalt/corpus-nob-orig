...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/tema/naringsliv/okonomi.html?id=1341'"/>
<xsl:variable name="title" select="'Ekonomiija ja ealáhuseallin - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'570'"/>
...
<xsl:variable name="para_nno" select="'Okonomi-og-naringsliv.html?id=1341'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Ekonomiija-ja-ealahuseallin.html?id=1341'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="okonomi-og-naringsliv_id_1341.html" xml:lang="nno"/>
	<parallel_text location="ekonomiija-ja-ealahuseallin_id_1341.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
