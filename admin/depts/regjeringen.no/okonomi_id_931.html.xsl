...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/tema/okonomi.html?id=931'"/>
<xsl:variable name="title" select="'Ekonomiija - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'1074'"/>
...
<xsl:variable name="para_eng" select="'The-economy.html?id=931'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Okonomi.html?id=931'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Ekonomiija.html?id=931'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="the-economy_id_931.html" xml:lang="eng"/>
	<parallel_text location="okonomi_id_931.html" xml:lang="nno"/>
	<parallel_text location="ekonomiija_id_931.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
