...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fin/dep/org/avdelinger/okonomiavdelingen.html?id=1546'"/>
<xsl:variable name="title" select="'Ekonomiijaossodat  - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'489'"/>
...
<xsl:variable name="para_eng" select="'The-Economic-Policy-Department.html?id=1546'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'okonomiavdelinga.html?id=1546'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Ekonomiijaossodat-.html?id=1546'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="the-economic-policy-department_id_1546.html" xml:lang="eng"/>
	<parallel_text location="okonomiavdelinga_id_1546.html" xml:lang="nno"/>
	<parallel_text location="ekonomiijaossodat-_id_1546.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
