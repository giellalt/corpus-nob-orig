...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/tema/lov_og_rett/kriminalitet_og_overgrep/okonomisk_kriminalitet.html?id=1263'"/>
<xsl:variable name="title" select="'Ekonomalaš rihkolašvuohta - regjeringen.no'"/>
...
<xsl:variable name="para_nno" select="'Okonomisk-kriminalitet.html?id=1263'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Ekonomala-rihkolavuohta.html?id=1263'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="okonomisk-kriminalitet_id_1263.html" xml:lang="nno"/>
	<parallel_text location="ekonomala-rihkolavuohta_id_1263.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
