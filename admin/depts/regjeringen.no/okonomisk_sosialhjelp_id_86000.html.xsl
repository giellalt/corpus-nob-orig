...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ad/tema/velferdspolitikk/midtspalte/okonomisk_sosialhjelp.html?id=86000'"/>
<xsl:variable name="title" select="'Ekonomalaš sosiálaveahkki - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'290'"/>
...
<xsl:variable name="para_eng" select="'financial-social-assistance.html?id=86000'"/>
...
<xsl:variable name="para_sme" select="'Ekonomala-sosialaveahkki.html?id=86000'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="financial-social-assistance_id_86000.html" xml:lang="eng"/>
	<parallel_text location="ekonomala-sosialaveahkki_id_86000.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
