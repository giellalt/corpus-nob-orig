...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/Om-nettstedet.html?id=450429'"/>
<xsl:variable name="title" select="'Om nettstedet - regjeringen.no'"/>
...
<xsl:variable name="para_nno" select="'Om-nettstaden.html?id=450429'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="om-nettstaden_id_450429.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
