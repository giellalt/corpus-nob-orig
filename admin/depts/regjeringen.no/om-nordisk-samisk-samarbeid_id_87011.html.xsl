...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/tema/samepolitikk/nordisk_samisk_samarbeid/om-nordisk-samisk-samarbeid.html?id=87011'"/>
<xsl:variable name="title" select="'Davviriikkalaš sámi ovttasbargu - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'447'"/>
...
<xsl:variable name="para_eng" select="'on-nordic-sami-cooperation.html?id=87011'"/>
...
<xsl:variable name="para_sme" select="'Davviriikkala-sami-ovttasbargu.html?id=87011'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="on-nordic-sami-cooperation_id_87011.html" xml:lang="eng"/>
	<parallel_text location="davviriikkala-sami-ovttasbargu_id_87011.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
