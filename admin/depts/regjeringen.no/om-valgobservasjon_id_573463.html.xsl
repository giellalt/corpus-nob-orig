...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/krd/kampanjer/valg/valgobservasjon/om-valgobservasjon.html?id=573463'"/>
<xsl:variable name="title" select="'Om valgobservasjon - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'about-election-observation.html?id=573463'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="about-election-observation_id_573463.html" xml:lang="eng"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
