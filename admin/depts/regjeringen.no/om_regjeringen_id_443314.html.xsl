...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/om_regjeringen.html?id=443314'"/>
<xsl:variable name="title" select="'Ráđđehus birra - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'the-government.html?id=443314'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Om-regjeringa.html?id=443314'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Raehus-birra.html?id=443314'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="the-government_id_443314.html" xml:lang="eng"/>
	<parallel_text location="om-regjeringa_id_443314.html" xml:lang="nno"/>
	<parallel_text location="raehus-birra_id_443314.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
