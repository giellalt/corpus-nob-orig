...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fin/pressesenter/pressemeldinger/2012/omregistreringsavgiften-reduseres-krafti.html?id=704096'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Ođđasit registrerema divat vuoliduvvo sakka ja birasprofiila nannejuvvo - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'608'"/>
...
<xsl:variable name="para_eng" select="'a-neutral-fiscal-stance-to-support-stabi.html_id=704074'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'omregistreringsavgifta-vert-kraftig-redu.html_id=704096'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="'raavrevijhke-saemien-gielen-reeremedajve.html_id=704691'"/>
<xsl:variable name="para_sme" select="'oasit-registrerema-divat-vuoliduvvo-sakk.html_id=704096'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="omregistreringsavgifta-vert-kraftig-redu_id_704096.html" xml:lang="nno"/>
	<parallel_text location="oasit-registrerema-divat-vuoliduvvo-sakk_id_704096.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
