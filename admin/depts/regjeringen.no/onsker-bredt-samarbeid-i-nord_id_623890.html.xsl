...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fd/aktuelt/nyheter/2010/onsker-bredt-samarbeid-i-nord.html?id=623890'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Háliidit viiddis ovttasbarggu davvin - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'403'"/>
...
<xsl:variable name="para_eng" select="'desire-for-broad-cooperation-in-the-nort.html?id=623890'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="desire-for-broad-cooperation-in-the-nort_id_623890.html" xml:lang="eng"/>
	<parallel_text location="moter-respekt-men-saksbehandlingstida-er-for-lang.html_id=624695" xml:lang="nno"/>
	<parallel_text location="haliidit-viiddis-ovttasbarggu-davvin_id_623890.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
