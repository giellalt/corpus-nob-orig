...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/kud/pressesenter/pressemeldinger/2013/onsker-enklere-hverdag-for-barne--og-ung.html?id=728487'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Háliida álkit árgabeaivvi mánáid- ja nuoraidorganisašuvnnaide - regjeringen.no'"/>
...
<xsl:variable name="para_sme" select="'haliida-alkit-argabeaivvi-manaid--ja-nuo.html_id=728487'"/>
<xsl:variable name="para_smj" select="'oecd-doajmmaplanajn-nuoraj-vuoksjuj-ja-v.html_id=728488'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="haliida-alkit-argabeaivvi-manaid--ja-nuo_id_728487.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
