...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/pressesenter/pressemeldinger/2012/onsker-flere-tilbydere-av-elektronisk-id.html?id=677965'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Sávvet eanebuid fállat elektrovnnalaš ID - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'400'"/>
...
<xsl:variable name="para_nno" select="'vil-ha-fleire-som-tilbyr-elektronisk-id.html_id=677965'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'savvet-eanebuid-fallat-elektrovnnala-id.html_id=677965'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="vil-ha-fleire-som-tilbyr-elektronisk-id_id_677965.html" xml:lang="nno"/>
	<parallel_text location="savvet-eanebuid-fallat-elektrovnnala-id_id_677965.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
