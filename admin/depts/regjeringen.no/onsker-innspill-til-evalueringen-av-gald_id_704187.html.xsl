...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/pressesenter/pressemeldinger/2012/onsker-innspill-til-evalueringen-av-gald.html?id=704187'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Háliida árvalusaid Gáldu árvvoštallamii - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'251'"/>
...
<xsl:variable name="para_sme" select="'haliida-arvalusaid-galdu-arvvotallamii.html_id=704187'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="raavrevijhke-saemien-gielen-reeremedajve.html_id=704691" xml:lang="sma"/>
	<parallel_text location="haliida-arvalusaid-galdu-arvvotallamii_id_704187.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
