...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/dep/underliggende-etater/opplysningsvesenets-fond.html?id=408533'"/>
<xsl:variable name="title" select="'Čuvgehuslágádusa foanda  - regjeringen.no'"/>
...
<xsl:variable name="para_sme" select="'uvgehuslagadusa-foanda-.html?id=408533'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="uvgehuslagadusa-foanda-_id_408533.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
