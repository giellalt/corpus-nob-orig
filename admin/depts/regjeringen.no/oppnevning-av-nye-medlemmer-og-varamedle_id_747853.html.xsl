...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/kud/pressesenter/pressemeldinger/2013/oppnevning-av-nye-medlemmer-og-varamedle.html?id=747853'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Ođđa miellahtuid ja várrelahtuid nammadeapmi Norgga kulturráđđái - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'699'"/>
...
<xsl:variable name="para_nno" select="'forslag-om-oppheving-av-boklova.html_id=747915'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'oa-miellahtuid-ja-varrelahtuid-nammadeap.html_id=747853'"/>
...
<xsl:variable name="parallels">
	...
	<parallel_text location="forslag-om-oppheving-av-boklova.html_id=747915" xml:lang="nno"/>
	<parallel_text location="oa-miellahtuid-ja-varrelahtuid-nammadeap_id_747853.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
