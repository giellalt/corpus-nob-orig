...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/dep/org.html?id=363'"/>
...
<xsl:variable name="para_eng" select="'Organisation.html?id=363'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'organisasjon.html?id=363'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'organisauvdna.html?id=363'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="organisation_id_363.html" xml:lang="eng"/>
	<parallel_text location="organisasjon_id_363.html" xml:lang="nno"/>
	<parallel_text location="organisauvdna_id_363.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
