...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/hod/dep/org.html?id=445'"/>
...
<xsl:variable name="para_nno" select="'organisasjon.html?id=445'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Organisauvdna-.html?id=445'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="organisasjon_id_445.html" xml:lang="nno"/>
	<parallel_text location="organisauvdna-_id_445.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
