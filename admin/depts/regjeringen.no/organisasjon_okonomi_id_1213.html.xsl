...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/md/dep/org/avdelinger/organisasjon_okonomi.html?id=1213'"/>
<xsl:variable name="title" select="'Organisašuvnnaid ja ekonomiija ossodat  - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'307'"/>
...
<xsl:variable name="para_eng" select="'department-for-organisational-and-econom.html?id=1213'"/>
...
<xsl:variable name="para_sme" select="'Organisauvnnaid-ja-ekonomiija-ossodat-.html?id=1213'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="department-for-organisational-and-econom_id_1213.html" xml:lang="eng"/>
	<parallel_text location="organisauvnnaid-ja-ekonomiija-ossodat-_id_1213.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
