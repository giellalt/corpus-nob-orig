...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fd/dep/org/organisasjonskart.html?id=406'"/>
<xsl:variable name="title" select="'Organisašuvdnakárta - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'164'"/>
...
<xsl:variable name="para_eng" select="'organisation-chart.html?id=406'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'organisasjonskart.html?id=406'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'organisauvdnakarta.html?id=406'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="organisation-chart_id_406.html" xml:lang="eng"/>
	<parallel_text location="organisasjonskart_id_406.html" xml:lang="nno"/>
	<parallel_text location="organisauvdnakarta_id_406.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
