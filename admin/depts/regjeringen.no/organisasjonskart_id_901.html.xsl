...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/smk/dep/org/organisasjonskart.html?id=901'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Organisasjonskart - regjeringen.no'"/>
    <!--
    ...
    <xsl:variable name="wordcount" select="'134'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="Organization-Map.html?id=901"/>
        ...
        <parallel_text xml:lang="nno" location="Organisasjonskart.html?id=901"/>
        <parallel_text xml:lang="nob" location=""/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location=""/>
        <parallel_text xml:lang="sme" location="organisasjonskart.html?id=901"/>
