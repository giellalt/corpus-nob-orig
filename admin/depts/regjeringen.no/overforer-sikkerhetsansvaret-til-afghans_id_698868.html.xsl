...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fd/aktuelt/nyheter/2012/overforer-sikkerhetsansvaret-til-afghans.html?id=698868'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Sirdá sihkarvuođaovddasvástádusa Afganistana eiseválddiide - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'731'"/>
...
<xsl:variable name="para_eng" select="'responsibility-for-security-transferred-.html_id=698868'"/>
...
<xsl:variable name="para_sme" select="'sirda-sihkarvuoaovddasvastadusa-afganist.html_id=698868'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="responsibility-for-security-transferred-_id_698868.html" xml:lang="eng"/>
	<parallel_text location="sirda-sihkarvuoaovddasvastadusa-afganist_id_698868.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
