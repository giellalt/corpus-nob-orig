...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ad/dep/org/avdelinger/pa.html?id=975'"/>
<xsl:variable name="title" select="'Ealáhatossodat - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'279'"/>
...
<xsl:variable name="para_eng" select="'the-department-of-pension-policy.html?id=975'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Pensjonsavdelinga.html?id=975'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Ealahatossodat.html?id=975'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="the-department-of-pension-policy_id_975.html" xml:lang="eng"/>
	<parallel_text location="pensjonsavdelinga_id_975.html" xml:lang="nno"/>
	<parallel_text location="ealahatossodat_id_975.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
