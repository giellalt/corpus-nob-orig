...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/krd/dok/hoeringer/paa_hoering.html?id=1941'"/>
<xsl:variable name="title" select="'Áššit gulaskuddamis - regjeringen.no'"/>
...
<xsl:variable name="para_nno" select="'Saker-pa-hoyring.html?id=1941'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'SE_Saker-pa-horing.html?id=1941'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="saker-pa-hoyring_id_1941.html" xml:lang="nno"/>
	<parallel_text location="se_saker-pa-horing_id_1941.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
