...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/hod/tema/pasientinformasjon.html?id=86962'"/>
<xsl:variable name="title" select="'Divššohasdiehtojuohkin - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'patient-information.html?id=86962'"/>
...
<xsl:variable name="para_sme" select="'divohasdiehtojuohkin.html?id=86962'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="patient-information_id_86962.html" xml:lang="eng"/>
	<parallel_text location="divohasdiehtojuohkin_id_86962.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
