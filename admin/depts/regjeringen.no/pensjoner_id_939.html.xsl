...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ad/tema/pensjoner.html?id=939'"/>
<xsl:variable name="title" select="'Ealáhagat  - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'pensions.html?id=939'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'pensjoner.html?id=939'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Ealahagat-.html?id=939'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="pensions_id_939.html" xml:lang="eng"/>
	<parallel_text location="pensjoner_id_939.html" xml:lang="nno"/>
	<parallel_text location="ealahagat-_id_939.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
