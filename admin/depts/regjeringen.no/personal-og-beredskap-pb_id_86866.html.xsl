...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/nhd/dep/org/avdelinger/administrasjonsavdelingen/personal-og-beredskap-pb.html?id=86866'"/>
<xsl:variable name="title" select="'Bargit ja gearggusvuohta - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'human-resources-and-embergency-planning.html?id=86866'"/>
...
<xsl:variable name="para_sme" select="'Bargit-ja-gearggusvuohta.html?id=86866'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="human-resources-and-embergency-planning_id_86866.html" xml:lang="eng"/>
	<parallel_text location="bargit-ja-gearggusvuohta_id_86866.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
