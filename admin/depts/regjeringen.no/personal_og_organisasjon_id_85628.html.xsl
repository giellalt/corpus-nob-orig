...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/md/dep/org/avdelinger/organisasjon_okonomi/personal_og_organisasjon.html?id=85628'"/>
<xsl:variable name="title" select="'Bargiid- ja organisašunsekšuvdna - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'Section-for-Personnel-and-Organization-.html?id=85628'"/>
...
<xsl:variable name="para_sme" select="'Bargiid--ja-organisaunsekuvdna.html?id=85628'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="section-for-personnel-and-organization-_id_85628.html" xml:lang="eng"/>
	<parallel_text location="bargiid--ja-organisaunsekuvdna_id_85628.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
