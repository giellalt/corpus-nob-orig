...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/dep/underliggende-etater/personvernnemnda.html?id=373619'"/>
<xsl:variable name="title" select="'Persunsuodjaluslávdegoddi  - regjeringen.no'"/>
...
<xsl:variable name="para_sme" select="'persunsuodjaluslavdegoddi-.html?id=373619'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="persunsuodjaluslavdegoddi-_id_373619.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
