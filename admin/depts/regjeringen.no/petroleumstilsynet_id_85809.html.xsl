...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ad/dep/underliggende_etater/petroleumstilsynet.html?id=85809'"/>
<xsl:variable name="title" select="'Petroleabearráigeahčču - regjeringen.no'"/>
...
<xsl:variable name="para_sme" select="'Petroleabearraigeahu.html?id=85809'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="petroleabearraigeahu_id_85809.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
