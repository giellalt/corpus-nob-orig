...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ad/dep/org/avdelinger/pks.html?id=85803'"/>
<xsl:variable name="title" select="'Preassa- ja gulahallansekšuvdna  - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'the-press-and-communications-division.html?id=85803'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Presse--og-kommunikasjonsseksjonen.html?id=85803'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'preassa--ja-gulahallansekuvdna-.html?id=85803'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="the-press-and-communications-division_id_85803.html" xml:lang="eng"/>
	<parallel_text location="presse--og-kommunikasjonsseksjonen_id_85803.html" xml:lang="nno"/>
	<parallel_text location="preassa--ja-gulahallansekuvdna-_id_85803.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
