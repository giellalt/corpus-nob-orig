...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/bld/dep/org/avdelinger/pla.html?id=84'"/>
...
<xsl:variable name="para_eng" select="'Department-of-Planning-and-Administration.html?id=84'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Plan--og-administrasjonsavdelinga-.html?id=84'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Plana--ja-halddahusossodat.html?id=84'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="department-of-planning-and-administration_id_84.html" xml:lang="eng"/>
	<parallel_text location="plan--og-administrasjonsavdelinga-_id_84.html" xml:lang="nno"/>
	<parallel_text location="plana--ja-halddahusossodat_id_84.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
