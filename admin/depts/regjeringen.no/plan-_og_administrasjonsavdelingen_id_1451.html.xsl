...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/jd/dep/org/avdelinger/plan-_og_administrasjonsavdelingen.html?id=1451'"/>
<xsl:variable name="title" select="'Plána- ja hálddahusossodat - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'206'"/>
...
<xsl:variable name="para_eng" select="'The-Administrative-Affairs-Department.html?id=1451'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Plan--og-administrasjonsshyavdelinga.html?id=1451'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Plana--ja-halddahusossodat.html?id=1451'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="the-administrative-affairs-department_id_1451.html" xml:lang="eng"/>
	<parallel_text location="plan--og-administrasjonsshyavdelinga_id_1451.html" xml:lang="nno"/>
	<parallel_text location="plana--ja-halddahusossodat_id_1451.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
