...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/sd/dep/organisasjon/avdelinger/plan-_okonomi-_og_administrasjonsavdelin.html?id=1572'"/>
<xsl:variable name="title" select="'Plána-, ja ekonomija-, ja hálddahusossodat - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'department-of-planning-administration-an.html?id=1572'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="department-of-planning-administration-an_id_1572.html" xml:lang="eng"/>
	<parallel_text location="plan--okonomi--og-administrasjonsavdelin_id_1572.html" xml:lang="nno"/>
	<parallel_text location="plana--ja-ekonomija--ja-halddahusossodat_id_1572.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
