...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/md/dok/veiledninger/2009/planlegging-plan-bygningsloven.html?id=570991'"/>
<xsl:variable name="title" select="'T-1476 Planlegging etter Plan- og bygningsloven - regjeringen.no'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="planlegging-plan-bygningsloven_id_570991.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
