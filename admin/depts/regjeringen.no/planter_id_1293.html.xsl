...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/lmd/tema/planter.html?id=1293'"/>
<xsl:variable name="title" select="'Šattut  - regjeringen.no'"/>
...
<xsl:variable name="para_nno" select="'plantar.html?id=1293'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'attut-.html?id=1293'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="plantar_id_1293.html" xml:lang="nno"/>
	<parallel_text location="attut-_id_1293.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
