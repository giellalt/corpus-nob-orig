...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/md/tema/planlegging_plan-_og_bygningsloven/planveiledere.html?id=534064'"/>
<xsl:variable name="title" select="'Veiledning om plan- og bygningsloven og forskrifter - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'928'"/>
