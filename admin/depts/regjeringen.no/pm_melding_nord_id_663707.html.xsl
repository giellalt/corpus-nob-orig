...
<xsl:variable name="para_eng" select="'goals_high_north.html_id=663707'"/>
...
<xsl:variable name="para_sme" select="'nord_samisk.html_id=663707'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="goals_high_north_id_663707.html" xml:lang="eng"/>
	<parallel_text location="nord_samisk_id_663707.html" xml:lang="sme"/>
