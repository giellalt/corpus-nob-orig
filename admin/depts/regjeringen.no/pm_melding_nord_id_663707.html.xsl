...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ud/pressesenter/pressemeldinger/2011/pm_melding_nord.html?id=663707'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'- Mearridan gudneáŋgiris ulbmiliid davviguovlluide - regjeringen.no'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="goals_high_north_id_663707.html"/>
        ...
        <parallel_text xml:lang="nno" location="fullmakt-til-opptak-av-statslan-i-2012_id_663572.html"/>
        <parallel_text xml:lang="nob" location=""/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location=""/>
        <parallel_text xml:lang="sme" location="nord_samisk_id_663707.html"/>
