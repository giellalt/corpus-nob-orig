...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/jd/dep/org/avdelinger/polaravdelingen.html?id=1447'"/>
<xsl:variable name="title" select="'Polarossodat - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'The-Polar-Affairs-Department.html?id=1447'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Polaravdelinga.html?id=1447'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Polarossodat.html?id=1447'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="the-polar-affairs-department_id_1447.html" xml:lang="eng"/>
	<parallel_text location="polaravdelinga_id_1447.html" xml:lang="nno"/>
	<parallel_text location="polarossodat_id_1447.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
