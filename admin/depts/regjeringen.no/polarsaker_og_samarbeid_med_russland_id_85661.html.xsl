...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/md/dep/org/avdelinger/internasjonalt_samarbeid/polarsaker_og_samarbeid_med_russland.html?id=85661'"/>
<xsl:variable name="title" select="'Polaráššiid sekšuvdna ja ovttasbargu Ruoššain - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'224'"/>
...
<xsl:variable name="para_eng" select="'polar-affairs-cooperation-russia.html?id=85661'"/>
...
<xsl:variable name="para_sme" select="'polaraiid-sekuvdna-ja-ovttasbargu-ruoain.html?id=85661'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="polar-affairs-cooperation-russia_id_85661.html" xml:lang="eng"/>
	<parallel_text location="polaraiid-sekuvdna-ja-ovttasbargu-ruoain_id_85661.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
