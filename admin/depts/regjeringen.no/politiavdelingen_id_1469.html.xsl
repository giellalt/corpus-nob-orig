...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/jd/dep/org/avdelinger/politiavdelingen.html?id=1469'"/>
<xsl:variable name="title" select="'Politiijaossodat  - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'202'"/>
...
<xsl:variable name="para_eng" select="'the-police-departement.html?id=1469'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Politiavdelinga.html?id=1469'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Politiijaossodat-.html?id=1469'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="the-police-departement_id_1469.html" xml:lang="eng"/>
	<parallel_text location="politiavdelinga_id_1469.html" xml:lang="nno"/>
	<parallel_text location="politiijaossodat-_id_1469.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
