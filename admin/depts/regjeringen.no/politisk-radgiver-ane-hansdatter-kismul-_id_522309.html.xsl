...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/lmd/dep/politisk_ledelse/politisk-radgiver-ane-hansdatter-kismul-.html?id=522309'"/>
<xsl:variable name="title" select="'Politihkalaš ráđđeaddi Ane Hansdatter Kismul  - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'political-advisor-ane-hansdatter-kismul-.html?id=522309'"/>
...
<xsl:variable name="para_sme" select="'politihkala-raeaddi-ane-hansdatter-kismu.html?id=522309'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="political-advisor-ane-hansdatter-kismul-_id_522309.html" xml:lang="eng"/>
	<parallel_text location="politihkala-raeaddi-ane-hansdatter-kismu_id_522309.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
