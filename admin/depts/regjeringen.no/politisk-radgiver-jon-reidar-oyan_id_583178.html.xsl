...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ad/dep/politisk_ledelse/politisk-radgiver-jon-reidar-oyan.html?id=583178'"/>
<xsl:variable name="title" select="'Politihkalaš ráđđeaddi Jon Reidar Øyan - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'political-adviser-jon-reidar-oyan.html?id=583178'"/>
...
<xsl:variable name="para_sme" select="'politihkala-raeaddi-jon-reidar-oyan.html?id=583178'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="political-adviser-jon-reidar-oyan_id_583178.html" xml:lang="eng"/>
	<parallel_text location="politihkala-raeaddi-jon-reidar-oyan_id_583178.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
