...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/kud/dep/politisk_ledelse/politisk-radgiver-roger-remme-solheim.html?id=583029'"/>
<xsl:variable name="title" select="'Politihkalaš ráđđeaddin Roger Remme Solheim - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'376'"/>
...
<xsl:variable name="para_eng" select="'political-adviser-roger-remme-solheim.html?id=583029'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'politisk-radgivar-roger-remme-solheim.html?id=583029'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'politihkala-raeaddi-roger-remme-solheim.html?id=583029'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="political-adviser-roger-remme-solheim_id_583029.html" xml:lang="eng"/>
	<parallel_text location="politisk-radgivar-roger-remme-solheim_id_583029.html" xml:lang="nno"/>
	<parallel_text location="politihkala-raeaddi-roger-remme-solheim_id_583029.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
