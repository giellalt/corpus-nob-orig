...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/sd/dep/politisk_ledelse/politisk-radgiver-sigrid-brattabo-handeg.html?id=586858'"/>
<xsl:variable name="title" select="'Politihkalaš ráđđeaddi Sigrid Brattabø Handegard - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'284'"/>
...
<xsl:variable name="para_eng" select="'political-adviser-sigrid-brattabo-handeg.html?id=586858'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'politisk-radgijevar-sigrid-brattabo-hand.html?id=586858'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'politihkala-raeaddi-sigrid-brattabo-hand.html?id=586858'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="political-adviser-sigrid-brattabo-handeg_id_586858.html" xml:lang="eng"/>
	<parallel_text location="politisk-radgijevar-sigrid-brattabo-hand_id_586858.html" xml:lang="nno"/>
	<parallel_text location="politihkala-raeaddi-sigrid-brattabo-hand_id_586858.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
