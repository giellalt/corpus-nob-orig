...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/dep/politisk_ledelse/politisk-radgiver-trond-blattmann.html?id=582839'"/>
<xsl:variable name="title" select="'Politihkalaš ráđđeaddi Trond Blattmann - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'189'"/>
...
<xsl:variable name="para_eng" select="'political-adviser-trond-blattmann.html?id=582839'"/>
...
<xsl:variable name="para_sme" select="'Politihkala-raeaddi-Trond-Blattmann.html?id=582839'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="political-adviser-trond-blattmann_id_582839.html" xml:lang="eng"/>
	<parallel_text location="politihkala-raeaddi-trond-blattmann_id_582839.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
