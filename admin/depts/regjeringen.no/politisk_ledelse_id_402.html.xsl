...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fd/dep/politisk_ledelse.html?id=402'"/>
...
<xsl:variable name="para_eng" select="'Other-political-staff.html?id=402'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Anna-politisk-leiing.html?id=402'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Eara-politihkala-njunnoat.html?id=402'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="other-political-staff_id_402.html" xml:lang="eng"/>
	<parallel_text location="anna-politisk-leiing_id_402.html" xml:lang="nno"/>
	<parallel_text location="eara-politihkala-njunnoat_id_402.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
