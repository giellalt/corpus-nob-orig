...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/oed/dep/politisk_ledelse.html?id=772'"/>
<xsl:variable name="title" select="'Politihkalaš jođihus muđui - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'151'"/>
...
<xsl:variable name="para_eng" select="'Other-political-Staff.html?id=772'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'anna-politisk-leiing.html?id=772'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Politihkala-joihus-muui.html?id=772'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="other-political-staff_id_772.html" xml:lang="eng"/>
	<parallel_text location="anna-politisk-leiing_id_772.html" xml:lang="nno"/>
	<parallel_text location="politihkala-joihus-muui_id_772.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
