...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/smk/statsministerens-kontor/politisk_ledelse.html?id=897'"/>
<xsl:variable name="title" select="'Politihkalaš mieldebargit - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'245'"/>
...
<xsl:variable name="para_eng" select="'political-staff.html?id=897'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Politiske-medarbeidarar.html?id=897'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Politihkala-mieldebargit.html?id=897'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="political-staff_id_897.html" xml:lang="eng"/>
	<parallel_text location="politiske-medarbeidarar_id_897.html" xml:lang="nno"/>
	<parallel_text location="politihkala-mieldebargit_id_897.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
