...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/smk/statsministerens-kontor/politisk_ledelse/politisk_radgiver_mina_gerhardsen.html?id=85879'"/>
<xsl:variable name="title" select="'Stáhtačálli Mina Gerhardsen - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'147'"/>
...
<xsl:variable name="para_eng" select="'political-advisor-mina-gerhardsen.html?id=85879'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'politisk-radgjevar-mina-gerhardsen.html?id=85879'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'politihkala-raeaddi-mina-gerhardsen.html?id=85879'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="political-advisor-mina-gerhardsen_id_85879.html" xml:lang="eng"/>
	<parallel_text location="politisk-radgjevar-mina-gerhardsen_id_85879.html" xml:lang="nno"/>
	<parallel_text location="politihkala-raeaddi-mina-gerhardsen_id_85879.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
