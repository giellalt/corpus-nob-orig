...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="a-positive-attitude-towards-labour-migra_id_508327.html"/>
        ...
        <parallel_text xml:lang="sme" location="positiiva-oaidnu-bargosisfarremii_id_508327.html"/>
