...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ad/pressesenter/pressemeldinger/2008/positiv-holdning-til-arbeidsinnvandring.html?id=508327'"/>
<xsl:variable name="title" select="'Positiiva oaidnu bargosisfárremii - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'543'"/>
...
<xsl:variable name="para_eng" select="'a-positive-attitude-towards-labour-migra.html?id=508327'"/>
...
<xsl:variable name="para_sme" select="'positiiva-oaidnu-bargosisfarremii.html?id=508327'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="a-positive-attitude-towards-labour-migra_id_508327.html" xml:lang="eng"/>
	<parallel_text location="positiiva-oaidnu-bargosisfarremii_id_508327.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
