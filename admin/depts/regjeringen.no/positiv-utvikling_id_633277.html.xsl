...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/pressesenter/pressemeldinger/2011/positiv-utvikling.html?id=633277'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Positiiva ovdáneapmi, muhto sámegielaid dilli lea ain duođalaš - regjeringen.no'"/>
...
<<<<<<< HEAD
<xsl:variable name="wordcount" select="'1063'"/>
=======
<xsl:variable name="wordcount" select="'1070'"/>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
...
<xsl:variable name="para_sme" select="'positiiva-ovdaneapmi.html?id=633277'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="positiiva-ovdaneapmi_id_633277.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
