...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/sd/dep/organisasjon/avdelinger/luft--post--og-teleavdelingen/post--og-teleseksjonen-pts.html?id=332353'"/>
<xsl:variable name="title" select="'Poasta- ja telesekšuvdna - regjeringen.no'"/>
...
<xsl:variable name="para_nno" select="'Post--og-teleseksjonen-PTS.html?id=332353'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Poasta--ja-telesekuvdna.html?id=332353'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="post--og-teleseksjonen-pts_id_332353.html" xml:lang="nno"/>
	<parallel_text location="poasta--ja-telesekuvdna_id_332353.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
