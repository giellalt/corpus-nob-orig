...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/nhd/pressesenter/pressemeldinger/2010-2/Presidentbesoket-Norge-klar-til-a-starte-handelsavtaleforhandlinger-med-Russland.html?id=601877'"/>
<xsl:variable name="title" select="'Presideantagalledeapmi: Norga lea válmmaš siehtadallagoahtit gávpesoahpamuša Ruoššain - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'Norway-ready-to-start-negotiations-with-Russia.html?id=601877'"/>
...
<xsl:variable name="para_sme" select="'Presideantagalledeapmi-Norga-lea-valmma-siehtadallagoahtit-gavpesoahpamua-Ruoain.html?id=601877'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="norway-ready-to-start-negotiations-with-russia_id_601877.html" xml:lang="eng"/>
	<parallel_text location="presideantagalledeapmi-norga-lea-valmma-siehtadallagoahtit-gavpesoahpamua-ruoain_id_601877.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
