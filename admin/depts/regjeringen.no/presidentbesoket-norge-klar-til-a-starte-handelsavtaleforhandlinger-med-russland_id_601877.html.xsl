...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="author1_ln" select="'Nærings- og handelsdepartementet'"/>
    <!-- m, f or unknown -->
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="norway-ready-to-start-negotiations-with-russia_id_601877.html"/>
        ...
        <parallel_text xml:lang="sme" location="presideantagalledeapmi-norga-lea-valmma-siehtadallagoahtit-gavpesoahpamua-ruoain_id_601877.html"/>
