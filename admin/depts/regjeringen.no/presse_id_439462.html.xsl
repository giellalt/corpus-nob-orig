...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/presse.html?id=439462'"/>
...
<xsl:variable name="para_nno" select="'presse.html?id=439462'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Preassaguovdda.html?id=439462'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="presse_id_439462.html" xml:lang="nno"/>
	<parallel_text location="preassaguovdda_id_439462.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
