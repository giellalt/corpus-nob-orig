...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/smk/pressesenter/pressekontakter.html?id=87090'"/>
<xsl:variable name="title" select="'Preassaoktavuođat - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'press-contacts.html?id=87090'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Pressekontaktar.html?id=87090'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Preassaoktavuoat.html?id=87090'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="press-contacts_id_87090.html" xml:lang="eng"/>
	<parallel_text location="pressekontaktar_id_87090.html" xml:lang="nno"/>
	<parallel_text location="preassaoktavuoat_id_87090.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
