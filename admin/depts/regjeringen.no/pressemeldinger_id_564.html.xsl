...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/kud/pressesenter/pressemeldinger.html?id=564'"/>
...
<xsl:variable name="wordcount" select="'1426'"/>
...
<xsl:variable name="para_nno" select="'pressemeldingar.html?id=564'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Preassadieahus.html?id=564'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="pressemeldingar_id_564.html" xml:lang="nno"/>
	<parallel_text location="preassadieahus_id_564.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
