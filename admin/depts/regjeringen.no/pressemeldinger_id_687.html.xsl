...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/md/pressesenter/pressemeldinger.html?id=687'"/>
...
<xsl:variable name="para_eng" select="'Press-releases.html?id=687'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Pressemeldingar.html?id=687'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Preassadieahusat.html?id=687'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="press-releases_id_687.html" xml:lang="eng"/>
	<parallel_text location="pressemeldingar_id_687.html" xml:lang="nno"/>
	<parallel_text location="preassadieahusat_id_687.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
