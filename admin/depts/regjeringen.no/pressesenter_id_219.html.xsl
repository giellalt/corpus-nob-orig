...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fin/pressesenter.html?id=219'"/>
...
<xsl:variable name="para_eng" select="'press-center.html?id=219'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'pressesenter.html?id=219'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Preassaguovdda.html?id=219'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="press-center_id_219.html" xml:lang="eng"/>
	<parallel_text location="pressesenter_id_219.html" xml:lang="nno"/>
	<parallel_text location="preassaguovdda_id_219.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
