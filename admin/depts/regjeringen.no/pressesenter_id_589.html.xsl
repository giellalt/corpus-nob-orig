...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/kd/pressesenter.html?id=589'"/>
<xsl:variable name="title" select="'Pressesenter - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'press-contacts.html?id=589'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Pressesenter.html?id=589'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="press-contacts_id_589.html" xml:lang="eng"/>
	<parallel_text location="pressesenter_id_589.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
