...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/smk/pressesenter.html?id=878'"/>
<xsl:variable name="title" select="'Preassaguovddáš - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'144'"/>
...
<xsl:variable name="para_eng" select="'press-center.html?id=878'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'pressesenter.html?id=878'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'preassaguovdda.html?id=878'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="press-center_id_878.html" xml:lang="eng"/>
	<parallel_text location="pressesenter_id_878.html" xml:lang="nno"/>
	<parallel_text location="preassaguovdda_id_878.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
