...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/kud/pressesenter/pressemeldinger/2012/pressestotte-blir-mediestotte.html?id=677308'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Preassadoarjja nuppástuvvo mediadoarjjan - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'282'"/>
...
<xsl:variable name="para_eng" select="'long-term-good-management-of-our-common-.html_id=677408'"/>
...
<xsl:variable name="para_sme" select="'preassadoarjja-nuppastuvvo-mediadoarjjan.html_id=677308'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="preassadoarjja-nuppastuvvo-mediadoarjjan_id_677308.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
