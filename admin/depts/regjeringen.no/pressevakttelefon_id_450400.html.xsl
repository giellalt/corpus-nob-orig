...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fkd/pressesenter/pressemeldinger/2007/pressevakttelefon.html?id=450400'"/>
<xsl:variable name="title" select="'Preassafáktatelefuvdna - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'184'"/>
...
<xsl:variable name="para_eng" select="'Media-contact-line.html?id=450400'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Pressevakttelefon.html?id=450400'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'-Preassafaktatelefuvdna.html?id=450400'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="media-contact-line_id_450400.html" xml:lang="eng"/>
	<parallel_text location="pressevakttelefon_id_450400.html" xml:lang="nno"/>
	<parallel_text location="preassafaktatelefuvdna_id_450400.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
