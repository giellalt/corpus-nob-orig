...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dok/regpubl/prop.html?id=1753'"/>
<xsl:variable name="title" select="'Proposišuvnnat Stuorradiggái - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'465'"/>
...
<xsl:variable name="para_nno" select="'prop.html?id=1753'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'odeldiggeproposiuvnnat.html?id=1753'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="prop_id_1753.html" xml:lang="nno"/>
	<parallel_text location="odeldiggeproposiuvnnat_id_1753.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
