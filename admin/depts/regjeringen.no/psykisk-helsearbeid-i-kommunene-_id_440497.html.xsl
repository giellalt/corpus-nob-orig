...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/hod/tema/psykisk_helse/psykisk-helsearbeid-i-kommunene-.html?id=440497'"/>
<xsl:variable name="title" select="'Psykalaš dearvvašvuođadoaibma gielddain - regjeringen.no'"/>
...
<xsl:variable name="para_sme" select="'psykala-dearvvavuoadoaibma-gielddain.html?id=440497'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="psykala-dearvvavuoadoaibma-gielddain_id_440497.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
