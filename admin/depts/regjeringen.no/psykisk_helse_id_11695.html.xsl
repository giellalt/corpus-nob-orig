...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/hod/tema/psykisk_helse.html?id=11695'"/>
<xsl:variable name="title" select="'Psykalaš dearvvašvuohta - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'psychiatric-health.html?id=11695'"/>
...
<xsl:variable name="para_sme" select="'psykala-dearvvavuohta.html?id=11695'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="psychiatric-health_id_11695.html" xml:lang="eng"/>
	<parallel_text location="psykala-dearvvavuohta_id_11695.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
