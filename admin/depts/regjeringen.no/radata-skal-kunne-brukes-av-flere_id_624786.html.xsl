...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/pressesenter/pressemeldinger/2010/radata-skal-kunne-brukes-av-flere.html?id=624786'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Vuođđodieđuid galget eanet sáhttit geavahit - regjeringen.no'"/>
...
<xsl:variable name="para_nno" select="'radata-skal-kunne-nyttast-av-fleire.html?id=624786'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="radata-skal-kunne-nyttast-av-fleire_id_624786.html" xml:lang="nno"/>
	<parallel_text location="vuoodieuid-galget-eanet-sahttit-geavahit_id_624786.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
