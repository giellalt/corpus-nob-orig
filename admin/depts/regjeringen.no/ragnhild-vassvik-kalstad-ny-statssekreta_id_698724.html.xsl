...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/pressesenter/pressemeldinger/2012/ragnhild-vassvik-kalstad-ny-statssekreta.html?id=698724'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Ragnhild Vassvik Kalstad OHD ođđa stáhtačálli - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'253'"/>
...
<xsl:variable name="para_eng" select="'co2.html_id=698862'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'ragnhild-vassvik-kalstad-ny-statssekreta.html_id=698724'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'ragnhild-vassvik-kalstad-ohd-oa-stahtaal.html_id=698724'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="co2.html_id=698862" xml:lang="eng"/>
	<parallel_text location="ragnhild-vassvik-kalstad-ny-statssekreta_id_698724.html" xml:lang="nno"/>
	<parallel_text location="ragnhild-vassvik-kalstad-ohd-oa-stahtaal_id_698724.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
