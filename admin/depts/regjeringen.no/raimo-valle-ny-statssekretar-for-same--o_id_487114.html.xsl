...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ad/pressesenter/pressemeldinger/2007/raimo-valle-ny-statssekretar-for-same--o.html?id=487114'"/>
<xsl:variable name="title" select="'Raimo Valle sáme- ja minoritehtaáššiid ođđa stáhtačálli  - regjeringen.no'"/>
...
<xsl:variable name="para_sme" select="'Raimo-Valle-same--ja-minoritehtaaiid-oa-.html?id=487114'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="raimo-valle-same--ja-minoritehtaaiid-oa-_id_487114.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
