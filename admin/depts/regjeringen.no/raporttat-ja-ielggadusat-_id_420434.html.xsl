...
<xsl:variable name="filename" select="'http://regjeringen.no/se/dep/aid/Dokumeanttat-/Raporttat-ja-planat/Raporttat-/2006/raporttat-ja-ielggadusat-.html?id=420434'"/>
<xsl:variable name="title" select="'Raporttat ja čielggadusat  - regjeringen.no'"/>
