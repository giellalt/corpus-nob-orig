...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ad/dok/rapporter_planer/rapporter.html?id=1793'"/>
...
<xsl:variable name="para_nno" select="'rapportar.html?id=1793'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Raporttat-.html?id=1793'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="rapportar_id_1793.html" xml:lang="nno"/>
	<parallel_text location="raporttat-_id_1793.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
