...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/krd/dok/rapporter_planer/rapporter.html?id=1946'"/>
<xsl:variable name="title" select="'Raporttat - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'reports.html?id=1946'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'rapportar.html?id=1946'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Raporttat.html?id=1946'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="rapporter_id_1946.html" xml:lang="eng"/>
	<parallel_text location="rapportar_id_1946.html" xml:lang="nno"/>
	<parallel_text location="raporttat_id_1946.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
