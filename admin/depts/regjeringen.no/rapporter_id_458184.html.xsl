...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/krd/kampanjer/valg/for-valgmedarbeidere/rapporter.html?id=458184'"/>
...
<xsl:variable name="para_nno" select="'rapporter.html?id=458184'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="rapporter_id_458184.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
