...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ad/dok/rapporter_planer.html?id=270416'"/>
...
<xsl:variable name="wordcount" select="'199'"/>
...
<xsl:variable name="para_nno" select="'rapportar-og-planer.html?id=270416'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Raporttat-ja-planat.html?id=270416'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="rapportar-og-planer_id_270416.html" xml:lang="nno"/>
	<parallel_text location="raporttat-ja-planat_id_270416.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
