...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/krd/dok/rapporter_planer.html?id=272527'"/>
...
<xsl:variable name="para_eng" select="'rapporter.html?id=1946'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Rapportar-og-planar.html?id=272527'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Raporttat-ja-planat.html?id=272527'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="rapporter.html_id=1946" xml:lang="eng"/>
	<parallel_text location="rapportar-og-planar_id_272527.html" xml:lang="nno"/>
	<parallel_text location="raporttat-ja-planat_id_272527.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
