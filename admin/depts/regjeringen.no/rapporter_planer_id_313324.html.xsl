...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/bld/dok/rapporter_planer.html?id=313324'"/>
<xsl:variable name="title" select="'Raporttat ja plánat - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'Reports-and-plans.html?id=313324'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Rapportar-og-planar.html?id=313324'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Raporttat-ja-planat.html?id=313324'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="reports-and-plans_id_313324.html" xml:lang="eng"/>
	<parallel_text location="rapportar-og-planar_id_313324.html" xml:lang="nno"/>
	<parallel_text location="raporttat-ja-planat_id_313324.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
