...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dok/rapporter_planer.html?id=438817'"/>
...
<xsl:variable name="para_eng" select="'Reports-and-plans.html?id=438817'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'rapportar-og-planar.html?id=438817'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Raporttat-ja-planat.html?id=438817'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="reports-and-plans_id_438817.html" xml:lang="eng"/>
	<parallel_text location="rapportar-og-planar_id_438817.html" xml:lang="nno"/>
	<parallel_text location="raporttat-ja-planat_id_438817.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
