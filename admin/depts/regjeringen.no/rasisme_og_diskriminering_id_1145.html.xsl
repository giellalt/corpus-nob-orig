...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/bld/tema/rasisme_og_diskriminering.html?id=1145'"/>
<xsl:variable name="title" select="'Čearddalaš vealaheapmi - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'ethnic-discrimination.html?id=1145'"/>
...
<xsl:variable name="para_sme" select="'earddala-vealaheapmi.html?id=1145'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="ethnic-discrimination_id_1145.html" xml:lang="eng"/>
	<parallel_text location="earddala-vealaheapmi_id_1145.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
