...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/jd/dep/org/avdelinger/rednings-_og_beredskapsshyavdelingen_.html?id=1470'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Gádjun- ja válmmastanossodat  - regjeringen.no'"/>
    <!--
        Information of the first author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author1_fn" select="''"/>
    <xsl:variable name="author1_ln" select="'Justis- og politidepartementet'"/>
    <!-- m, f or unknown -->
    ...
    <xsl:variable name="wordcount" select="'214'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="rescue-and-emergency-planning-department_id_1470.html"/>
        ...
        <parallel_text xml:lang="nno" location="rednings--og-beredskapsavdelinga_id_1470.html"/>
        <parallel_text xml:lang="nob" location=""/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location=""/>
        <parallel_text xml:lang="sme" location="gadjun--ja-valmmastanossodat-_id_1470.html"/>
