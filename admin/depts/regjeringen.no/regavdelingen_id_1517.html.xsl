...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ud/dep/org/avdelinger/regavdelingen.html?id=1517'"/>
<xsl:variable name="title" select="'Regionála gažaldagaid ja ovdáneami ossodat - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'reg.html?id=1517'"/>
...
<xsl:variable name="para_sme" select="'Regionala-gaaldagaid-ja-ovdaneami-ossodat.html?id=1517'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="reg_id_1517.html" xml:lang="eng"/>
	<parallel_text location="regionala-gaaldagaid-ja-ovdaneami-ossodat_id_1517.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
