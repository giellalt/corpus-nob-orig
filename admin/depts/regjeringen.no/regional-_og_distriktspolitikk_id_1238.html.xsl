...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/krd/tema/regional-_og_distriktspolitikk.html?id=1238'"/>
<xsl:variable name="title" select="'Guovllu- ja regionálapolitihkka - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'rural-and-regional-policy.html?id=1238'"/>
...
<xsl:variable name="para_sme" select="'guovllu--ja-regionalapolitihkka.html?id=1238'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="rural-and-regional-policy_id_1238.html" xml:lang="eng"/>
	<parallel_text location="guovllu--ja-regionalapolitihkka_id_1238.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
