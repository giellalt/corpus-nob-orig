...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/md/dep/org/avdelinger/regional_planlegging.html?id=1214'"/>
<xsl:variable name="title" select="'Regiunála plánema lávdegoddi  - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'department-for-regional-planning.html?id=1214'"/>
...
<xsl:variable name="para_sme" select="'Regiunala-planema-lavdegoddi-.html?id=1214'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="department-for-regional-planning_id_1214.html" xml:lang="eng"/>
	<parallel_text location="regiunala-planema-lavdegoddi-_id_1214.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
