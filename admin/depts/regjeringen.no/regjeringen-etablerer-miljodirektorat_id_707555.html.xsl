...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/md/pressesenter/pressemeldinger/2012/regjeringen-etablerer-miljodirektorat.html?id=707555'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Ráđđehus ásaha Birasdirektoráhta - regjeringen.no'"/>
...
<xsl:variable name="para_sme" select="'raehus-asaha-birasdirektorahta.html_id=707555'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="new-directorate-environment_id_707555.html" xml:lang="eng"/>
	<parallel_text location="raehus-asaha-birasdirektorahta_id_707555.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
