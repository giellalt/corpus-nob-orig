...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/kmd/pressesenter/pressemeldinger/2014/Regjeringen-foreslar-at-flere-kommuner-far-differensiert-arbeidsgiveravgift-.html?id=753007'"/>
...
<xsl:variable name="para_sma" select="'Reerenasse-raereste-jienebh-tjielth-joekehtamme-barkoevedtijemaaksoem-aadtjoeh.html_id=753007'"/>
...
<xsl:variable name="parallels">
	...
	<parallel_text location="reerenasse-raereste-jienebh-tjielth-joekehtamme-barkoevedtijemaaksoem-aadtjoeh_id_753007.html" xml:lang="sma"/>
