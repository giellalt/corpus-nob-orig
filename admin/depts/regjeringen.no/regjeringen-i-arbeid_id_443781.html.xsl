...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/om_regjeringen/regjeringen-i-arbeid.html?id=443781'"/>
<xsl:variable name="title" select="'Ráđđehusa bargu - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'the-government-at-work.html?id=443781'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Slik-arbeider-regjeringa.html?id=443781'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Raehusa-bargu.html?id=443781'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="the-government-at-work_id_443781.html" xml:lang="eng"/>
	<parallel_text location="slik-arbeider-regjeringa_id_443781.html" xml:lang="nno"/>
	<parallel_text location="raehusa-bargu_id_443781.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
