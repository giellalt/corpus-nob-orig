...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fin/pressesenter/pressemeldinger/2012/regjeringen-investerer-i-velferd-og-arbe.html?id=704074'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Ráđđehus investere čálgui ja bargui - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'988'"/>
...
<xsl:variable name="para_nno" select="'regjeringa-investerer-i-velferd-og-arbei.html_id=704074'"/>
...
<xsl:variable name="parallels">
	...
	<parallel_text location="regjeringa-investerer-i-velferd-og-arbei_id_704074.html" xml:lang="nno"/>
	<parallel_text location="raehus-investere-algui-ja-bargui_id_704074.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
