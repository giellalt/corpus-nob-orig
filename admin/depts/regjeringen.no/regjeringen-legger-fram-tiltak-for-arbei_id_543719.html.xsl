...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/smk/pressesenter/pressemeldinger/2009/regjeringen-legger-fram-tiltak-for-arbei.html?id=543719'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="norways-government-presents-measures-to-_id_543719.html"/>
        ...
        <parallel_text xml:lang="sme" location="raehus-bidja-ovdan-doaibmabijuid-bargosa_id_543719.html"/>
