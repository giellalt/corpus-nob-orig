...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/pressesenter/pressemeldinger/2011/regjeringen-prioriterer-utviklingen-av-d.html?id=659582'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="nok-56-billion-for-municipal-interaction_id_657073.html"/>
        ...
        <parallel_text xml:lang="nno" location="komm-pressemelding-1-3_id_657120.html"/>
        ...
        <parallel_text xml:lang="smj" location="raehus-vuoruha-digitala-balvalusaid-ovdd_id_659582.html"/>
