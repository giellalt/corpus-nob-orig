...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ad/pressesenter/pressemeldinger/2008/regjeringen-utarbeider-handlingsplan-for.html?id=514922'"/>
<xsl:variable name="title" select="'Ráđđehus ráhkadahttá sámegiela doaibmaplána   - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'512'"/>
...
<xsl:variable name="para_sme" select="'raehus-rahkadahtta-samegiela-doaibmaplan.html?id=514922'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="raehus-rahkadahtta-samegiela-doaibmaplan_id_514922.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
