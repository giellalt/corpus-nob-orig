...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/kud/pressesenter/pressemeldinger/2013/regjeringen-vil-foresla-stotte-til-sykke.html?id=747976'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Ráđđehus árvala doarjut sihkkel- MM Bergenis jagi 2017:s - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'399'"/>
...
<xsl:variable name="para_nno" select="'fjordfiskenemnda-blir-oppretta.html_id=747988'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'raehus-arvala-doarjut-sihkkel--mm-bergen.html_id=747976'"/>
