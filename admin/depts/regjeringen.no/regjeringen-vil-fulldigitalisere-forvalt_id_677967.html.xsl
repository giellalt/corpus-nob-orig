...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/pressesenter/pressemeldinger/2012/regjeringen-vil-fulldigitalisere-forvalt.html?id=677967'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Ráđđehus áigu ollásit digitaliseret hálddašeami - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'529'"/>
...
<xsl:variable name="para_sme" select="'raehus-aigu-ollasit-digitaliseret-haldda.html_id=677967'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="public-administration-to-be-fully-digita_id_677967.html" xml:lang="eng"/>
	<parallel_text location="raehus-aigu-ollasit-digitaliseret-haldda_id_677967.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
