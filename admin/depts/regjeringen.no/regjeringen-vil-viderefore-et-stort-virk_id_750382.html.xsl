...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/kmd/pressesenter/pressemeldinger/2014/regjeringen-vil-viderefore-et-stort-virk.html?id=750382'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Ráđđehus dáhttu joatkit investerendoarjagiidda gullevaš doaibmaguovllu Norgga doaresbealguovlluin.   - regjeringen.no'"/>
    <!--
