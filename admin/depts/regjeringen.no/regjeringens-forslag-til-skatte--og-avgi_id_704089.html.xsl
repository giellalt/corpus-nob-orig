...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fin/pressesenter/pressemeldinger/2012/regjeringens-forslag-til-skatte--og-avgi.html?id=704089'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Ráđđehusa 2013 vearro- ja divatárvalus  - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'1751'"/>
...
<xsl:variable name="para_nno" select="'regjeringa-sitt-framlegg-til-skatte--og-.html_id=704089'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="'raavrevijhke-saemien-gielen-reeremedajve.html_id=704691'"/>
<xsl:variable name="para_sme" select="'raehusa-2013-vearro--ja-divatarvalus-.html_id=704089'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="regjeringa-sitt-framlegg-til-skatte--og-_id_704089.html" xml:lang="nno"/>
	<parallel_text location="raehusa-2013-vearro--ja-divatarvalus-_id_704089.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
