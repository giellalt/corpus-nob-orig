...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/aktuelt/taler_og_artikler/av_ovrig_politisk_ledelse/taler-og-artikler-av-statssekretar-raimo/2010/regjeringens-innsats-for-samiske-sprak.html?id=622466'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Ráđđehusa áŋgiruššan sámi gielaid ovddas - regjeringen.no'"/>
...
<<<<<<< HEAD
<xsl:variable name="wordcount" select="'1705'"/>
=======
<xsl:variable name="wordcount" select="'1740'"/>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
...
<xsl:variable name="para_sme" select="'raehusa-agiruan-sami-gielaid-ovddas.html?id=622466'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="raehusa-agiruan-sami-gielaid-ovddas_id_622466.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
