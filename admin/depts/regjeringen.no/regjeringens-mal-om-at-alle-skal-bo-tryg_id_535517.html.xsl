...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/krd/tema/bolig-_og_bygningspolitikk/boligsosialt_arbeid/regjeringens-mal-om-at-alle-skal-bo-tryg.html?id=535517'"/>
<xsl:variable name="title" select="'Ráđđehusa mihttomearri lea ahte buohkat galget ássat bures ja oadjebasat - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'343'"/>
...
<xsl:variable name="para_sme" select="'raehusa-mihttomearri-lea-ahte-buohkat-ga.html?id=535517'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="raehusa-mihttomearri-lea-ahte-buohkat-ga_id_535517.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
