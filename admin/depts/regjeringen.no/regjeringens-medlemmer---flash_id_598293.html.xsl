...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://regjeringen.no/nb/om_regjeringen/stoltenberg-ii/Regjeringens-medlemmer---flash.html?id=598293'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Ráđđehusa mieldelahtut - regjeringen.no'"/>
    <!--
    ...
    <xsl:variable name="wordcount" select="'137'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="Members-of-the-Government---flash.html?id=598293"/>
        ...
        <parallel_text xml:lang="sme" location="Raehusa-mieldelahtut.html?id=598293"/>
