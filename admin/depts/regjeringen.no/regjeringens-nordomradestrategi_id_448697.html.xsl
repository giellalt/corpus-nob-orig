...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ud/dok/rapporter_planer/planer/2006/regjeringens-nordomradestrategi.html?id=448697'"/>
<xsl:variable name="title" select="'Ráđđehusa davviguovlostrategiija - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'445'"/>
...
<xsl:variable name="para_eng" select="'strategy-for-the-high-north.html?id=448697'"/>
...
<xsl:variable name="para_sme" select="'strategi_samisk.html?id=448697'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="strategy-for-the-high-north_id_448697.html" xml:lang="eng"/>
	<parallel_text location="strategi_samisk_id_448697.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
