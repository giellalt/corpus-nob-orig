...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/smk/dok/regjeringens-tiltredelseserklaring.html?id=256201'"/>
<xsl:variable name="title" select="'Ráđđehusa álginjulggaštus - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'Inaugural-Address.html?id=256201'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Tiltredingserklaringa-for-regjeringa.html?id=256201'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Raehusa-alginjulggatus.html?id=256201'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="inaugural-address_id_256201.html" xml:lang="eng"/>
	<parallel_text location="tiltredingserklaringa-for-regjeringa_id_256201.html" xml:lang="nno"/>
	<parallel_text location="raehusa-alginjulggatus_id_256201.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
