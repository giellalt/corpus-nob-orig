...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/om_regjeringen/regjeringen-i-arbeid/regjeringskonferanse.html?id=270335'"/>
<xsl:variable name="title" select="'Ráđđehuskonferánsa - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'government-conferences.html?id=270335'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Regjeringskonferanse.html?id=270335'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Raehuskonferansa.html?id=270335'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="government-conferences_id_270335.html" xml:lang="eng"/>
	<parallel_text location="regjeringskonferanse_id_270335.html" xml:lang="nno"/>
	<parallel_text location="raehuskonferansa_id_270335.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
