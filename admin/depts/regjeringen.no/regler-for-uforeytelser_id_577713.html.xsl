...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ad/tema/pensjoner/uforepensjon/regler-for-uforeytelser.html?id=577713'"/>
<xsl:variable name="title" select="'Regler for uføreytelser - regjeringen.no'"/>
