...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dok/regpubl.html?id=1751'"/>
...
<xsl:variable name="para_nno" select="'proposisjonar-og-meldingar.html?id=1751'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'proposiuvnnat-ja-dieahusat-.html?id=1751'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="proposisjonar-og-meldingar_id_1751.html" xml:lang="nno"/>
	<parallel_text location="proposiuvnnat-ja-dieahusat-_id_1751.html" xml:lang="sme"/>
<parallel_text location="propositions-and-reports-_id_1751.html" xml:lang="eng"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
