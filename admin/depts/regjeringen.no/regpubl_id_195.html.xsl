...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ad/dok/regpubl.html?id=195'"/>
...
<xsl:variable name="para_nno" select="'proposisjonar-og-meldingar.html?id=195'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'proposiuvnnat-ja-dieahusat-.html?id=195'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="proposisjonar-og-meldingar_id_195.html" xml:lang="nno"/>
	<parallel_text location="proposiuvnnat-ja-dieahusat-_id_195.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
