...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/bld/dok/regpubl.html?id=328'"/>
...
<xsl:variable name="para_eng" select="'Propositions-and-reports.html?id=328'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'proposisjonar-og-meldingar.html?id=328'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'proposiuvnnat-ja-dieahusat.html?id=328'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="propositions-and-reports_id_328.html" xml:lang="eng"/>
	<parallel_text location="proposisjonar-og-meldingar_id_328.html" xml:lang="nno"/>
	<parallel_text location="proposiuvnnat-ja-dieahusat_id_328.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
