...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/dok/regpubl.html?id=369'"/>
...
<xsl:variable name="para_eng" select="'Government-propositions-and-reports-.html?id=369'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'proposisjonar-og-meldingar.html?id=369'"/>
...
<xsl:variable name="parallels">
	...
	<parallel_text location="proposisjonar-og-meldingar_id_369.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
