...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/krd/dok/regpubl.html?id=534'"/>
...
<xsl:variable name="wordcount" select="'256'"/>
...
<xsl:variable name="para_eng" select="'white.html?id=534'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'proposisjonar-og-meldingar.html?id=534'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'proposiuvnnat-ja-dieahusat-.html?id=534'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="white_id_534.html" xml:lang="eng"/>
	<parallel_text location="proposisjonar-og-meldingar_id_534.html" xml:lang="nno"/>
	<parallel_text location="proposiuvnnat-ja-dieahusat-_id_534.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
