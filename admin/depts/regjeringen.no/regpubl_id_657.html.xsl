...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/lmd/dok/regpubl.html?id=657'"/>
<xsl:variable name="title" select="'Proposisjoner og meldinger - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'propositions-and-reports.html?id=657'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'proposisjonar-og-meldingar.html?id=657'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="propositions-and-reports_id_657.html" xml:lang="eng"/>
	<parallel_text location="proposisjonar-og-meldingar_id_657.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
