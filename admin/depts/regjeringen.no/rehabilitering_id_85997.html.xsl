...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ad/tema/arbeidsmarkedspolitikk/midtspalte/rehabilitering.html?id=85997'"/>
<xsl:variable name="title" select="'Doaimmaidahttin  - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'rehabilitation.html?id=85997'"/>
...
<xsl:variable name="para_sme" select="'Doaimmaidahttin-.html?id=85997'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="rehabilitation_id_85997.html" xml:lang="eng"/>
	<parallel_text location="doaimmaidahttin-_id_85997.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
