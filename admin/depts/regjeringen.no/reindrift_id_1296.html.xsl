...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/lmd/tema/reindrift.html?id=1296'"/>
<xsl:variable name="title" select="'Boazodoallu - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'560'"/>
...
<xsl:variable name="para_nno" select="'reindrift.html?id=1296'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'boazodoallu.html?id=1296'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="reindrift_id_1296.html" xml:lang="nno"/>
	<parallel_text location="boazodoallu_id_1296.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
