...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/lmd/aktuelt/nyheter/2011/mars-11/reintallvedtak.html?id=635550'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Mearrádus Finnmárkku boazologuid birra - regjeringen.no'"/>
...
<xsl:variable name="para_sme" select="'mearradus-finnmarkku-boazologuid-birra.html_id=635550'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="mearradus-finnmarkku-boazologuid-birra_id_635550.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
