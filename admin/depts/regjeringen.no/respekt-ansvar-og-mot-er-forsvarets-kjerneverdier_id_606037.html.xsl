...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fd/aktuelt/taler_artikler/ministeren/taler-og-artikler-av-forsvarsminister-gr/2010/--Respekt-ansvar-og-mot-er-Forsvarets-kjerneverdier.html?id=606037'"/>
<<<<<<< HEAD
<xsl:variable name="title" select="'- Respekt, ansvar og mot er Forsvarets kjerneverdier - regjeringen.no'"/>
=======
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'- Áktejupmi, ovddasvástádus ja jálluvuohta leat suodjalusa guovddášárvvut - regjeringen.no'"/>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
...
<<<<<<< HEAD
<xsl:variable name="wordcount" select="'1456'"/>
<xsl:variable name="metadata" select="'uncomplete'"/>
<xsl:variable name="template_version" select="'$Revision$'"/>
=======
<xsl:variable name="wordcount" select="'1192'"/>
<xsl:variable name="metadata" select="'uncomplete'"/>
...
<xsl:variable name="para_sme" select="'--Aktejupmi-ovddasvastadus-ja-jalluvuohta-leat-suodjalusa-guovddaarvvut.html?id=606037'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="aktejupmi-ovddasvastadus-ja-jalluvuohta-leat-suodjalusa-guovddaarvvut_id_606037.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
