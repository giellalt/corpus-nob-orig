...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fkd/dep/org/avdelinger/ressurs-_og_havavdelingen.html?id=1582'"/>
<xsl:variable name="title" select="'Áhperesursa- ja ridduossodat - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'335'"/>
...
<xsl:variable name="para_eng" select="'department-of-marine-resources-and-envir.html?id=1582'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'ressurs--og-havavdelinga.html?id=1582'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'resursa--ja-ahpeossodat.html?id=1582'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="department-of-marine-resources-and-envir_id_1582.html" xml:lang="eng"/>
	<parallel_text location="ressurs--og-havavdelinga_id_1582.html" xml:lang="nno"/>
	<parallel_text location="resursa--ja-ahpeossodat_id_1582.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
