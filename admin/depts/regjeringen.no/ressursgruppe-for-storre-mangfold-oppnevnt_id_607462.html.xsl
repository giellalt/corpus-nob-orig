...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/kud/pressesenter/pressemeldinger/2010/Ressursgruppe-for-storre-mangfold-oppnevnt.html?id=607462'"/>
<xsl:variable name="title" select="'Ressursgruppe for større mangfold oppnevnt - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'626'"/>
...
<xsl:variable name="para_sme" select="'Stuorit-valljivuoa-resursajoavku-nammaduvvon.html?id=607462'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="stuorit-valljivuoa-resursajoavku-nammaduvvon_id_607462.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
