...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/md/dok/lover_regler/retningslinjer.html?id=706'"/>
<xsl:variable name="title" select="'Njuolggadusat ja juridihkalaš bagadusat - regjeringen.no'"/>
...
<xsl:variable name="para_nno" select="'Retningsliner-og-juridiske-rettleiingar.html?id=706'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Njuolggadusat-ja-juridihkala-bagadusat.html?id=706'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="retningsliner-og-juridiske-rettleiingar_id_706.html" xml:lang="nno"/>
	<parallel_text location="njuolggadusat-ja-juridihkala-bagadusat_id_706.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
