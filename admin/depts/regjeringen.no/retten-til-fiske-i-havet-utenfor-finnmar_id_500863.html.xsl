...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fkd/pressesenter/pressemeldinger/2008/retten-til-fiske-i-havet-utenfor-finnmar.html?id=500863'"/>
<xsl:variable name="title" select="'Riekti bivdit ábis Finnmárkku olggobealde  - regjeringen.no'"/>
...
<xsl:variable name="para_sme" select="'Riekti-bivdit-abis-Finnmarkku-olggobeald.html?id=500863'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="riekti-bivdit-abis-finnmarkku-olggobeald_id_500863.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
