...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ud/dep/org/avdelinger/rettsavdelingen.html?id=1528'"/>
<xsl:variable name="title" select="'Riekteossodat - regjeringen.no'"/>
...
<xsl:variable name="para_sme" select="'Riekteossodat.html?id=1528'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="riekteossodat_id_1528.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
