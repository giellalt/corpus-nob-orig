...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/md/dep/underliggende-etater/riksantikvaren.html?id=85702'"/>
<xsl:variable name="title" select="'Riikaantikvára - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'431'"/>
...
<xsl:variable name="para_eng" select="'The-Directorate-for-Cultural-Heritage.html?id=85702'"/>
...
<xsl:variable name="para_sme" select="'Riikaantikvara.html?id=85702'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="the-directorate-for-cultural-heritage_id_85702.html" xml:lang="eng"/>
	<parallel_text location="riikaantikvara_id_85702.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
