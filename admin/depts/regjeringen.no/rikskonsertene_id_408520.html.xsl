...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/kud/dep/underliggende_etater/rikskonsertene.html?id=408520'"/>
<xsl:variable name="title" select="'Riikkakonsearttat - regjeringen.no'"/>
...
<xsl:variable name="para_nno" select="'rikskonsertane.html?id=408520'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="rikskonsertane_id_408520.html" xml:lang="nno"/>
	<parallel_text location="riikkakonsearttat_id_408520.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
