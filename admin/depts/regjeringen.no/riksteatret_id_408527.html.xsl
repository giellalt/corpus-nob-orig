...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/kud/dep/underliggende_etater/riksteatret.html?id=408527'"/>
<xsl:variable name="title" select="'Riikkateáhter - regjeringen.no'"/>
...
<xsl:variable name="para_nno" select="'riksteatret.html?id=408527'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Riikkateahter.html?id=408527'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="riksteatret_id_408527.html" xml:lang="nno"/>
	<parallel_text location="riikkateahter_id_408527.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
