...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fin/dep/politisk_ledelse/roger-schjerva-.html?id=272481'"/>
<xsl:variable name="title" select="'Stáhtačálli Roger Schjerva  - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'208'"/>
...
<xsl:variable name="para_eng" select="'roger-schjerva.html?id=272481'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'roger-schjerva.html?id=272481'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Stahtaalli-Roger-Schjerva-.html?id=272481'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="roger-schjerva_id_272481.html" xml:lang="eng"/>
	<parallel_text location="roger-schjerva_id_272481.html" xml:lang="nno"/>
	<parallel_text location="stahtaalli-roger-schjerva-_id_272481.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
