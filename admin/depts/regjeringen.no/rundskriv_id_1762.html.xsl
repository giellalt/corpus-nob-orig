...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dok/rundskriv.html?id=1762'"/>
<xsl:variable name="title" select="'Johtočállosat  - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'consultation-papers.html?id=1762'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Rundskriv.html?id=1762'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Johtoallosat-.html?id=1762'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="consultation-papers_id_1762.html" xml:lang="eng"/>
	<parallel_text location="rundskriv_id_1762.html" xml:lang="nno"/>
	<parallel_text location="johtoallosat-_id_1762.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
