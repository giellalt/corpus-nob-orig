...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ad/dok/rundskriv.html?id=1786'"/>
...
<xsl:variable name="para_nno" select="'rundskriv.html?id=1786'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Gulaskuddamat.html?id=1786'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="rundskriv_id_1786.html" xml:lang="nno"/>
	<parallel_text location="gulaskuddamat_id_1786.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
