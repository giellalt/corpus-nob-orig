...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/krd/dok/rundskriv.html?id=1939'"/>
...
<xsl:variable name="para_nno" select="'Rundskriv.html?id=1939'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Johtoallosat.html?id=1939'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="rundskriv_id_1939.html" xml:lang="nno"/>
	<parallel_text location="johtoallosat_id_1939.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
