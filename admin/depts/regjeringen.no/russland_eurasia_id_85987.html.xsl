...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ud/dep/org/avdelinger/avdeling_for_sikkerhetspolitikk/russland_eurasia.html?id=85987'"/>
<xsl:variable name="title" select="'Miehtámáilbmásaš sihkkarvuođagažaldagaid ja SUS-riikkaid sekšuvdna - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'russia_eurasia.html?id=85987'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="russia_eurasia_id_85987.html" xml:lang="eng"/>
	<parallel_text location="miehtamailbmasa-sihkkarvuoagaaldagaid-ja-sus-riikkaid-sekuvdna_id_85987.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
