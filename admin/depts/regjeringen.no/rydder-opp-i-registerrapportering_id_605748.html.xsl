...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fd/aktuelt/nyheter/2010/Rydder-opp-i-registerrapportering.html?id=605748'"/>
...
<xsl:variable name="para_sma" select="'Lahkoebieljelimmiem-sjeakodh.html?id=605748'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="lahkoebieljelimmiem-sjeakodh_id_605748.html" xml:lang="sma"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
