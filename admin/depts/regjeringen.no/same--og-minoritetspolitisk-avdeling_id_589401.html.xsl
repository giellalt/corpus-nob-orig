...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/dep/org/avdelinger/same--og-minoritetspolitisk-avdeling.html?id=589401'"/>
<xsl:variable name="title" select="'Sámi ja minoritehtapolitihkalaš ossodat  - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'the-department-of-sami-and-minority-affa.html?id=589401'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'same--og-minoritetspolitisk-avdeling.html?id=589401'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'same--og-minoritetspolitisk-avdeling.html?id=589401'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="the-department-of-sami-and-minority-affa_id_589401.html" xml:lang="eng"/>
	<parallel_text location="same--og-minoritetspolitisk-avdeling_id_589401.html" xml:lang="nno"/>
	<parallel_text location="same--og-minoritetspolitisk-avdeling_id_589401.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
