...
<xsl:variable name="para_eng" select="'the-sami-act-.html?id=449701'"/>
...
<xsl:variable name="para_sme" select="'lahka-geassemanu-12-b-1987-nr-56-samedik.html?id=449701'"/>
