...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/pressesenter/pressemeldinger/2010/Sameministeren-besoker-Finnmark.html?id=592292'"/>
<xsl:variable name="title" select="'Sámeministtar galleda Finnmárkku - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'606'"/>
...
<xsl:variable name="para_sme" select="'Sameministtar-galleda-Finnmarkku.html?id=592292'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="sameministtar-galleda-finnmarkku_id_592292.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
