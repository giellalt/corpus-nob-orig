...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/tema/samepolitikk.html?id=1403'"/>
<xsl:variable name="title" select="'Sámepolitihkka - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'Sami-policy.html?id=1403'"/>
...
<xsl:variable name="para_sme" select="'Samepolitihkka.html?id=1403'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="sami-policy_id_1403.html" xml:lang="eng"/>
	<parallel_text location="samepolitihkka_id_1403.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
