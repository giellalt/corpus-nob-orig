...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/jd/pressesenter/pressemeldinger/2007/samerettsutvalget-overleverer-sin-innsti-2.html?id=493171'"/>
<xsl:variable name="title" select="'Samerettsutvalget overleverer sin innstilling - regjeringen.no'"/>
