...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/dep/tilknyttede-virksomheter/sametinget.html?id=444358'"/>
<xsl:variable name="title" select="'Sámediggi - regjeringen.no'"/>
...
<xsl:variable name="para_sme" select="'Samediggi.html?id=444358'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi_id_444358.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
