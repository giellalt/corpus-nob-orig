...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ad/dok/rundskriv/2009/sametingsvalget-2009--rundskriv-om-endri.html?id=568101'"/>
<xsl:variable name="title" select="'Sámediggeválga 2009 – Johtočálus nuppástusaid birra válganjuolggadusaide mat leat sámelágas ja ođđa láhkaásahusas Sámediggeválgga birra - regjeringen.no'"/>
...
<xsl:variable name="para_sme" select="'samediggevalga-2009--johtoalus-nuppastus.html?id=568101'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggevalga-2009--johtoalus-nuppastus_id_568101.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
