...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/tema/samfunnssikkerhet.html?id=1120'"/>
<xsl:variable name="title" select="'Siviila gearggusvuohta - regjeringen.no'"/>
...
<xsl:variable name="para_nno" select="'samfunnssikkerheit.html?id=1120'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Siviila-gearggusvuohta.html?id=1120'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samfunnssikkerheit_id_1120.html" xml:lang="nno"/>
	<parallel_text location="siviila-gearggusvuohta_id_1120.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
