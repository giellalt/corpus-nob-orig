...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/hod/kampanjer/samhandlingsreformen.html?id=524777'"/>
<xsl:variable name="title" select="'Ovttasdoaibmanođastus  - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'the-coordination-reform.html?id=524777'"/>
...
<xsl:variable name="para_sme" select="'ovttasdoaibmanoastus-.html?id=524777'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="the-coordination-reform_id_524777.html" xml:lang="eng"/>
	<parallel_text location="ovttasdoaibmanoastus-_id_524777.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
