...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/tema/samepolitikk/bruk_av_samisk_sprak/samisk-sprak-og-it.html?id=86947'"/>
<xsl:variable name="title" select="'Sámegiella ja IT - regjeringen.no'"/>
...
<xsl:variable name="para_sme" select="'Samegiella-ja-IT.html?id=86947'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samegiella-ja-it_id_86947.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
