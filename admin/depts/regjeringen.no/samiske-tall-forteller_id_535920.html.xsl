...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ad/dok/rapporter_planer/rapporter/2008/samiske-tall-forteller.html?id=535920'"/>
<xsl:variable name="title" select="'Samiske tall forteller - regjeringen.no'"/>
