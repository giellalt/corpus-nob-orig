...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ud/pressesenter/pressemeldinger/2012/satsing_gavi.html?id=701312'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Árjjaid bidjan mánáid- ja etniiddearvvašvuođa nannemii  - regjeringen.no'"/>
...
<xsl:variable name="para_sme" select="'globala_dearvvasvuohta.html_id=701312'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="affordable_medicine_id_701312.html" xml:lang="eng"/>
	<parallel_text location="globala_dearvvasvuohta_id_701312.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
