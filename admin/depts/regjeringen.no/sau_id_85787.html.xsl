...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ad/dep/org/avdelinger/vpa/sau.html?id=85787'"/>
<xsl:variable name="title" select="'Barguiheivehansekšuvdna - regjeringen.no'"/>
...
<xsl:variable name="para_sme" select="'Barguiheivehansekuvdna.html?id=85787'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="barguiheivehansekuvdna_id_85787.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
