...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/pressesenter/pressemeldinger/2010/Seks-millioner-til-kirkevalg.html?id=604470'"/>
<xsl:variable name="title" select="'Guhtta milliuvnna girkoválggaide - regjeringen.no'"/>
...
<xsl:variable name="para_nno" select="'Seks-millionar-til-kyrkjeval.html?id=604470'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="seks-millionar-til-kyrkjeval_id_604470.html" xml:lang="nno"/>
	<parallel_text location="guhtta-milliuvnna-girkovalggaide_id_604470.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
