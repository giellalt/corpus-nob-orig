...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ad/dep/org/avdelinger/vpa/seksjon_for_fellestjenester.html?id=85786'"/>
<xsl:variable name="title" select="'Searvebálvalusaid sekšuvdna  - regjeringen.no'"/>
...
<xsl:variable name="para_sme" select="'Searvebalvalusaid-sekuvdna-.html?id=85786'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="searvebalvalusaid-sekuvdna-_id_85786.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
