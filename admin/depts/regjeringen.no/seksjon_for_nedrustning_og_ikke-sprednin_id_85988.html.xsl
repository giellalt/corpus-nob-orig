...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ud/dep/org/avdelinger/avdeling_for_sikkerhetspolitikk/seksjon_for_nedrustning_og_ikke-sprednin.html?id=85988'"/>
<xsl:variable name="title" select="'Vearjjuid geahpedeami ja vearjjuid viidánaneastadeami sekšuvdna - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'222'"/>
...
<xsl:variable name="para_eng" select="'disarmament.html?id=85988'"/>
...
<xsl:variable name="para_sme" select="'Vearjjuid-geahpedeami-ja-vearjjuid-viidananeastadeami-sekuvdna.html?id=85988'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="disarmament_id_85988.html" xml:lang="eng"/>
	<parallel_text location="vearjjuid-geahpedeami-ja-vearjjuid-viidananeastadeami-sekuvdna_id_85988.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
