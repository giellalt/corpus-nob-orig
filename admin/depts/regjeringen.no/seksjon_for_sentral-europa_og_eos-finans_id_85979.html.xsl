...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ud/dep/org/avdelinger/europaavdelingen/seksjon_for_sentral-europa_og_eos-finans.html?id=85979'"/>
<xsl:variable name="title" select="'Gaska-Eurohpá ja EESa ruhtadanortnegiid sekšuvdna (SEEF) - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'221'"/>
...
<xsl:variable name="para_eng" select="'central_europe.html?id=85979'"/>
...
<xsl:variable name="para_sme" select="'Gaska-Eurohpa-ja-EESa-ruhtadanortnegiid-sekuvdna-SEEF.html?id=85979'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="central_europe_id_85979.html" xml:lang="eng"/>
	<parallel_text location="gaska-eurohpa-ja-eesa-ruhtadanortnegiid-sekuvdna-seef_id_85979.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
