...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ud/dep/org/avdelinger/avdeling_for_sikkerhetspolitikk/seksjon_for_sikkerhetspolitikk_og_bilate.html?id=1514'"/>
<xsl:variable name="title" select="'Sihkkarvuođa ja Davvi-Amerihká sekšuvdna - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'220'"/>
...
<xsl:variable name="para_eng" select="'security_policy.html?id=1514'"/>
...
<xsl:variable name="para_sme" select="'Sihkkarvuoa-ja-Davvi-Amerihka-sekuvdna.html?id=1514'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="security_policy_id_1514.html" xml:lang="eng"/>
	<parallel_text location="sihkkarvuoa-ja-davvi-amerihka-sekuvdna_id_1514.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
