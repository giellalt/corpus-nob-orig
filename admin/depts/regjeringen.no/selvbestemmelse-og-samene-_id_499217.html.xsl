...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ad/aktuelt/taler_artikler/politisk_ledelse/statssekretar-raimo-valle/2008/selvbestemmelse-og-samene-.html?id=499217'"/>
<<<<<<< HEAD
<xsl:variable name="title" select="'Selvbestemmelse og samene  - regjeringen.no'"/>
=======
...
<<<<<<< HEAD
<xsl:variable name="wordcount" select="'1720'"/>
...
<xsl:variable name="para_eng" select="'Self-determination-and-the-Sami.html?id=499217'"/>
...
<xsl:variable name="parallels">
	...
	<parallel_text location="iemearrideapmi-ja-samit-_id_499217.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
