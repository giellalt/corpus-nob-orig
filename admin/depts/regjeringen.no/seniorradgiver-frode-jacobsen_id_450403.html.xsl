...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/dep/org/avdelinger/kommunikasjonsenheten/seniorradgiver-frode-jacobsen.html?id=450403'"/>
<xsl:variable name="title" select="'Gulahallanhoavda Frode Jacobsen - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'head-of-communication-frode-jacobsen.html?id=450403'"/>
...
<xsl:variable name="para_sme" select="'Gulahallanhoavda-Frode-Jacobsen.html?id=450403'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="head-of-communication-frode-jacobsen_id_450403.html" xml:lang="eng"/>
	<parallel_text location="gulahallanhoavda-frode-jacobsen_id_450403.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
