...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ad/dep/org/avdelinger/pks/seniorradgiver-ingrid-dasnes.html?id=446952'"/>
<xsl:variable name="title" select="'Seniorráđđeaddi Ingrid Dåsnes - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'168'"/>
...
<xsl:variable name="para_eng" select="'senior-adviser-ingrid-dasnes.html?id=446952'"/>
...
<xsl:variable name="para_sme" select="'seniorraeaddi-ingrid-dasnes.html?id=446952'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="senior-adviser-ingrid-dasnes_id_446952.html" xml:lang="eng"/>
	<parallel_text location="seniorraeaddi-ingrid-dasnes_id_446952.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
