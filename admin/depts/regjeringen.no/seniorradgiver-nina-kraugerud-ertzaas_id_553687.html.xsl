...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ad/dep/org/avdelinger/pks/seniorradgiver-nina-kraugerud-ertzaas.html?id=553687'"/>
<xsl:variable name="title" select="'Seniorráđđeaddi Nina Kraugerud Ertzaas - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'-senior-adviser-nina-kraugerud-ertzaas.html?id=553687'"/>
...
<xsl:variable name="para_sme" select="'seniorraeaddi-nina-kraugerud-ertzaas.html?id=553687'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="senior-adviser-nina-kraugerud-ertzaas_id_553687.html" xml:lang="eng"/>
	<parallel_text location="seniorraeaddi-nina-kraugerud-ertzaas_id_553687.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
