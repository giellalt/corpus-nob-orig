...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/dep/org/avdelinger/kommunikasjonsenheten/seniorradgiver.html?id=439586'"/>
<xsl:variable name="title" select="'Senior gulahallanrávvejeaddji Ragnvald Berggrav - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'180'"/>
...
<xsl:variable name="para_eng" select="'senior-adviser-ragnvald-berggrav.html?id=439586'"/>
...
<xsl:variable name="para_sme" select="'Senior-gulahallanravvejeaddji-Ragnvald-Berggrav.html?id=439586'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="senior-adviser-ragnvald-berggrav_id_439586.html" xml:lang="eng"/>
	<parallel_text location="senior-gulahallanravvejeaddji-ragnvald-berggrav_id_439586.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
