...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/smk/dep/org/avdelinger/kommunikasjonsseksjonen/seniorradgiver_oivind_ostang.html?id=1717'"/>
<xsl:variable name="title" select="'Seniorráđđeaddi Øivind Østang - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'Head-of-Information-Oivind-Ostang.html?id=1717'"/>
...
<xsl:variable name="para_sme" select="'Informauvdnahoavda-Oivind-Ostang.html?id=1717'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="head-of-information-oivind-ostang_id_1717.html" xml:lang="eng"/>
	<parallel_text location="informauvdnahoavda-oivind-ostang_id_1717.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
