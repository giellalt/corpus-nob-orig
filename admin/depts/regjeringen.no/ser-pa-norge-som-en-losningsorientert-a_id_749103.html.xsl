...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fd/aktuelt/nyheter/2014/-ser-pa-norge-som-en-losningsorientert-a.html?id=749103'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'-Oaidná Norgga čovdosiidda rabas lihtolažžan - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'641'"/>
...
<xsl:variable name="para_eng" select="'norway-seen-as-solutions-oriented-ally.html_id=749103'"/>
...
<xsl:variable name="para_sme" select="'-oaidna-norgga-ovdosiidda-rabas-lihtolaa.html_id=749103'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="norway-seen-as-solutions-oriented-ally_id_749103.html" xml:lang="eng"/>
	<parallel_text location="oaidna-norgga-ovdosiidda-rabas-lihtolaa_id_749103.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
