...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/pressesenter/pressemeldinger/2011/sikrer-permanent-drift-av-slettmegno.html?id=663841'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Sihkkarastá Slettmeg.no šaddá bissovaš doaibman - regjeringen.no'"/>
...
<xsl:variable name="para_nno" select="'sikrar-permanent-drift-av-slettmegno.html_id=663841'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'sihkkarasta-slettmegno-adda-bissova-doai.html_id=663841'"/>
...
<xsl:variable name="parallels">
	...
	<parallel_text location="sihkkarasta-slettmegno-adda-bissova-doai_id_663841.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
