...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/krd/dep/org/avdelinger/kommunikasjonsenheten/sim.html?id=446503'"/>
<xsl:variable name="title" select="'Seniorráđđeaddi Sissel Mossing - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'senior-adviser-sissel-mossing.html?id=446503'"/>
...
<xsl:variable name="para_sme" select="'Seniorraeaddi-Sissel-Mossing.html?id=446503'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="senior-adviser-sissel-mossing_id_446503.html" xml:lang="eng"/>
	<parallel_text location="seniorraeaddi-sissel-mossing_id_446503.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
