...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/jd/dep/org/avdelinger/sivilavdelingen.html?id=1471'"/>
<xsl:variable name="title" select="'Siviilaossodat  - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'The-Department-of-Civil-Affairs.html?id=1471'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Sivilavdelinga.html?id=1471'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Siviilaossodat-.html?id=1471'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="the-department-of-civil-affairs_id_1471.html" xml:lang="eng"/>
	<parallel_text location="sivilavdelinga_id_1471.html" xml:lang="nno"/>
	<parallel_text location="siviilaossodat-_id_1471.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
