...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fkd/tema/sjomat_marked_og_handel.html?id=1181'"/>
<xsl:variable name="title" select="'Norgga mearrabiepmu márkanolaheapmi - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'273'"/>
...
<xsl:variable name="para_nno" select="'Sjomat---marknad-og-handel.html?id=1181'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'norgga-mearrabiepmu-markanolaheapmi.html?id=1181'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="sjomat---marknad-og-handel_id_1181.html" xml:lang="nno"/>
	<parallel_text location="norgga-mearrabiepmu-markanolaheapmi_id_1181.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
