...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/hod/pressesenter/pressemeldinger/2010/Skal-gjennomga-regler-om-tvang.html?id=606057'"/>
<xsl:variable name="title" select="'Galget geahčadit njuolggadusaid bákkoheami birra  - regjeringen.no'"/>
...
<xsl:variable name="para_sme" select="'Galget-geahadit-njuolggadusaid-bakkoheami-birra-.html?id=606057'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="galget-geahadit-njuolggadusaid-bakkoheami-birra-_id_606057.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
