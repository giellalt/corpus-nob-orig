...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ad/pressesenter/pressemeldinger/2008/skal-sikre-samers-rettigheter.html?id=514916'"/>
<xsl:variable name="title" select="'Áigu sihkkarastit sámiid vuoigatvuođaid - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'861'"/>
...
<xsl:variable name="para_sme" select="'aigu-sihkkarastit-samiid-vuoigatvuoaid.html?id=514916'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="aigu-sihkkarastit-samiid-vuoigatvuoaid_id_514916.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
