...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fin/dep/underliggende_etater/skatteetaten.html?id=270405'"/>
<xsl:variable name="title" select="'Vearroetáhtta - Vearrodirektoráhtta - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'the-tax-administration---the-directorate.html?id=270405'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'skatteetaten.html?id=270405'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Vearroetahtta---Vearrodirektorahtta.html?id=270405'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="the-tax-administration---the-directorate_id_270405.html" xml:lang="eng"/>
	<parallel_text location="skatteetaten_id_270405.html" xml:lang="nno"/>
	<parallel_text location="vearroetahtta---vearrodirektorahtta_id_270405.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
