...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fin/aktuelt/taler_artikler/taler_og_artikler_av_ovrig_politisk_lede/statssekretaer_schjerva/2011/skatteetatens-kontorstruktur.html?id=650204'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Vearroetáhta kantuvrrat - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'443'"/>
...
<xsl:variable name="para_eng" select="'address-by-prime-minister-in-oslo-cathed.html_id=651789'"/>
...
<xsl:variable name="para_sme" select="'vearroetahta-kantuvrrat.html_id=650204'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="vearroetahta-kantuvrrat_id_650204.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
