...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fin/dep/org/avdelinger/skattelovavdelingen.html?id=1549'"/>
<xsl:variable name="title" select="'Vearroláhkaossodat - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'The-Tax-Law-Department.html?id=1549'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Skattelovavdelinga.html?id=1549'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Vearrolahkaossodat.html?id=1549'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="the-tax-law-department_id_1549.html" xml:lang="eng"/>
	<parallel_text location="skattelovavdelinga_id_1549.html" xml:lang="nno"/>
	<parallel_text location="vearrolahkaossodat_id_1549.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
