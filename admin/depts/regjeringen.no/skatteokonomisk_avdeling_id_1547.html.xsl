...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fin/dep/org/avdelinger/skatteokonomisk_avdeling.html?id=1547'"/>
<xsl:variable name="title" select="'Vearroekonomalaš ossodat  - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'327'"/>
...
<xsl:variable name="para_eng" select="'Tax_Policy_Department.html?id=1547'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Skatteokonomisk-avdeling.html?id=1547'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Vearroekonomala-ossodat-.html?id=1547'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="tax_policy_department_id_1547.html" xml:lang="eng"/>
	<parallel_text location="skatteokonomisk-avdeling_id_1547.html" xml:lang="nno"/>
	<parallel_text location="vearroekonomala-ossodat-_id_1547.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
