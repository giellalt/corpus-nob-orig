...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/lmd/tema/skogbruk_og_bioenergi/skogbruk.html?id=473272'"/>
<xsl:variable name="title" select="'Vuovdedoallu - regjeringen.no'"/>
...
<xsl:variable name="para_sme" select="'vuovdedoallu.html?id=473272'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="vuovdedoallu_id_473272.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
