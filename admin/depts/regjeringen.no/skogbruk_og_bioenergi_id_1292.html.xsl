...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/lmd/tema/skogbruk_og_bioenergi.html?id=1292'"/>
<xsl:variable name="title" select="'Vuovdedoallu ja bioenergiija - regjeringen.no'"/>
...
<xsl:variable name="para_nno" select="'skogbruk_og_bioenergi.html?id=1292'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'vuovdedoallu-ja-bioenergiija.html?id=1292'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="skogbruk_og_bioenergi_id_1292.html" xml:lang="nno"/>
	<parallel_text location="vuovdedoallu-ja-bioenergiija_id_1292.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
