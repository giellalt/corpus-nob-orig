...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/bld/dep/org/avdelinger/sla.html?id=82'"/>
<xsl:variable name="title" select="'Ovttaseallin- ja dásseárvoossodat - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'department-of-family-affairs-and-gender-.html?id=82'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="department-of-family-affairs-and-gender-_id_82.html" xml:lang="eng"/>
	<parallel_text location="samlivs--og-likestillingsavdelinga_id_82.html" xml:lang="nno"/>
	<parallel_text location="ovttaseallin--ja-dassearvoossodat_id_82.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
