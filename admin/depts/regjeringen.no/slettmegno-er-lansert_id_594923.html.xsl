...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/aktuelt/nyheter/2010/slettmegno-er-lansert.html?id=594923'"/>
<xsl:variable name="title" select="'slettmeg.no lea almmuhuvvon - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'520'"/>
...
<xsl:variable name="para_eng" select="'Service-for-removal-of-web-information-launched.html?id=594923'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'slettmegno-er-lansert.html?id=594923'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'slettmegno-lea-almmuhuvvon.html?id=594923'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="service-for-removal-of-web-information-launched_id_594923.html" xml:lang="eng"/>
	<parallel_text location="slettmegno-er-lansert_id_594923.html" xml:lang="nno"/>
	<parallel_text location="slettmegno-lea-almmuhuvvon_id_594923.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
