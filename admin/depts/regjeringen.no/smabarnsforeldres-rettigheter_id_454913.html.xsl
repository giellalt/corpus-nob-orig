...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/bld/dok/veiledninger_brosjyrer/2007/smabarnsforeldres-rettigheter.html?id=454913'"/>
...
<xsl:variable name="wordcount" select="'8337'"/>
...
<xsl:variable name="para_eng" select="'The-rights-of-parents-of-small-children.html?id=454913'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="the-rights-of-parents-of-small-children_id_454913.html" xml:lang="eng"/>
	<parallel_text location="rettar-for-smabarnsforeldre_id_454913.html" xml:lang="nno"/>
	<parallel_text location="samisk_id_454913.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
