...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/sok.html?id=86008'"/>
<xsl:variable name="title" select="'Ohcan - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'881'"/>
...
<xsl:variable name="para_eng" select="'search.html?id=86008'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'sok.html?id=86008'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'ohcan.html?id=86008'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="search_id_86008.html" xml:lang="eng"/>
	<parallel_text location="sok_id_86008.html" xml:lang="nno"/>
	<parallel_text location="ohcan_id_86008.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
