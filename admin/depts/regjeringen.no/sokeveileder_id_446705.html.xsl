...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/Om-nettstedet/Hjelp/sokeveileder.html?id=446705'"/>
...
<xsl:variable name="wordcount" select="'596'"/>
...
<xsl:variable name="para_eng" select="'help-with-search.html?id=446705'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="help-with-search_id_446705.html" xml:lang="eng"/>
	<parallel_text location="sokehjelp_id_446705.html" xml:lang="nno"/>
	<parallel_text location="ohcanveahkki-_id_446705.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
