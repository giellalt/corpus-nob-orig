...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/smk/aktuelt/taler_og_artikler/statsministeren/statsminister_jens_stoltenberg/2012/speech-at-the-ceremony-in-the-government.html?id=696940'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Sárdni kránsabidjamis - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'565'"/>
...
<xsl:variable name="para_sme" select="'sardni-kransabidjamis.html_id=696940'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="speech-at-memorial-ceremony_id_696940.html" xml:lang="eng"/>
	<parallel_text location="sardni-kransabidjamis_id_696940.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
