...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/md/tema/planlegging_plan-_og_bygningsloven/planveiledere/sporsmal-og-svar-til-ny-plan--og-bygning.html?id=576821'"/>
<xsl:variable name="title" select="'Spørsmål og svar til ny plan- og bygningslov (plandelen) - regjeringen.no'"/>
...
<xsl:variable name="para_nno" select="'sporsmal-og-svar-til-ny-plan--og-bygning.html?id=576821'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="sporsmal-og-svar-til-ny-plan--og-bygning_id_576821.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
