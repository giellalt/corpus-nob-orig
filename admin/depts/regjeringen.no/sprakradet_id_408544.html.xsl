...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/kud/dep/underliggende_etater/sprakradet.html?id=408544'"/>
<xsl:variable name="title" select="'Giellaráđđi - regjeringen.no'"/>
...
<xsl:variable name="para_nno" select="'sprakradet.html?id=408544'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Giellarai.html?id=408544'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="sprakradet_id_408544.html" xml:lang="nno"/>
	<parallel_text location="giellarai_id_408544.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
