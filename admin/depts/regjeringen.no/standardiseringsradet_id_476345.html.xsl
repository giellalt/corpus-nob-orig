...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/dep/styrer-rad-og-utvalg/standardiseringsradet.html?id=476345'"/>
<xsl:variable name="title" select="'Standardiserenráđđi - regjeringen.no'"/>
...
<xsl:variable name="para_sme" select="'standardiserenrai.html?id=476345'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="standardiserenrai_id_476345.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
