...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/tema/kirke/stat_og_kirke.html?id=1218'"/>
<xsl:variable name="title" select="'Stáhta ja girku - regjeringen.no'"/>
...
<xsl:variable name="para_sme" select="'Stahta-ja-girku.html?id=1218'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="stahta-ja-girku_id_1218.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
