...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fin/dep/underliggende_etater/statens-innkrevingssentral.html?id=270406'"/>
<xsl:variable name="title" select="'Stáhta gáibidanguovddáš - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'316'"/>
...
<xsl:variable name="para_eng" select="'the-state-agency-for-the-recovery-of-fin.html?id=270406'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'statens-innkrevingssentral.html?id=270406'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Stahta-gaibidanguovdda.html?id=270406'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="the-state-agency-for-the-recovery-of-fin_id_270406.html" xml:lang="eng"/>
	<parallel_text location="statens-innkrevingssentral_id_270406.html" xml:lang="nno"/>
	<parallel_text location="stahta-gaibidanguovdda_id_270406.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
