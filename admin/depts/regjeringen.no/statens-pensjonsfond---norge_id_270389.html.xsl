...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fin/dep/underliggende_etater/statens-pensjonsfond---norge.html?id=270389'"/>
...
<xsl:variable name="para_eng" select="'national-insurance-scheme-fund.html?id=270389'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="national-insurance-scheme-fund_id_270389.html" xml:lang="eng"/>
	<parallel_text location="folketrygdfondet_id_270389.html" xml:lang="nno"/>
	<parallel_text location="stahta-penunfoanda---norga_id_270389.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
