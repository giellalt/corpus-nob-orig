...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fin/dep/underliggende_etater/statens-pensjonsfond---utland.html?id=270410'"/>
<xsl:variable name="title" select="'Stáhta penšunfoanda - Olgoriikkat - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'The-Government-Pension-Fund-.html?id=270410'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Statens-pensjonsfond.html?id=270410'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'stahta-penunfoanda---olgoriikkat.html?id=270410'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="the-government-pension-fund-_id_270410.html" xml:lang="eng"/>
	<parallel_text location="statens-pensjonsfond_id_270410.html" xml:lang="nno"/>
	<parallel_text location="stahta-penunfoanda---olgoriikkat_id_270410.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
