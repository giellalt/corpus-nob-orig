...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/md/dep/underliggende-etater/statens_forurensningstilsyn.html?id=85642'"/>
<xsl:variable name="title" select="'Dálkkádat- ja nuoskkidandirektoráhta birra - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'the-norwegian-pollution-control-authorit.html?id=85642'"/>
...
<xsl:variable name="para_sme" select="'stada-nuoskkidanbearraigeahus.html?id=85642'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="the-norwegian-pollution-control-authorit_id_85642.html" xml:lang="eng"/>
	<parallel_text location="stada-nuoskkidanbearraigeahus_id_85642.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
