...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/md/dep/underliggende-etater/statens_kartverk.html?id=85701'"/>
<xsl:variable name="title" select="'Stáda kártadoaimmahat - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'341'"/>
...
<xsl:variable name="para_eng" select="'the-norwegian-mapping-authority.html?id=85701'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="the-norwegian-mapping-authority_id_85701.html" xml:lang="eng"/>
	<parallel_text location="stada-kartadoaimmahat_id_85701.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
