...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fin/dep/underliggende_etater/statistisk-sentralbyra.html?id=270407'"/>
<xsl:variable name="title" select="'Statistihkalaš guovddášbyrå - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'345'"/>
...
<xsl:variable name="para_eng" select="'Statistics-Norway.html?id=270407'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Statistisk-sentralbyra.html?id=270407'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Statistihkala-guovddabyra.html?id=270407'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="statistics-norway_id_270407.html" xml:lang="eng"/>
	<parallel_text location="statistisk-sentralbyra_id_270407.html" xml:lang="nno"/>
	<parallel_text location="statistihkala-guovddabyra_id_270407.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
