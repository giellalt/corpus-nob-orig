...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/dep/underliggende-etater/statsbygg.html?id=440426'"/>
<xsl:variable name="title" select="'Statsbygg - regjeringen.no'"/>
...
<xsl:variable name="para_sme" select="'statsbygg.html?id=440426'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="statsbygg_id_440426.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
