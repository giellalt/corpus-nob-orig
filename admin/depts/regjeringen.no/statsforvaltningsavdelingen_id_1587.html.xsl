...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/dep/org/avdelinger/statsforvaltningsavdelingen.html?id=1587'"/>
<xsl:variable name="title" select="'Stáhtahálddahusossodat - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'department-of-government-services.html?id=1587'"/>
...
<xsl:variable name="para_sme" select="'stahtahalddahusossodat.html?id=1587'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="department-of-government-services_id_1587.html" xml:lang="eng"/>
	<parallel_text location="stahtahalddahusossodat_id_1587.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
