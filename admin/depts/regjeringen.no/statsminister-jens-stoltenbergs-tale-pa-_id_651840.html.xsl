...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/smk/aktuelt/taler_og_artikler/statsministeren/statsminister_jens_stoltenberg/2011/statsminister-jens-stoltenbergs-tale-pa-.html?id=651840'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Stáhtaministtar Jens Stoltenberg sárdni Ráđđeviesu olggobealde Oslos - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'prime-ministers-address-at-the-city-hall.html_id=651840'"/>
...
<xsl:variable name="para_sme" select="'stahtaministtar-jens-stoltenberg-sardni-.html_id=651840'"/>
