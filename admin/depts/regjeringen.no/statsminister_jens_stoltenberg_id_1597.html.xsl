...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/smk/statsministerens-kontor/statsminister_jens_stoltenberg.html?id=1597'"/>
<xsl:variable name="title" select="'Stáhtaministtar Jens Stoltenberg - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'239'"/>
...
<xsl:variable name="para_eng" select="'prime-minister-jens-stoltenberg.html?id=1597'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'statsminister-jens-stoltenberg.html?id=1597'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'-stahtaministtar-jens-stoltenberg.html?id=1597'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="prime-minister-jens-stoltenberg_id_1597.html" xml:lang="eng"/>
	<parallel_text location="statsminister-jens-stoltenberg_id_1597.html" xml:lang="nno"/>
	<parallel_text location="stahtaministtar-jens-stoltenberg_id_1597.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
