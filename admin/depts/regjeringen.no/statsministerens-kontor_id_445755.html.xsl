...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/smk/statsministerens-kontor.html?id=445755'"/>
<xsl:variable name="title" select="'Stáhtaministtar - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'119'"/>
...
<xsl:variable name="para_eng" select="'primeminister.html?id=445755'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'statsminister.html?id=445755'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'stahtaministtar.html?id=445755'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="primeminister_id_445755.html" xml:lang="eng"/>
	<parallel_text location="statsminister_id_445755.html" xml:lang="nno"/>
	<parallel_text location="stahtaministtar_id_445755.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
