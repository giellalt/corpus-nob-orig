...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/smk/aktuelt/taler_og_artikler/statsministeren/statsminister_jens_stoltenberg/2010/statsministerens-nyttarstale-2010.html?id=589483'"/>
<<<<<<< HEAD
<xsl:variable name="title" select="'Statsministerens nyttårstale 2010 - regjeringen.no'"/>
=======
...
<<<<<<< HEAD
<xsl:variable name="wordcount" select="'2052'"/>
...
<xsl:variable name="para_eng" select="'prime-ministers-new-years-address-2010.html?id=589483'"/>
...
<xsl:variable name="para_sme" select="'stahtaministara-oajagesardni-jagi-2010.html?id=589483'"/>
...
<xsl:variable name="parallels">
	...
	<parallel_text location="stahtaministara-oajagesardni-jagi-2010_id_589483.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
