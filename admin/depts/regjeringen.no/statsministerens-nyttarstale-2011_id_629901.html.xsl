...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/smk/aktuelt/taler_og_artikler/statsministeren/statsminister_jens_stoltenberg/2011/statsministerens-nyttarstale-2011.html?id=629901'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Stáhtaministara ođđajagesárdni jagi 2011 - regjeringen.no'"/>
...
<<<<<<< HEAD
<xsl:variable name="wordcount" select="'1505'"/>
=======
<xsl:variable name="wordcount" select="'1519'"/>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
...
<xsl:variable name="para_sme" select="'stahtaministara-oajagesardni-jagi-2010.html?id=629901'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="prime-minister-jens-stoltenbergs-new-yea_id_629901.html" xml:lang="eng"/>
	<parallel_text location="stahtaministara-oajagesardni-jagi-2010_id_629901.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
