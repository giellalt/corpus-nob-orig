...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/smk/aktuelt/taler_og_artikler/statsministeren/statsminister_jens_stoltenberg/2013/statsministerens-nyttarstale-2013.html?id=710868'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Stáhtaministara Jens Stoltenberg ođđajagisárdni 2013 - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'2456'"/>
...
<xsl:variable name="para_eng" select="'prime-minister-jens-stoltenbergs-new-yea.html_id=710868'"/>
...
<xsl:variable name="para_sme" select="'stahtaministara-jens-stoltenberg-oajagis.html_id=710868'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="prime-minister-jens-stoltenbergs-new-yea_id_710868.html" xml:lang="eng"/>
	<parallel_text location="stahtaministara-jens-stoltenberg-oajagis_id_710868.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
