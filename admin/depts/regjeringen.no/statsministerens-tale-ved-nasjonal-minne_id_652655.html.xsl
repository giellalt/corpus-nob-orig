...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/smk/aktuelt/taler_og_artikler/statsministeren/statsminister_jens_stoltenberg/2011/statsministerens-tale-ved-nasjonal-minne.html?id=652655'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Stáhtaministara sárdni 22.7.2011 našunála muitodoalus - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'428'"/>
...
<xsl:variable name="para_eng" select="'the-prime-ministers-speech-at-the-nation.html_id=652655'"/>
...
<xsl:variable name="para_sme" select="'stahtaministara-sardni-2272011-naunala-m.html_id=652655'"/>
<xsl:variable name="para_smj" select="'dearvvahansardni-daiddaskuvlla-rahpandil.html_id=654228'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="the-prime-ministers-speech-at-the-nation_id_652655.html" xml:lang="eng"/>
	<parallel_text location="stahtaministara-sardni-2272011-naunala-m_id_652655.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
