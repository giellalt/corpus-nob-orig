...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/kd/dep/kunnskapsminister-tora-aasland-/kalender/2010/Statsrad-Aasland-apner-seminaret-Norges-spesialpedagogiske-kapital.html?id=616102'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Statsråd Aasland åpner seminaret ”Norges spesialpedagogiske kapital” - regjeringen.no'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="Statsrad-Aasland-apner-seminaret-Norges-spesialpedagogiske-kapital.html?id=616102"/>
