...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/om_regjeringen/regjeringen-i-arbeid/statsrad.html?id=270325'"/>
<xsl:variable name="title" select="'Stáhtaráđđi - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'The-Council-of-State.html?id=270325'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'statsrad.html?id=270325'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Stahtarai.html?id=270325'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="the-council-of-state_id_270325.html" xml:lang="eng"/>
	<parallel_text location="statsrad_id_270325.html" xml:lang="nno"/>
	<parallel_text location="stahtarai_id_270325.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
