...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/smk/statsministerens-kontor/politisk_ledelse/statssekretar-dagfinn-sundsbo.html?id=582412'"/>
<xsl:variable name="title" select="'Stáhtačálli Dagfinn Sundsbø - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'state-secretary-dagfinn-sundsbo.html?id=582412'"/>
...
<xsl:variable name="para_sme" select="'stahtaalli-dagfinn-sundsbo.html?id=582412'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="state-secretary-dagfinn-sundsbo_id_582412.html" xml:lang="eng"/>
	<parallel_text location="stahtaalli-dagfinn-sundsbo_id_582412.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
