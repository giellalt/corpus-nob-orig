...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ad/dep/politisk_ledelse/statssekretar-gina-lund.html?id=583301'"/>
<xsl:variable name="title" select="'Stáhtačálli Gina Lund - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'state-secretary-gina-lund.html?id=583301'"/>
...
<xsl:variable name="para_sme" select="'stahtaalli-gina-lund.html?id=583301'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="state-secretary-gina-lund_id_583301.html" xml:lang="eng"/>
	<parallel_text location="stahtaalli-gina-lund_id_583301.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
