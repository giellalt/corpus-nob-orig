...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/krd/dep/politisk_ledelse/statssekretar-guri-storvold.html?id=582284'"/>
<xsl:variable name="title" select="'Stáhtačálli Guri Størvold - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'state-secretary-guri-storvold.html?id=582284'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'statssekretar-guri-storvold.html?id=582284'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'stahtaalli-guri-storvold.html?id=582284'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="state-secretary-guri-storvold_id_582284.html" xml:lang="eng"/>
	<parallel_text location="statssekretar-guri-storvold_id_582284.html" xml:lang="nno"/>
	<parallel_text location="stahtaalli-guri-storvold_id_582284.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
