...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/krd/dep/politisk_ledelse/statssekretar-hege-solbakken.html?id=582312'"/>
<xsl:variable name="title" select="'Stáhtačálli Hege Solbakken - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'state-secretary-hege-solbakken.html?id=582312'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'statssekretar-hege-solbakken.html?id=582312'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'stahtaalli-hege-solbakken.html?id=582312'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="state-secretary-hege-solbakken_id_582312.html" xml:lang="eng"/>
	<parallel_text location="statssekretar-hege-solbakken_id_582312.html" xml:lang="nno"/>
	<parallel_text location="stahtaalli-hege-solbakken_id_582312.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
