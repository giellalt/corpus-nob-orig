...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/md/dep/politisk_ledelse/statssekretar-heidi-sorensen.html?id=486358'"/>
<xsl:variable name="title" select="'Stáhtačálli Heidi Sørensen - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'238'"/>
...
<xsl:variable name="para_eng" select="'state-secretary-heidi-sorensen.html?id=486358'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Statssekretar-Heidi-Sorensen.html?id=486358'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Stahtaalli-Heidi-Sorensen.html?id=486358'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="state-secretary-heidi-sorensen_id_486358.html" xml:lang="eng"/>
	<parallel_text location="statssekretar-heidi-sorensen_id_486358.html" xml:lang="nno"/>
	<parallel_text location="stahtaalli-heidi-sorensen_id_486358.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
