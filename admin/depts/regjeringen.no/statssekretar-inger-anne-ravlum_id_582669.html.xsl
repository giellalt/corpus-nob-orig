...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/dep/politisk_ledelse/statssekretar-inger-anne-ravlum.html?id=582669'"/>
<xsl:variable name="title" select="'Stáhtačálli Inger-Anne Ravlum - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'state-secretary-inger-anne-ravlum.html?id=582669'"/>
...
<xsl:variable name="para_sme" select="'Stahtaalli-Inger-Anne-Ravlum.html?id=582669'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="state-secretary-inger-anne-ravlum_id_582669.html" xml:lang="eng"/>
	<parallel_text location="stahtaalli-inger-anne-ravlum_id_582669.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
