...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/sd/dep/politisk_ledelse/statssekretar-lars-erik-bartnes.html?id=582289'"/>
<xsl:variable name="title" select="'Stáhtačálli Lars Erik Bartnes - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'state-secretary-lars-erik-bartnes.html?id=582289'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'statssekretar-lars-erik-bartnes.html?id=582289'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'-stahtaalli-lars-erik-bartnes.html?id=582289'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="state-secretary-lars-erik-bartnes_id_582289.html" xml:lang="eng"/>
	<parallel_text location="statssekretar-lars-erik-bartnes_id_582289.html" xml:lang="nno"/>
	<parallel_text location="stahtaalli-lars-erik-bartnes_id_582289.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
