...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dokumentarkiv/stoltenberg-ii/aid/personer-og-enheter/politisk-ledelse/2006/statssekretar-raimo-valle.html?id=487117'"/>
<xsl:variable name="title" select="'Ovddeš stáhtačálli Raimo Valle - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'state-secretary-raimo-valle.html?id=487117'"/>
...
<xsl:variable name="para_sme" select="'stahtaalli-raimo-valle.html?id=487117'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="state-secretary-raimo-valle_id_487117.html" xml:lang="eng"/>
	<parallel_text location="stahtaalli-raimo-valle_id_487117.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
