...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fd/dep/politisk_ledelse/statssekretar-roger-ingebrigtsen.html?id=610369'"/>
<xsl:variable name="title" select="'Stáhtačálli Roger Ingebrigtsen - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'139'"/>
...
<xsl:variable name="para_eng" select="'state-secretary-roger-ingebrigtsen.html?id=610369'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'statssekretar-roger-ingebrigtsen.html?id=610369'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'stahtaalli-roger-ingebrigtsen.html?id=610369'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="state-secretary-roger-ingebrigtsen_id_610369.html" xml:lang="eng"/>
	<parallel_text location="statssekretar-roger-ingebrigtsen_id_610369.html" xml:lang="nno"/>
	<parallel_text location="stahtaalli-roger-ingebrigtsen_id_610369.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
