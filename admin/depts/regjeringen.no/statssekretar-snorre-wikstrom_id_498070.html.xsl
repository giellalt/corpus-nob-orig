...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/smk/statsministerens-kontor/politisk_ledelse/statssekretar-snorre-wikstrom.html?id=498070'"/>
<xsl:variable name="title" select="'Stáhtačálli Snorre Wikstrøm - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'141'"/>
...
<xsl:variable name="para_eng" select="'state-secretary-snorre-wikstrom.html?id=498070'"/>
...
<xsl:variable name="para_sme" select="'stahtaalli-snorre-wikstrom.html?id=498070'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="state-secretary-snorre-wikstrom_id_498070.html" xml:lang="eng"/>
	<parallel_text location="stahtaalli-snorre-wikstrom_id_498070.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
