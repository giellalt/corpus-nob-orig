...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/smk/statsministerens-kontor/politisk_ledelse/statssekretar-tor-brostigen.html?id=587281'"/>
<xsl:variable name="title" select="'Stáhtačálli Tor Brostigen - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'state-secretary-tor-brostigen.html?id=587281'"/>
...
<xsl:variable name="para_sme" select="'stahtaalli-tor-brostigen.html?id=587281'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="state-secretary-tor-brostigen_id_587281.html" xml:lang="eng"/>
	<parallel_text location="stahtaalli-tor-brostigen_id_587281.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
