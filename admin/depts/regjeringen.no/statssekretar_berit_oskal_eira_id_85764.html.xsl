...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dokumentarkiv/stoltenberg-ii/aid/andre-dokumenter/personer/2005/statssekretar_berit_oskal_eira.html?id=85764'"/>
<xsl:variable name="title" select="'Stáhtačálli Berit Oskal Eira - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'State-Secretary-Berit-Oskal-Eira.html?id=85764'"/>
...
<xsl:variable name="para_sme" select="'Stahtaalli-Berit-Oskal-Eira.html?id=85764'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="state-secretary-berit-oskal-eira_id_85764.html" xml:lang="eng"/>
	<parallel_text location="stahtaalli-berit-oskal-eira_id_85764.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
