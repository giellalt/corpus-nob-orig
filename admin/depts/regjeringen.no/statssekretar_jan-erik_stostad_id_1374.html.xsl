...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ad/dep/politisk_ledelse/statssekretar_jan-erik_stostad.html?id=1374'"/>
<xsl:variable name="title" select="'Stáhtačálli Jan-Erik Støstad  - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'166'"/>
...
<xsl:variable name="para_eng" select="'secretary-of-state-jan-erik-stostad.html?id=1374'"/>
...
<xsl:variable name="para_sme" select="'stahtaalli-jan-erik-stostad-.html?id=1374'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="secretary-of-state-jan-erik-stostad_id_1374.html" xml:lang="eng"/>
	<parallel_text location="stahtaalli-jan-erik-stostad-_id_1374.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
