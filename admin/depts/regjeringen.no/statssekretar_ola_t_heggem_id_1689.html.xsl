...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/lmd/dep/politisk_ledelse/statssekretar_ola_t_heggem_.html?id=1689'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Stáhtačálli Ola T. Heggem  - regjeringen.no'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="state-secretary-ola-t-heggem-cent_id_1689.html"/>
        ...
        <parallel_text xml:lang="sme" location="stahtaalli-ola-t-heggem-_id_1689.html"/>
