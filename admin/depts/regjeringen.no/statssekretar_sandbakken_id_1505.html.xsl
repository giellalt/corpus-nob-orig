...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/krd/dep/politisk_ledelse/statssekretar_sandbakken.html?id=1505'"/>
<xsl:variable name="title" select="'Stáhtačálli Dag-Henrik Sandbakken - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'secretary-of-state-dag-henrik-sandbakken.html?id=1505'"/>
...
<xsl:variable name="para_sme" select="'Stahtaalli-Dag-Henrik-Sandbakken.html?id=1505'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="secretary-of-state-dag-henrik-sandbakken_id_1505.html" xml:lang="eng"/>
	<parallel_text location="stahtaalli-dag-henrik-sandbakken_id_1505.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
