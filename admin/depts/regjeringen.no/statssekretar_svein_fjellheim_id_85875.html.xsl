...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/smk/statsministerens-kontor/politisk_ledelse/statssekretar_svein_fjellheim.html?id=85875'"/>
<xsl:variable name="title" select="'Stáhtačálli Svein Fjellheim - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'State-Secretary-Svein-Fjellheim.html?id=85875'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="state-secretary-svein-fjellheim_id_85875.html" xml:lang="eng"/>
	<parallel_text location="stahtaalli-svein-fjellheim_id_85875.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
