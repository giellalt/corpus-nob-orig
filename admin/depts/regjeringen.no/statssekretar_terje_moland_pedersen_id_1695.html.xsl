...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/jd/dep/politisk_ledelse/statssekretar_terje_moland_pedersen.html?id=1695'"/>
<xsl:variable name="title" select="'Stáhtačálli Terje Moland Pedersen - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'State-Secretary-Terje-Moland-Pedersen.html?id=1695'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Statssekretar-Terje-Moland-Pedersen.html?id=1695'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Stahtaalli-Terje-Moland-Pedersen.html?id=1695'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="state-secretary-terje-moland-pedersen_id_1695.html" xml:lang="eng"/>
	<parallel_text location="statssekretar-terje-moland-pedersen_id_1695.html" xml:lang="nno"/>
	<parallel_text location="stahtaalli-terje-moland-pedersen_id_1695.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
