...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/krd/kampanjer/valg/stortingsvalg/stemme-pa-valgdagen.html?id=457112'"/>
<xsl:variable name="title" select="'Ná don jienastat válgabeaivvi - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'how-to-vote-on-election-day.html?id=457112'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'royste-pa-valdagen.html?id=457112'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'na-don-jienastat-valgabeaivvi.html?id=457112'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="how-to-vote-on-election-day_id_457112.html" xml:lang="eng"/>
	<parallel_text location="royste-pa-valdagen_id_457112.html" xml:lang="nno"/>
	<parallel_text location="na-don-jienastat-valgabeaivvi_id_457112.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
