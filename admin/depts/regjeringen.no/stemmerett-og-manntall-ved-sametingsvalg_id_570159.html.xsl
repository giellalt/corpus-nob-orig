...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/krd/kampanjer/valg/sametingsvalg/stemmerett-og-manntall-ved-sametingsvalg.html?id=570159'"/>
...
<xsl:variable name="wordcount" select="'566'"/>
...
<xsl:variable name="para_nno" select="'570159.html?id=570159'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'jienastanvuoigatvuohta-ja-jienastuslohku.html?id=570159'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="570159_id_570159.html" xml:lang="nno"/>
	<parallel_text location="jienastanvuoigatvuohta-ja-jienastuslohku_id_570159.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
