...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/kud/pressesenter/pressemeldinger/2012/sterkere-beskyttelse-av-barn-i-kringkast.html?id=705436'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Nannoseabbo mánáid suddjen áibmomedialágas - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'502'"/>
...
<xsl:variable name="para_sme" select="'nannoseabbo-manaid-suddjen-aibmomedialag.html_id=705436'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="nannoseabbo-manaid-suddjen-aibmomedialag_id_705436.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
