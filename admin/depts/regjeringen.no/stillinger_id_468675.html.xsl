...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ad/aktuelt/stillinger.html?id=468675'"/>
<xsl:variable name="title" select="'Rabas virggit - regjeringen.no'"/>
...
<xsl:variable name="para_nno" select="'ledige-stillingar.html?id=468675'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'rabas-virggit.html?id=468675'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="ledige-stillingar_id_468675.html" xml:lang="nno"/>
	<parallel_text location="rabas-virggit_id_468675.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
