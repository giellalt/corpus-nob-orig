...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/bld/aktuelt/stillinger.html?id=468677'"/>
<xsl:variable name="title" select="'Rabas virggit Mánáid- ja dásseárvodepartemeanttas - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'269'"/>
...
<xsl:variable name="para_eng" select="'available-positions-in-the-children-equa.html?id=468677'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Ledige-stillingar.html?id=468677'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Rabas-virggit-Manaid--ja-dassearvodepartemeanttas.html?id=468677'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="ledige-stillingar_id_468677.html" xml:lang="nno"/>
	<parallel_text location="rabas-virggit-manaid--ja-dassearvodepartemeanttas_id_468677.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
