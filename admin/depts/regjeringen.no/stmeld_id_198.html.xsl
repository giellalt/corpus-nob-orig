...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ad/dok/regpubl/stmeld.html?id=198'"/>
...
<xsl:variable name="para_nno" select="'stortingsmeldingar.html?id=198'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'stuorradiggedieahusat.html?id=198'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="stortingsmeldingar_id_198.html" xml:lang="nno"/>
	<parallel_text location="stuorradiggedieahusat_id_198.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
