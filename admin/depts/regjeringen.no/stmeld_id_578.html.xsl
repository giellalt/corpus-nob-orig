...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/kud/dok/regpubl/stmeld.html?id=578'"/>
<xsl:variable name="title" select="'Dieđáhusat Stuorradiggái - regjeringen.no'"/>
...
<xsl:variable name="para_nno" select="'stortingsmeldingar.html?id=578'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'dieahusat-stuorradiggai.html?id=578'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="stortingsmeldingar_id_578.html" xml:lang="nno"/>
	<parallel_text location="dieahusat-stuorradiggai_id_578.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
