...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/smk/pressesenter/pressemeldinger/2007/stoltenberg-lanserer-ny-helsekampanje-fo.html?id=480082'"/>
<xsl:variable name="title" select="'Stoltenberg almmuha ođđa dearvvašvuođaáŋggirdeami geafes riikkaid várás - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'452'"/>
...
<xsl:variable name="para_eng" select="'Stoltenberg-launches-global-health-campa.html?id=480082'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="stoltenberg-launches-global-health-campa_id_480082.html" xml:lang="eng"/>
	<parallel_text location="stoltenberg-almmuha-oa-dearvvavuoaaggird_id_480082.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
