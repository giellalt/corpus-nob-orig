...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/pressesenter/pressemeldinger/2010/stor-byggevirksomhet-i-2011.html?id=619663'"/>
<xsl:variable name="title" select="'Stor byggevirksomhet i 2011 - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'800'"/>
...
<xsl:variable name="para_sme" select="'Stuora-huksendoaibma-2011s.html?id=619663'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="stuora-huksendoaibma-2011s_id_619663.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
