...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/pressesenter/pressemeldinger/2012/stortingsmelding-om-sametingets-virksomh.html?id=700246'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Stuoradiggedieđáhus Sámedikki doaimma  birra 2011 almmuhuvvon - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'607'"/>
...
<xsl:variable name="para_sme" select="'stuoradiggedieahus-samedikki-doaimma--bi.html_id=700246'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="stuoradiggedieahus-samedikki-doaimma--bi_id_700246.html" xml:lang="sme"/>
<parallel_text location="changes-among-the-political-advisers3_id_699577.html" xml:lang="eng"/>
<parallel_text location="pol_radgivere_id_699577.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
