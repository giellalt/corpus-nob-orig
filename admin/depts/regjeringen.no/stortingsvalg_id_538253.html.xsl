...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/krd/kampanjer/valg/stortingsvalg.html?id=538253'"/>
<xsl:variable name="title" select="'Stuorradiggeválga - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'444'"/>
...
<xsl:variable name="para_eng" select="'the-parliamentary-storting-election.html?id=538253'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'stortingsval.html?id=538253'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'ddd.html?id=538253'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="the-parliamentary-storting-election_id_538253.html" xml:lang="eng"/>
	<parallel_text location="stortingsval_id_538253.html" xml:lang="nno"/>
	<parallel_text location="ddd_id_538253.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
