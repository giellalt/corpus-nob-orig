...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/dep/styrer-rad-og-utvalg.html?id=440970'"/>
<xsl:variable name="title" select="'Stivrrat, ráđit ja lávdegottit - regjeringen.no'"/>
...
<xsl:variable name="para_sme" select="'Stivrrat-rait-ja-lavdegottit.html?id=440970'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="stivrrat-rait-ja-lavdegottit_id_440970.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
