...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/hod/pressesenter/pressemeldinger/2013/styrker-omsorgstjenestene-i-kommunene.html?id=745218'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Nannejit gielddaid fuolahanbálvalusa - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'438'"/>
...
<xsl:variable name="para_sme" select="'nannejit-gielddaid-fuolahanbalvalusa.html_id=745218'"/>
