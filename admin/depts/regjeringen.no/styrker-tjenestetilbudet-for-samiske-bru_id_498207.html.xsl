...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ad/pressesenter/pressemeldinger/2008/styrker-tjenestetilbudet-for-samiske-bru.html?id=498207'"/>
<xsl:variable name="title" select="'Nanne bálvalusfálaldaga sámi geavaheaddjiide - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'418'"/>
...
<xsl:variable name="para_sme" select="'Nanne-balvalusfalaldaga-sami-geavaheaddj.html?id=498207'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="nanne-balvalusfalaldaga-sami-geavaheaddj_id_498207.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
