...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/smk/pressesenter/pressemeldinger/2013/styrket-samarbeid-i-nord.html?id=728955'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Nannejuvvon ovttasbargu davvin - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'1528'"/>
...
<xsl:variable name="para_sme" select="'nannejuvvon-ovttasbargu-davvin.html_id=728955'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="strengthened-cooperation-in-the-north_id_728955.html" xml:lang="eng"/>
	<parallel_text location="nannejuvvon-ovttasbargu-davvin_id_728955.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
