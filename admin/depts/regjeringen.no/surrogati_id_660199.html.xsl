...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/bld/aktuelt/nyheter/2011/surrogati.html?id=660199'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Surrogatiija  - regjeringen.no'"/>
    <!--
    ...
    <xsl:variable name="wordcount" select="'840'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="surrogate-maternity_id_660199.html"/>
        ...
        <parallel_text xml:lang="nno" location="surrogati_id_660199.html"/>
        <parallel_text xml:lang="nob" location=""/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location=""/>
        <parallel_text xml:lang="sme" location="surrogatiija-_id_660199.html"/>
