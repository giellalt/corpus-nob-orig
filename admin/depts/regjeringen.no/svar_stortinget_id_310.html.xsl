...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/bld/aktuelt/svar_stortinget.html?id=310'"/>
<xsl:variable name="title" select="'Vástádusat Stuorradiggái - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'219'"/>
...
<xsl:variable name="para_eng" select="'Replies-to-the-Storting.html?id=310'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Svar-til-Stortinget.html?id=310'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Vastadusat-Stuorradiggai.html?id=310'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="replies-to-the-storting_id_310.html" xml:lang="eng"/>
	<parallel_text location="svar-til-stortinget_id_310.html" xml:lang="nno"/>
	<parallel_text location="vastadusat-stuorradiggai_id_310.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
