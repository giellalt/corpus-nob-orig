...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fkd/pressesenter/pressemeldinger/2010/Svart-gode-resultater-i-kampen-mot-ulovlig-fiske.html?id=601898'"/>
<xsl:variable name="title" select="'Hui buorit bohtosat lobihis guolásteami vuostálastimis - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'449'"/>
...
<xsl:variable name="para_eng" select="'Very-good-results-in-combating-illegal-fishing.html?id=601898'"/>
...
<xsl:variable name="para_sme" select="'Hui-buorit-bohtosat-lobihis-guolasteami-vuostalastimis.html?id=601898'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="very-good-results-in-combating-illegal-fishing_id_601898.html" xml:lang="eng"/>
	<parallel_text location="hui-buorit-bohtosat-lobihis-guolasteami-vuostalastimis_id_601898.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
