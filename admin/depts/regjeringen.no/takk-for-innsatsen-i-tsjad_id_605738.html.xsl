...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fd/aktuelt/taler_artikler/ministeren/taler-og-artikler-av-forsvarsminister-gr/2010/--Takk-for-innsatsen-i-Tsjad.html?id=605738'"/>
<xsl:variable name="title" select="'- Takk for innsatsen i Tsjad - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'1000'"/>
...
<xsl:variable name="para_sme" select="'--Giitu-agiruama-ovddas-Tsjadas.html?id=605738'"/>
...
<!-- variable filename contains the original name of the file (from submitter)-->
  ...
  <xsl:variable name="title" select="'- Giitu áŋgiruššama ovddas Tsjadas - regjeringen.no'"/>
  <xsl:variable name="author1_fn" select="''"/>
  <xsl:variable name="author1_ln" select="''"/>
  <xsl:variable name="author1_gender" select="'unknown'"/>
  <xsl:variable name="author1_nat" select="''"/>
  ...
  <xsl:variable name="sub_name" select="''"/>
  <xsl:variable name="sub_email" select="'divvun@samediggi.no'"/>
  <xsl:variable name="wordcount" select="'770'"/>
  <xsl:variable name="metadata" select="'uncomplete'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="giitu-agiruama-ovddas-tsjadas_id_605738.html" xml:lang="sme"/>
</xsl:variable>
