...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/aktuelt/taler_og_artikler/av_ovrig_politisk_ledelse/taler-og-artikler-av-statssekretar-raimo/2010/Tale-til-Nordlige-folk--dagen.html?id=611720'"/>
<<<<<<< HEAD
<xsl:variable name="title" select="'Tale til Nordlige folk -dagen - regjeringen.no'"/>
=======
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Sárdnon Riddu Riđđu Davvi Álbmogiid beaivve - regjeringen.no'"/>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
...
<<<<<<< HEAD
<xsl:variable name="wordcount" select="'683'"/>
<xsl:variable name="metadata" select="'uncomplete'"/>
<xsl:variable name="template_version" select="'$Revision$'"/>
=======
<xsl:variable name="wordcount" select="'531'"/>
<xsl:variable name="metadata" select="'uncomplete'"/>
...
<xsl:variable name="para_eng" select="'Speech-at-Northern-People-Day.html?id=611720'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="speech-at-northern-people-day_id_611720.html" xml:lang="eng"/>
