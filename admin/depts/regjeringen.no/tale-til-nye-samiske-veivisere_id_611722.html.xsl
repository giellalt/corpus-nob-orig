...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/aktuelt/taler_og_artikler/av_ovrig_politisk_ledelse/taler-og-artikler-av-statssekretar-raimo/2010/Tale-til-nye-samiske-veivisere.html?id=611722'"/>
<<<<<<< HEAD
<xsl:variable name="title" select="'Tale til nye samiske veivisere - regjeringen.no'"/>
=======
...
<<<<<<< HEAD
<xsl:variable name="wordcount" select="'636'"/>
...
<xsl:variable name="para_eng" select="'speech-at-the-announcement-of-the-new-sa.html?id=611722'"/>
...
<xsl:variable name="para_sme" select="'xx.html?id=611722'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="speech-at-the-announcement-of-the-new-sa_id_611722.html" xml:lang="eng"/>
	<parallel_text location="xx_id_611722.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
