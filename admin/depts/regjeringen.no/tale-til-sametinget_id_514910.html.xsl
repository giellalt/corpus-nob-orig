...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/smk/aktuelt/taler_og_artikler/statsministeren/statsminister_jens_stoltenberg/2008/tale-til-sametinget.html?id=514910'"/>
<<<<<<< HEAD
=======
<xsl:variable name="text_encoding" select="''"/>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
<xsl:variable name="title" select="'Tale til Sametinget - regjeringen.no'"/>
...
<<<<<<< HEAD
<xsl:variable name="wordcount" select="'1618'"/>
<xsl:variable name="metadata" select="'uncomplete'"/>
<xsl:variable name="template_version" select="'$Revision$'"/>
=======
<xsl:variable name="wordcount" select="'1279'"/>
<xsl:variable name="metadata" select="'uncomplete'"/>
...
<xsl:variable name="para_sme" select="'tale-til-sametinget.html?id=514910'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="tale-til-sametinget_id_514910.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
