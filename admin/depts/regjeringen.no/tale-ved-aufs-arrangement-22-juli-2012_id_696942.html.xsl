...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/smk/aktuelt/taler_og_artikler/statsministeren/statsminister_jens_stoltenberg/2012/tale-ved-aufs-arrangement-22-juli-2012.html?id=696942'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Sárdni AUFs lágideamis Utøyas - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'612'"/>
...
<xsl:variable name="para_eng" select="'speech-at-labour-youth-league-meeting.html_id=696942'"/>
...
<xsl:variable name="para_sme" select="'sardni-aufs-lagideamis-utoyas.html_id=696942'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="speech-at-labour-youth-league-meeting_id_696942.html" xml:lang="eng"/>
	<parallel_text location="sardni-aufs-lagideamis-utoyas_id_696942.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
