...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/smk/aktuelt/taler_og_artikler/statsministeren/statsminister_jens_stoltenberg/2012/tale-ved-minnekonsert.html?id=696944'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Sárdni Ráđđeviessošilju muitokonsearttas - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'528'"/>
...
<xsl:variable name="para_eng" select="'speech-at-rembrance-consert.html_id=696944'"/>
...
<xsl:variable name="para_sme" select="'sardni-raeviessoilju-muitokonsearttas.html_id=696944'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="speech-at-rembrance-consert_id_696944.html" xml:lang="eng"/>
	<parallel_text location="sardni-raeviessoilju-muitokonsearttas_id_696944.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
