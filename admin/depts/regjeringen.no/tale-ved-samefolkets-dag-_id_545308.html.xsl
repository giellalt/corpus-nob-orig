...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ad/aktuelt/taler_artikler/politisk_ledelse/statssekretar-raimo-valle/2009/tale-ved-samefolkets-dag-.html?id=545308'"/>
<<<<<<< HEAD
<xsl:variable name="title" select="'Tale ved samefolkets dag  - regjeringen.no'"/>
=======
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Sártni  Sámi álbmotbeaivvi guovvamánu 6. 2009 - regjeringen.no'"/>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
...
<<<<<<< HEAD
<xsl:variable name="wordcount" select="'673'"/>
<xsl:variable name="metadata" select="'uncomplete'"/>
<xsl:variable name="template_version" select="'$Revision$'"/>
=======
<xsl:variable name="wordcount" select="'525'"/>
<xsl:variable name="metadata" select="'uncomplete'"/>
...
<xsl:variable name="para_sme" select="'sartni--sami-albmotbeaivvi-guovvamanu-6-.html?id=545308'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="sartni--sami-albmotbeaivvi-guovvamanu-6-_id_545308.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
