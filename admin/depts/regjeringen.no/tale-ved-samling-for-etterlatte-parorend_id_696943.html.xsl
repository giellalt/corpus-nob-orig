...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/smk/aktuelt/taler_og_artikler/statsministeren/statsminister_jens_stoltenberg/2012/tale-ved-samling-for-etterlatte-parorend.html?id=696943'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Sárdni oamehasaide ja eaktodáhtolaččaide - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'631'"/>
...
<xsl:variable name="para_eng" select="'speech-to-.html_id=696943'"/>
...
<xsl:variable name="para_sme" select="'sardni-oamehasaide-ja-eaktodahtolaaide.html_id=696943'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="speech-to-_id_696943.html" xml:lang="eng"/>
	<parallel_text location="sardni-oamehasaide-ja-eaktodahtolaaide_id_696943.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
