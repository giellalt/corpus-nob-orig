...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/lmd/aktuelt/taler_artikler/ministeren/landbruks--og-matminister-lars-peder-bre/2012/tale-velkommen-til-bords-1.html?id=673153'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Sáhkavuorru: ”Bures boahtin beavdái!” - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'3758'"/>
...
<xsl:variable name="para_sme" select="'sahkavuorru-bures-boahtin-beavdai1.html_id=673153'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="sahkavuorru-bures-boahtin-beavdai1_id_673153.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
