...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/lmd/aktuelt/taler_artikler/ministeren/landbruks--og-matminister-lars-peder-bre/2012/tale-velkommen-til-bords3.html?id=673157'"/>
...
<xsl:variable name="wordcount" select="'3759'"/>
...
<xsl:variable name="para_sme" select="'sahkavuorru-bures-boahtin-beavdai.html_id=673157'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="sahkavuorru-bures-boahtin-beavdai_id_673157.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
