...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/smk/aktuelt/taler_og_artikler/statsministeren/statsminister_jens_stoltenberg/2011/tale1.html?id=651974'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Stáhtaministara muitosánit Stuorradikkis - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'563'"/>
...
<xsl:variable name="para_eng" select="'commemorative-address-by-the-prime-minis.html_id=651974'"/>
...
<xsl:variable name="para_sme" select="'stahtaministara-muitosanit-stuorradikkis.html_id=651974'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="commemorative-address-by-the-prime-minis_id_651974.html" xml:lang="eng"/>
	<parallel_text location="stahtaministara-muitosanit-stuorradikkis_id_651974.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
