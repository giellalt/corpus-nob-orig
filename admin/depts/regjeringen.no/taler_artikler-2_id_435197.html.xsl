...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fkd/dep/politisk_ledelse/vidar_ulriksen__statssekretar_ap/taler_artikler-2.html?id=435197'"/>
...
<xsl:variable name="para_eng" select="'Speeches-and-articles-by-other-political-staff.html?id=435197'"/>
...
<xsl:variable name="para_sme" select="'Sartnit-ja-artihkkalat.html?id=435197'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="speeches-and-articles-by-other-political-staff_id_435197.html" xml:lang="eng"/>
	<parallel_text location="sartnit-ja-artihkkalat_id_435197.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
