...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/aktuelt/taler_artikler.html?id=1334'"/>
<xsl:variable name="title" select="'Sártnit ja artihkkalat - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'824'"/>
...
<xsl:variable name="para_eng" select="'speeches_articles.html?id=1334'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'taler_artiklar.html?id=1334'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'sartnit_artihkkalat.html?id=1334'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="speeches_articles_id_1334.html" xml:lang="eng"/>
	<parallel_text location="taler_artiklar_id_1334.html" xml:lang="nno"/>
	<parallel_text location="sartnit_artihkkalat_id_1334.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
