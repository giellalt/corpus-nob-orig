...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/smk/dep/kontakt/telefonliste-statsministerens-kontor.html?id=224917'"/>
...
<xsl:variable name="wordcount" select="'385'"/>
...
<xsl:variable name="para_nno" select="'telefonliste.html?id=224917'"/>
