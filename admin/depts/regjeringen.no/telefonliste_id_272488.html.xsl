...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/jd/dep/kontakt/telefonliste.html?id=272488'"/>
<xsl:variable name="title" select="'Telefonlista - regjeringen.no'"/>
...
<xsl:variable name="para_nno" select="'Telefonliste.html?id=272488'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="telefonliste_id_272488.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
