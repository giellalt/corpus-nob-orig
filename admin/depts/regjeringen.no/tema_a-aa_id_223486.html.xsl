...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/tema_a-aa.html?id=223486'"/>
<xsl:variable name="title" select="'Fáddá A-Å - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'421'"/>
...
<xsl:variable name="para_eng" select="'Topics_a-z.html?id=223486'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'tema_a-aa.html?id=223486'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'fadda_a-aa.html?id=223486'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="topics_a-z_id_223486.html" xml:lang="eng"/>
	<parallel_text location="tema_a-aa_id_223486.html" xml:lang="nno"/>
	<parallel_text location="fadda_a-aa_id_223486.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
