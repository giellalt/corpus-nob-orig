...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ad/tema.html?id=167'"/>
...
<xsl:variable name="para_eng" select="'topics.html?id=167'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'tema.html?id=167'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Fadda-.html?id=167'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="topics_id_167.html" xml:lang="eng"/>
	<parallel_text location="tema_id_167.html" xml:lang="nno"/>
	<parallel_text location="fadda-_id_167.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
