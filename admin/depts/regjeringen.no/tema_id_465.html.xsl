...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/jd/tema.html?id=465'"/>
<xsl:variable name="title" select="'Fáttát - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'Subjects.html?id=465'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Tema.html?id=465'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Fattat.html?id=465'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="subjects_id_465.html" xml:lang="eng"/>
	<parallel_text location="tema_id_465.html" xml:lang="nno"/>
	<parallel_text location="fattat_id_465.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
