...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/kd/tema.html?id=588'"/>
<xsl:variable name="title" select="'Fáddá - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'165'"/>
...
<xsl:variable name="para_eng" select="'Selected-topics.html?id=588'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Tema.html?id=588'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'fadda.html?id=588'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="selected-topics_id_588.html" xml:lang="eng"/>
	<parallel_text location="tema_id_588.html" xml:lang="nno"/>
	<parallel_text location="fadda_id_588.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
