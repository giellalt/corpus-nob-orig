...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/md/dok/veiledninger/2009/temaveileder-barn-og-unge-og-planlegging.html?id=588604'"/>
<xsl:variable name="title" select="'Temaveileder: Barn og unge og planlegging etter plan- og bygningsloven  - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'455'"/>
