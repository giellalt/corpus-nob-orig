...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/md/dok/veiledninger/2009/temaveileder-energitiltak-og-plan--og-by.html?id=588200'"/>
<xsl:variable name="title" select="'Temaveileder: Energitiltak og plan- og bygningsloven - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'1381'"/>
