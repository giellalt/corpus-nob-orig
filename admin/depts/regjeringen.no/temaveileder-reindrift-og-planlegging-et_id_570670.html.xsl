...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/md/dok/veiledninger/2009/temaveileder-reindrift-og-planlegging-et.html?id=570670'"/>
<xsl:variable name="title" select="'Temaveileder: Reindrift og planlegging etter Plan- og bygningsloven (plandelen) - regjeringen.no'"/>
