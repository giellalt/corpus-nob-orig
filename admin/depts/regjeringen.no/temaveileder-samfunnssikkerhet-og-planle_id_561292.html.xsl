...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/md/dok/veiledninger/2009/temaveileder-samfunnssikkerhet-og-planle.html?id=561292'"/>
<xsl:variable name="title" select="'Temaveileder: Samfunnssikkerhet og planlegging etter Plan- og bygningsloven (Plandelen) - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'2141'"/>
