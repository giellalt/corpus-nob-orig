...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/md/dok/veiledninger/2009/temaveileder-universell-utforming-og-pla.html?id=557913'"/>
<xsl:variable name="title" select="'Temaveileder: Universell utforming og planlegging etter Plan- og bygningsloven - regjeringen.no'"/>
