...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/tema/forsvars_og_sikkerhetspolitikk/terrorisme.html?id=1114'"/>
<xsl:variable name="title" select="'Terrorisma - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'Terrorism.html?id=1114'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Terrorisme.html?id=1114'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Terrorisma.html?id=1114'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="terrorism_id_1114.html" xml:lang="eng"/>
	<parallel_text location="terrorisme_id_1114.html" xml:lang="nno"/>
	<parallel_text location="terrorisma_id_1114.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
