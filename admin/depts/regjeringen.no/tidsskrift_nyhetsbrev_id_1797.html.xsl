...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ad/dok/tidsskrift_nyhetsbrev.html?id=1797'"/>
<xsl:variable name="title" select="'Áigecállagat ja odasreivvet - regjeringen.no'"/>
...
<xsl:variable name="para_nno" select="'Tidsskrift-og-nyheitsbrev.html?id=1797'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Aigecallagat-ja-odasreivvet.html?id=1797'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="tidsskrift-og-nyheitsbrev_id_1797.html" xml:lang="nno"/>
	<parallel_text location="aigecallagat-ja-odasreivvet_id_1797.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
