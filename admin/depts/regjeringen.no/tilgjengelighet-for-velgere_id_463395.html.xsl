...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/krd/kampanjer/valg/for-valgmedarbeidere/tilgjengelighet-for-velgere.html?id=463395'"/>
<xsl:variable name="title" select="'Tilgjengelighet til valg - regjeringen.no'"/>
...
<xsl:variable name="para_nno" select="'tilgjengelighet-for-velgere.html?id=463395'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="tilgjengelighet-for-velgere_id_463395.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
