...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/bld/dep/tilknyttede-virksomheter.html?id=115191'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Etater og virksomheter - regjeringen.no'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="Offices-and-agencies-associated-with-the-Ministry-of-Children-and-Equality.html?id=115191"/>
        ...
        <parallel_text xml:lang="nno" location="Tilknytta-verksemder.html?id=115191"/>
        <parallel_text xml:lang="nob" location=""/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location=""/>
        <parallel_text xml:lang="sme" location="tilknyttede-virksomheter.html?id=115191"/>
