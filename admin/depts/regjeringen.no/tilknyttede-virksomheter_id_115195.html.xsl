...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fkd/dep/tilknyttede-virksomheter.html?id=115195'"/>
<xsl:variable name="title" select="'Daidda gullevaš doaimmat - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'372'"/>
...
<xsl:variable name="para_eng" select="'Institutions.html?id=115195'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Tilknytta-verksemder.html?id=115195'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Daidda-gulleva-doaimmat.html?id=115195'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="institutions_id_115195.html" xml:lang="eng"/>
	<parallel_text location="tilknytta-verksemder_id_115195.html" xml:lang="nno"/>
	<parallel_text location="daidda-gulleva-doaimmat_id_115195.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
