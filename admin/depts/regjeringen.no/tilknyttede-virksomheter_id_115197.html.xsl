...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/dep/tilknyttede-virksomheter.html?id=115197'"/>
...
<xsl:variable name="para_nno" select="'Tilknytta-verksemder.html?id=115197'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Daidda-gulleva-doaimmat.html?id=115197'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="tilknytta-verksemder_id_115197.html" xml:lang="nno"/>
	<parallel_text location="daidda-gulleva-doaimmat_id_115197.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
