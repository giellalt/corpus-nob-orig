...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fin/dep/tilknyttede_virksomheter.html?id=115193'"/>
<xsl:variable name="title" select="'Čatnaseaddji doaimmahusat - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'Related-Institutions.html?id=115193'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Tilknytta-verksemder.html?id=115193'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'atnaseaddji-doaimmahusat.html?id=115193'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="related-institutions_id_115193.html" xml:lang="eng"/>
	<parallel_text location="tilknytta-verksemder_id_115193.html" xml:lang="nno"/>
	<parallel_text location="atnaseaddji-doaimmahusat_id_115193.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
