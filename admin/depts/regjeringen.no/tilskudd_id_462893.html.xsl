...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/krd/kampanjer/valg/tilskudd.html?id=462893'"/>
<xsl:variable name="title" select="'Tilskudd - regjeringen.no'"/>
