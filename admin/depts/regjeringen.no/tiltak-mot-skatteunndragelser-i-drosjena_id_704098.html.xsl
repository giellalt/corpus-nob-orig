...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fin/pressesenter/pressemeldinger/2012/tiltak-mot-skatteunndragelser-i-drosjena.html?id=704098'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Doaimmat dákseealáhusa vearrobeaitima vuostá - regjeringen.no'"/>
...
<xsl:variable name="para_nno" select="'tiltak-mot-skatteunndragingar-i-drosjena.html_id=704098'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="'raavrevijhke-saemien-gielen-reeremedajve.html_id=704691'"/>
<xsl:variable name="para_sme" select="'doaimmat-dakseealahusa-vearrobeaitima-vu.html_id=704098'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="tiltak-mot-skatteunndragingar-i-drosjena_id_704098.html" xml:lang="nno"/>
	<parallel_text location="doaimmat-dakseealahusa-vearrobeaitima-vu_id_704098.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
