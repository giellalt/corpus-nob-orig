...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/md/pressesenter/pressemeldinger/2013/tine-sundtoft-pa-plass-som-klima--og-mil.html?id=743010'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Tine Sundtoft lea sajis dálkkádat- ja birasgáhttenministtarin - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'349'"/>
...
<xsl:variable name="para_eng" select="'tine-sundtoft-in-place-as-climate-and-en.html_id=743010'"/>
...
<xsl:variable name="para_sme" select="'tine-sundtoft-birasgahttenministtarin.html_id=743010'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="tine-sundtoft-in-place-as-climate-and-en_id_743010.html" xml:lang="eng"/>
	<parallel_text location="tine-sundtoft-birasgahttenministtarin_id_743010.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
