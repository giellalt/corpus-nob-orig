...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/hod/tema/folkehelse/tobakk.html?id=426168'"/>
<xsl:variable name="title" select="'Eastadit duhpátvigiid - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'Tobacco.html?id=426168'"/>
...
<xsl:variable name="para_sme" select="'eastadit-duhpatvigiid.html?id=426168'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="tobacco_id_426168.html" xml:lang="eng"/>
	<parallel_text location="eastadit-duhpatvigiid_id_426168.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
