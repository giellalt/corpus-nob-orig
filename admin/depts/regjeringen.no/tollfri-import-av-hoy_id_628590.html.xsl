...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/lmd/aktuelt/nyheter/2010/des-10/tollfri-import-av-hoy.html?id=628590'"/>
<xsl:variable name="text_encoding" select="''"/>
<<<<<<< HEAD
<xsl:variable name="title" select="'Suinniisd tuolohis riikiibuktin - regjeringen.no'"/>
=======
<xsl:variable name="title" select="'Suinniid tuolohis riikiibuktin - regjeringen.no'"/>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
...
<xsl:variable name="para_sme" select="'suinniisd-tuolohis-riikiibuktin.html?id=628590'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="suinniisd-tuolohis-riikiibuktin_id_628590.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
