...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ad/dep/administrativ_ledelse/tom-radahl.html?id=439550'"/>
<xsl:variable name="title" select="'Veahkkedepartemeantaráđđi Tom Rådahl - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'162'"/>
...
<xsl:variable name="para_eng" select="'Deputy-Secretary-General-Tom-Radahl.html?id=439550'"/>
...
<xsl:variable name="para_sme" select="'Veahkkedepartemeantarai-Tom-Radahl.html?id=439550'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="deputy-secretary-general-tom-radahl_id_439550.html" xml:lang="eng"/>
	<parallel_text location="veahkkedepartemeantarai-tom-radahl_id_439550.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
