...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fin/dep/org/avdelinger/informasjonsenheten/tor-martin-barum.html?id=445353'"/>
<xsl:variable name="title" select="'Seniorráđđeaddi Tor Martin Bærum - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'163'"/>
...
<xsl:variable name="para_eng" select="'Senior-Adviser-Tor-MArtin-Barum.html?id=445353'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'seniorradgivar-tor-martin-barum.html?id=445353'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Seniorraeaddi-Tor-Martin-Barum.html?id=445353'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="senior-adviser-tor-martin-barum_id_445353.html" xml:lang="eng"/>
	<parallel_text location="seniorradgivar-tor-martin-barum_id_445353.html" xml:lang="nno"/>
	<parallel_text location="seniorraeaddi-tor-martin-barum_id_445353.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
