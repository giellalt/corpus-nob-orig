...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/sd/dep/organisasjon/avdelinger/veg-_og_baneavdelingen/trafikksikkerhets--og-beredskapsseksjone.html?id=332359'"/>
<xsl:variable name="title" select="'Johtolatsihkkarvuođa- ja gearggusvuođasekšuvdna - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'213'"/>
...
<xsl:variable name="para_nno" select="'Seksjon-for-trafikktryggleik-og-beredska.html?id=332359'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Johtolatsihkkarvuoa--gearggusvuoasekuvdna.html?id=332359'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="seksjon-for-trafikktryggleik-og-beredska_id_332359.html" xml:lang="nno"/>
	<parallel_text location="johtolatsihkkarvuoa--gearggusvuoasekuvdna_id_332359.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
