...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/tema/transport_og_kommunikasjon.html?id=928'"/>
<xsl:variable name="title" select="'Fievrrideapmi ja johtalus  - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'553'"/>
...
<xsl:variable name="para_eng" select="'Transport-and-communications.html?id=928'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Transport-og-kommunikasjon.html?id=928'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Fievrrideapmi-ja-johtalus-.html?id=928'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="transport-and-communications_id_928.html" xml:lang="eng"/>
	<parallel_text location="transport-og-kommunikasjon_id_928.html" xml:lang="nno"/>
	<parallel_text location="fievrrideapmi-ja-johtalus-_id_928.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
