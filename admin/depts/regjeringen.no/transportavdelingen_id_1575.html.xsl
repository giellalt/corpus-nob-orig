...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/sd/dep/organisasjon/avdelinger/transportavdelingen.html?id=1575'"/>
<xsl:variable name="title" select="'Fievrredanossodat - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'226'"/>
...
<xsl:variable name="para_eng" select="'transport-department.html?id=1575'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'transportavdelinga-ta.html?id=1575'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'fievrredanossodat.html?id=1575'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="transport-department_id_1575.html" xml:lang="eng"/>
	<parallel_text location="transportavdelinga-ta_id_1575.html" xml:lang="nno"/>
	<parallel_text location="fievrredanossodat_id_1575.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
