...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/aktuelt/nyheter/2010/tre-ministre-med-brev-til-kommunene-om-m.html?id=621039'"/>
...
<xsl:variable name="para_nno" select="'tre-ministar-med-brev-til-kommunane-om-m.html?id=621039'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="tre-ministar-med-brev-til-kommunane-om-m_id_621039.html" xml:lang="nno"/>
	<parallel_text location="golbma-ministariid-reive-suohkaniidda-giehtatelefon--ja-govdafierpmadathuksema-birra_id_621039.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
