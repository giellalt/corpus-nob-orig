...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/kud/dep/org/avdelinger/medieavdelingen_/tredje-medieseksjon-m3.html?id=551549'"/>
<xsl:variable name="title" select="'Sekšuvdna  M3 - regjeringen.no'"/>
...
<xsl:variable name="para_nno" select="'Seksjon-M3.html?id=551549'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Sekuvdna--M3.html?id=551549'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="seksjon-m3_id_551549.html" xml:lang="nno"/>
	<parallel_text location="sekuvdna--m3_id_551549.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
