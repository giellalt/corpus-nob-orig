...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/smk/dep/org/avdelinger/kommunikasjonsseksjonen/trude_maseide.html?id=1707'"/>
<xsl:variable name="title" select="'Informašuvdnahoavda Trude Måseide - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'Communication-Officer-Trude-Maseide.html?id=1707'"/>
...
<xsl:variable name="para_sme" select="'Kommunikasjonsradgiver-Trude-Maseide.html?id=1707'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="communication-officer-trude-maseide_id_1707.html" xml:lang="eng"/>
	<parallel_text location="kommunikasjonsradgiver-trude-maseide_id_1707.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
