...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fkd/tema/trygg_og_sunn_sjomat.html?id=1273'"/>
<xsl:variable name="title" select="'Sihkkaris ja dearvvaslaš mearrabiepmu - regjeringen.no'"/>
...
<xsl:variable name="para_nno" select="'Trygg-sjomat.html?id=1273'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'sihkkaris-ja-dearvvasla-mearrabiepmu.html?id=1273'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="trygg-sjomat_id_1273.html" xml:lang="nno"/>
	<parallel_text location="sihkkaris-ja-dearvvasla-mearrabiepmu_id_1273.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
