...
<xsl:variable name="para_sme" select="'divtasvuona-suohkan--suohkana-same-namma.html_id=660248'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="divtasvuona-suohkan--suohkana-same-namma_id_660248.html" xml:lang="smj"/>
