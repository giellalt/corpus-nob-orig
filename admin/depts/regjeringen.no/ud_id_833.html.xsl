...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ud.html?id=833'"/>
<xsl:variable name="title" select="'Olgoriikadepartemeanta - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'228'"/>
...
<xsl:variable name="para_eng" select="'ud.html?id=833'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'ud.html?id=833'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'ud.html?id=833'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="ud_id_833.html" xml:lang="eng"/>
	<parallel_text location="ud_id_833.html" xml:lang="nno"/>
	<parallel_text location="ud_id_833.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
