...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ad/tema/pensjoner/uforepensjon.html?id=9462'"/>
<xsl:variable name="title" select="'Uførepensjon - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'disability-pension.html?id=9462'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="disability-pension_id_9462.html" xml:lang="eng"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
