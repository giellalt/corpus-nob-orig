...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dok/hoeringer/under_behandling.html?id=1765'"/>
...
<xsl:variable name="para_nno" select="'Saker-under-behandling.html?id=1765'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="saker-under-behandling_id_1765.html" xml:lang="nno"/>
	<parallel_text location="ait-mat-leat-meannuduvvomin-_id_1765.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
