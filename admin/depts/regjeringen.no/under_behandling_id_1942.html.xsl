...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/krd/dok/hoeringer/under_behandling.html?id=1942'"/>
<xsl:variable name="title" select="'Áššit mat leat meannuduvvomin  - regjeringen.no'"/>
...
<xsl:variable name="para_nno" select="'Saker-under-behandling.html?id=1942'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'SE_Saker-under-behandling.html?id=1942'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="saker-under-behandling_id_1942.html" xml:lang="nno"/>
	<parallel_text location="se_saker-under-behandling_id_1942.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
