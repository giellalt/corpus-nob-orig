...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/nhd/dep/org/avdelinger/ledelse/departementsradens-kontor/underdirektor-hege-elisabeth-seel.html?id=437456'"/>
<xsl:variable name="title" select="'Vuolitdirektevra Hege Elisabeth Seel - regjeringen.no'"/>
...
<xsl:variable name="para_sme" select="'Vuolitdirektevra-Hege-Elisabeth-Seel.html?id=437456'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="vuolitdirektevra-hege-elisabeth-seel_id_437456.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
