...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fkd/dep/underliggende-etater.html?id=115194'"/>
...
<xsl:variable name="para_eng" select="'Subordinate-agencies-and-institutions.html?id=115194'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Underliggjande-etatat.html?id=115194'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Vuollasa-asahusat.html?id=115194'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="subordinate-agencies-and-institutions_id_115194.html" xml:lang="eng"/>
	<parallel_text location="underliggjande-etatat_id_115194.html" xml:lang="nno"/>
	<parallel_text location="vuollasa-asahusat_id_115194.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
