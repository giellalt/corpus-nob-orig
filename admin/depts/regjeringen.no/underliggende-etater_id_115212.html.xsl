...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/md/dep/underliggende-etater.html?id=115212'"/>
<xsl:variable name="title" select="'Vuolit etáhtat - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'Subordinate-agencies.html?id=115212'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Underliggjande-etatar.html?id=115212'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Vuolit-etahtat.html?id=115212'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="subordinate-agencies_id_115212.html" xml:lang="eng"/>
	<parallel_text location="underliggjande-etatar_id_115212.html" xml:lang="nno"/>
	<parallel_text location="vuolit-etahtat_id_115212.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
