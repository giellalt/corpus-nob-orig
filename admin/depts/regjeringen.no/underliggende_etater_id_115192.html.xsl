...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fin/dep/underliggende_etater.html?id=115192'"/>
<xsl:variable name="title" select="'Vuollásaš ásahusat - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'663'"/>
...
<xsl:variable name="para_eng" select="'Underliggende-etater.html?id=115192'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'etatar-og-verksemder.html?id=115192'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Vuollasa-asahusat.html?id=115192'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="underliggende-etater_id_115192.html" xml:lang="eng"/>
	<parallel_text location="etatar-og-verksemder_id_115192.html" xml:lang="nno"/>
	<parallel_text location="vuollasa-asahusat_id_115192.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
