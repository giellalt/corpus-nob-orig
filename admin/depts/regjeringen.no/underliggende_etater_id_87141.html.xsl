...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ad/dep/underliggende_etater.html?id=87141'"/>
...
<xsl:variable name="wordcount" select="'366'"/>
...
<xsl:variable name="para_nno" select="'Underliggjande-etatar.html?id=87141'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="underliggjande-etatar_id_87141.html" xml:lang="nno"/>
	<parallel_text location="vuollasa-asahusat_id_87141.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
