...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/pressesenter/pressemeldinger/2011/universitet-i-tromso.html?id=650381'"/>
...
<xsl:variable name="para_sme" select="'romssa_universitehta.html_id=650381'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="romssa_universitehta_id_650381.html" xml:lang="sme"/>
	<parallel_text location="romssa_universitehta_id_650381.html" xml:lang="smj"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
