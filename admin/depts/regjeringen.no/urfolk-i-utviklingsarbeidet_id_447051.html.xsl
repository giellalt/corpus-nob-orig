...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ud/tema/menneskerettigheter/menneskerettigheter-urfolk/urfolk-i-utviklingsarbeidet.html?id=447051'"/>
<xsl:variable name="title" select="'Álgoálbmogat ovddidanbarggus - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'indigenous-peoples-in-development-cooper.html?id=447051'"/>
...
<xsl:variable name="para_sme" select="'utvpol_samisk.html?id=447051'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="indigenous-peoples-in-development-cooper_id_447051.html" xml:lang="eng"/>
	<parallel_text location="utvpol_samisk_id_447051.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
