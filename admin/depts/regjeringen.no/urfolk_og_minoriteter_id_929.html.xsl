...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/tema/urfolk_og_minoriteter.html?id=929'"/>
<xsl:variable name="title" select="'Álgoálbmogat ja unnitlogut - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'Indigenous-peoples-and-minorities.html?id=929'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Urfolk-og-minoritetar.html?id=929'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Algoalbmogat-ja-unnitlogut.html?id=929'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="indigenous-peoples-and-minorities_id_929.html" xml:lang="eng"/>
	<parallel_text location="urfolk-og-minoritetar_id_929.html" xml:lang="nno"/>
	<parallel_text location="algoalbmogat-ja-unnitlogut_id_929.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
