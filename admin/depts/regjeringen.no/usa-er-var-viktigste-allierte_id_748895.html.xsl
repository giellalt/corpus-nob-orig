...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fd/aktuelt/nyheter/2014/-usa-er-var-viktigste-allierte.html?id=748895'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'-USA lea min mávssoleamos lihtolaš - regjeringen.no'"/>
...
<xsl:variable name="para_sme" select="'-usa-lea-min-mavssoleamos-lihtola.html_id=748895'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="usa-lea-min-mavssoleamos-lihtola_id_748895.html" xml:lang="sme"/>
	<parallel_text location="the-us-is-our-most-important-ally_id_748895.html" xml:lang="eng"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
