...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/tema/utdanning_og_forskning.html?id=930'"/>
<xsl:variable name="title" select="'Oahpahus ja dutkan - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'650'"/>
...
<xsl:variable name="para_eng" select="'Education-and-research.html?id=930'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Utdanning-og-forsking.html?id=930'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Oahpahus-ja-dutkan.html?id=930'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="education-and-research_id_930.html" xml:lang="eng"/>
	<parallel_text location="utdanning-og-forsking_id_930.html" xml:lang="nno"/>
	<parallel_text location="oahpahus-ja-dutkan_id_930.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
