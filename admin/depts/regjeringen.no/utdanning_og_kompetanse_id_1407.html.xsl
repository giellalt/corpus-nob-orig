...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/kd/tema/utdanning_og_kompetanse.html?id=1407'"/>
<xsl:variable name="title" select="'Gelbbolašvuođapolitihkka - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'policy-for-lifelong-learning.html?id=1407'"/>
...
<xsl:variable name="para_sme" select="'gelbbolavuoapolitihkka.html?id=1407'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="policy-for-lifelong-learning_id_1407.html" xml:lang="eng"/>
	<parallel_text location="gelbbolavuoapolitihkka_id_1407.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
