...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/kd/tema/utdanningsfinansering.html?id=1422'"/>
<xsl:variable name="title" select="'Oahppodoarjja - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'study-financing-.html?id=1422'"/>
...
<xsl:variable name="para_sme" select="'oahppodoarjja.html?id=1422'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="study-financing-_id_1422.html" xml:lang="eng"/>
	<parallel_text location="oahppodoarjja_id_1422.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
