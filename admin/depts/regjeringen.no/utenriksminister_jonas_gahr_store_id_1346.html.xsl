...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ud/dep/utenriksminister_jonas_gahr_store.html?id=1346'"/>
<xsl:variable name="title" select="'Olgoriikaministtar Jonas Gahr Støre  - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'244'"/>
...
<xsl:variable name="para_eng" select="'minister_foreign.html?id=1346'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'utenriksminister-jonas-gahr-store.html?id=1346'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'olgoriikaministtar-jonas-gahr-store.html?id=1346'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="minister_foreign_id_1346.html" xml:lang="eng"/>
	<parallel_text location="utenriksminister-jonas-gahr-store_id_1346.html" xml:lang="nno"/>
	<parallel_text location="olgoriikaministtar-jonas-gahr-store_id_1346.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
