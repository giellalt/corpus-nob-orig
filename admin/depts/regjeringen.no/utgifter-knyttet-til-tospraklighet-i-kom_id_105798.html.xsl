...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ad/dok/rapporter_planer/rapporter/2002/utgifter-knyttet-til-tospraklighet-i-kom.html?id=105798'"/>
<xsl:variable name="title" select="'Lassegolut suohkaniid ja fylkkagielddaid guovttegielalašvuođa geažil - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'143'"/>
...
<xsl:variable name="para_sme" select="'lassegolut-suohkaniid-ja-fylkkagielddaid.html?id=105798'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="lassegolut-suohkaniid-ja-fylkkagielddaid_id_105798.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
