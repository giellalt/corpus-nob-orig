...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/jd/dep/underliggende-etater/utlendingsdirektoratet_udi.html?id=85817'"/>
<xsl:variable name="title" select="'Olgoriikkalaččaiddirektoráhta (ODI) - regjeringen.no'"/>
...
<xsl:variable name="para_sme" select="'Olgoriikkalaaiddirektorahta-ODI.html?id=85817'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="olgoriikkalaaiddirektorahta-odi_id_85817.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
