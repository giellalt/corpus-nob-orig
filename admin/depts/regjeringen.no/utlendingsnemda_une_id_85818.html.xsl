...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/jd/dep/underliggende-etater/utlendingsnemda_une.html?id=85818'"/>
<xsl:variable name="title" select="'Olgoriikkalaččaidnammagoddi (ONA) - regjeringen.no'"/>
...
<xsl:variable name="para_sme" select="'Olgoriikkalaaidnammagoddi-ONA.html?id=85818'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="olgoriikkalaaidnammagoddi-ona_id_85818.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
