...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/kud/aktuelt/nyheter/2012/utlysning---proveordning-med-tilskudd-ti.html?id=698048'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Almmuhus – Geahččalanortnet, mas dorjot kulturealáhusaktevrraid fierpmádagaid ja oktasaš doaibmalanjaid gávpogiin ja guovlluguovddážiin - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'522'"/>
...
<xsl:variable name="para_eng" select="'the-prime-minister-announces-new-emergen.html_id=698072'"/>
...
<xsl:variable name="para_sme" select="'almmuhus--geahalanortnet-mas-dorjot-kult.html_id=698048'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="the-prime-minister-announces-new-emergen.html_id=698072" xml:lang="eng"/>
	<parallel_text location="almmuhus--geahalanortnet-mas-dorjot-kult_id_698048.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
