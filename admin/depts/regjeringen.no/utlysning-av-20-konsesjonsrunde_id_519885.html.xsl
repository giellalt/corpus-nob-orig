...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/oed/pressesenter/pressemeldinger/2008/utlysning-av-20-konsesjonsrunde.html?id=519885'"/>
<xsl:variable name="title" select="'Almmuhus - 20. konsešuvdnavuorru  - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'516'"/>
...
<xsl:variable name="para_eng" select="'announcement--20th-licensing-round.html?id=519885'"/>
...
<xsl:variable name="para_sme" select="'almmuhus---20-konseuvdnavuorru-.html?id=519885'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="announcement--20th-licensing-round_id_519885.html" xml:lang="eng"/>
	<parallel_text location="almmuhus---20-konseuvdnavuorru-_id_519885.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
