...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fin/pressesenter/pressemeldinger/2012/utredning-om-fripoliser-og-kapitalkrav.html?id=669927'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Friijapoliissaid ja kapitálagáibádusaid čielggadeapmi - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'298'"/>
...
<xsl:variable name="para_nno" select="'samarbeidsavtale-mellom-statskog-og-same.html_id=670335'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="'giske-eun-jielemeministerh-gaavnesji.html_id=672425'"/>
<xsl:variable name="para_sme" select="'friijapoliissaid-ja-kapitalagaibadusaid-.html_id=669927'"/>
...
<xsl:variable name="parallels">
	...
	<parallel_text location="utgreiing-om-fripolisar-og-kapitalkrav_id_669927.html" xml:lang="nno"/>
	<parallel_text location="friijapoliissaid-ja-kapitalagaibadusaid-_id_669927.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
