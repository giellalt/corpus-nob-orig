...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fin/pressesenter/pressemeldinger/2012/utredning-om-samfunnsokonomiske-analys-2.html?id=701024'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Servodatekonomiija analysaid guorahallan - regjeringen.no'"/>
...
<xsl:variable name="para_sme" select="'servodatekonomiija-analysaid-guorahallan.html_id=701024'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="report-on-cost-benefit-analysis_id_701024.html" xml:lang="eng"/>
	<parallel_text location="servodatekonomiija-analysaid-guorahallan_id_701024.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
