...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/krd/kampanjer/valg/for-valgmedarbeidere/nytt-om-valg---arkiv/nytt-om-valg-2009/utsendelse-av-valgmateriell-til-kommunen.html?id=563550'"/>
<xsl:variable name="title" select="'Påminning: Utsendelse av valgmateriell til kommunene - regjeringen.no'"/>
