...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/kud/dep/underliggende_etater/utsmykkingsfondet-for-offentlige-bygg.html?id=408528'"/>
<xsl:variable name="title" select="'Almmolaš visttiid čiŋáhanfoanda  - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'157'"/>
...
<xsl:variable name="para_nno" select="'kunst-i-offentlege-rom-koro.html?id=408528'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Almmola-visttiid-iahanfoanda-.html?id=408528'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="kunst-i-offentlege-rom-koro_id_408528.html" xml:lang="nno"/>
	<parallel_text location="almmola-visttiid-iahanfoanda-_id_408528.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
