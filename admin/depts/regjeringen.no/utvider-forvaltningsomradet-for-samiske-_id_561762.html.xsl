...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ad/pressesenter/pressemeldinger/2009/utvider-forvaltningsomradet-for-samiske-.html?id=561762'"/>
<xsl:variable name="title" select="'Viiddida sámegielaid hálddašanguovllu - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'405'"/>
...
<xsl:variable name="para_sme" select="'viiddida-samegielaid-halddaanguovllu.html?id=561762'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="viiddida-samegielaid-halddaanguovllu_id_561762.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
