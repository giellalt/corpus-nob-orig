...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/krd/tema/regional-_og_distriktspolitikk/utvikling-av-bedrifter-og-naringsmiljo.html?id=526842'"/>
<xsl:variable name="title" select="'Fitnodagaid ja ealáhusdoaimmaid ovdánahttin - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'330'"/>
...
<xsl:variable name="para_eng" select="'development-of-companies-and-business-en.html?id=526842'"/>
...
<xsl:variable name="para_sme" select="'Fitnodagaid-ja-ealahusdoaimmaid-ovdanahttin.html?id=526842'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="development-of-companies-and-business-en_id_526842.html" xml:lang="eng"/>
	<parallel_text location="fitnodagaid-ja-ealahusdoaimmaid-ovdanahttin_id_526842.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
