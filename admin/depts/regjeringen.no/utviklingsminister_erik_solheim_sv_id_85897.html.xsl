...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ud/dep/utviklingsminister_erik_solheim_sv.html?id=85897'"/>
<xsl:variable name="title" select="'Biras- ja ovdánahttinministtar Erik Solheim  - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'minister_development.html?id=85897'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'utviklingsminister-erik-solheim-sv.html?id=85897'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'stahtarai-erik-solheim-sg.html?id=85897'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="minister_development_id_85897.html" xml:lang="eng"/>
	<parallel_text location="utviklingsminister-erik-solheim-sv_id_85897.html" xml:lang="nno"/>
	<parallel_text location="stahtarai-erik-solheim-sg_id_85897.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
