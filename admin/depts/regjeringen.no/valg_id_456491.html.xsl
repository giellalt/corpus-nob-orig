...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/krd/kampanjer/valg.html?id=456491'"/>
<xsl:variable name="title" select="'Stuorradiggeválga ja sámediggeválga 2009 - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'127'"/>
...
<xsl:variable name="para_eng" select="'election_portal.html?id=456491'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'valportalen.html?id=456491'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'valga-portal.html?id=456491'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="election_portal_id_456491.html" xml:lang="eng"/>
	<parallel_text location="valportalen_id_456491.html" xml:lang="nno"/>
	<parallel_text location="valga-portal_id_456491.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
