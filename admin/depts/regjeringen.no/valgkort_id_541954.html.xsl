...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/krd/kampanjer/valg/stortingsvalg/valgkort.html?id=541954'"/>
<xsl:variable name="title" select="'Válgakoarta - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'polling-cards.html?id=541954'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'valkort.html?id=541954'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'valgakoarta.html?id=541954'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="polling-cards_id_541954.html" xml:lang="eng"/>
	<parallel_text location="valkort_id_541954.html" xml:lang="nno"/>
	<parallel_text location="valgakoarta_id_541954.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
