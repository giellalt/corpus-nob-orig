...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/krd/kampanjer/valg/valgobservasjon.html?id=573442'"/>
<xsl:variable name="title" select="'Valgobservasjon - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'election-observation.html?id=573442'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="election-observation_id_573442.html" xml:lang="eng"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
