...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/krd/kampanjer/valg/stortingsvalg/valgoppgjor-hvem-blir-valgt.html?id=570018'"/>
<xsl:variable name="title" select="'Válgaloahpparehkenastin: geat válljejuvvojit - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'1076'"/>
...
<xsl:variable name="para_eng" select="'determining-the-election-results-who-get.html?id=570018'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'valoppgjer-kven-blir-vald.html?id=570018'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'valgaloahpparehkenastin-geat-valljejuvvo.html?id=570018'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="determining-the-election-results-who-get_id_570018.html" xml:lang="eng"/>
	<parallel_text location="valoppgjer-kven-blir-vald_id_570018.html" xml:lang="nno"/>
	<parallel_text location="valgaloahpparehkenastin-geat-valljejuvvo_id_570018.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
