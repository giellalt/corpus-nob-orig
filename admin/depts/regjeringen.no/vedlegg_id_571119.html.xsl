...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/md/dok/rundskriv/2009/ikraftsetting-plandel-plan-bygningslov/vedlegg.html?id=571119'"/>
<xsl:variable name="title" select="'Mildosat - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'763'"/>
...
<xsl:variable name="para_sme" select="'Mildosat.html?id=571119'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="mildosat_id_571119.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
