...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/sd/dep/organisasjon/avdelinger/veg-_og_baneavdelingen.html?id=1574'"/>
<xsl:variable name="title" select="'Luodda- ja bána- ossodat - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'243'"/>
...
<xsl:variable name="para_eng" select="'department-of-public-roads-and-rail-tran.html?id=1574'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="department-of-public-roads-and-rail-tran_id_1574.html" xml:lang="eng"/>
	<parallel_text location="veg--og-baneavdelinga-vb_id_1574.html" xml:lang="nno"/>
	<parallel_text location="luodda--ja-bana--ossodat_id_1574.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
