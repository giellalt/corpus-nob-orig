...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/md/dok/veiledninger/2010/veiledning-til-forskrift-om-kart-stedfes.html?id=611023'"/>
<xsl:variable name="title" select="'Veiledning til kart- og plan forskriften - regjeringen.no'"/>
...
<xsl:variable name="para_nno" select="'veiledning-til-forskrift-om-kart-stedfes.html?id=611023'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="veiledning-til-forskrift-om-kart-stedfes_id_611023.html" xml:lang="nno"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
