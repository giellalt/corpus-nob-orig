...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/bld/dok/veiledninger_brosjyrer.html?id=2083'"/>
...
<xsl:variable name="para_eng" select="'Guidelines-and-brochures.html?id=2083'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Rettleiingar-og-brosjyrar.html?id=2083'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Bagadusat-ja-gihppagat.html?id=2083'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="guidelines-and-brochures_id_2083.html" xml:lang="eng"/>
	<parallel_text location="rettleiingar-og-brosjyrar_id_2083.html" xml:lang="nno"/>
	<parallel_text location="bagadusat-ja-gihppagat_id_2083.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
