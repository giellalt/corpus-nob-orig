...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ad/tema/velferdspolitikk.html?id=942'"/>
<xsl:variable name="title" select="'Čálgopolitihkka - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'welfare-policy.html?id=942'"/>
...
<xsl:variable name="para_sme" select="'algopolitihkka.html?id=942'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="welfare-policy_id_942.html" xml:lang="eng"/>
	<parallel_text location="algopolitihkka_id_942.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
