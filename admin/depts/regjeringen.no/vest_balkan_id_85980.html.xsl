...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ud/dep/org/avdelinger/europaavdelingen/vest_balkan.html?id=85980'"/>
<xsl:variable name="title" select="'Oarje-Bálkan-sekšuvdna - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'western_balkans.html?id=85980'"/>
...
<xsl:variable name="para_sme" select="'Oarje-Balkan-sekuvdna.html?id=85980'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="western_balkans_id_85980.html" xml:lang="eng"/>
	<parallel_text location="oarje-balkan-sekuvdna_id_85980.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
