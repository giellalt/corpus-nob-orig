...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fkd/dep/tilknyttede-virksomheter/veterinarinstituttet.html?id=168615'"/>
<xsl:variable name="title" select="'Veterinearainstituhtta - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'The-National-Veterinary-Institute.html?id=168615'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Veterinarinstituttet.html?id=168615'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'Veterinearainstituhtta.html?id=168615'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="the-national-veterinary-institute_id_168615.html" xml:lang="eng"/>
	<parallel_text location="veterinarinstituttet_id_168615.html" xml:lang="nno"/>
	<parallel_text location="veterinearainstituhtta_id_168615.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
