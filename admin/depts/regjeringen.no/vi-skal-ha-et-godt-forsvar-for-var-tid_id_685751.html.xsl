...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fd/aktuelt/nyheter/2012/--vi-skal-ha-et-godt-forsvar-for-var-tid.html?id=685751'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Mis galgá leat buorre suodjalus heivehuvvon min áigái - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'712'"/>
...
<xsl:variable name="para_nno" select="'-vi-star-pa-terskelen-til-eit-nytt-havev.html_id=697512'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'mis-galga-leat-buorre-suodjalus-heivehuv.html_id=685751'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="mis-galga-leat-buorre-suodjalus-heivehuv_id_685751.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
