...
<xsl:variable name="para_eng" select="'Vidar-Ulriksen--Secretary-of-State.html?id=1676'"/>
...
<xsl:variable name="para_sme" select="'Stahtaalli-Vidar-Ulriksen-.html?id=1676'"/>
