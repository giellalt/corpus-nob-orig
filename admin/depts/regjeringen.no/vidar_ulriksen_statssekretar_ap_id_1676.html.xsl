...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fkd/dep/politisk_ledelse/vidar_ulriksen__statssekretar_ap.html?id=1676'"/>
<xsl:variable name="title" select="'Stáhtačálli Vidar Ulriksen  - regjeringen.no'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="vidar-ulriksen--secretary-of-state_id_1676.html" xml:lang="eng"/>
	<parallel_text location="stahtaalli-vidar-ulriksen-_id_1676.html" xml:lang="sme"/>
</xsl:variable>
