...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/kd/tema/videregaende-opplaring.html?id=87102'"/>
<xsl:variable name="title" select="'Joatkkaoahpahus - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'upper-secondary-education.html?id=87102'"/>
...
<xsl:variable name="para_sme" select="'joatkkaoahpahus.html?id=87102'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="upper-secondary-education_id_87102.html" xml:lang="eng"/>
	<parallel_text location="joatkkaoahpahus_id_87102.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
