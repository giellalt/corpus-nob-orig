...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fin/pressesenter/pressemeldinger/2012/videreutvikling-av-investeringsstrategie.html?id=677409'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Stáhta olgoriikka penšuvdnafoandda viidáset ahtanuššan - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'757'"/>
...
<xsl:variable name="para_eng" select="'further-development-of-the-investment-st.html_id=677409'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'vidareutvikling-av-investeringsstrategie.html_id=677409'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'stahta-olgoriikka-penuvdnafoandda-viidas.html_id=677409'"/>
...
<xsl:variable name="parallels">
	...
	<parallel_text location="vidareutvikling-av-investeringsstrategie_id_677409.html" xml:lang="nno"/>
	<parallel_text location="stahta-olgoriikka-penuvdnafoandda-viidas_id_677409.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
