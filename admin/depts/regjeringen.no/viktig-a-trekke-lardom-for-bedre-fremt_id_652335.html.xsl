...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/smk/pressesenter/pressemeldinger/2011/--viktig-a-trekke-lardom-for-bedre-fremt.html?id=652335'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'- Dehálaš oahppat vai sáhttá buoridit boahtteáiggi gearggusvuođa - regjeringen.no'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="22-july-commission-lessons-are-important_id_652335.html"/>
        ...
        <parallel_text xml:lang="sme" location="dehala-oahppat-vai-sahtta-buoridit-boa_id_652335.html"/>
