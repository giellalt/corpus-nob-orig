...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ad/pressesenter/pressemeldinger/2009/vil-oke-bruken-av-samiske-sprak.html?id=564145'"/>
<xsl:variable name="title" select="'Áigu eanedit sámegiela geavaheami - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'1119'"/>
...
<xsl:variable name="para_sme" select="'aigu-eanedit-samegiela-geavaheami.html?id=564145'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="aigu-eanedit-samegiela-geavaheami_id_564145.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
