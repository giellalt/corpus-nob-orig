...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/fad/pressesenter/pressemeldinger/2011/vil-undersoke-korrupsjonsrisiko-i-norge.html?id=663225'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Áigu iskat korrupšuvdnariskka Norggas - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'268'"/>
...
<xsl:variable name="para_eng" select="'risk-of-corruption-in-norway-to-be-explo.html_id=663225'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'vil-undersokje-korrupsjonsrisiko-i-noreg.html_id=663225'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'aigu-iskat-korrupuvdnariskka-norggas.html_id=663225'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="risk-of-corruption-in-norway-to-be-explo_id_663225.html" xml:lang="eng"/>
	<parallel_text location="vil-undersokje-korrupsjonsrisiko-i-noreg_id_663225.html" xml:lang="nno"/>
	<parallel_text location="aigu-iskat-korrupuvdnariskka-norggas_id_663225.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
