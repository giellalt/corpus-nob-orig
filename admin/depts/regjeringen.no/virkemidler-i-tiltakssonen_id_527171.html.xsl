...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/krd/tema/regional-_og_distriktspolitikk/virkeomrader-retningslinjer-og-regler/virkemidler-i-tiltakssonen.html?id=527171'"/>
<xsl:variable name="title" select="'Doaibmaguovlu Finnmárku ja Davvi-Romsa  - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'action-zone-in-finnmark-and-nord-troms.html?id=527171'"/>
...
<xsl:variable name="para_sme" select="'doaibmaguovlu-finnmarku-ja-davvi-romsa-.html?id=527171'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="action-zone-in-finnmark-and-nord-troms_id_527171.html" xml:lang="eng"/>
	<parallel_text location="doaibmaguovlu-finnmarku-ja-davvi-romsa-_id_527171.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
