...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/krd/tema/regional-_og_distriktspolitikk/virkeomrader-retningslinjer-og-regler.html?id=526844'"/>
<xsl:variable name="title" select="'Doaibmaguovlu ja njuolggadusat  - regjeringen.no'"/>
...
<xsl:variable name="para_sme" select="'doaibmaguovlu-ja-njuolggadusat-.html?id=526844'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="doaibmaguovlu-ja-njuolggadusat-_id_526844.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
