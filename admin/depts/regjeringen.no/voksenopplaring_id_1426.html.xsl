...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/kd/tema/livslang-laring/voksenopplaring.html?id=1426'"/>
<xsl:variable name="title" select="'Rávisolbmuid oahpahus - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'education-and-training-for-adults.html?id=1426'"/>
...
<xsl:variable name="para_sme" select="'ravisolbmuid-oahpahus.html?id=1426'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="education-and-training-for-adults_id_1426.html" xml:lang="eng"/>
	<parallel_text location="ravisolbmuid-oahpahus_id_1426.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
