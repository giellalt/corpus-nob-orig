...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="author1_ln" select="'Barne-, likestillings- og inkluderingsdepartementet'"/>
    <!-- m, f or unknown -->
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="violence-and-abuse-in-close-relationship_id_1022.html"/>
        ...
        <parallel_text xml:lang="nno" location="vald-og-overgrep-i-nare-relasjonar_id_1022.html"/>
        <parallel_text xml:lang="nob" location=""/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location=""/>
        <parallel_text xml:lang="sme" location="veahkavaldimat-ja-veahkavalddalavuoat-la_id_1022.html"/>
