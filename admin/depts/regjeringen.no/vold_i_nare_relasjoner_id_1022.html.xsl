...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/bld/tema/vold_i_nare_relasjoner.html?id=1022'"/>
<xsl:variable name="title" select="'Veahkaváldimat ja veahkaválddálašvuođat lagas gaskavuođain - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'359'"/>
...
<xsl:variable name="para_eng" select="'Violence-and-abuse-in-close-relationship.html?id=1022'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="violence-and-abuse-in-close-relationship_id_1022.html" xml:lang="eng"/>
	<parallel_text location="vald-og-overgrep-i-nare-relasjonar_id_1022.html" xml:lang="nno"/>
	<parallel_text location="veahkavaldimat-ja-veahkavalddalavuoat-la_id_1022.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
