...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ad/dep/org/avdelinger/vpa.html?id=1456'"/>
<xsl:variable name="title" select="'Čálgopolitihkalaš ossodat  - regjeringen.no'"/>
...
<xsl:variable name="para_eng" select="'the-department-of-welfare-policy.html?id=1456'"/>
<xsl:variable name="para_fin" select="''"/>
<xsl:variable name="para_fkv" select="''"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="'Velferdspolitisk-avdeling.html?id=1456'"/>
<xsl:variable name="para_nob" select="''"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'algopolitihkala-ossodat-.html?id=1456'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="the-department-of-welfare-policy_id_1456.html" xml:lang="eng"/>
	<parallel_text location="velferdspolitisk-avdeling_id_1456.html" xml:lang="nno"/>
	<parallel_text location="algopolitihkala-ossodat-_id_1456.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
