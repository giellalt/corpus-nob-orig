...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/kud/pressesenter/pressemeldinger/2010/William-Nygaard-ny-styreleder-i-NRK.html?id=607730'"/>
<xsl:variable name="title" select="'William Nygaard ny styreleder i NRK - regjeringen.no'"/>
...
<xsl:variable name="wordcount" select="'351'"/>
...
<xsl:variable name="para_sme" select="'William-Nygaard-NRK-oa-stivrajoiheaddjin.html?id=607730'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="william-nygaard-nrk-oa-stivrajoiheaddjin_id_607730.html" xml:lang="sme"/>
</xsl:variable>
>>>>>>> cc98ec8d55 (Norwegian Bokmål regjeringen.no docs renamed, metadata updated in parallel files)
