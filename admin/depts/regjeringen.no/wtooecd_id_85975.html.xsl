...
<xsl:variable name="filename" select="'http://regjeringen.no/nb/dep/ud/dep/org/avdelinger/europaavdelingen/wtooecd.html?id=85975'"/>
<xsl:variable name="title" select="'WTO/OECD-sekšuvdna  - regjeringen.no'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="wto_oecd_id_85975.html" xml:lang="eng"/>
