...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.skatteetaten.no/upload/PDFer/Rettledninger_2013/RettledningPosteneBM.pdf'"/>
    ...
    <parallel_text location="rettledningpostenes.pdf" xml:lang="sme"/>
</xsl:variable>
