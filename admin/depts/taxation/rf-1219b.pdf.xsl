...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.skatteetaten.no/upload/Skjemaer/2014/RF-1219B.pdf'"/>
    ...
    <parallel_text location="80336_rf-1219-s_utfyll.pdf" xml:lang="sme"/>
</xsl:variable>
