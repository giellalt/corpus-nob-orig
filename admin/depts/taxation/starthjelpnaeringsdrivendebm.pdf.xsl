...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
            ...
            <xsl:import href="file:///home/boerre/langtech-samling/langtech/tools/CorpusTools/corpustools/xslt/common.xsl"/>
    ...
    <xsl:variable name="filename" select="'http://www.skatteetaten.no/upload/PDFer/Rettledninger_2013/StarthjelpNaeringsdrivendeBM.pdf'"/>
    ...
    <parallel_text location="starthjelpnaeringsdrivendes.pdf" xml:lang="sme"/>
</xsl:variable>
