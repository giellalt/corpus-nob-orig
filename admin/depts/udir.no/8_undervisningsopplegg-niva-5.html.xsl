...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://veiledninger.udir.no/Samisk%20andrespr%e5k/www.udir.no/Lareplaner/Veiledninger-til-lareplaner/Revidert-2013/Samisk-som-andrespraak/Samisk-andrespraak-bokmaal/template-andre-trinn-i-enkel-tabell/Undervisningsopplegg-Niva-5/index.html'"/>
	...
	<parallel_text xml:lang="smj" location="8_undervisningsoppl.html"/></xsl:variable>
