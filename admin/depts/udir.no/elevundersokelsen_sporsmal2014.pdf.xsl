...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.udir.no/globalassets/upload/brukerundersokelser/sporsmal/elevundersokelsen/elevundersokelsen_sporsmal2014.pdf'"/>
    ...
    <parallel_text xml:lang="nno" location="elevundersokinga-sporsmala-nynorsk.pdf_epslanguage-no.pdf"/>
	<parallel_text xml:lang="sme" location="elevsporreskjema_2013_nord-samisk_obligatorisk_del_og_t1-t15_.pdf_epslanguage-no.pdf"/></xsl:variable>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'12-16'"/>
