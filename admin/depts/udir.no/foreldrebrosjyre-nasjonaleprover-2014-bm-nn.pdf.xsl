...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.udir.no/PageFiles/82639/Foreldrebrosjyre-Nasjonaleprover-2014-bm-nn.pdf'"/>
    ...
    <language xml:lang="nno"/><language xml:lang="nob"/></xsl:variable>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="smj" location="foreldrebrosjyre_nasjonaleprover_2014_lulesamisk.pdf"/>
