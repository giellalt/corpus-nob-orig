...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.udir.no/globalassets/upload/brosjyrer/5/fra_eldst_til_yngst_veileder_fra_kd.pdf'"/>
    ...
    <parallel_text xml:lang="sme" location="veileder-fra-eldst-til-yngst-nsamisk_web.pdf"/></xsl:variable>
