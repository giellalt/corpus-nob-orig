...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.udir.no/globalassets/upload/vurdering/grunnlagsdokument-2014-2017.pdf'"/>
    ...
    <parallel_text xml:lang="nno" location="grunnlagsdokument-2014-2017-nyn.pdf"/>
	<parallel_text xml:lang="sme" location="grunnlagsdokument-20142017-samisk.pdf"/></xsl:variable>
