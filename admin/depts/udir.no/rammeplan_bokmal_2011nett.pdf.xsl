...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.udir.no/globalassets/upload/barnehage/rammeplan/rammeplan_bokmal_2011nett.pdf'"/>
    ...
    <parallel_text xml:lang="eng" location="framework_plan_for_the_content_and_tasks_of_kindergartens_2011_rammeplan_engelsk.pdf"/>
	<parallel_text xml:lang="nno" location="rammeplan_nynorsk_nett2011.pdf"/>
	<parallel_text xml:lang="sme" location="rammeplan_nordsamisk.pdf"/></xsl:variable>
