...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'Samisk_1_Vurderingsskjema_kortsvar_langsvar_B.docx'"/>
	...
	<parallel_text xml:lang="sma" location="samisk_1_vurderingsskjema_kortsvar_langsvar_s.docx"/></xsl:variable>
