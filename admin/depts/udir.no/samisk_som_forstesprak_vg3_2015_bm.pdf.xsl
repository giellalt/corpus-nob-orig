...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'Samisk_som_forstesprak_Vg3_2015_BM.pdf'"/>
    ...
    <parallel_text xml:lang="sma" location="samisk_som_forstesprak_vg3_2015_sorsamisk.pdf"/>
	<parallel_text xml:lang="sme" location="samisk_som_forstesprak_vg3_2015_nordsamisk.pdf"/></xsl:variable>
