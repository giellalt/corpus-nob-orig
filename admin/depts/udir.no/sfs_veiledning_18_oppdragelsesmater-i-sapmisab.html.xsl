...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://veiledninger.udir.no/Samisk%20som%20f%f8rstespr%e5k/www.udir.no/Lareplaner/Veiledninger-til-lareplaner/Revidert-2013/Veiledning-til-lareplan-i-Samisk-som-forstespra/Samisk-som-forstesprak-Nordsamisk/Jo1--Vg1/Oppdragelsesmater-i-SapmiSab/index.html'"/>
	...
	<parallel_text xml:lang="smj" location="sfs_veiledning_18_oppdragelsesmater-i-sapmisabmesae.html"/></xsl:variable>
