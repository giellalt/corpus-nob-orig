...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://veiledninger.udir.no/Samisk%20som%20f%f8rstespr%e5k/www.udir.no/Lareplaner/Veiledninger-til-lareplaner/Revidert-2013/Veiledning-til-lareplan-i-Samisk-som-forstesprak/Samisk-som-forstesprak-Nordsamisk/4-arstrinn/index.html'"/>
	...
	<parallel_text xml:lang="sme" location="sfs_veiledning_7_4-arstrinn.html"/>
	<parallel_text xml:lang="smj" location="sfs_veiledning_7_4-jahkedasse.html"/></xsl:variable>
