...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.udir.no/contentassets/a7d84e333b6c4391b3e212c1b9af6ef9/udir_forelderinfo_skole_bokmaal.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Informasjon til foreldre i skolen'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="udir_forelderinfo_skole_engelsk.pdf"/>
        ...
        <parallel_text xml:lang="nno" location="udir_forelderinfo_skole_nynorsk.pdf"/>
        <parallel_text xml:lang="nob" location=""/>
        <parallel_text xml:lang="rus" location=""/>
        <parallel_text xml:lang="sma" location="udir_forelderinfo_skole_sorsamisk.pdf"/>
        <parallel_text xml:lang="sme" location="udir_forelderinfo_skole_nordsamisk.pdf"/>
