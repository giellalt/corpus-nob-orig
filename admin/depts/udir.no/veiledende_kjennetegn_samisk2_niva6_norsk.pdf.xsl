...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.udir.no/globalassets/upload/vurdering/kjennetegn/kjennetegn_samisk2_niva6_norsk.pdf'"/>
    ...
    <parallel_text xml:lang="sma" location="veiledende_kjennetegn_samisk2_niva6_sorsamisk.pdf"/>
	<parallel_text xml:lang="sme" location="veiledende_kjennetegn_samisk2_niva6_nordsamisk.pdf"/></xsl:variable>
