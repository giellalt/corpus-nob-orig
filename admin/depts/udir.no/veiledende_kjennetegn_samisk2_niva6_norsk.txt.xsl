...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <parallel_text xml:lang="sma" location="veiledende_kjennetegn_samisk2_niva6_sorsamisk.txt"/>
	<parallel_text xml:lang="sme" location="veiledende_kjennetegn_samisk2_niva6_nordsamisk.txt"/></xsl:variable>
