...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'Vurderingsskjema_Samisk1_BM.pdf'"/>
    ...
    <parallel_text xml:lang="sma" location="vurderingsskjema_samisk1_sorsamisk.pdf"/>
	<parallel_text xml:lang="sme" location="vurderingsskjema_samisk1_nordsamisk.pdf"/></xsl:variable>
