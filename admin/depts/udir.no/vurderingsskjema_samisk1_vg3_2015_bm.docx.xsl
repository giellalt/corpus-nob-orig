...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'Vurderingsskjema_Samisk1_Vg3_2015_BM.docx'"/>
    ...
    <parallel_text xml:lang="sma" location="vurderingsskjema_samisk1_vg3_2015_sorsamisk.docx"/>
	<parallel_text xml:lang="sme" location="vurderingsskjema_samisk1_vg3_2015_nordsamisk.docx"/></xsl:variable>
