...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'7-9, 18, 54-56'"/>
    ...
    <xsl:variable name="top_margin" select="'16=28, 17=25, 20=22, 23=39'"/>
    ...
    <xsl:variable name="inner_top_margin" select="'15=60, 16=40, 17=37, 19=55, 20=37, 21=40, 22=38, 24=54'"/>
    <xsl:variable name="inner_bottom_margin" select="'15=26, 16=22, 17=44, 19=35, 20=48, 21=43, 22=49, 24=30'"/>
