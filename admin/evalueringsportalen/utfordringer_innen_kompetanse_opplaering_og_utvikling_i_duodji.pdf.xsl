...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'2, 29, 34'"/>
    ...
    <xsl:variable name="top_margin" select="'24=25'"/>
    <xsl:variable name="bottom_margin" select="'all=10, 8=13, 23=34'"/>
    ...
    <xsl:variable name="inner_top_margin" select="'4=28, 5=11, 18=14, 23=33, 25=12, 30=15'"/>
    <xsl:variable name="inner_bottom_margin" select="'4=60, 5=81, 18=70, 23=43, 25=80, 30=65'"/>
