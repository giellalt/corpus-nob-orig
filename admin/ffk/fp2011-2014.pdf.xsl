...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.ffk.no/docs/ec5d1016-da8a-4b82-817c-3055eb4f548d.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'FAGSKOLEPLAN 2011-2014 Strategisk plan for fagskoleutdanning i Finnmark'"/>
    <!--
    ...
    <xsl:variable name="publisher" select="'Finnmark fylkeskommune'"/>
    ...
    <xsl:variable name="sub_email" select="'marja.eira@uit.no'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="pff2011-2014.pdf"/>
