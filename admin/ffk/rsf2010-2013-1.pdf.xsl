...
<xsl:variable name="filename" select="'http://ffk.no/docs/3beef1e2-44d8-406c-89ed-4576694ce2ba.pdf'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Regional Samferdselsplan for Finnmark 2010–2013'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="fjp2010-2013-1.pdf" xml:lang="sme"/>
</xsl:variable>
