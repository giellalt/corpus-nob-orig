...
<xsl:variable name="filename" select="'http://www.ffk.no/docs/c9577fb4-9d85-4bb3-bd5a-975291c752d8.pdf'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Strategier for høyere utdanning og forskning i Finnmark 2011-2014'"/>
...
<xsl:variable name="para_sme" select="'sf2011-2014.pdf'"/>
