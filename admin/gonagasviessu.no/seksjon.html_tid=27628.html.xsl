...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.kongehuset.no/seksjon.html?tid=27628'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="seksjon.html_tid=28696.html"/>
        ...
        <parallel_text xml:lang="sme" location="seksjon.html_tid=75707_sek=74949.html"/>
