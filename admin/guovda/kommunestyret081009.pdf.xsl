...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.kautokeino.kommune.no/Finnmark/Kautokeino/kautokeinok.nsf/Attachments/D5EFDE51D6AA0E8641257728004AC8AE/$FILE/KST+protokoll+08.10.09.pdf'"/>
    ...
    <xsl:variable name="publisher" select="'Kautokeino kommune'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="suohkanstivra081009.pdf"/>
