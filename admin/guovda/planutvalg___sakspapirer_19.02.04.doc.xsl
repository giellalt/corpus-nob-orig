...
<xsl:stylesheet xmlns:i18n="http://apache.org/cocoon/i18n/2.1" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:variable name="filename" select="'Planutvalg___sakspapirer_19.02.04.doc'"/>
  <xsl:variable name="title" select="'Medlemmer i planutvalget'"/>
  ...
  <xsl:variable name="wordcount" select="'8132'"/>
