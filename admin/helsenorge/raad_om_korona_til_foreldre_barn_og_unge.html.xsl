...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://helsenorge.no/koronavirus/barn-og-gravide?redirect=false'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Råd om korona til foreldre, barn og unge'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="advice_for_parents_children_and_youth.html"/>
        ...
        <parallel_text xml:lang="sme" location="ravvagat_korona_birra_vahnemiidda_manaide_ja_nuoraide.html"/>
