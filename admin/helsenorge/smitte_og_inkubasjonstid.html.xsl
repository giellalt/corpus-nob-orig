...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://helsenorge.no/koronavirus/smitte-og-inkubasjonstid?redirect=false'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Symptomer, inkubasjonstid og sykdomsforløp'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="transmission_and_incubation_time.html"/>
        ...
        <parallel_text xml:lang="sme" location="njoammun_ja_inkubasuvdnaaigi.html"/>
