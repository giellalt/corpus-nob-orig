...
<xsl:variable name="para_fkv" select="'halti_kvenkultusenter_iks_26.06.09_kvensk.doc'"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="''"/>
<xsl:variable name="para_nob" select="'halti_kvenkultusenter_iks_26.06.09_norsk.doc'"/>
