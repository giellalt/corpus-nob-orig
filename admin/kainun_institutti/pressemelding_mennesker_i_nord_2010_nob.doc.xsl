...
<xsl:variable name="para_fkv" select="'pressemelding_mennesker_i_nord_2010.doc'"/>
...
<xsl:variable name="para_sme" select="'pressemelding_mennesker_i_nord_2010_sme.doc'"/>
