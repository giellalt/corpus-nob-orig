...
<xsl:variable name="para_fkv" select="'uuet_laulut_konserttiprogramin_teksti.doc'"/>
...
<xsl:variable name="para_sme" select="'uuet_laulut_konserttiprogramin_teksti_sme.doc'"/>
