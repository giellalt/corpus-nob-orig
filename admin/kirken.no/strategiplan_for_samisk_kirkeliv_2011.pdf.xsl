...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://kirken.no/globalassets/kirken.no/om-kirken/slik-styres-kirken/planer-visjonsdokument-og-strategier/strategiplan_samisk_kirkeliv_2011_norsk_web.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Strategiplan for samisk kirkeliv'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="sami_girkoeallima_strategalas_plana.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'1-3, 5-7, 9-36, 43, 52, 116'"/>
    ...
    <xsl:variable name="top_margin" select="'67=60, 92=42, 107=80'"/>
    <xsl:variable name="bottom_margin" select="'66=66'"/>
    ...
    <!--
        ...
        must be defined.
    -->
    <xsl:variable name="inner_right_margin" select="'37=7, 41=7'"/>
    <xsl:variable name="inner_left_margin" select="'37=50, 41=50'"/>
    <xsl:variable name="inner_top_margin" select="'37=25, 41=22'"/>
    <xsl:variable name="inner_bottom_margin" select="'37=50, 41=42'"/>
