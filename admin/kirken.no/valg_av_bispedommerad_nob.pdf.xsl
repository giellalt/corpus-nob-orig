...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://kirken.no/globalassets/kirken.no/om-kirken/slik-styres-kirken/kirkevalget/2015/for-medarbeidere/veiledninger/2-3-6_plakat_valg-av-bdr-forhtallsv_bm.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Valg av bispedømmeråd og Kirkemøtet'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="smj" location="valg_av_bispedommerad_smj.pdf"/>
    ...
    <xsl:variable name="inner_left_margin" select="'1=60'"/>
    <xsl:variable name="inner_top_margin" select="'1=55'"/>
    <xsl:variable name="inner_bottom_margin" select="'1=15'"/>
