...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.arkivinordland.no/nytt-seminar-om-nordlands-historie.aspx'"/>
    ...
    <parallel_text xml:lang="sma" location="artikkel.aspx_mid1-583_aid-17307.html"/></xsl:variable>
