...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://nsr.no/wp-content/uploads/2017/10/muohtacalmmit--norsk.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Muohtačalmmiterklæringen'"/>
    <!--
    ...
    <xsl:template match="p[parent::body][not(./em | ./span)][text()]">
        ...
        <xsl:element name="p">
            ...
            <xsl:call-template name="globalTextReplace">
                ...
                <xsl:with-param name="target" select="'MuohtačAlmmiterklæringen/* I norsk oversettelse fra Gustavsen, Jon og Sandvik, Kjell (1981): Vår jord er vårt liv. Forfatterforlaget./'"/>
                <xsl:with-param name="replacement" select="'Muohtačalmmiterklæringen//'"/>
