...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="nsr_valgmagasin_trykkfil_2017.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'1-6, 9-14, 16-33, 35-40'"/>
    ...
    <xsl:variable name="left_margin" select="'8=50'"/>
    <xsl:variable name="top_margin" select="'all=12, 7=50, 34=50'"/>
