...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.ntfk.no/OmOss/budsjett/Documents/Budsjett2013_ferdig.pdf'"/>
    ...
    <parallel_text xml:lang="sma" location="budsjett-_a_konomiplan_sa_rsamisk_13._feb.docx"/></xsl:variable>
