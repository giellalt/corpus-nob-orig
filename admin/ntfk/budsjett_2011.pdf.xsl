...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.ntfk.no/OmOss/budsjett/Documents/Budsjett%202011.pdf'"/>
    ...
    <parallel_text xml:lang="sma" location="budsjedte_2011_ntfk.pdf"/></xsl:variable>
