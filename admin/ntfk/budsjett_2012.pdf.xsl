...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.ntfk.no/OmOss/budsjett/Documents/Budsjett%202012.pdf'"/>
    ...
    <parallel_text xml:lang="sma" location="budsjett_2012_-_8_mai_-_sa_rsamisk.pdf"/></xsl:variable>
