...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.ntfk.no/OmOss/budsjett/Documents/Endelig%20b2010.doc'"/>
    ...
    <parallel_text xml:lang="sma" location="budsjett_2010.pdf"/></xsl:variable>
