...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.ntfk.no/bibliotek/saker/2011/FR/FR11158.htm'"/>
    ...
    <parallel_text xml:lang="sma" location="fr11158-1_innstilling_og_vurdering_pay-_sa_rsamisk.htm.html"/></xsl:variable>
