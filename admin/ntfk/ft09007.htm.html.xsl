...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.ntfk.no/bibliotek/saker/2009/FT/FT09007.htm'"/>
    ...
    <parallel_text xml:lang="sma" location="ft09007sorsamisk.htm.html"/></xsl:variable>
