...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.ntfk.no/Aarjelsaemien/Sider/Guektiengielevoetevierhtieh.aspx'"/>
    ...
    <parallel_text xml:lang="sma" location="guektiengielevoete.html"/></xsl:variable>
