...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.ntfk.no/NordTrondelag/brosjyre/Documents/Nord-Tr%C3%B8ndelag.pdf'"/>
    ...
    <parallel_text xml:lang="sma" location="noerhte-tra_a_ndelaage.pdf"/></xsl:variable>
