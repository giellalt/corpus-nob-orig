...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.ntfk.no/Politikk/fylkesradet/Sider/Politiskplattform.aspx'"/>
    ...
    <parallel_text xml:lang="sma" location="politihkeles.vaarome.html"/></xsl:variable>
