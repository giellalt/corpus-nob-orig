...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.ntfk.no/Documents/RUP%202013%20trykt%20versjon.pdf'"/>
    ...
    <parallel_text xml:lang="sma" location="regijovnale_evtiedimmie_programme_2013.pdf"/></xsl:variable>
