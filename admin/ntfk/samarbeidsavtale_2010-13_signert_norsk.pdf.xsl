...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.ntfk.no/Aarjelsaemien/Documents/Samarbeidsavtale%202010-13%20signert%20norsk.pdf'"/>
    ...
    <parallel_text xml:lang="sma" location="samarbeidsavtale_2010-13_signert_samisk.pdf"/></xsl:variable>
