...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.ntfk.no/Arbeidsomrader/utdanning/Sider/Oppf%C3%B8lgingstjenesten.aspx'"/>
    ...
    <parallel_text xml:lang="sma" location="vaaksjoestim-miedienesje.html"/></xsl:variable>
