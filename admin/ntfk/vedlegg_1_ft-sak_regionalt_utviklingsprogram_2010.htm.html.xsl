...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.ntfk.no/bibliotek/saker/2009/FR/%D8vrige%20vedlegg/Vedlegg%201%20FT-sak%20regionalt%20utviklingsprogram%202010.htm'"/>
    ...
    <parallel_text xml:lang="sma" location="vedlegg_1_ft-sak_regionalt_utviklingsprogram_2010.htm.html"/></xsl:variable>
