...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.ntfk.no/bibliotek/saker/2005/FT/Vedlegg%5CFT05041_1.htm'"/>
    ...
    <parallel_text xml:lang="sma" location="vedlegg_ft05041_1.htm.html"/></xsl:variable>
