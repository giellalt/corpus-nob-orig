...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="author1_fn" select="'Svanhild'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="Samelagagiellanjuolggadusaid_evalueren.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'1-4, 6-8, 12-14, 69-115, 138-281'"/>
    ...
    <xsl:variable name="bottom_margin" select="'11=65, 17;26;56=15, 35=22'"/>
