...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.regjeringen.no/contentassets/78f5a49a59964b21beb1be515c8a14d2/bevilgninger-til-samiske-formal-i-statsbudsjettet-2020.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Bevilgninger til samiske formål i statsbudsjettet 2020'"/>
    <!--
    ...
    <xsl:variable name="publisher" select="'Kommunal- og moderniseringsdepartementet'"/>
    <!-- The values are either: published or unpublished -->
    <xsl:variable name="publChannel" select="'published'"/>
    <!-- Publication year -->
    <xsl:variable name="year" select="'2019'"/>
    <xsl:variable name="ISBN" select="''"/>
    <xsl:variable name="ISSN" select="''"/>
    <xsl:variable name="place" select="'regjeringen.no'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="bevilgninger-til-samiske-formal-i-statsbudsjettet-2020.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'1, 24-48'"/>
    ...
    <xsl:variable name="bottom_margin" select="'all=10, 2=60'"/>
