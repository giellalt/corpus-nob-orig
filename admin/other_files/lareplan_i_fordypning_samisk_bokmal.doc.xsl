...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.udir.no/upload/larerplaner/Fastsatte_lareplaner_for_Kunnskapsloeftet/Samiske/Lareplan_i_fordypning_samisk_bokmal.rtf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'LÆREPLAN I FORDYPNING I SAMISK'"/>
    <!--
    ...
    <xsl:variable name="wordcount" select="'1137'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="smj" location="fordypning_i_samisk_lulesamisk.doc"/>
