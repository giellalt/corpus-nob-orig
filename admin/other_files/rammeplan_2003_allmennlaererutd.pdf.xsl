...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.regjeringen.no/globalassets/upload/kilde/kd/pla/2006/0002/ddd/pdfv/175666-rammeplan_2003_allmennlaererutd.pd'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Rammeplan for Allmennlærerutdanningen'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="rammeplan_for_allmennlaererutdanningen_pa_samisk04_ny.pdf"/>
    ...
    <!--
        ...
        must be defined.
    -->
    <xsl:variable name="inner_right_margin" select="'14=5'"/>
    <xsl:variable name="inner_left_margin" select="'14=5'"/>
    <xsl:variable name="inner_top_margin" select="'14=20'"/>
    <xsl:variable name="inner_bottom_margin" select="'14=50'"/>
