...
<xsl:variable name="filename" select="'http://www.regjeringen.no/upload/KRD/Vedlegg/REGA/FK_rapportering_2009/Troms_RUP_08_09.pdf'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Regionalt utviklingsprogram for Troms 2008-2009'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="regionalt_utviklingsprogram_for_troms_2008-2009.pdf" xml:lang="sme"/>
</xsl:variable>
