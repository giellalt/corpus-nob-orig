...
<!-- variable filename contains the original name of the file (from submitter)-->
  <xsl:variable name="filename" select="'aktivitetsplan_2002_no.doc'"/>
  <xsl:variable name="title" select="'SAMISK SPRÃKSENTERS AKTIVITETER I 2002'"/>
  ...
  <xsl:variable name="wordcount" select="'854'"/>
