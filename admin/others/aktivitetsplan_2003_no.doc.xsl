...
<!-- variable filename contains the original name of the file (from submitter)-->
  <xsl:variable name="filename" select="'aktivitetsplan_2003_no.doc'"/>
  <xsl:variable name="title" select="'SAMISK SPRÃKSENTERS AKTIVITETER I 2003'"/>
  ...
  <xsl:variable name="wordcount" select="'1387'"/>
