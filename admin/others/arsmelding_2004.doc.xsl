...
<!-- variable filename contains the original name of the file (from submitter)-->
  <xsl:variable name="filename" select="'arsmelding_2004.doc'"/>
  <xsl:variable name="title" select="'SÃMI GIELLAGUOVDDÃÅ½A JAHKEDIEÄÃHUS JAGI 2004'"/>
  ...
  <xsl:variable name="wordcount" select="'4243'"/>
