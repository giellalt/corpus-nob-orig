...
<xsl:variable name="filename" select="'http://www.tromsfylke.no/Portals/0/Vedlegg/Publikasjoner/Rapporter/rsrapport20030001.pdf'"/>
...
<xsl:variable name="para_sme" select="'samiskarsrapport0000.pdf'"/>
