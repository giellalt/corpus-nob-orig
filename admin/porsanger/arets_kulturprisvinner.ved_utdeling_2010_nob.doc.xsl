...
<xsl:variable name="parallels">
	<parallel_text location="arets_kulturprisvinner.ved_utdeling_2010_sme.doc" xml:lang="sme"/>
	<parallel_text location="arets_kulturprisvinner.ved_utdeling_2010.doc" xml:lang="fkv"/>
</xsl:variable>
