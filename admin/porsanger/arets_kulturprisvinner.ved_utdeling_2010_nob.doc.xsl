...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="translator_born" select="'FIN'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fkv" location="arets_kulturprisvinner.ved_utdeling_2010.doc"/>
        ...
        <parallel_text xml:lang="sme" location="arets_kulturprisvinner.ved_utdeling_2010_sme.doc"/>
