...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.royrvik.kommune.no/nordtrondelag/royrvik/royrvikk.nsf/Attachments/794F28BDE6048A30C1257DD3004C14CD/$FILE/Brev+sendt+til+alle+lag+og+organisasjoner.pdf'"/>
    ...
    <parallel_text xml:lang="sma" location="brev_sendt_til_alle_lag_og_organisasjoner.pdf"/></xsl:variable>
