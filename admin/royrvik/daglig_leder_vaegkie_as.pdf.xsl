...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://royrvik.kommune.no/nordtrondelag/royrvik/royrvikk.nsf/Attachments/Daglig+leder+Vaegkie+as.pdf/$FILE/Daglig+leder+Vaegkie+as.pdf'"/>
    ...
    <parallel_text xml:lang="sma" location="mijjieh_ay-vtehkem_vaegkie_as_10.12.14.docx"/></xsl:variable>
