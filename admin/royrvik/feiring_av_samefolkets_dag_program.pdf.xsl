...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.royrvik.kommune.no/nordtrondelag/royrvik/royrvikk.nsf/Attachments/018F7F16512D4884C1257C74002C703D/$FILE/Feiring+av+Samefolkets+dag+Program.pdf'"/>
    ...
    <parallel_text xml:lang="sma" location="feiring_av_samefolkets_dag_program_samisk.pdf"/></xsl:variable>
