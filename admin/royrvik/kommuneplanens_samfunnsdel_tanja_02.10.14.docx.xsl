...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.royrvik.kommune.no/nordtrondelag/royrvik/royrvikk.nsf/Attachments/AC0A757839F9704DC1257D650034E217/$FILE/Kommuneplanens+samfunnsdel+(TAnja)+02.10.14.docx'"/>
    ...
    <parallel_text xml:lang="sma" location="kommuneplanens_samfunnsdel_tanja_02.10.14.docx"/></xsl:variable>
