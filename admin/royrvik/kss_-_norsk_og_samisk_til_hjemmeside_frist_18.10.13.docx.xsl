...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.royrvik.kommune.no/nordtrondelag/royrvik/royrvikk.nsf/Attachments/EC259229C3132AA7C1257BF10033FC3F/$FILE/KSS+-+norsk+og+samisk+til+hjemmeside+frist+18.10.13.docx'"/>
    ...
    <parallel_text xml:lang="sma" location="kss_-_norsk_og_samisk_til_hjemmeside_frist_18.10.13.docx"/></xsl:variable>
