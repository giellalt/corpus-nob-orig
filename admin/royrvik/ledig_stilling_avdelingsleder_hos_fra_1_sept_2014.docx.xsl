...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.royrvik.kommune.no/nordtrondelag/royrvik/royrvikk.nsf/Attachments/C8D8860445D95174C1257CF600384CA7/$FILE/Ledig+stilling+avdelingsleder+HOS+fra+1+sept+2014.docx'"/>
    ...
    <parallel_text xml:lang="sma" location="ledig_stilling_avdelingsleder_hos_fra_1_sept_2014.docx"/></xsl:variable>
