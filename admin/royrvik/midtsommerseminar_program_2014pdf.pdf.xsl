...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.royrvik.kommune.no/nordtrondelag/royrvik/royrvikk.nsf/Attachments/Midtsommerseminar+program+2014PDF.pdf/$FILE/Midtsommerseminar+program+2014PDF.pdf'"/>
    ...
    <parallel_text xml:lang="sma" location="midtsommerseminar_program_2014pdf.pdf"/></xsl:variable>
