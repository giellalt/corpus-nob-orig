...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.royrvik.kommune.no/nordtrondelag/royrvik/royrvikk.nsf/Attachments/CD4E967508B31B5CC1257C3F004CF87B/$FILE/Pedagogisk+leder+Maurtua+-+f%C3%B8dsels+vikariat+2014.docx'"/>
    ...
    <parallel_text xml:lang="sma" location="pedagogisk_leder_maurtua_-_fa_dsels_vikariat_2014.docx"/></xsl:variable>
