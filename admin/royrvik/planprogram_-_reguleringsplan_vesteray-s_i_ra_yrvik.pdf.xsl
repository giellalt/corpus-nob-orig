...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.royrvik.kommune.no/nordtrondelag/royrvik/royrvikk.nsf/Attachments/5DDF9EDBEF23073BC1257B8600435542/$FILE/Planprogram+-+reguleringsplan+Vester%C3%A5s+i+R%C3%B8yrvik.pdf'"/>
    ...
    <parallel_text xml:lang="sma" location="planprogram_-_reguleringsplan_vesteray-s_i_ra_yrvik_-_kunngja_ring_samisk.docx"/></xsl:variable>
