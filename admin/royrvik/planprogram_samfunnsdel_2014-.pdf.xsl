...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.royrvik.kommune.no/nordtrondelag/royrvik/royrvikk.nsf/Attachments/BB4BEDA2A98D4AB2C1257CD90033038B/$FILE/Planprogram+samfunnsdel+2014-.pdf'"/>
    ...
    <parallel_text xml:lang="sma" location="planprogram_samfunnsdel_samisk_endelig.pdf"/></xsl:variable>
