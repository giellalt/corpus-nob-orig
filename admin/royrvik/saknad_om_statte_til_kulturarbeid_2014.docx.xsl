...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.royrvik.kommune.no/nordtrondelag/royrvik/royrvikk.nsf/Attachments/10F17A8D0FB345BDC1257CA5004A24A6/$FILE/S%C3%98KNAD+OM+ST%C3%98TTE+TIL+KULTURARBEID+2014.docx'"/>
    ...
    <parallel_text xml:lang="sma" location="samisk_versjon-sa_knad_om_midler_til_kulturarbeid_anne_gunn_.docx"/></xsl:variable>
