...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.royrvik.kommune.no/nordtrondelag/royrvik/royrvikk.nsf/Attachments/Spr%C3%A5kbad+2014+PDF.pdf/$FILE/Spr%C3%A5kbad+2014+PDF.pdf'"/>
    ...
    <parallel_text xml:lang="sma" location="spray-kbad_2014_pdf.pdf"/></xsl:variable>
