...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.royrvik.kommune.no/nordtrondelag/royrvik/royrvikk.nsf/Attachments/ADFB55DA44877D45C1257DAD00441BD0/$FILE/Utlysningstekst+ROS+13.12.14+norsk+og+samisk+5+stillinger.docx'"/>
    ...
    <parallel_text xml:lang="sma" location="utlysningstekst_ros_13.12.14_norsk_og_samisk_5_stillinger.docx"/></xsl:variable>
