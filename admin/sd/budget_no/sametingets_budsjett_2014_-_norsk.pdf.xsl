...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'1-8'"/>
    ...
    <xsl:variable name="bottom_margin" select="'17=52'"/>

    <xsl:variable name="inner_right_margin" select="'16=0,18=0,22=0,23=0'"/>
    <xsl:variable name="inner_left_margin" select="'16=0,18=0,22=0,23=0'"/>
    <xsl:variable name="inner_top_margin" select="'16=42,18=14,22=53,23=59'"/>
    <xsl:variable name="inner_bottom_margin" select="'16=28,18=55,22=32,23=28'"/>
