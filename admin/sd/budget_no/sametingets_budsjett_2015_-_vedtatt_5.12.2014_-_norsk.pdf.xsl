...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="bottom_margin" select="'14=89'"/>

    <xsl:variable name="inner_right_margin" select="'13=0'"/>
    <xsl:variable name="inner_left_margin" select="'13=0'"/>
    <xsl:variable name="inner_top_margin" select="'13=11'"/>
    <xsl:variable name="inner_bottom_margin" select="'13=59'"/>
