...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://samediggi.no/content/download/5975/55121/version/1/file/Sametingets+reviderte+budsjett+2014+-+norsk.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sametingets reviderte budsjett 2014'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="sametingets_reviderte_budsjett_2014_-_nordsamisk.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'1-3,8,9,12'"/>
    ...
    <xsl:variable name="top_margin" select="'10=30,11=33'"/>
    <xsl:variable name="bottom_margin" select="'5=86,6=39,7=40,10=25,11=59'"/>
    ...
    <xsl:variable name="inner_top_margin" select="'6=20,7=11'"/>
    <xsl:variable name="inner_bottom_margin" select="'6=55,7=61'"/>
