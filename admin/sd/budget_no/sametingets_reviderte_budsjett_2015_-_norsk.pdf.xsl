...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://samediggi.no/content/download/8081/71699/version/1/file/Sametingets+reviderte+budsjett+2015+-+norsk.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sametingets reviderte budsjett 2015'"/>
    ...
    <parallel_text location="sametingets_reviderte_budsjett_2015_-_nordsamisk.pdf" xml:lang="sme"/>
</xsl:variable>
    ...
    <xsl:variable name="bottom_margin" select="'5=88'"/>

    <xsl:variable name="inner_right_margin" select="'6=0,7=0'"/>
    <xsl:variable name="inner_left_margin" select="'6=0,7=0'"/>
    <xsl:variable name="inner_top_margin" select="'6=12,7=12'"/>
    <xsl:variable name="inner_bottom_margin" select="'6=63,7=26'"/>
