...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://samediggi.no/content/download/593/5236/version/1/file/Avtale+om+gjennomf%C3%B8ring+av+konsultasjoner+mellom+Sametinget+og+NVE+%282009%29.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Avtale om gjennomføring av konsultasjoner mellom Sametinget og NVE'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="a_iehtadus_konsultaa_uvnnaid_aaaaheamis_sa_medikki_ja_nae_gaskka_2009_.pdf"/>
    ...
    <xsl:variable name="top_margin" select="'1=22,2=7,3=7'"/>
    <xsl:variable name="bottom_margin" select="'3=50'"/>
