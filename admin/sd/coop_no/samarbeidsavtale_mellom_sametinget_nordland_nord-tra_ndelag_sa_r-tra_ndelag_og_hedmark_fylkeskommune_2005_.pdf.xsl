...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <parallel_text location="na_a_rjen_saemiedigkie_noerhtelaanten_-_noerhte-tra_ndelaagen_-_ay=arjelh_tra_ndelaagen_-_jih_hedemarken_fylhkestjielth_edtjieh_ektesne_barkedh_2005_.pdf" xml:lang="sma"/>
</xsl:variable>
