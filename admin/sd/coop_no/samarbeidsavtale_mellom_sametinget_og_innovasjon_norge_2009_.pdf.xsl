...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://samediggi.no/content/download/592/5232/version/1/file/Samarbeidsavtale+mellom+Sametinget+og+Innovasjon+Norge+%282009%29.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Samarbeidsavtale mellom Sámediggi/Sametinget og Innovasjon Norge/Innovašuvdna Norga'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="ovttasbargoa_iehtadus_sa_medikki_ja_innovaa_uvdna_norgga_gaskka_2009_.pdf"/>
    ...
    <xsl:variable name="bottom_margin" select="'4=82'"/>
