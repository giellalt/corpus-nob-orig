...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://samediggi.no/content/download/595/5244/version/1/file/Samarbeidsavtale+om+samisk+kulturminnevern+mellom+Sametinget+og+Oppland+fylkeskommune+%282009-2012%29.pdf'"/>
    ...
    <parallel_text location="laavenjostememay=ay=htedimmie_saemien_kultuvrevaarjelimmien_ba-jre_saemiedigkie_jih_oppland_fylhkentja-elten_gaskem_2009-2012_.pdf" xml:lang="sma"/>
</xsl:variable>
