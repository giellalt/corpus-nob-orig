...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'Handlingsplan mot vold og overgrep i samiske samfunn -lars filip paulsen nob.docx'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="handlingsplan_mot_vold_og_overgrep_i_samiske_samfunn-lars_filip_paulsen_sme.docx"/>
