...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'Muotka_oppnevnt_til_styringsgruppen_regional_plan_for_reindrift_i_Troms_og_Finnmark_-1 nob.docx'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="muotka_oppnevnt_til_styringsgruppen_regional_plan_for_reindrift_i_troms_og_finnmark_-1_sme.docx"/>
