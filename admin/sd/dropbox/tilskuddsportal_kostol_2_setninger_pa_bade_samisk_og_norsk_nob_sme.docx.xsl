...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'tilskuddsportal Kostøl, 2 setninger på både samisk og norsk nob sme.docx'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="tilskuddsportal_kostol_2_setninger_pa_bade_samisk_og_norsk_nob_sme.docx"/>
