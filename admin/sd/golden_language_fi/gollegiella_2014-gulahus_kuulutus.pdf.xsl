...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="title" select="'Nordisk samisk språkpris deles ut høsten 2014'"/>
    <!--
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'1-7,9'"/>
    ...
    <xsl:variable name="top_margin" select="'8=11'"/>
    <xsl:variable name="bottom_margin" select="'8=43'"/>
