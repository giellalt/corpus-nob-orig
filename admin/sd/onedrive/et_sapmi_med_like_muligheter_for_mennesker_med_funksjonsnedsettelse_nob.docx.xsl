...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'Et_Sápmi_med_like_muligheter_for_mennesker_med_funksjonsnedsettelse nob.docx'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="et_sapmi_med_like_muligheter_for_mennesker_med_funksjonsnedsettelse_sme.docx"/>
