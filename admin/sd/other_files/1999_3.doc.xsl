...
<xsl:variable name="wordcount" select="'69763'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="1999_3s.doc" xml:lang="sme"/>
</xsl:variable>
...
<xsl:template match="p[parent::body][not(./em | ./span)][text()]">
    ...
    <xsl:element name="p">
        ...
        <xsl:call-template name="globalTextReplace">
           ...
           <xsl:with-param name="target" select="'bufé/'"/>
           <xsl:with-param name="replacement" select="'bufe/'"/>
