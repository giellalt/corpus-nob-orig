...
<xsl:variable name="filename" select="'http://samediggi.no/filnedlasting.aspx?FilId=1495&amp;ct=.pdf'"/>
<xsl:variable name="title" select="'Evaluering av tilskuddsordningen for Samisk utviklingsfond'"/>
...
<xsl:variable name="ISBN" select="'978-82-7571-165-4'"/>
...
<xsl:variable name="wordcount" select="'35621'"/>
...
<xsl:variable name="para_sme" select="'Sámi_ovddidanfoandda_doarjjaortnegiid_árvvoštallan.pdf'"/>
