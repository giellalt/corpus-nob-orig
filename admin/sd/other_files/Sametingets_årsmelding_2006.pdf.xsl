...
<xsl:variable name="filename" select="'http://samediggi.no/filnedlasting.aspx?FilId=1200&amp;ct=.pdf'"/>
<xsl:variable name="title" select="'Sametingets årsmelding 2006'"/>
...
<xsl:variable name="wordcount" select="'16485'"/>
...
<xsl:variable name="para_sme" select="'Sámedikki_2006_jahkedieđáhus.pdf'"/>
