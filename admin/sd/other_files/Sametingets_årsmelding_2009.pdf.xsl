...
<xsl:variable name="filename" select="'http://samediggi.no/filnedlasting.aspx?FilId=2801&amp;ct=.pdf'"/>
<xsl:variable name="title" select="'Sametingets årsmelding 2009'"/>
...
<xsl:variable name="wordcount" select="'31013'"/>
...
<xsl:variable name="para_sme" select="'Sámedikki_2009_jahkedieđáhus.pdf'"/>
