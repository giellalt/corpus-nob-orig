...
<xsl:variable name="filename" select="'http://samediggi.no/filnedlasting.aspx?FilId=1819&amp;ct=.pdf'"/>
<xsl:variable name="title" select="'SAMETINGETS HANDLINGSPLAN FOR HOLDNINGSSKAPENDE ARBEID I BARNEHAGEN'"/>
...
<xsl:variable name="wordcount" select="'3413'"/>
...
<xsl:variable name="para_sme" select="'Sámedikki_doaibmaplána_mánáidgárddiid_miellaávkkálaš_bargguid_ovddideami_várás.pdf'"/>
