...
<xsl:variable name="filename" select="'http://samediggi.no/filnedlasting.aspx?FilId=1957&amp;ct=.pdf'"/>
<xsl:variable name="title" select="'Sametingets handlingsplan for likestilling'"/>
...
<xsl:variable name="wordcount" select="'2077'"/>
...
<xsl:variable name="para_sme" select="'Sámedikki_dásseárvodoaibmaplána_2009_2013.pdf'"/>
