...
<xsl:variable name="filename" select="'http://samediggi.no/filnedlasting.aspx?FilId=2041&amp;ct=.pdf'"/>
<xsl:variable name="title" select="'Sametingsrådets miljø- og arealmelding'"/>
...
<xsl:variable name="wordcount" select="'17600'"/>
...
<xsl:variable name="para_sme" select="'Sámediggeráđi_biras-_ja_areáladieđáhus.pdf'"/>
