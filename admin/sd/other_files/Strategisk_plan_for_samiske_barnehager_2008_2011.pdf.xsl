...
<xsl:variable name="filename" select="'http://samediggi.no/filnedlasting.aspx?FilId=1816&amp;ct=.pdf'"/>
<xsl:variable name="title" select="'Strategisk plan for samiske barnehager 2008–2011'"/>
...
<xsl:variable name="wordcount" select="'4905'"/>
...
<xsl:variable name="para_sme" select="'Strategalaš_plána_sámi_mánáidgárddiide_2008_2011.pdf'"/>
