...
<xsl:variable name="filename" select="'http://samediggi.no/filnedlasting.aspx?FilId=2610&amp;ct=.pdf'"/>
<xsl:variable name="title" select="'Vurdering av behovet for et kompetansesenter for utmarksnæringer'"/>
<xsl:variable name="author1_fn" select="'Magne'"/>
<xsl:variable name="author1_ln" select="'Svineng'"/>
<xsl:variable name="author1_gender" select="'m'"/>
<xsl:variable name="author1_born" select="''"/>
<xsl:variable name="author1_nat" select="'NO'"/>
<xsl:variable name="author2_fn" select="'Veslemøy K.'"/>
<xsl:variable name="author2_ln" select="'Dahl'"/>
...
<xsl:variable name="wordcount" select="'24382'"/>
...
<xsl:variable name="para_sme" select="'árvvoštallat_gealboguovddáža_dárbbu_meahcástanealáhusaid_várás.pdf'"/>
