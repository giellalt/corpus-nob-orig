...
<xsl:variable name="filename" select="'http://samediggi.no/filnedlasting.aspx?FilId=124&amp;ct=.doc'"/>
<xsl:variable name="title" select="'Bruken av samiske språk 2000'"/>
...
<xsl:variable name="wordcount" select="'29662'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samegielaid_geavaheapmi_2000.doc" xml:lang="sme"/>
</xsl:variable>
