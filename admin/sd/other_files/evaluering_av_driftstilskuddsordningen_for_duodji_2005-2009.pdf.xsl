...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://samediggi.no/filnedlasting.aspx?FilId=2867&amp;ct=.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Evaluering av driftstilskuddsordningen for duodji 2005-2009'"/>
    <!--
        Information of the first author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author1_fn" select="'Stig'"/>
    <xsl:variable name="author1_ln" select="'Karlstad'"/>
    <!-- m, f or unknown -->
    ...
    <!--
        ...
        date or year of birth, nationality.
    -->
    <xsl:variable name="author2_fn" select="'Ivar'"/>
    <xsl:variable name="author2_ln" select="'Lie'"/>
    ...
    <xsl:variable name="ISBN" select="'978-82-7571-192-0'"/>
    ...
    <xsl:variable name="wordcount" select="'20245'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="duoji_doaibmadoarjagiid_arvvostallan_2005-2009.pdf"/>
