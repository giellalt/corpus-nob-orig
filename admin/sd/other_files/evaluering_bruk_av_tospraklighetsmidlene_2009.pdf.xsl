...
<xsl:variable name="filename" select="'http://samediggi.no/filnedlasting.aspx?FilId=2089&amp;ct=.pdf'"/>
<xsl:variable name="title" select="'EVALUERING Bruk av tospråklighetsmidlene'"/>
<xsl:variable name="author1_fn" select="'Ole-Magne'"/>
<xsl:variable name="author1_ln" select="'Kleve'"/>
<xsl:variable name="author1_gender" select="'m'"/>
<xsl:variable name="author1_born" select="''"/>
<xsl:variable name="author1_nat" select="'NO'"/>
<xsl:variable name="author2_fn" select="'Trygg'"/>
<xsl:variable name="author2_ln" select="'Jakola'"/>
<xsl:variable name="author2_gender" select="'m'"/>
<xsl:variable name="author2_born" select="''"/>
<xsl:variable name="author2_nat" select="'NO'"/>
<xsl:variable name="author3_fn" select="'Lone'"/>
<xsl:variable name="author3_ln" select="'Hegg'"/>
<xsl:variable name="author3_gender" select="'f'"/>
<xsl:variable name="author3_born" select="''"/>
<xsl:variable name="author3_nat" select="'NO'"/>
<xsl:variable name="author4_fn" select="'Jan'"/>
<xsl:variable name="author4_ln" select="'Aslaksen'"/>
...
<xsl:variable name="wordcount" select="'23050'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="guovttegielatvuoda_doarjagiid_geavaheapmi_2009.pdf" xml:lang="sme"/>
</xsl:variable>
