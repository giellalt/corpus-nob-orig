...
<xsl:variable name="title" select="'Melding om samiske helse- og sosialtjenester'"/>
...
<xsl:variable name="wordcount" select="'8445'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="helse-_og_sosialmelding_samisk.pdf" xml:lang="sme"/>
</xsl:variable>
