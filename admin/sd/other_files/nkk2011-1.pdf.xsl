...
<xsl:variable name="filename" select="'http://innsyn.e-kommune.no/innsyn_sametinget_norsk/wfdocument.aspx?journalpostid=2011004906&amp;dokid=305842&amp;versjon=2&amp;variant=P&amp;ct=RA-PDF'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Nærings- og kulturkomiteen Møtebok 01/11'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="ekl2011-1.pdf" xml:lang="sme"/>
</xsl:variable>
