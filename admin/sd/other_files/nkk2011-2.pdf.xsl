...
<xsl:variable name="filename" select="'http://innsyn.e-kommune.no/innsyn_sametinget_norsk/wfdocument.aspx?journalpostid=2011013203&amp;dokid=321027&amp;versjon=3&amp;variant=P&amp;ct=RA-PDF'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Nærings- og kulturkomiteen Møtebok 2/11'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="ekl2011-2.pdf" xml:lang="sme"/>
</xsl:variable>
