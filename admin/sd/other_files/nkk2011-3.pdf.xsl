...
<xsl:variable name="filename" select="'http://innsyn.e-kommune.no/innsyn_sametinget_norsk/wfdocument.aspx?journalpostid=2011024092&amp;dokid=339692&amp;versjon=1&amp;variant=P&amp;ct=RA-PDF'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Nærings- og kulturkomiteen Møtebok 3/11'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="ekl2011-3.pdf" xml:lang="sme"/>
</xsl:variable>
