...
<xsl:variable name="filename" select="'http://innsyn.e-kommune.no/innsyn_sametinget_norsk/wfdocument.aspx?journalpostid=2011030631&amp;dokid=351076&amp;versjon=1&amp;variant=P&amp;ct=RA-PDF'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Nærings- og kulturkomiteen Møtebok 004/11'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="ekl2011-4.pdf" xml:lang="sme"/>
</xsl:variable>
