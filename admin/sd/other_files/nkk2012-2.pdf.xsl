...
<xsl:variable name="filename" select="'http://innsyn.e-kommune.no/innsyn_sametinget_norsk/wfdocument.aspx?journalpostid=2012016071&amp;dokid=384223&amp;versjon=1&amp;variant=P&amp;ct=RA-PDF'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Nærings- og kulturkomiteen Møtebok 002/12'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="ekl2012-2.pdf" xml:lang="sme"/>
</xsl:variable>
