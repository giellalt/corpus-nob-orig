...
<xsl:stylesheet xmlns:i18n="http://apache.org/cocoon/i18n/2.1" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:variable name="filename" select="'nkk_1_04_1.doc'"/>
  <xsl:variable name="title" select="'M&#xF8;teprotokoll'"/>
  <xsl:variable name="author1_fn" select="'Hege'"/>
  <xsl:variable name="author1_ln" select="'Fjellheim Sarre'"/>
  ...
  <xsl:variable name="wordcount" select="'2801'"/>
