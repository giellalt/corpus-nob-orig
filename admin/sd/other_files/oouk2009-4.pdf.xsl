...
<xsl:variable name="filename" select="'http://innsyn.e-kommune.no/innsyn_sametinget_norsk/wfdocument.aspx?journalpostid=2009030622&amp;dokid=232542&amp;versjon=1&amp;variant=P&amp;ct=RA-PDF'"/>
<xsl:variable name="title" select="'Møtebok 04/09'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="bfol2009-4.pdf" xml:lang="sme"/>
</xsl:variable>
