...
<xsl:variable name="filename" select="'http://innsyn.e-kommune.no/innsyn_sametinget_norsk/wfdocument.aspx?journalpostid=2010004055&amp;dokid=245316&amp;versjon=1&amp;variant=A&amp;ct=RA-PDF'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Plan- og finanskomiteen Møtebok 01/10'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="pfl2010-1.pdf" xml:lang="sme"/>
</xsl:variable>
