...
<xsl:variable name="filename" select="'http://innsyn.e-kommune.no/innsyn_sametinget_norsk/wfdocument.aspx?journalpostid=2012015754&amp;dokid=383717&amp;versjon=1&amp;variant=P&amp;ct=RA-PDF'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Plan- og finanskomiteen Møtebok 02/12'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="pfl2012-2.pdf" xml:lang="sme"/>
</xsl:variable>
