...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'pfk_1_04.doc'"/>
    ...
    -->
    <xsl:variable name="author1_fn" select="'Per A.'"/>
    <xsl:variable name="author1_ln" select="'Bær'"/>
    <!-- m, f or unknown -->
    ...
    <xsl:variable name="wordcount" select="'17845'"/>
