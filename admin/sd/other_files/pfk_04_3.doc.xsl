...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'pfk_3_04.doc'"/>
    ...
    -->
    <xsl:variable name="author1_fn" select="'Carl Erik'"/>
    <xsl:variable name="author1_ln" select="'Moksness'"/>
    <!-- m, f or unknown -->
    ...
    <!--
        ...
        date or year of birth, nationality.
    -->
    <xsl:variable name="author2_fn" select="'Tove'"/>
    <xsl:variable name="author2_ln" select="'Anti'"/>
    ...
    <xsl:variable name="wordcount" select="'16433'"/>
