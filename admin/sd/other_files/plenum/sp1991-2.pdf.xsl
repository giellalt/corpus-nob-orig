...
<xsl:variable name="filename" select="'http://samediggi.no/Filnedlasting.aspx?MId1=3434&amp;FilId=2425'"/>
<xsl:variable name="title" select="'MØTEBOK 2/91'"/>
...
<xsl:variable name="wordcount" select="'7354'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="dc1991-2.pdf" xml:lang="sme"/>
</xsl:variable>
