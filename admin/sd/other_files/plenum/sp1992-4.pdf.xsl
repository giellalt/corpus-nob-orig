...
<xsl:variable name="filename" select="'http://samediggi.no/Filnedlasting.aspx?MId1=3434&amp;FilId=2435'"/>
<xsl:variable name="title" select="'MØTEBOK 4/92'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="dc1992-4.pdf" xml:lang="sme"/>
</xsl:variable>
