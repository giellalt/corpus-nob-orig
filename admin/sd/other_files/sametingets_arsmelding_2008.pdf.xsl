...
<xsl:variable name="filename" select="'http://samediggi.no/filnedlasting.aspx?FilId=1976&amp;ct=.pdf'"/>
<xsl:variable name="title" select="'Sametingets årsmelding 2008'"/>
...
<xsl:variable name="wordcount" select="'22627'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samedikki_2008_jahkediedahus.pdf" xml:lang="sme"/>
</xsl:variable>
