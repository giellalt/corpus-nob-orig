...
<xsl:variable name="filename" select="'http://samediggi.no/filnedlasting.aspx?FilId=1555&amp;ct=.pdf'"/>
<xsl:variable name="title" select="'Sametingets regnskap 2007'"/>
...
<xsl:variable name="wordcount" select="'2437'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samedikki_2007_rehketdoallu.pdf" xml:lang="sme"/>
</xsl:variable>
