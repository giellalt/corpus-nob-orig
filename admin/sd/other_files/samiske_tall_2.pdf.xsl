...
<xsl:variable name="filename" select="'http://samediggi.no/filnedlasting.aspx?FilId=2200&amp;ct=.pdf'"/>
<xsl:variable name="title" select="'Samiske tall forteller 2'"/>
...
<xsl:variable name="author2_fn" select="'Johan Ailo'"/>
<xsl:variable name="author2_ln" select="'Kalstad'"/>
<xsl:variable name="author2_gender" select="'m'"/>
<xsl:variable name="author2_born" select="''"/>
<xsl:variable name="author2_nat" select="'NO'"/>
<xsl:variable name="author3_fn" select="'Magritt'"/>
<xsl:variable name="author3_ln" select="'Brustad'"/>
...
<xsl:variable name="wordcount" select="'35734'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="sami_logut_2.pdf" xml:lang="sme"/>
</xsl:variable>
