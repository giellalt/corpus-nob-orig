...
<xsl:variable name="filename" select="'http://samediggi.no/Filnedlasting.aspx?MId1=3434&amp;FilId=2320'"/>
<xsl:variable name="title" select="'MØTEBOK 1/90'"/>
...
<xsl:variable name="wordcount" select="'13516'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="dc1990-1.pdf" xml:lang="sme"/>
</xsl:variable>
