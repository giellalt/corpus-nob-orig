...
<xsl:variable name="filename" select="'http://samediggi.no/Filnedlasting.aspx?MId1=3434&amp;FilId=2415'"/>
<xsl:variable name="title" select="'MØTEBOK 2/90'"/>
...
<xsl:variable name="wordcount" select="'10707'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="dc1990-2.pdf" xml:lang="sme"/>
</xsl:variable>
