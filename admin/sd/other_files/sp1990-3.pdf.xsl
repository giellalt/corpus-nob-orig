...
<xsl:variable name="filename" select="'http://samediggi.no/Filnedlasting.aspx?MId1=3434&amp;FilId=2418'"/>
<xsl:variable name="title" select="'MØTEBOK 3/90'"/>
...
<xsl:variable name="wordcount" select="'10075'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="dc1990-3.pdf" xml:lang="sme"/>
</xsl:variable>
