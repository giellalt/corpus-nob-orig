...
<xsl:variable name="filename" select="'http://samediggi.no/Filnedlasting.aspx?MId1=3434&amp;FilId=2420'"/>
<xsl:variable name="title" select="'MØTEBOK 4/90'"/>
...
<xsl:variable name="wordcount" select="'5698'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="dc1990-4.pdf" xml:lang="sme"/>
</xsl:variable>
