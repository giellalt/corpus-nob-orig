...
<xsl:variable name="filename" select="'http://samediggi.no/Filnedlasting.aspx?MId1=3434&amp;FilId=2429'"/>
<xsl:variable name="title" select="'MØTEBOK 1/92'"/>
...
<xsl:variable name="wordcount" select="'12920'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="dc1992-1.pdf" xml:lang="sme"/>
</xsl:variable>
