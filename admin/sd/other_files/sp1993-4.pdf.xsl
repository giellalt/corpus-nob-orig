...
<xsl:variable name="filename" select="'http://samediggi.no/Filnedlasting.aspx?MId1=3434&amp;FilId=2442'"/>
<xsl:variable name="title" select="'MØTEBOK 4/93 • VEDTAKSDEL'"/>
...
<xsl:variable name="wordcount" select="'9675'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="dc1993-4.pdf" xml:lang="sme"/>
</xsl:variable>
