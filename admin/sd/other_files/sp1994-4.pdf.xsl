...
<xsl:variable name="filename" select="'http://samediggi.no/Filnedlasting.aspx?MId1=3435&amp;FilId=2450'"/>
<xsl:variable name="title" select="'MØTEBOK 4/94 - VEDTAKSDEL'"/>
...
<xsl:variable name="wordcount" select="'8411'"/>
...
<!-- 	<parallel_text location="dc1994-4.pdf" xml:lang="sme"/> -->
</xsl:variable>
