...
<xsl:variable name="filename" select="'http://samediggi.no/Filnedlasting.aspx?MId1=3435&amp;FilId=2462'"/>
<xsl:variable name="title" select="'MØTEBOK 1/96 - FORHANDLINGSDEL'"/>
...
<xsl:variable name="wordcount" select="'10891'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="dc1996-1a.pdf" xml:lang="sme"/>
</xsl:variable>
