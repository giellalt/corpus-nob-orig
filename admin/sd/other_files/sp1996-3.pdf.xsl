...
<xsl:variable name="filename" select="'http://samediggi.no/Filnedlasting.aspx?MId1=3435&amp;FilId=2468'"/>
<xsl:variable name="title" select="'Møtebok 3/96'"/>
...
<xsl:variable name="wordcount" select="'22768'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="dc1996-3.pdf" xml:lang="sme"/>
</xsl:variable>
