...
<xsl:variable name="filename" select="'http://samediggi.no/Filnedlasting.aspx?MId1=3435&amp;FilId=2469'"/>
<xsl:variable name="title" select="'Møtebok 4/96'"/>
...
<xsl:variable name="wordcount" select="'40935'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="dc1996-4.pdf" xml:lang="sme"/>
</xsl:variable>
...
<xsl:element name="p">
            ...
            <xsl:call-template name="globalTextReplace">
               ...
               <xsl:with-param name="target" select="'KåråSjohka/habi1it~/==±=/'"/>
               <xsl:with-param name="replacement" select="'Kárášjohka/habi1itet//'"/>
