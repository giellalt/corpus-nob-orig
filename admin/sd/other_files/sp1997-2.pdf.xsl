...
<xsl:variable name="filename" select="'http://samediggi.no/Filnedlasting.aspx?MId1=3435&amp;FilId=2474'"/>
...
<xsl:variable name="wordcount" select="'29985'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="dc1997-2.pdf" xml:lang="sme"/>
</xsl:variable>
