...
<xsl:variable name="filename" select="'http://samediggi.no/Filnedlasting.aspx?MId1=3435&amp;FilId=2476'"/>
<xsl:variable name="title" select="'Møtebok 3/97'"/>
...
<xsl:variable name="wordcount" select="'4834'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="dc1997-3.pdf" xml:lang="sme"/>
</xsl:variable>
