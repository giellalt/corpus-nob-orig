...
<xsl:variable name="filename" select="'http://innsyn.e-kommune.no/innsyn_sametinget_norsk/wfdocument.aspx?journalpostid=2011007474&amp;dokid=310350&amp;versjon=1&amp;variant=P&amp;ct=RA-PDF'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Sametingets plenum Møtebok 01/11'"/>
...
<xsl:variable name="publisher" select="'Norgga Sámedigg'"/>
...
<xsl:variable name="sub_name" select="'Márjá Eira'"/>
<xsl:variable name="sub_email" select="'marja.eira@gmail.com'"/>
...
<xsl:variable name="para_sme" select="'dc2011-1.pdf'"/>
