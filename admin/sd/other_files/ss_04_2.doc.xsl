...
<!-- Format query results for display --><xsl:stylesheet xmlns:i18n="http://apache.org/cocoon/i18n/2.1" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:variable name="filename" select="'ss_2_04.doc'"/>
  <xsl:variable name="title" select="'Møteprotokoll'"/>
  <xsl:variable name="author1_fn" select="'Berit Karen'"/>
  ...
  <xsl:variable name="author2_fn" select="'Maaren'"/>
  <xsl:variable name="author2_ln" select="'Palismaa'"/>
  <xsl:variable name="author2_gender" select="'f'"/>
  <xsl:variable name="author2_born" select="''"/>
  <xsl:variable name="author2_nat" select="'fin'"/>
  ...
  <xsl:variable name="translator_fn" select="'Berit Karen'"/>
