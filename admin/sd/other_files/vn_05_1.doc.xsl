...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'vn_1_05.doc'"/>
    ...
    -->
    <xsl:variable name="author1_fn" select="'Roy'"/>
    <xsl:variable name="author1_ln" select="'Amundsen'"/>
    <!-- m, f or unknown -->
    ...
    <xsl:variable name="wordcount" select="'6132'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="vl_05_1.doc"/>
