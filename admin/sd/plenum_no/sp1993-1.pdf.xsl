...
<xsl:variable name="filename" select="'http://samediggi.no/Filnedlasting.aspx?MId1=3434&amp;FilId=2437'"/>
<xsl:variable name="title" select="'MØTEBOK 1/93'"/>
...
<xsl:variable name="wordcount" select="'7904'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="dc1993-1.pdf" xml:lang="sme"/>
</xsl:variable>
