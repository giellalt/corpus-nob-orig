...
<xsl:variable name="filename" select="'http://samediggi.no/Filnedlasting.aspx?MId1=3434&amp;FilId=2440'"/>
<xsl:variable name="title" select="'MØTEBOK 3/93'"/>
...
<xsl:variable name="wordcount" select="'1479'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="dc1993-3.pdf" xml:lang="sme"/>
</xsl:variable>
