...
<xsl:variable name="filename" select="'http://samediggi.no/Filnedlasting.aspx?MId1=3435&amp;FilId=2444'"/>
<xsl:variable name="title" select="'MØTEBOK 1/94 - VEDTAKSDEL'"/>
...
<xsl:variable name="wordcount" select="'12102'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="dc1994-1.pdf" xml:lang="sme"/>
</xsl:variable>
