...
<xsl:variable name="filename" select="'http://samediggi.no/Filnedlasting.aspx?MId1=3435&amp;FilId=2448'"/>
<xsl:variable name="title" select="'MØTEBOK 3/94 - VEDTAKSDEL'"/>
...
<xsl:variable name="wordcount" select="'7212'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="dc1994-3.pdf" xml:lang="sme"/>
</xsl:variable>
