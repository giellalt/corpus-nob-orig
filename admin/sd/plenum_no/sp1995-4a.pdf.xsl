...
<xsl:variable name="filename" select="'http://samediggi.no/Filnedlasting.aspx?MId1=3435&amp;FilId=2458'"/>
<xsl:variable name="title" select="'MØTEBOK 4/95 - FORHANDLINGSDEL'"/>
...
<xsl:variable name="wordcount" select="'7736'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="dc1995-4a.pdf" xml:lang="sme"/>
</xsl:variable>
