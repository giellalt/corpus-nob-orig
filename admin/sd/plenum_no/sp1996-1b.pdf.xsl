...
<xsl:variable name="filename" select="'http://samediggi.no/Filnedlasting.aspx?MId1=3435&amp;FilId=2463'"/>
<xsl:variable name="title" select="'MØTEBOK 1/96 - VEDTAKSDEL'"/>
...
<xsl:variable name="wordcount" select="'23199'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="dc1996-1b.pdf" xml:lang="sme"/>
</xsl:variable>
