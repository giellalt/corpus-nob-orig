...
<xsl:variable name="filename" select="'http://samediggi.no/Filnedlasting.aspx?MId1=3435&amp;FilId=2466'"/>
<xsl:variable name="title" select="'MØTEBOK 2/96 VEDTAKSDEL'"/>
...
<xsl:variable name="wordcount" select="'14511'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="dc1996-2.pdf" xml:lang="sme"/>
</xsl:variable>
