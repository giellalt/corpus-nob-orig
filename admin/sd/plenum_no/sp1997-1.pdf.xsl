...
<xsl:variable name="filename" select="'http://samediggi.no/Filnedlasting.aspx?MId1=3435&amp;FilId=2472'"/>
<xsl:variable name="title" select="'Møtebok 1/97'"/>
...
<xsl:variable name="wordcount" select="'50285'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="dc1997-1.pdf" xml:lang="sme"/>
</xsl:variable>
