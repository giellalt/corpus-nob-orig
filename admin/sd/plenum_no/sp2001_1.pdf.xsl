...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://samediggi.no/content/download/3560/32306/version/1/file/P+1-2001+Norsk.pdf'"/>
    ...
    <parallel_text location="dc2001_1.doc" xml:lang="sme"/>
</xsl:variable>
