...
<xsl:variable name="filename" select="'http://innsyn.e-kommune.no/innsyn_sametinget_norsk/wfdocument.aspx?journalpostid=2011032945&amp;dokid=354846&amp;versjon=1&amp;variant=P&amp;ct=RA-PDF'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Sametingets plenum Møtebok 04/11'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="dc2011-4.pdf" xml:lang="sme"/>
</xsl:variable>
