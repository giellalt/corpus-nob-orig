...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://innsyn.e-kommune.no/innsyn_sametinget_norsk/wfdocument.aspx?journalpostid=2012006896&amp;dokid=368163&amp;versjon=2&amp;variant=P&amp;ct=RA-PDF'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sametingets plenum Møtebok 01/12'"/>
    <!--
    ...
    <xsl:variable name="sub_email" select="'berit.nystad.eskonsipo@uit.n'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="dc2012-2.pdf"/>
