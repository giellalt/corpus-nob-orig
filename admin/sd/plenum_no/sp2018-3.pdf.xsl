...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="title" select="'Sametingets plenum Møtebok 03/18'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="dc2018-3.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'1-20, 27-41, 64-65, 104'"/>
    ...
    <xsl:variable name="top_margin" select="'21=33, 42=55, 46=25'"/>
    <xsl:variable name="bottom_margin" select="'all=9, 26=30, 45=79, 63=46'"/>
