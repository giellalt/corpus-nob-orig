...
<xsl:variable name="filename" select="'http://samediggi.no/filnedlasting.aspx?FilId=1760&amp;ct=.pdf'"/>
<xsl:variable name="title" select="'Samiske institusjoner og det sivile samiske samfunn'"/>
...
<xsl:variable name="wordcount" select="'22414'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="melding_om_samisk_institusjonsutvikling_samisk.pdf" xml:lang="sme"/>
</xsl:variable>
