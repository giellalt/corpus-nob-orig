...
<xsl:variable name="filename" select="'http://samediggi.no/filnedlasting.aspx?FilId=1722&amp;ct=.pdf'"/>
<xsl:variable name="title" select="'Sametingets jordbruksmelding'"/>
...
<xsl:variable name="wordcount" select="'17502'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="sametingets_jordbruksmelding_samisk.pdf" xml:lang="sme"/>
</xsl:variable>
