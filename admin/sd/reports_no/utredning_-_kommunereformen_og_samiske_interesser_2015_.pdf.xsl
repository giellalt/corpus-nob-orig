...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://samediggi.no/content/download/9522/81302/version/1/file/Utredning+-+Kommunereformen+og+samiske+interesser+%282015%29.pdf'"/>
    ...
    <parallel_text location="cielggadus_-_suohkanoaastus_ja_sa_mi_2015_.pdf" xml:lang="sme"/>
</xsl:variable>
