...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.sametinget.no/layout/set/print/Om-Sametinget/Organisasjonsstruktur/Sametingsraadet/Taler-og-artikler/11-1-millioner-til-samiske-formaal-siden-februar'"/>
    ...
    <parallel_text location="11-1-miljon-ru-sami-aigumusaide-guovvamanu-rajes.html" xml:lang="sme"/>
<parallel_text location="11-1-millijovnh-saemien-aassjelidie-goevten-maenngan.html" xml:lang="sma"/>
</xsl:variable>
