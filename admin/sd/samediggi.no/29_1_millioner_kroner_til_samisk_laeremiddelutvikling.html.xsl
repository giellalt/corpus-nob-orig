...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/29-1-millioner-kroner-til-samisk-laremiddelutvikling.16502.aspx'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'29,1 millioner kroner til samisk læremiddelutvikling - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="29_1_millijovnh_kravnah_saemien_learoevierhtieevtiedaemman.html"/>
        <parallel_text xml:lang="sme" location="29_1_miljovnna_ruvnno_sami_oahpponeavvoovdanahttimii.html"/>
