...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/saernieh/5-pilovth-fotefar-mot-nord-vajsaldahkem-orrestieh.23034.aspx?sprak=1'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'5 piloter fornyer fotefar mot nord - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="5_pilovth_fotefar_mot_nord-vaejsaldahkem_orrestieh.html"/>
        <parallel_text xml:lang="sme" location="5_piloter_fornyer_fotefar_mot_nord.html"/>
