...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/saernieh/74-studeenth-stipendem-jollebe-oohpehtamman-aadtjeme.22347.aspx?sprak=1'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'74 studenter har fått stipend for høyere utdanning - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="74_studeenth_stipendem_jollebe_oohpehtaemman_aadtjeme.html"/>
        <parallel_text xml:lang="sme" location="74_studeantta_leat_ozzon_alit_oahpahusa_stipeandda.html"/>
