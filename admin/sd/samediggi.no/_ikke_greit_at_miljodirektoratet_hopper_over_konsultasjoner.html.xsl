...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/saernieh/ikke-greit-at-miljodirektoratet-hopper-over-konsultasjoner.33093.aspx?sprak=1'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'– Ikke greit at Miljødirektoratet hopper over konsultasjoner - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="_ii_dohkalas_ahte_birasdirektorahta_ii_cuovo_konsultasuvnnaid.html"/>
