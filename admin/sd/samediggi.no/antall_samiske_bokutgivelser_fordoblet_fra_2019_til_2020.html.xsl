...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/antall-samiske-bokutgivelser-fordoblet-fra-2019-til-2020.13631.aspx'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Antall samiske bokutgivelser fordoblet fra 2019 til 2020 - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="guektiengierth_dan_gellie_gaerjabaejhkoehtimmieh_2020_goh_2019.html"/>
        <parallel_text xml:lang="sme" location="sami_girjealmmuheamit_duppalastojuvvon_2019_rajes_2020_radjai_.html"/>
