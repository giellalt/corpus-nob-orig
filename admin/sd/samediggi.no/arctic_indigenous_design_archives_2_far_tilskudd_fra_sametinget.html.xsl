...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/arctic-indigenous-design-archives-2-far-tilskudd-fra-sametinget.1911.aspx'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Arctic Indigenous Design Archives 2 får tilskudd fra Sametinget - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="arctic_indigenous_design_archives_2_daarjoem_aadtje_saemiedigkeste.html"/>
        <parallel_text xml:lang="sme" location="arctic_indigenous_design_archives_2_oazzu_doarjaga_samedikkis.html"/>
