...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.sametinget.no/layout/set/print/Kulturliv/Stipend-og-tilskudd/Arena-for-kunst-og-kulturformidling'"/>
    ...
    <parallel_text location="daidda-ja-kulturgaskkustanarenat.html" xml:lang="sme"/>
<parallel_text location="sijjie-kaaanste-jih-kultuvrebeagkoehtaemman.html" xml:lang="sma"/>
</xsl:variable>
