...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:variable name="filename" select="'http://www.sametinget.no/Arkiv/Valgperiode-2009-2013/Artikler/Allsamisk-moete-om-FNs-verdenskonferanse-om-urfolk'"/>
  ...
  <xsl:variable name="parallels">
    ...
    <parallel_text xml:lang="smj" location="arkiv_valgperiode-2009-2013_artikler_same-tjaahkanibme-ana-vaeraltkonferanssa-alggoalmmugij-birra.html"/>
    <parallel_text xml:lang="sme" location="arkiv_valgperiode-2009-2013_artikler_oppasami-coahkkin-on-algoalbmogiid-mailmmikonferanssa-birra-2014-s.html"/>
  </xsl:variable>
  <!--
