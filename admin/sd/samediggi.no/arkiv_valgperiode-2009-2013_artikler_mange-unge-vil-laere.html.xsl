...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.sametinget.no/Arkiv/Valgperiode-2009-2013/Artikler/Mange-unge-vil-laere'"/>
    ...
    <parallel_text xml:lang="smj" location="arkiv_valgperiode-2009-2013_artikler_ollu-nuorat-dahttot-oahppat.html"/>
