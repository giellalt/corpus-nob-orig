...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:variable name="parallels">
    ...
    <parallel_text xml:lang="sme" location="arkiv_valgperiode-2009-2013_artikler_haliida-laga-bokte-mearriduvvot-vuoigatvuohta-samegieloahpahussii-manaidgarddis.html"/>
  </xsl:variable>
  <!--
