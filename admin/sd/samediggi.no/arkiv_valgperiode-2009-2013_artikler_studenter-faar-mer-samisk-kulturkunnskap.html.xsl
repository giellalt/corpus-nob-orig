...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:variable name="filename" select="'http://www.sametinget.no/layout/set/print/Arkiv/Valgperiode-2009-2013/Artikler/Studenter-faar-mer-samisk-kulturkunnskap'"/>
  ...
  <xsl:variable name="parallels">
    ...
    <parallel_text xml:lang="smj" location="arkiv_valgperiode-2009-2013_artikler_oahppe-oadtju-ienep-same-kulturmahtudagav.html"/>
    <parallel_text xml:lang="sme" location="arkiv_valgperiode-2009-2013_artikler_studeanttat-ozzot-eanet-sami-kulturmahtu.html"/>
  </xsl:variable>
  <!--
