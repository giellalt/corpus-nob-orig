...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/arvu-skal-lede-faamoe-sammen-med-sametinget.6782.aspx'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Árvu skal lede Faamoe sammen med Sametinget - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="arvu_edtja_faamoem_juhtedh_saemiedigkine_ektine.html"/>
        <parallel_text xml:lang="sme" location="arvu_galga_jodihit_faamoe_ovttas_samedikkiin_.html"/>
