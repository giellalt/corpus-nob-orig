...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/saernieh/avjovarri-mandaatem-aarjel-noorjese-dassa.27712.aspx?sprak=1'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Ávjovárri mister mandat til Sør-Norge  - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="avjovarri_mandaatem_aarjel-noorjese_dassa.html"/>
        <parallel_text xml:lang="sme" location="avjovarri_massa_mandahta_lulli-norgii.html"/>
