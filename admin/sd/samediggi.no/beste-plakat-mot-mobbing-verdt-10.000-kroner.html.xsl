...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.sametinget.no/layout/set/print/Opplaering/Arbeidet-mot-mobbing/Beste-plakat-mot-mobbing-verdt-10.000-kroner'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="boeoeremes-plakaate-irhkemen-voeoeste-man-aarvoe-10-000-kraavnah.html"/>
        <parallel_text xml:lang="sme" location="buoremus-plakahtas-givssideami-vuosta-lea-10-000-ruvdnosas-arvu.html"/>
...
<xsl:template match="p[parent::body][not(./em | ./span)][text()]">
        ...
        <xsl:element name="p">
            ...
            <xsl:call-template name="globalTextReplace">
                <xsl:with-param name="inputString" select="$text"/>
                <xsl:with-param name="target" select="'08. april 2014/'"/>
