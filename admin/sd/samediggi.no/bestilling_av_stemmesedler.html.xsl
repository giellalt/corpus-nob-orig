...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/politihke/veeljeme/dutnjien-guhte-leah-veeljemebarkije/dongkeme-jienestimmiesietelijstie/?sprak=1'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Bestilling av stemmesedler - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="dongkeme_jienestimmiesietelijstie.html"/>
        <parallel_text xml:lang="sme" location="jienastanlihpuid_dinggojupmi_.html"/>
