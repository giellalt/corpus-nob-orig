...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.sametinget.no/layout/set/print/Opplaering/Barnehager/Bevilgninger-til-prosjekter-og-utviklingsarbeid-i-barnehager-i-2015'"/>
    ...
    <parallel_text location="daaarjoeh-prosjektide-jih-evtiedimmiebarkose-maanagiertine-2015.html" xml:lang="sma"/>
</xsl:variable>
