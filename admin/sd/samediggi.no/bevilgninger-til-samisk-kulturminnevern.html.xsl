...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.sametinget.no/layout/set/print/Miljoe-areal-og-kulturvern/Kulturminner/Bevilgninger-til-samisk-kulturminnevern'"/>
    ...
    <parallel_text location="daaarjoeh-saemien-kultuvremojhtesevaarjelaemman.html" xml:lang="sma"/>
<parallel_text location="juolludusat-sami-kulturmuitosuodjaleapmai.html" xml:lang="sme"/>
</xsl:variable>
