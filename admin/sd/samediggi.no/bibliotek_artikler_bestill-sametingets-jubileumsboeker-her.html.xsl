...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:variable name="filename" select="'http://www.sametinget.no/Bibliotek/Artikler/Bestill-Sametingets-jubileumsboeker-her'"/>
  ...
  <xsl:variable name="parallels">
    ...
    <parallel_text xml:lang="sme" location="girjeradju_artikler_dingo-samedikki-avvugirjjiid-dakko.html"/>
  </xsl:variable>
  <!--
