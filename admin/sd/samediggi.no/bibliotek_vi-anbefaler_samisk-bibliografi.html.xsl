...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.sametinget.no/Bibliotek/Vi-anbefaler/Samisk-bibliografi'"/>
    ...
    <parallel_text xml:lang="smj" location="girjeradju_mii-avzzuhit_sami-bibliografiija.html"/>
