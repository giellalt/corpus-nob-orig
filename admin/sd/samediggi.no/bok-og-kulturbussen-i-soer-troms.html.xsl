...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.sametinget.no/layout/set/print/Bibliotek/Vi-anbefaler/Bokbusser/Bok-og-kulturbussen-i-Soer-Troms'"/>
    ...
    <parallel_text location="bok-og-kulturbussen-i-soer-troms.html" xml:lang="sme"/>
<parallel_text location="gaerja-jih-kultuvrebusse-tromsesne.html" xml:lang="sma"/>
</xsl:variable>
