...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.sametinget.no/layout/set/print/Bibliotek/Vi-anbefaler/Bokbusser/Bokbussen-Karasjok-Utsjok-og-Porsanger'"/>
    ...
    <parallel_text location="bokbussen-karasjok-utsjok-og-porsanger.html" xml:lang="sme"/>
<parallel_text location="gaerjabusse-karasjohka-utsjok-porsanger.html" xml:lang="sma"/>
</xsl:variable>
