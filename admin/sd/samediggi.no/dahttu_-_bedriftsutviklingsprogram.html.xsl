...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/ealahus/sami-hutkasealahus/proseavttat/dahttu-fitnodatovddidanprogramma/?sprak=1'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Dáhttu - bedriftsutviklingsprogram - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="sielteevtiedimmieprogramme_dahttu.html"/>
        <parallel_text xml:lang="sme" location="dahttu_-_fitnodatovddidanprogramma.html"/>
