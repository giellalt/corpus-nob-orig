...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/kulturminne-og-bygningsvern/samiske-kulturminner-og-landskap/hva-er-samiske-kulturminner/'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Definisjoner på samiske kulturminner  - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="saemien_kultuvremojhtesh_-_definisjovnh.html"/>
        <parallel_text xml:lang="sme" location="sami_kulturmuittu_definisuvdna_.html"/>
