...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/rijkajgasskasasj-barggo/nuorttaguovlo/den-europeiske-unionen-eu/?sprak=1'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Den europeiske unionen (EU) - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="europan_ektiedimmie_ee_.html"/>
        <parallel_text xml:lang="sme" location="eurohpauniovdna_eu_.html"/>
