...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/adasa/dette-kan-du-gjore-dersom-du-opplever-hets-i-forbindelse-med-fosen-aksjonene.27854.aspx?sprak=1'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Dette kan du gjøre dersom du opplever hets i forbindelse med Fosen-aksjonene - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="dam_maahtah_darjodh_jis_laavsemem_fovsen-aksjovni_sjiekenisnie_daajrh.html"/>
        <parallel_text xml:lang="sme" location="maid_sahtat_dahkat_jus_vasihat_cielaheami_fovsen-aksuvnnaid_oktavuodas.html"/>
