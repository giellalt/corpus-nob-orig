...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/saernieh/digital-horing-om-rapporten-fra-sannhets-og-forsoningskommisjonen.27864.aspx?sprak=1'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Digital høring om rapporten fra Sannhets- og forsoningskommisjonen - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="digitala_gulaskuddan_duohtavuoda-_ja_soabahankommisuvnna_raporta_birra.html"/>
