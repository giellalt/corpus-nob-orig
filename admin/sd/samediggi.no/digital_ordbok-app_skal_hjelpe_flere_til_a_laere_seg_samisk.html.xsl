...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/digital-ordbok-app-skal-hjelpe-flere-til-a-lare-seg-samisk.8569.aspx'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Digital ordbok-app skal hjelpe flere til å lære seg samisk - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="digitala_satnegirje-appa_galga_veahkehit_eanet_olbmuid_oahppat_samegiela.html"/>
