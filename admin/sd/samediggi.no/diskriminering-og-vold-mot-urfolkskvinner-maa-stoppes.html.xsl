...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.sametinget.no/layout/set/print/Om-Sametinget/Organisasjonsstruktur/Sametingsraadet/Taler-og-artikler/Diskriminering-og-vold-mot-urfolkskvinner-maa-stoppes'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="sierredimmie-jih-vaedtsoesvoete-aalkoealmetjenyjseni-voeoeste-tjuara-naahkedh.html"/>
        <parallel_text xml:lang="sme" location="algoalbmotnissoniid-vealaheapmi-ja-veahkavaldi-sin-vuosta-ferte-bissehuvvot.html"/>
