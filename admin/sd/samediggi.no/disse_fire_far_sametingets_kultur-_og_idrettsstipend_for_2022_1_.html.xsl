...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/oddasat/dat-njealjis-ozzot-samedikki-kultur-ja-valastallanstipeandda-2022.23208.aspx?sprak=1'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Disse fire får Sametingets kultur- og idrettsstipend for 2022 - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="smj" location="da_nieljes_oadtju_samedikke_kultuvrra-_ja_valastallamstipendav_2022_1_.html"/>
