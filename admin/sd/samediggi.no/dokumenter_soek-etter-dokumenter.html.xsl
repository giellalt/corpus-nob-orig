...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.sametinget.no/Dokumenter/Soek-etter-dokumenter'"/>
    ...
    <parallel_text xml:lang="smj" location="dokumeantta_oza-dokumeanttaid.html"/>
