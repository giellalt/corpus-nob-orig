...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:variable name="filename" select="'http://www.sametinget.no/layout/set/print/Arkiv/Valgperiode-2009-2013/Representanter/Egil-Olli'"/>
...
<!--     <parallel_text xml:lang="sme" location="arkiv_valgperiode-2009-2013_airasat_egil-olli.html"/> -->
  </xsl:variable>
  <!--
