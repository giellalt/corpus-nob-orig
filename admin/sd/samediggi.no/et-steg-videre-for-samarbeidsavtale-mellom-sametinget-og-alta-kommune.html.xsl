...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:variable name="filename" select="'http://www.sametinget.no/layout/set/print/Om-Sametinget/Organisasjonsstruktur/Sametingsraadet/Taler-og-artikler/Et-steg-videre-for-samarbeidsavtale-mellom-Sametinget-og-Alta-kommune'"/>
...
<!--     <parallel_text xml:lang="sme" location="samedikki-birra_organisasuvdnastruktuvra_samediggeraddi_sartnit-ja-artihkkalat_et-steg-videre-for-samarbeidsavtale-mellom-sametinget-og-alta-kommune.html"/> -->
  </xsl:variable>
  <!--
