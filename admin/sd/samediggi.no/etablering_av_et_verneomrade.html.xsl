...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/areal-klima-og-miljo/naturmangfold/verneprosesser-i-samiske-omrader/etablering-av-et-verneomrade/'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Etablering av et verneområde - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="tseegkeme_vaarjelimmiedajveste.html"/>
        <parallel_text xml:lang="sme" location="etablering_av_et_verneomrade.html"/>
