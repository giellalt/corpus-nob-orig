...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/barnevern-helse-og-sosial/etiske-retningslinjer-for-samisk-helseforskning-og-kollektiv-samtykke/'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Etiske retningslinjer for samisk helseforskning - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="etihkeles_njoelkedassh_saemien_healsoedotkemasse.html"/>
        <parallel_text xml:lang="sme" location="etihkalas_njuolggadusat_sami_dearvvasvuodadutkama_varas.html"/>
