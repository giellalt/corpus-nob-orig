...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.sametinget.no/layout/set/print/Internasjonalt-arbeid/Internasjonalt-urfolkssamarbeid/FN-undersoeker-etnisk-diskriminering-i-Norge'"/>
    ...
    <parallel_text location="on-gazada-etnihkalas-vealaheami-birra-norggas.html" xml:lang="sme"/>
<parallel_text location="en-etnihkeles-sierredimmiem-noeoerjesne-goerehte.html" xml:lang="sma"/>
</xsl:variable>
