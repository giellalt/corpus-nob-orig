...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/barnehage/nyttige-ressurser/foreldreutvalget-for-barnehager-fub/'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Foreldreutvalget for barnehager - FUB - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="maanagierti_eejhtegemoenehtse_eem_.html"/>
        <parallel_text xml:lang="sme" location="manaidgarddi_vahnenlavdegoddi_-_fub.html"/>
