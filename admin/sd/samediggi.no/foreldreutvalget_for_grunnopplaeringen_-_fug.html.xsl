...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/vuodoahpadus/skavllabiras-ja-skavllaavddanibme/foreldreutvalget-for-grunnopplaringen-fug/?sprak=1'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Foreldreutvalget for grunnopplæringen - FUG - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="maadthlierehtimmien_eejhtegemoenehtse_-_mlem.html"/>
        <parallel_text xml:lang="sme" location="vuoddooahpahusa_vahnenlavdegoddi_-_fug.html"/>
