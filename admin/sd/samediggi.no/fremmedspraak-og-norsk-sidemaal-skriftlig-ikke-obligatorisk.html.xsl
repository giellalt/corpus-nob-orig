...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.sametinget.no/Tjenester/Opplaering-og-laeremidler/Fremmedspraak-og-norsk-sidemaal-skriftlig-ikke-obligatorisk'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Fremmedspråk og norsk sidemål skriftlig – ikke obligatorisk'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="ammesgiele-jih-noeoerjen-baaltegiele-tjaaleldh-ij-obligatovreles.html"/>
        <parallel_text xml:lang="sme" location="vierisgiella-ja-darogiella-siidogiella-ii-leat-bakkolas.html"/>
