...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/sprak/sprakpriser/gollegiella-nordisk-samisk-sprakpris/'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Gollegiella - nordisk samisk språkpris - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="gulliegiele_-_noerhtelaanti_saemien_gielebaalhka.html"/>
        <parallel_text xml:lang="sme" location="gollegiella_-_davviriikkalas_sami_giellabalkkasupmi.html"/>
