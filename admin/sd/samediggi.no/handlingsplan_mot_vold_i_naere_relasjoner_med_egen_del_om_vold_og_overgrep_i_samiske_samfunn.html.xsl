...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/saernieh/handlingsplan-mot-vold-i-nare-relasjoner-med-egen-del-om-vold-og-overgrep-i-samiske-samfunn.15847.aspx?sprak=1'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Handlingsplan mot vold i nære relasjoner med egen del om vold og overgrep i samiske samfunn - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="doaibmaplanas_veahkavalddi_vuosta_lagas_gaskavuodain_lea_sierra_oassi_veahkavalddi_ja_illastemiid_birra_sami_servodagain_.html"/>
