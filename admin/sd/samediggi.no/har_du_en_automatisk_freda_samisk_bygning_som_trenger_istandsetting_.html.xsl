...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/saernieh/har-du-en-automatisk-freda-samisk-bygning-som-trenger-istandsetting.22435.aspx?sprak=1'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Har du en automatisk freda samisk bygning som trenger istandsetting?  - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="leago_dus_rafaidahttojuvvon_sami_visti_maid_fertesii_divodit_.html"/>
