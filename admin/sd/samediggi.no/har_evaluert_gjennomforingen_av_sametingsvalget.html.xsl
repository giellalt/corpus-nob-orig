...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/har-evaluert-gjennomforingen-av-sametingsvalget.20903.aspx'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Har evaluert gjennomføringen av sametingsvalget - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="tjirrehtimmiem_saemiedigkieveeljemistie_evalueereme.html"/>
        <parallel_text xml:lang="sme" location="leat_arvvostallan_samediggevalggaid_cadaheami.html"/>
