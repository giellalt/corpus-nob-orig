...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.sametinget.no/layout/set/print/Spraak/Forvaltningsomraade/Hattfjelldal-kommune-har-vedtatt-om-aa-soeke-om-innlemming-i-forvaltningsomraade-for-samisk-spraak'"/>
    ...
    <parallel_text location="arborde-suohkan-lea-mearridan-ohcat-laktojuvvot-samegiela-halddasanguvlui.html" xml:lang="sme"/>
<parallel_text location="aarborten-tjielte-lea-naennoestamme-syoekedh-mejtie-aaaadtje-akte-bielie-sjidtedh-saemien-gielen-reeremedajveste.html" xml:lang="sma"/>
</xsl:variable>
