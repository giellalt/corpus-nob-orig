...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.sametinget.no/Helse-og-sosial/Helse/Har-saadd-et-froe-for-samarbeid'"/>
    ...
    <parallel_text xml:lang="smj" location="dearvvasvuohta-ja-sosiala_dearvvasvuohta_lea-oalgguhan-ovttasbargui.html"/>
