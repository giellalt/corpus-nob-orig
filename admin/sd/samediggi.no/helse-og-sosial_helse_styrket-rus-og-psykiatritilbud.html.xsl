...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:variable name="filename" select="'http://www.sametinget.no/layout/set/print/Helse-og-sosial/Helse/Styrket-rus-og-psykiatritilbud'"/>
  ...
  <xsl:variable name="parallels">
    ...
    <parallel_text xml:lang="smj" location="varresvuohta-ja-sosialla_varresvuohta_styrket-rus-og-psykiatritilbud.html"/>
    <parallel_text xml:lang="sme" location="dearvvasvuohta-ja-sosiala_dearvvasvuohta_styrket-rus-og-psykiatritilbud.html"/>
  </xsl:variable>
  <!--
