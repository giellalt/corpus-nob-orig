...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.sametinget.no/layout/set/print/Om-Sametinget/Organisasjonsstruktur/Sametingsraadet/Taler-og-artikler/Hoering-Endring-av-Grunnloven-108-og-Grunnloven-paa-samisk'"/>
    ...
    <parallel_text location="gulaskuddan-vuoddolaga-108-rievdadeapmi-ja-vuoddolahka-samegillii.html" xml:lang="sme"/>
</xsl:variable>
