...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/politihkka/histavrra/hor-opptak-fra-den-forste-plenumssamlingen/?sprak=1'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Hør opptak fra den første plenumssamlingen - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="goltelh_baantedimmiem_voestes_stoerretjaanghkojste.html"/>
        <parallel_text xml:lang="sme" location="guldal_baddejumiid_dan_vuosttas_dievascoahkkimis.html"/>
