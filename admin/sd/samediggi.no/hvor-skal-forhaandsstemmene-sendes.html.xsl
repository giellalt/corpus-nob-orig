...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.sametinget.no/layout/set/print/Valg-og-manntall/Kampanjeside/Partier-Valgmedarbeidere/Hvor-skal-forhaandsstemmene-sendes'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="gaaabph-edtja-dejtie-aavtelhbodti-steemmide-seedtedh.html"/>
        <parallel_text xml:lang="sme" location="gosa-galget-ovddalgihtiijienastagat-saddejuvvot.html"/>
...
<xsl:template match="p[parent::body][not(./em | ./span)][text()]">
        ...
        <xsl:element name="p">
            ...
            <xsl:call-template name="globalTextReplace">
                <xsl:with-param name="inputString" select="$text"/>
                <xsl:with-param name="target" select="'14. mai 2013/Adresseregister_kommuner_og_opptellingskommuner 2013.xlsx/47,83 kB/'"/>
