...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/adasa/hvorfor-det-er-nodvendig-med-en-samisk-parallell-likeverdig-lareplan-i-matematikk.32144.aspx?sprak=1'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Hvorfor det er nødvendig med en samisk parallell likeverdig læreplan i matematikk - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="manne_lea_darbu_samegiel_parallealla_seammaarvosas_oahppoplanii_matematihkas_.html"/>
