...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/saernieh/gaarsjelimmien-biejjie-saemiedigkesne.23051.aspx?sprak=1'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Idrettens dag på Sametinget 8. desember - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="gaarsjelimmien_biejjie_saemiedigkesne_.html"/>
        <parallel_text xml:lang="sme" location="valastallama_beaivi_samedikkis_.html"/>
