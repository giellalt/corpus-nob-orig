...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/hoyere-utdanning-og-forskning/implementering-av-samisk-perspektiv-i-hoyere-utdanning-og-forskning/'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Implementering av samisk perspektiv i høyere utdanning og forskning - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="tjirrehtimmie_saemien_perspektijveste_jollebe_oohpehtimmesne_jih_dotkemisnie.html"/>
        <parallel_text xml:lang="sme" location="sami_perspektiivva_implementeren_alit_ohppui_ja_dutkamii.html"/>
