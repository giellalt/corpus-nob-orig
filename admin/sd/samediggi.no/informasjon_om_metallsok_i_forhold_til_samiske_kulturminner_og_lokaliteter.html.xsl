...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/kultuvrramujtto-ja-huonajsuodjalus/metallaahtamus/metallsok-i-forhold-til-samiske-kulturminner-og-lokaliteter/?sprak=1'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Informasjon om metallsøk i forhold til samiske kulturminner og lokaliteter - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="bievnesh_metalleohtsemen_bijre_saemien_kultuvremojhtesinie_jih_lokaliteetine.html"/>
        <parallel_text xml:lang="sme" location="diedut_metallaohcama_birra_sami_kulturmuittuid_ja_lokalitehtaid_oktavuodas.html"/>
