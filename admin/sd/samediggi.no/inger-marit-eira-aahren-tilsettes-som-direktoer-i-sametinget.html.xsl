...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.sametinget.no/Nyhetsarkiv/Inger-Marit-Eira-AAhren-tilsettes-som-direktoer-i-Sametinget'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Inger Marit Eira-Åhrén tilsettes som direktør i Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="inger-marit-eira-aahren-barkoem-direktoeoerine-aaaadtje-saemiedigkesne.html"/>
        <parallel_text xml:lang="sme" location="inger-marit-eira-aahren-virgaduvvo-samedikki-direktevran.html"/>
