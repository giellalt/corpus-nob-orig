...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/inger-marit-eira-ahren-tilsettes-som-direktor-i-sametinget.4179.aspx'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Inger Marit Eira-Åhrén tilsettes som direktør i Sametinget - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="inger_marit_eira-ahren_barkoem_direktoorine_aadtje_saemiedigkesne.html"/>
        <parallel_text xml:lang="sme" location="inger_marit_eira-ahren_virgaduvvo_samedikki_direktevran.html"/>
