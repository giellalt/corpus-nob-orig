...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.sametinget.no/layout/set/print/Om-Sametinget/Organisasjonsstruktur/Sametingsraadet/Taler-og-artikler/Innlegg-Sametingsraadets-beretning-02.06.2015'"/>
    ...
    <parallel_text location="sahkavuorru-samediggeradi-diedahusa-oktavuodas-02.06.2015.html" xml:lang="sme"/>
</xsl:variable>
