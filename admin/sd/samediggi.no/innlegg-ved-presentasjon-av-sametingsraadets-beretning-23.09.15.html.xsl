...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.sametinget.no/layout/set/print/Om-Sametinget/Organisasjonsstruktur/Sametingsraadet/Taler-og-artikler/Innlegg-ved-presentasjon-av-Sametingsraadets-beretning-23.09.15'"/>
    ...
    <parallel_text location="sahkavuorru-samediggeradi-diedahusa-ovdan-buktimis-23.09.15.html" xml:lang="sme"/>
<parallel_text location="haaaleme-aaehpiedehtiemisnie-saemiedigkieraerien-reektemistie-23.09.15.html" xml:lang="sma"/>
</xsl:variable>
