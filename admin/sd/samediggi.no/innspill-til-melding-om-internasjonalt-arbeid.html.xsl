...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.sametinget.no/layout/set/print/Internasjonalt-arbeid/Internasjonalt-urfolkssamarbeid/Innspill-til-melding-om-internasjonalt-arbeid'"/>
    ...
    <language xml:lang="nob"/><language xml:lang="sme"/><language xml:lang="eng"/></xsl:variable>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="boeoeredimmie-raeriejgujmie-jih-vuajnoejgujmie-baaetedh-saemiedigkieraerien-bievnesasse-gaskenasjovnaale-barkoen-bijre.html"/>
        <parallel_text xml:lang="sme" location="bovdehus-buktit-cealkamusaid-diedahussii-riikkaidgaskasas-barggu-birra.html"/>
