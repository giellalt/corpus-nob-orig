...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.sametinget.no/Internasjonalt-arbeid/Alta-2013/Additional-logisitics-information'"/>
    ...
    <parallel_text xml:lang="smj" location="riikkaidgaskasas-bargu_alta-2013_additional-logisitics-information.html"/>
