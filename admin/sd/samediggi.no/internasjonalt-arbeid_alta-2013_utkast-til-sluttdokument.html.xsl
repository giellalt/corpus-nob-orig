...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:variable name="filename" select="'http://www.sametinget.no/Internasjonalt-arbeid/Alta-2013/Utkast-til-sluttdokument'"/>
  ...
  <xsl:variable name="parallels">
    ...
    <parallel_text xml:lang="sme" location="riikkaidgaskasas-bargu_alta-2013_utkast-til-sluttdokument.html"/>
  </xsl:variable>
  <!--
