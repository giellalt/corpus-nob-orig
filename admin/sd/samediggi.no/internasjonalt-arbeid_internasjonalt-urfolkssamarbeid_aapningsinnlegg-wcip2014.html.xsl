...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:variable name="filename" select="'http://www.sametinget.no/Internasjonalt-arbeid/Internasjonalt-urfolkssamarbeid/AApningsinnlegg-WCIP2014'"/>
  ...
  <xsl:variable name="parallels">
    ...
    <parallel_text xml:lang="sme" location="riikkaidgaskasas-bargu_riikkaidgaskasas-algoalbmotovttasbargu_rahpansahkavuorru-wcip2014.html"/>
  </xsl:variable>
  <!--
