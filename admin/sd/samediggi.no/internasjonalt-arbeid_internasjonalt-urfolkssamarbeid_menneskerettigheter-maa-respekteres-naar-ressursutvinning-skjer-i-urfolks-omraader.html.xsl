...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:variable name="parallels">
    ...
    <parallel_text xml:lang="sme" location="riikkaidgaskasas-bargu_riikkaidgaskasas-algoalbmotovttasbargu_olmmosvuoigatvuodaid-galga-arvvusatnit-go-resursaavkkastallan-dahpahuvva-algoalbmotguovlluin.html"/>
  </xsl:variable>
  <!--
