...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/kultur/kunst-og-kulturutovelse/internasjonalt-samisk-filminstitutt/'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Internasjonalt Samisk Filminstitutt (ISFI) - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="gaskenasjonaale_saemien_filmeinstituhte_isfi_.html"/>
        <parallel_text xml:lang="sme" location="internasunala_sami_filbmainstituhtta_isfi_.html"/>
