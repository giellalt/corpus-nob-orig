...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.sametinget.no/layout/set/print/Spraak/Fakta-om-samiske-spraak/Invitasjon-til-innspill-hoering-om-nordsamiske-rettskrivningsregler'"/>
    ...
    <parallel_text location="bovdehus-buktit-gulaskuddancealkamusa-davvisami-callinravagirji.html" xml:lang="sme"/>
</xsl:variable>
