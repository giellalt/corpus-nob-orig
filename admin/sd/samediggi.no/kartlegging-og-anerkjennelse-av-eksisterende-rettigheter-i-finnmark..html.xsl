...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.sametinget.no/layout/set/print/Land-og-ressursrettigheter/Kartlegging/Finnmarkskommisjonen/Kartlegging-og-anerkjennelse-av-eksisterende-rettigheter-i-Finnmark.'"/>
    ...
    <parallel_text xml:lang="smj" location="karttim-ja-daahkkidibme-gavnne-riektajs-finnmarkon.html"/>
