...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.sametinget.no/Tjenester/Opplaering-og-laeremidler/Koffert-med-samisk-innhold-til-utlaan-til-barnehager'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Koffert med samisk innhold til utlån til barnehager'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="vuelkemeveaskoe-saemien-sisveginie-loeoenedaemman-maanagiertide.html"/>
        <parallel_text xml:lang="sme" location="koaffar-sami-sisdoaluin-luoikamassii-manaidgarddiide.html"/>
