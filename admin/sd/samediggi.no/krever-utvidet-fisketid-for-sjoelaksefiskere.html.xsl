...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.sametinget.no/layout/set/print/Naeringer/Marine-naeringer/Krever-utvidet-fisketid-for-sjoelaksefiskere'"/>
    ...
    <parallel_text location="guhkebe-goeoelemetijjem-kreava-mearoeloesegoeoelijidie.html" xml:lang="sma"/>
<parallel_text location="gaibidit-viiddiduvvon-bivdoaiggi-mearrasami-guolasteddjiide.html" xml:lang="sme"/>
</xsl:variable>
