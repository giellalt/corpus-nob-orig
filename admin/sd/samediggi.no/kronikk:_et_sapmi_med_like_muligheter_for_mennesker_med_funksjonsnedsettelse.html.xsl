...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/politihkka/kronikker-og-leserinnlegg/kronikk-et-sapmi-med-like-muligheter-for-mennesker-med-funksjonsnedsettelse.18048.aspx?sprak=1'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Kronikk: Et Sápmi med like muligheter for mennesker med funksjonsnedsettelse - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="kronihkka:_sapmi_ovttalagan_vejolasvuodaiguin_olbmuide_geain_lea_doaibmavadjitvuoht.html"/>
