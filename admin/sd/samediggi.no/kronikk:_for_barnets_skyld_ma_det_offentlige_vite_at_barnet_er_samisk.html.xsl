...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/politikk/kronikker-og-leserinnlegg/kronikk-for-barnets-skyld-ma-det-offentlige-vite-at-barnet-er-samisk.22773.aspx'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Kronikk: For barnets skyld må det offentlige vite at barnet er samisk - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="kronihke:_maanan_gaavhtan_byogkelesvoete_tjuara_daejredh_dihte_saemien.html"/>
        <parallel_text xml:lang="sme" location="kronihkka:_mana_dihte_de_fertejit_almmolas_organat_diehtit_ahte_manna_lea_sapmelas.html"/>
