...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:variable name="filename" select="'http://www.sametinget.no/Kulturliv/Kunst-og-kulturutoevelse/Alvorlig-bekymret-for-museet-i-Karasjok'"/>
  ...
  <xsl:variable name="parallels">
    ...
    <parallel_text xml:lang="sme" location="kultureallin_daidda-ja-kulturbargu_alvorlig-bekymret-for-museet-i-karasjok.html"/>
  </xsl:variable>
  <!--
