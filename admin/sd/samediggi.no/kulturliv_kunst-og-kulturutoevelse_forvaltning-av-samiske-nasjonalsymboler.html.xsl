...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.sametinget.no/Kulturliv/Kunst-og-kulturutoevelse/Forvaltning-av-samiske-nasjonalsymboler'"/>
    ...
    <parallel_text xml:lang="smj" location="kultureallin_daidda-ja-kulturbargu_sami-nationala-symbolaid-calmmustahttin.html"/>
