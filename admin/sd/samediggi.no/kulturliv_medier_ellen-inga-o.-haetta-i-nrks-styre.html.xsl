...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.sametinget.no/Kulturliv/Medier/Ellen-Inga-O.-Haetta-i-NRKs-styre'"/>
    ...
    <parallel_text xml:lang="smj" location="kultureallin_mediaid_ellen-inga-o.-haetta-nrk-stivrii.html"/>
