...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.sametinget.no/Kulturliv/Medier/OEnsker-Internasjonalt-Samisk-filminstitutt-velkommen'"/>
    ...
    <parallel_text xml:lang="smj" location="kultureallin_mediaid_savva-riikkaidgaskasas-sami-filbmainstituhttii-bures-boahtima.html"/>
