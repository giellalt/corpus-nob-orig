...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:variable name="filename" select="'http://www.sametinget.no/Kulturliv/Stipend-og-tilskudd/Musikk'"/>
  ...
  <xsl:variable name="parallels">
    ...
    <parallel_text xml:lang="sme" location="kultureallin_stipeanda-ja-doarjja_musihkka.html"/>
  </xsl:variable>
  <!--
