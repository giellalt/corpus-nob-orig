...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:variable name="filename" select="'http://www.sametinget.no/layout/set/print/Land-og-ressursrettigheter/Fiskerettigheter/Kystfiskeutvalget/Slaar-ring-om-kyst-og-fjordbefolkningens-historiske-rettigheter'"/>
  ...
  <xsl:variable name="parallels">
    ...
    <parallel_text xml:lang="sme" location="eatnan-ja-resursavuoigatvuodat_bivdovuoigatvuohta_riddoguolastanlavdegotti_gahttejit-riddo-ja-vuotnaalbmoga-historjjalas-vuoigatvuodaid.html"/>
  </xsl:variable>
  <!--
