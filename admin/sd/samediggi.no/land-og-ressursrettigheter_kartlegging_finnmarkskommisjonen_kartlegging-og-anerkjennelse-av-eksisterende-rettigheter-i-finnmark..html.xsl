...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.sametinget.no/Land-og-ressursrettigheter/Kartlegging/Finnmarkskommisjonen/Kartlegging-og-anerkjennelse-av-eksisterende-rettigheter-i-Finnmark.'"/>
    ...
    <parallel_text xml:lang="smj" location="ednam-ja-resurssarievtesvuodaj_karttim_finnmarkokommisjaavnaan_karttim-ja-daahkkidibme-gavnne-riektajs-finnmarkon.html"/>
