...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:variable name="filename" select="'http://www.sametinget.no/layout/set/print/Land-og-ressursrettigheter/Landrettigheter/Fornyet-samarbeidsavtale-mellom-Sametinget-og-Statskog'"/>
  ...
  <xsl:variable name="parallels">
    ...
    <parallel_text xml:lang="smj" location="ednam-ja-resurssarievtesvuodaj_ednamrievtesvuoda_aadaastuhtedum-aktisasjbarggosjiehtadus-samedikke-ja-statskoga-gaskan.html"/>
    <parallel_text xml:lang="sme" location="eatnan-ja-resursavuoigatvuodat_eananvuoigatvuodat_odasmahttojuvvon-ovttasbargosiehtadus-gaskal-samedikki-ja-statskog.html"/>
  </xsl:variable>
  <!--
