...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.sametinget.no/Land-og-ressursrettigheter/Stipend-og-tilskudd'"/>
    ...
    <parallel_text xml:lang="smj" location="eatnan-ja-resursavuoigatvuodat_stipend-og-tilskudd.html"/>
