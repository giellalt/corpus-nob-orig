...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/sametingets-bibliotek/les-for-meg-sprak-fra-forste-stund/les-for-meg-bokgaver/'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Les for meg! - Bokgaver - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="_lohkh_munnjien_-prosjekten_bijre.html"/>
        <parallel_text xml:lang="sme" location="loga_munnje-proseavtta_birra.html"/>
