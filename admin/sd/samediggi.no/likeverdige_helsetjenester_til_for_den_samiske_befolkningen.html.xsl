...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/likeverdige-helsetjenester-til-for-den-samiske-befolkningen.8733.aspx'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Likeverdige helsetjenester til for den samiske befolkningen - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="seammavyortegs_healsoedienesjh_saemien_arroejidie.html"/>
        <parallel_text xml:lang="sme" location="ovttaarvosas_dearvvasvuodabalvalusat_sami_albmogii.html"/>
