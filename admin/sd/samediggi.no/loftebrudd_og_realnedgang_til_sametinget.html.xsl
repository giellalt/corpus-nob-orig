...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/saernieh/daajvehtsmiedtelimmie-jih-realgiehpiedimmie-saemiedagkan.22273.aspx?sprak=1'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Løftebrudd og realnedgang til Sametinget - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="daajvehtsmiedtelimmie_jih_realgiehpiedimmie_saemiedaegkan.html"/>
        <parallel_text xml:lang="sme" location="samedikki_lohpadusrihkkun_ja_goarideapmi.html"/>
