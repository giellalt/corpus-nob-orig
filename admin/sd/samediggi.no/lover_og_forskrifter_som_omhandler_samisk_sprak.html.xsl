...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/sprak/nyttige-ressurser/lover-og-forskrifter-som-omhandler-samisk-sprak/'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Lover og forskrifter som omhandler samisk språk - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="laakh_jih_mieriedimmieh_saemien_gielen_bijre.html"/>
        <parallel_text xml:lang="sme" location="lagat_ja_njuolggadusat_mat_valddahallet_sami_gielaid.html"/>
