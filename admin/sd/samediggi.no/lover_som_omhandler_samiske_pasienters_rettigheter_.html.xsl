...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/barnevern-helse-og-sosial/lover-som-omhandler-samiske-pasienters-rettigheter/'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Lover som omhandler samiske pasienters rettigheter  - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="laakh_mah_leah_saemien_skiemtjiji_reaktaj_bijre.html"/>
        <parallel_text xml:lang="sme" location="lagat_mat_valddahit_sami_buhcciid_vuoigatvuodaid_.html"/>
