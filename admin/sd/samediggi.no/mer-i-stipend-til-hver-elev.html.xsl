...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.sametinget.no/layout/set/print/Opplaering/Grunnskole-og-VGS/Mer-i-stipend-til-hver-elev'"/>
    ...
    <parallel_text location="eanet-stipeanda-juohke-oahppai.html" xml:lang="sme"/>
<parallel_text location="stuerebe-stipende-fierhten-learoehkasse.html" xml:lang="sma"/>
</xsl:variable>
