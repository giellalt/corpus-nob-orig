...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:variable name="filename" select="'http://www.sametinget.no/layout/set/print/Miljoe-areal-og-kulturvern/Areal/Sametinget-planveileder'"/>
  ...
  <xsl:variable name="parallels">
    ...
    <parallel_text xml:lang="smj" location="biras-arealla-ja-kultursuodjalus_areala_samedikke-pladnabagadus.html"/>
    <parallel_text xml:lang="sme" location="biras-areala-ja-kultursuodjaleapmi_areala_samedikki-planaveahkki.html"/>
  </xsl:variable>
  <!--
