...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.sametinget.no/Miljoe-areal-og-kulturvern/Energi-og-mineraler/Gleder-seg-med-ungdommene-i-Falesrassa'"/>
    ...
    <parallel_text xml:lang="smj" location="biras-areala-ja-kultursuodjaleapmi_energiija-ja-mineralat_gleder-seg-med-ungdommene-i-falesrassa.html"/>
