...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.sametinget.no/Miljoe-areal-og-kulturvern/Energi-og-mineraler/Sametinget-mineralveileder/Mineralloven'"/>
    ...
    <parallel_text xml:lang="smj" location="biras-arealla-ja-kultursuodjalus_energija-ja-minerala_samedikke-minerallabagadus_minerallahka.html"/>
