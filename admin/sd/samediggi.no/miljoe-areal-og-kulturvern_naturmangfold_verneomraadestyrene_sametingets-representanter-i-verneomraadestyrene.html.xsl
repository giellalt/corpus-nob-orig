...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:variable name="filename" select="'http://www.sametinget.no/layout/set/print/Miljoe-areal-og-kulturvern/Naturmangfold/Verneomraadestyrene/Sametingets-representanter-i-verneomraadestyrene'"/>
  ...
  <xsl:variable name="parallels">
    ...
    <parallel_text xml:lang="sme" location="biras-areala-ja-kultursuodjaleapmi_luonddusladdjivuohta_suodjaluvvonguovllustivrrat_samedikki-ovddasteaddjit-suodjalanguolostirraide.html"/>
  </xsl:variable>
  <!--
