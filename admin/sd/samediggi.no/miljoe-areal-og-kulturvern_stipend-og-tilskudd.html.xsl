...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:variable name="filename" select="'http://www.sametinget.no/Miljoe-areal-og-kulturvern/Stipend-og-tilskudd'"/>
  ...
  <xsl:variable name="parallels">
    ...
    <parallel_text xml:lang="sme" location="biras-areala-ja-kultursuodjaleapmi_stipeanda-ja-doarjja.html"/>
  </xsl:variable>
  <!--
