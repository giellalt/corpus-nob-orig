...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:variable name="filename" select="'http://www.sametinget.no/layout/set/print/Kulturliv/Stipend-og-tilskudd/Musikk'"/>
  ...
  <xsl:variable name="parallels">
    ...
    <parallel_text xml:lang="sma" location="musihke.html"/>
    <parallel_text xml:lang="sme" location="musihkka.html"/>
  </xsl:variable>
  <!--
