...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:variable name="filename" select="'http://www.sametinget.no/layout/set/print/Naeringer/Marine-naeringer/Finsk-fisketurisme-er-en-trussel-for-lokalbefolkningens-fiske'"/>
  ...
  <xsl:variable name="parallels">
    ...
    <parallel_text xml:lang="sme" location="ealahusat_mearraealahusat_suoma-oaggunturisma-lea-aittan-baikkalas-olbmuid-oaggumii.html"/>
  </xsl:variable>
  <!--
