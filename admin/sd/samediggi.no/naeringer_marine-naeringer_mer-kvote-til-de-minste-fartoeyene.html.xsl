...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.sametinget.no/Naeringer/Marine-naeringer/Mer-kvote-til-de-minste-fartoeyene'"/>
    ...
    <parallel_text xml:lang="smj" location="ealahusat_mearraealahusat_lassi-earri-uhcimus-fatnasiidda.html"/>
