...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:variable name="filename" select="'http://www.sametinget.no/layout/set/print/Naeringer/Reindrift/Norsk-svensk-reinbeitekonvensjon/Viktige-dokumenter'"/>
  ...
  <xsl:variable name="parallels">
    ...
    <parallel_text xml:lang="smj" location="aeladus_boatsojaeladus_svieriga-ja-vuona-boatsojguohtomsaabadibme_ajnas-dokumenta.html"/>
    <parallel_text xml:lang="sme" location="ealahusat_boazodoallu_norgga-ruota-boazoguohtunkonvensuvdna_dehalas-dokumeanttat.html"/>
  </xsl:variable>
  <!--
