...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:variable name="filename" select="'http://www.sametinget.no/Naeringer/Reindrift/Stipend-og-tilskudd'"/>
  ...
  <xsl:variable name="parallels">
    ...
    <parallel_text xml:lang="sme" location="ealahusat_boazodoallu_stipeanda-ja-doarjja.html"/>
  </xsl:variable>
  <!--
