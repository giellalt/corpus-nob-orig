...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.sametinget.no/Naeringer/Stipend-og-tilskudd/Attraktive-lokalsamfunn'"/>
    ...
    <parallel_text xml:lang="smj" location="ealahusat_stipeanda-ja-doarjja_geasuheaddji-baikegottit.html"/>
