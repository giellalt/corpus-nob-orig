...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.sametinget.no/Naeringer/Variert-naeringsliv/15-millioner-kroner-til-samiske-tiltak-siden-januar'"/>
    ...
    <parallel_text xml:lang="smj" location="ealahusat_manggalagan-ealahusdoaibma_15-miljon-ruvnno-sami-doaibmabijuide-oddajagimanu-rajes.html"/>
