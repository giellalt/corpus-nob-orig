...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/adasa/nav-ja-nve-bierriji-valggogisa-sjaddat-vasstedittjat-samegiellaj.33558.aspx?sprak=1'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'NAV og NVE bør forpliktes til å svare på samisk - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="smj" location="nav_ja_nve_bierriji_vaelggogisa_sjaddat_vasstedittjat_samegiellaj_.html"/>
