...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/riikkaidgaskasas-bargu/sami-ovttasbargu/davviriikkalas-sami-assiid-ammatorgana/?sprak=1'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Nordisk embetsmannsorgan for samiske spørsmål (NÄS) - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="noerhtelaanti_embetsmaennieorgaane_saemien_gyhtjelasside_nas_.html"/>
        <parallel_text xml:lang="sme" location="davviriikkalas_sami_assiid_ammatorgana_nas_.html"/>
