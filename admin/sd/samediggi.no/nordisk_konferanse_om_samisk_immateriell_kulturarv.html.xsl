...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/adasa/nordisk-konferanse-om-samisk-immateriell-kulturarv.22591.aspx?sprak=1'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Nordisk konferanse om samisk immateriell kulturarv - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="noerhtelaanti_konferanse_saemien_immaterijelle_kultuvreaerpien_bijre.html"/>
        <parallel_text xml:lang="sme" location="davviriikkalas_konferansa_sami_immemateriala_kulturarbbi_birra.html"/>
