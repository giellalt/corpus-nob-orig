...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/ny-sprakomradeordning-endelig-ute-pa-horing.15879.aspx'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Ny språkområdeordning endelig ute på høring - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="orre_gieledajveoornege_saahtah_govlehtaemman_baata.html"/>
        <parallel_text xml:lang="sme" location="odda_giellaguovloortnet_viimmat_gulaskuddamii.html"/>
