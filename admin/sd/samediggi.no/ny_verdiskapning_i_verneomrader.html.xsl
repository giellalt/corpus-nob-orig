...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/areaale-klijma-jih-byjrese/eatnemegellievoete/orre-aarvoesjugniedimmie-vaarjelimmiedajvine/?sprak=1'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Ny verdiskapning i verneområder - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="orre_aarvoesjugniedimmie_vaarjelimmiedajvine.html"/>
        <parallel_text xml:lang="sme" location="odda_arvohahkan_suodjalanguovlluin.html"/>
