...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/nye-prioriteringer-i-sametingets-tilskuddsordning-for-reindrift.14807.aspx'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Nye prioriteringer i Sametingets tilskuddsordning for reindrift  - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="orre_prioriteeremh_saemiedigkien_daarjoeoornegisnie_baatsose.html"/>
        <parallel_text xml:lang="sme" location="samedikki_doarjjaortnegis_boazodollui_leat_odda_vuoruheamit.html"/>
