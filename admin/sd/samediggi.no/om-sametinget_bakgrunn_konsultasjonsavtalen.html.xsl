...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.sametinget.no/layout/set/print/Om-Sametinget/Bakgrunn/Konsultasjonsavtalen'"/>
    ...
    <parallel_text xml:lang="smj" location="sammedikke-birra_duogasj_radadallamsjiehtadus.html"/>
