...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:variable name="filename" select="'http://www.sametinget.no/layout/set/print/Om-Sametinget/Organisasjonsstruktur/Plenumsledelsen/Taler-og-artikler'"/>
  ...
  <xsl:variable name="parallels">
    ...
    <parallel_text xml:lang="sme" location="samedikki-birra_organisasuvdnastruktuvra_dievascoahkkima-jodihangoddi_sartnit-ja-artihkkalat.html"/>
  </xsl:variable>
  <!--
