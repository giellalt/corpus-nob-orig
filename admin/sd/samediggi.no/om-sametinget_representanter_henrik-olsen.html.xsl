...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.sametinget.no/Om-Sametinget/Representanter/Henrik-Olsen'"/>
    ...
    <parallel_text xml:lang="smj" location="samedikki-birra_airasat_henrik-olsen.html"/>
