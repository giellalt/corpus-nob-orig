...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:variable name="filename" select="'http://www.sametinget.no/layout/set/print/Om-Sametinget/Representanter/Skjema-for-folkevalgte'"/>
  ...
  <xsl:variable name="parallels">
    ...
    <parallel_text xml:lang="smj" location="sammedikke-birra_ajrrasa_sjiema-ajrrasida.html"/>
    <parallel_text xml:lang="sme" location="samedikki-birra_airasat_skovit-airasiidda.html"/>
  </xsl:variable>
  <!--
