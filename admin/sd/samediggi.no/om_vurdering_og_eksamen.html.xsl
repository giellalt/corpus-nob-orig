...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/lierehtimmie/learoesoejkesjh/daarjoematerijelle/vuarjasjimmien-jih-eksamenen-bijre/?sprak=1'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Om vurdering og eksamen - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="vuarjasjimmien_jih_eksamenen_bijre.html"/>
        <parallel_text xml:lang="sme" location="arvvostallan_ja_eksamen_samegielas.html"/>
