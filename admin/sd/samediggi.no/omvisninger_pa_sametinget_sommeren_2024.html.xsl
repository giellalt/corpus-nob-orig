...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/adasa/omvisninger-pa-sametinget-sommeren-2024.32857.aspx?sprak=1'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Omvisninger på Sametinget sommeren 2024 - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="vuesiehtimmieh_saemiedigkesne_giesien_2024.html"/>
        <parallel_text xml:lang="sme" location="ofelastimat_samedikkis_2024_geasi.html"/>
