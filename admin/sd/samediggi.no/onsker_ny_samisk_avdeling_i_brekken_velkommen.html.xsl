...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/adasa/onsker-ny-samisk-avdeling-i-brekken-velkommen.27180.aspx?sprak=1'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Ønsker ny samisk avdeling i Brekken velkommen - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="orre_saemien_goevtesem_praahkesne_buerie_baeteme_vaajtele.html"/>
        <parallel_text xml:lang="sme" location="savva_bures_boahtima_praahka_odda_sami_ossodahkii.html"/>
