...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:variable name="filename" select="'http://www.sametinget.no/layout/set/print/Opplaering/Arbeidet-mot-mobbing/Alle-har-rett-til-en-mobbefri-hverdag'"/>
  ...
  <xsl:variable name="parallels">
    ...
    <parallel_text xml:lang="sme" location="oahpahus_julggastus-givssideami-vuosta_buohkain-lea-vuoigatvuohta-beassat-eallit-givssideami-haga.html"/>
  </xsl:variable>
  <!--
