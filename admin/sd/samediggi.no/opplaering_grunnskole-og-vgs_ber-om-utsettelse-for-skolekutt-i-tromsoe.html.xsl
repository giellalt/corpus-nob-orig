...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.sametinget.no/Opplaering/Grunnskole-og-VGS/Ber-om-utsettelse-for-skolekutt-i-Tromsoe'"/>
    ...
    <parallel_text xml:lang="smj" location="oahpahus_vuoddoskuvla-ja-js_bivda-maniduvvot-skuvlaheaittihemiid-romssas.html"/>
