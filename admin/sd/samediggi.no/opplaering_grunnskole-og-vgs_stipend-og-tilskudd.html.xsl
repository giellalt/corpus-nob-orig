...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.sametinget.no/Opplaering/Grunnskole-og-VGS/Stipend-og-tilskudd'"/>
    ...
    <parallel_text xml:lang="smj" location="oahpahus_vuoddoskuvla-ja-js_stipeanda-ja-doarjja.html"/>
