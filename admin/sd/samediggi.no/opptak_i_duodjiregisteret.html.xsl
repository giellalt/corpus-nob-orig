...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/stipenda-ja-darja/darja/aladus/duodje/opptak-i-duodjiregisteret/?sprak=1'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Opptak i duodjiregisteret - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="jijtjemse_duedtieregisterasse_tjaeledh.html"/>
        <parallel_text xml:lang="sme" location="duodji:_sisavaldin_duodjeregistarii.html"/>
