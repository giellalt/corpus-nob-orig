...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/grunnopplaring/lareplaner/overordnet-del-verdier-og-prinsipper-for-grunnopplaringen/'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Overordnet del – verdier og prinsipper for grunnopplæringen - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="bijjemes_bielie_-_aarvoeh_jih_prinsihph_maadthoohpehtimmesne.html"/>
        <parallel_text xml:lang="sme" location="bajitoassi_-_vuoddooahpahusa_arvvut_ja_prinsihpat.html"/>
