...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/samedikki-girjeradju/loga-munnje-giella-alggu-rajes/avkkalas-resurssat/plakahtat-girjemearkkat-ja-govat/?sprak=1'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Plakater, bokmerker og bilder - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="plakaath_gaerjamierhkh_jih_guvvieh.html"/>
        <parallel_text xml:lang="sme" location="plakahtat_girjemearkkat_ja_govat.html"/>
