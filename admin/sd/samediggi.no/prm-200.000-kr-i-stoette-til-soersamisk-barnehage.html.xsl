...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.sametinget.no/Nyhetsarkiv/PRM-200.000-kr-i-stoette-til-soersamisk-barnehage'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'PRM: 200.000 kr i støtte til sørsamisk barnehage'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="prm-200.000-kr-daaarjojne-aaarjelsaemien-maanagiertese.html"/>
        <parallel_text xml:lang="sme" location="prd-200.000-ru-doarjjan-lullisami-manaidgardai.html"/>
