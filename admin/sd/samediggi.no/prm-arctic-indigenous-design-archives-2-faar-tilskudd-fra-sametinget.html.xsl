...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.sametinget.no/Nyhetsarkiv/PRM-Arctic-Indigenous-Design-Archives-2-faar-tilskudd-fra-Sametinget'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'PRM: Arctic Indigenous Design Archives 2 får tilskudd fra Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="prm-arctic-indigenous-design-archives-2-daaarjoem-aaaadtje-saemiedigkeste.html"/>
        <parallel_text xml:lang="sme" location="prd-arctic-indigenous-design-archives-2-oazzu-doarjaga-samedikkis.html"/>
