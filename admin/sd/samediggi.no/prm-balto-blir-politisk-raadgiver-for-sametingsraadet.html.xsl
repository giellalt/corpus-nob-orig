...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.sametinget.no/Nyhetsarkiv/PRM-Balto-blir-politisk-raadgiver-for-sametingsraadet'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'PRM: Balto blir politisk rådgiver for sametingsrådet'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="prm-balto-saemiedigkieraerien-politihkeles-raeriestaejja-sjaedta.html"/>
        <parallel_text xml:lang="sme" location="prd-balto-sadda-samediggeradi-politihkalas-raddeaddin.html"/>
