...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.sametinget.no/Nyhetsarkiv/PRM-Fornoeyd-med-at-Riksrevisjonen-har-undersoekt-samisk-opplaering'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'PRM: Fornøyd med at Riksrevisjonen har undersøkt samisk opplæring'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="prm-madtjeles-ihke-rijhkerevisjovne-lea-saemien-lierehtimmiem-goerehtamme.html"/>
        <parallel_text xml:lang="sme" location="prd-dudavas-go-riikkarevisuvdna-lea-guorahallan-samegieloahpahusa.html"/>
