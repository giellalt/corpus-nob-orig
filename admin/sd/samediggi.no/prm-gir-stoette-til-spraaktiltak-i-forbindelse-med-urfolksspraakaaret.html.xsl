...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.sametinget.no/Nyhetsarkiv/PRM-Gir-stoette-til-spraaktiltak-i-forbindelse-med-urfolksspraakaaret'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'PRM: Gir støtte til språktiltak i forbindelse med urfolksspråkåret'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="prm-daaarjoe-gieleraaajvarimmide-aalkoealmetjegielejaepien-sjiekenisnie.html"/>
        <parallel_text xml:lang="sme" location="prd-adda-doarjaga-gielladoaibmabijuide-algoalbmotgiellajagi-oktavuodas.html"/>
