...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.sametinget.no/Nyhetsarkiv/PRM-Gladnyhet-Roeros-inn-i-forvaltningsomraadet-for-samiske-spraak'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'PRM: Gladnyhet: Røros inn i forvaltningsområdet for samiske språk'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="prm-aavoesaernie-roeros-saemien-gielen-reeremedajven-sijse.html"/>
        <parallel_text xml:lang="sme" location="prd-stuora-illusahka-roeros-samegielaid-halddasanguvlui.html"/>
