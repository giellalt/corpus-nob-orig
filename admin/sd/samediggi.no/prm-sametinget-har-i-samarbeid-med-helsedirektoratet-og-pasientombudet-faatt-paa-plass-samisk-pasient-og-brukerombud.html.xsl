...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.sametinget.no/Nyhetsarkiv/PRM-Sametinget-har-i-samarbeid-med-Helsedirektoratet-og-Pasientombudet-faatt-paa-plass-samisk-pasient-og-brukerombud'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'PRM: Sametinget har i samarbeid med Helsedirektoratet og Pasientombudet fått på plass samisk pasient- og brukerombud'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="smj" location="prm-samedigge-l-aktisasjbargon-varresvuodadirektorahtajn-ja-pasientajoahttsijn-same-pasientaj-ja-addnijoahttsev-sadjasis-oadtjum.html"/>
