...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.sametinget.no/Nyhetsarkiv/PRM-Sametinget-oeker-sin-satsning-paa-primaernaeringer-i-2020'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'PRM: Sametinget øker sin satsning på primærnæringer i 2020'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="prm-saemiedigkie-sov-daaarjoem-aalkoejieliemidie-lissehte-2020.html"/>
        <parallel_text xml:lang="sme" location="prd-samediggi-aigu-eanet-angirussat-vuoddoealahusaiguin-2020-s.html"/>
