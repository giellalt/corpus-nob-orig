...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.sametinget.no/Nyhetsarkiv/PRM-Sametingsraadet-stoetter-tiltak-til-bedre-helsetjenester-for-samer'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'PRM: Sametingsrådet støtter tiltak til bedre helsetjenester for samer'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="prd-saemiedigkieraerie-raaajvarimmieh-daaaarje-buerebe-healsoedienesjidie-saemide.html"/>
        <parallel_text xml:lang="sme" location="prd-samediggeraddi-adda-doarjaga-doaibmabijuide-maiguin-buoridit-samiide-dearvvasvuodabalvalusaid.html"/>
