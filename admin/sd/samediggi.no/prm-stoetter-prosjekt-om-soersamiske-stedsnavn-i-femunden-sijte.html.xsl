...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.sametinget.no/Nyhetsarkiv/PRM-Stoetter-prosjekt-om-soersamiske-stedsnavn-i-Femunden-sijte'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'PRM: Støtter prosjekt om sørsamiske stedsnavn i Femunden sijte'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="prm-prosjektem-daaaarje-aaarjelsaemien-sijjienommi-bijre-femunden-sijtesne.html"/>
        <parallel_text xml:lang="sme" location="prd-doarju-mattasami-baikenamat-proseavtta-femunden-sijtes.html"/>
