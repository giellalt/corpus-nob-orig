...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.sametinget.no/Nyhetsarkiv/PRM-Stoetter-soersamisk-barne-TV-med-300.000-kroner'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'PRM: Støtter sørsamisk barne-TV med 300.000 kroner'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="prd-aaarjelsaemien-maana-tv-m-daaaarje-300.000-kraavnajgujmie.html"/>
        <parallel_text xml:lang="sme" location="prd-doarju-mattasami-manaid-tv-300.000-ruvnnuin.html"/>
