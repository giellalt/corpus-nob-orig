...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.sametinget.no/Nyhetsarkiv/PRM-Vedtatt-koronatiltak-overfor-kultur-og-naeringslivet'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'PRM: Vedtatt koronatiltak overfor kultur- og næringslivet'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="prm-naennoestamme-koronaraaajvarimmieh-kultuvre-jih-jieliemasse.html"/>
        <parallel_text xml:lang="sme" location="prd-mearriduvvon-koronadoaibmabijut-kultur-ja-ealahuseallimii.html"/>
