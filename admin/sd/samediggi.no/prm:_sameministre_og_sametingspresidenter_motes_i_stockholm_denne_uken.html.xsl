...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/adasa/prm-sameministre-og-sametingspresidenter-motes-i-stockholm-denne-uken.23441.aspx?sprak=1'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'PRM: Sameministre og sametingspresidenter møtes i Stockholm denne uken - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="prd:_sameministarat_ja_samediggepresideanttat_deaivvadit_stockholmmas_dan_vahku.html"/>
