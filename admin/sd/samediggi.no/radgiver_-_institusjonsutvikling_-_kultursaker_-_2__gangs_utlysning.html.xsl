...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/radgiver-institusjonsutvikling-kultursaker-2-gangs-utlysning.19628.aspx'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Rådgiver - Institusjonsutvikling - kultursaker - 2. gangs utlysning - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="raddeaddi_-_institusuvdnaovdaneapmi_-_kulturassit_-_2__almmuheapmi.html"/>
