...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/rapport-og-webinar-om-situasjon-for-skoltesamisk-pa-norsk-side-av-sapmi.13675.aspx'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Rapport og webinar om situasjon for skoltesamisk på norsk side av Sápmi - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="raporta_ja_webinara_nuortalasgiela_dili_birra_norgga_beale_samis_.html"/>
