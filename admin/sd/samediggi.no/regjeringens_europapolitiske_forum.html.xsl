...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/rijkajgasskasasj-barggo/nuorttaguovlo/europapolitisk-forum/?sprak=1'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Regjeringens europapolitiske forum - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="reerenassen_europapolitihkeles_forume.html"/>
        <parallel_text xml:lang="sme" location="raddehusa_eurohpapolitihkalas_forum.html"/>
