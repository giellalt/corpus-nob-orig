...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/saemiedigkien-bijre/vuelkemereeknege-jih-honoraarekrievenassh-saemiedagkan/?sprak=1'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Reiseregning og honorarkrav til Sametinget - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="vuelkemereeknege_jih_honoraarekrievenassh_saemiedaegkan.html"/>
        <parallel_text xml:lang="sme" location="matkerehkegat_ja_buhtadusgaibadusat_samediggai.html"/>
