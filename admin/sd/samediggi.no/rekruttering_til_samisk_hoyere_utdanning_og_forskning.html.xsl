...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/hoyere-utdanning-og-forskning/kompetanseheving-og-rekruttering/rekruttering-til-samisk-hoyere-utdanning-og-forskning/'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Rekruttering til samisk høyere utdanning og forskning - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="daarrehtimmie_saemien_jollebe_oohpehtaemman_jih_dotkemasse.html"/>
        <parallel_text xml:lang="sme" location="rekrutteren_sami_alit_ohppui_ja_dutkamii.html"/>
