...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/saernieh/spaarh-daatojde-samos-en-baetije-konferansese.23080.aspx?sprak=1'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Reserver datoene til SáMOS kommende konferanse! - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="spaarh_daatojde_samos:en_baetije_konferansese_.html"/>
        <parallel_text xml:lang="sme" location="varre_dahtoniid_samos_boahttevas_konferansii_.html"/>
