...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.sametinget.no/Tjenester/Opplaering-og-laeremidler/Rett-til-opplaering-i-og-paa-samisk'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Rett til opplæring i og på samisk'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="reaktoe-gielelierehtaemman-jih-lierehtaemman-saemien-gielesne.html"/>
        <parallel_text xml:lang="sme" location="vuoigatvuohta-oazzut-oahpahusa-samegillii.html"/>
