...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/sprak/samiske-stedsnavn/saksgang-i-samiske-stedsnavnsaker/'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Saksgang i samiske stedsnavnsaker - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="aamhteseoornege_saemien_sijjienommeaamhtesinie.html"/>
        <parallel_text xml:lang="sme" location="sami_baikenammaassiid_assejohtu_.html"/>
