...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/rijkajgasskasasj-barggo/same-aktisasjbarggo/walt-disney-animation-studios-aktisasjbarggo/?sprak=1'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Samarbeid med Walt Disney Animation Studios - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="laavenjostoe_sieltine_walt_disney_animation_studios.html"/>
        <parallel_text xml:lang="sme" location="ovttasbargu_walt_disney_animation_studios.html"/>
