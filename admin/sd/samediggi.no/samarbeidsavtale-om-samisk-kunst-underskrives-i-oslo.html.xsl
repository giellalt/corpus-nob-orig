...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.sametinget.no/layout/set/print/Kulturliv/Kunst-og-kulturutoevelse/Samarbeidsavtale-om-samisk-kunst-underskrives-i-Oslo'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="laavenjostoelatjkoe-saemien-kaaansten-bijre-jaaaahkesjamme-sjaedta-oslosne.html"/>
        <parallel_text xml:lang="sme" location="ovttasbargosiehtadus-sami-daidaga-birra-vuollaicallojuvvo-oslos.html"/>
    ...
    <xsl:template match="p[parent::body][not(./em | ./span)][text()]">
        ...
        <xsl:element name="p">
            ...
            <xsl:call-template name="globalTextReplace">
                ...
                <xsl:with-param name="target" select="'09. desember 2015/'"/>
