...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Siste nytt - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1.html" xml:lang="sme"/>
</xsl:variable>
