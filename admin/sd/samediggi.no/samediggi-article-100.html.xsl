...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=100&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Samisk musikk - Kilder - Sámediggi Sametinget'"/>
...
<xsl:variable name="para_sme" select="'samediggi-article-100.html'"/>
