...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1024&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Reisepolitikk for Sametingets politiske nivå - Sámediggi Sametinget'"/>
...
<xsl:variable name="wordcount" select="'56'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1024.html" xml:lang="sme"/>
</xsl:variable>
