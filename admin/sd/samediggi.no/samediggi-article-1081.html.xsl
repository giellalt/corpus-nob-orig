...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1081&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Åpent møte om grenselosene i Tysfjord - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1081.html" xml:lang="smj"/>
</xsl:variable>
