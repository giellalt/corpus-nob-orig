...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1098&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sametingspresidenten ønsker forvaltningsreformen velkommen - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1098.html" xml:lang="sme"/>
</xsl:variable>
