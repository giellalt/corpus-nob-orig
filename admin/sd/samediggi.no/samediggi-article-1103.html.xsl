...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1103&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Tale: Overrekkelse av ny sørsamisk bokbuss - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1103.html" xml:lang="sme"/>
</xsl:variable>
