...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1184&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'PRM: Kunstneravtale for 2007 - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1184.html" xml:lang="sme"/>
</xsl:variable>
