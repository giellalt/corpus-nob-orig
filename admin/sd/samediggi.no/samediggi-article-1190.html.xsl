...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1190&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'PRM: Avslutning av språkmotiveringsprosjekt på Elgå - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1190.html" xml:lang="sme"/>
</xsl:variable>
