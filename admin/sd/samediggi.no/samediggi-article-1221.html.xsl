...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1221&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'PRM: Historisk FN-erklæring om urfolks rettigheter - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1221.html" xml:lang="sme"/>
</xsl:variable>
