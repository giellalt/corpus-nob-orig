...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1222&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sametingspresident Aili Keskitalos tale ved seremoni for Finnmarkseiendommen - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1222.html" xml:lang="sme"/>
</xsl:variable>
