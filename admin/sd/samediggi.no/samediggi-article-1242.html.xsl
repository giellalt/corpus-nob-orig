...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1242&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Åpen høring om retningslinjer om endret bruk av meahcci/utmark - Sámediggi Sametinget'"/>
...
<xsl:variable name="wordcount" select="'109'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1242.html" xml:lang="sme"/>
</xsl:variable>
