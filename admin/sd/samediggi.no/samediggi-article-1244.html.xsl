...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1244&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Nye samiske læreplaner for skoleåret 2006/2007 - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1244.html" xml:lang="sme"/>
</xsl:variable>
