...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1253&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Internasjonal urfolksdag - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1253.html" xml:lang="sme"/>
</xsl:variable>
