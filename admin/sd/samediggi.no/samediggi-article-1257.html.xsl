...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1257&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Møte med Olje- og energiminister Odd Roger Enoksen - Sámediggi Sametinget'"/>
...
<xsl:variable name="wordcount" select="'46'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1257.html" xml:lang="sme"/>
</xsl:variable>
