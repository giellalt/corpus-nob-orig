...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1266&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sametingets ungdomskonferanse 2006 - Sámediggi Sametinget'"/>
...
<xsl:variable name="wordcount" select="'41'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1266.html" xml:lang="sme"/>
</xsl:variable>
