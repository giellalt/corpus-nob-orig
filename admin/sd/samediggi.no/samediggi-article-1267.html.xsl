...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1267&amp;sprak=Norsk&amp;Print=1'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1267.html" xml:lang="sme"/>
</xsl:variable>
