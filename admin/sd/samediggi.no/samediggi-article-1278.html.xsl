...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1278&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'PRM: Forvaltningsreformen må sikre samiske interesser - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1278.html" xml:lang="sme"/>
</xsl:variable>
