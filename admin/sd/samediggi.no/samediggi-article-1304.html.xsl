...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1304&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'PRM:- Gruveindustrien må anerkjenne urfolkenes rettigheter - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1304.html" xml:lang="sme"/>
</xsl:variable>
