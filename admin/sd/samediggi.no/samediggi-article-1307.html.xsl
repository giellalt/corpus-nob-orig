...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1307&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Støtte til samisk barnehage i Tromsø - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1307.html" xml:lang="sme"/>
</xsl:variable>
