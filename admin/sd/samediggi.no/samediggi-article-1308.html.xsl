...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1308&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Støtte til småskala matproduksjon - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1308.html" xml:lang="sme"/>
</xsl:variable>
