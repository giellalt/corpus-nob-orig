...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1313&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'PRM: Fornøyd med løsning i Mauken og Blåtind - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1313.html" xml:lang="sme"/>
</xsl:variable>
