...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1328&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'PRM: 100.000 kroner til kvinnebladet Gába - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1328.html" xml:lang="sme"/>
</xsl:variable>
