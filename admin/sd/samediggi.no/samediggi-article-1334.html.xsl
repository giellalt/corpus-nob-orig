...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1334&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Enklere å velge: samisk eller norsk på nett - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1334.html" xml:lang="sme"/>
</xsl:variable>
