...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=134&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Kunst i Sametingsbygningen - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-134.html" xml:lang="sme"/>
</xsl:variable>
