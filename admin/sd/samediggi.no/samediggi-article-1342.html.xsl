...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1342&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Høringskonferanse om videregående opplæring - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1342.html" xml:lang="sme"/>
</xsl:variable>
