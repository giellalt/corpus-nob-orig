...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1344&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'PRM: Krever omfordeling av fiskekvoter - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1344.html" xml:lang="sme"/>
</xsl:variable>
