...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1346&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Åpne møter om retningslinjene til Finnmarksloven - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1346.html" xml:lang="sme"/>
</xsl:variable>
