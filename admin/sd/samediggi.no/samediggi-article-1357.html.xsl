...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1357&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Tale ved utdeling av Gollegiella-prisen 2006 - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1357.html" xml:lang="sme"/>
</xsl:variable>
