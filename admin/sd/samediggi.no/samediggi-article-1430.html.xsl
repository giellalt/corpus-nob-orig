...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1430&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'PRM: Nettbasert leseprogram for samiske brukere - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1430.html" xml:lang="sme"/>
</xsl:variable>
