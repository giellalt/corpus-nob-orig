...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1441&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'PRM: Skuffet over omkamp om FNs urfolkserklæring - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1441.html" xml:lang="sme"/>
</xsl:variable>
