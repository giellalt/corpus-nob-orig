...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=145&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Retningslinjer for tilskudd til samisk kulturminnevern - Sámediggi Sametinget'"/>
...
<xsl:variable name="wordcount" select="'797'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-145.html" xml:lang="sme"/>
</xsl:variable>
