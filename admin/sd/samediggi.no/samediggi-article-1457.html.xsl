...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1457&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'PRM: Rekruttering til sørsamiske studier - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1457.html" xml:lang="sme"/>
</xsl:variable>
