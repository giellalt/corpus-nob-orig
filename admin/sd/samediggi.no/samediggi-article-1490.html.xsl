...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1490&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'PRM: Sametingsrådet positiv til evaluering av distriktskvoteordning - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1490.html" xml:lang="sme"/>
</xsl:variable>
