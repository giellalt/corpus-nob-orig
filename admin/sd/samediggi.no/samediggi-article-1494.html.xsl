...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1494&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Minside - offentlig servicekontor på internett - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1494.html" xml:lang="sme"/>
</xsl:variable>
