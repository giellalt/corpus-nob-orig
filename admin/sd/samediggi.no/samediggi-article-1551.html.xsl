...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1551&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sametingets komitemøter i februar 2007 - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1551.html" xml:lang="sme"/>
</xsl:variable>
