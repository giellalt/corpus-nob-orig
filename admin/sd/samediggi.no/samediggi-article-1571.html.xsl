...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1571&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Til redaksjonene: Informasjonsmøte om adgangsreglement i Sametinget - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1571.html" xml:lang="sme"/>
</xsl:variable>
