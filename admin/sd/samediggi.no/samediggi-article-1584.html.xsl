...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1584&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'PRM: Avgiftsordninger undergraver samisk reindrift - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1584.html" xml:lang="sme"/>
</xsl:variable>
