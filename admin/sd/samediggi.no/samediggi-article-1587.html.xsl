...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1587&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'PRM: Enighet om samer og nasjonalparker - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1587.html" xml:lang="sme"/>
</xsl:variable>
