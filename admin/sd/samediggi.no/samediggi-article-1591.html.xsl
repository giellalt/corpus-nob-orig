...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1591&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Åpent seminar om Samefolkets fond - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1591.html" xml:lang="sme"/>
</xsl:variable>
