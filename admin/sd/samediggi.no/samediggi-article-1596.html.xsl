...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1596&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sametingsrådets medlemmer på 6. februar - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1596.html" xml:lang="sme"/>
</xsl:variable>
