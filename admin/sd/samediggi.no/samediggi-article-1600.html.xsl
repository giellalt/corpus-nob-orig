...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1600&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Seminar: Tradisjonell og ny utmarksbruk i samiske områder - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1600.html" xml:lang="sme"/>
</xsl:variable>
