...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1624&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Adgangsregler for Sametinget - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1624.html" xml:lang="sme"/>
</xsl:variable>
