...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1646&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Kunstutstilling på Sametinget: Mor og sønn, og hellige landskap - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1646.html" xml:lang="sme"/>
</xsl:variable>
