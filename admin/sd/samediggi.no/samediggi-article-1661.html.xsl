...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1661&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'PRM: Aili Keskitalo ny president i Samisk parlamentarisk råd - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1661.html" xml:lang="sme"/>
</xsl:variable>
