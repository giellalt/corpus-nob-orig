...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1662&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'PRM: - Else Laula Renberg kampskrift på samisk - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1662.html" xml:lang="sme"/>
</xsl:variable>
