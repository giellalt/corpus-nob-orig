...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1694&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'PRM: 200.000 kroner i tilskudd til Bivdi - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1694.html" xml:lang="sme"/>
</xsl:variable>
