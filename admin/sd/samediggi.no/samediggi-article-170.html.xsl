...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=170&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Stipend til studier i spesialpedagogikk - skoleåret 2007/2008 - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-170.html" xml:lang="sme"/>
</xsl:variable>
