...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1730&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sametingets komitémøter i mai 2007 - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1730.html" xml:lang="sme"/>
</xsl:variable>
