...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1759&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'PRM Samiske interesser styrkes i plan- og bygningsloven - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1759.html" xml:lang="sme"/>
</xsl:variable>
