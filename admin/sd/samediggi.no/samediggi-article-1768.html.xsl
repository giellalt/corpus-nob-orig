...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1768&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Likestillingstest av Samisk utviklingsfond - Sámediggi Sametinget'"/>
...
<xsl:variable name="wordcount" select="'29'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1768.html" xml:lang="sme"/>
</xsl:variable>
