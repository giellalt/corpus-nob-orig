...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1784&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'FoU-midler innen tilpasset opplæring - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1784.html" xml:lang="sme"/>
</xsl:variable>
