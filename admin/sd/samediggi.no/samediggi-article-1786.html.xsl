...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1786&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'FoU-midler innen tilpasset opplæring - Retningslinjer - Sámediggi Sametinget'"/>
...
<xsl:variable name="wordcount" select="'843'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1786.html" xml:lang="sme"/>
</xsl:variable>
