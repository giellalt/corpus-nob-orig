...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1795&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'PRM: Oda Utsi Onstad og Siv Anja Mienna mottar Sametingets idrettspris 2007 - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1795.html" xml:lang="sme"/>
</xsl:variable>
