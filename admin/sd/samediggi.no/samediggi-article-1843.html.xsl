...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1843&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'PRM: Kartportalen NordAtlas utvides - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1843.html" xml:lang="sme"/>
</xsl:variable>
