...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1860&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'GIELLA: Språknormering - Giella.org'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1860.html" xml:lang="sme"/>
</xsl:variable>
