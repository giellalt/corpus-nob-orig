...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1862&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'GIELLA: Bøker og tidskrifter - Giella.org'"/>
...
<xsl:variable name="wordcount" select="'613'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1862.html" xml:lang="sme"/>
</xsl:variable>
