...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1863&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Lenker til samarbeidsorganer - Giella.org'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1863.html" xml:lang="sme"/>
</xsl:variable>
