...
<xsl:variable name="title" select="'Bibliotekfaglig - Sรกmedikki girjeradju - Sametingets bilbiotek'"/>
...
<xsl:variable name="para_sme" select="'samediggi-article-1872.html'"/>
