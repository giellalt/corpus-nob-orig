...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=1943&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Biblioteket: Nyheter - Sámedikki girjeradju - Sametingets bilbiotek'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-1943.html" xml:lang="sme"/>
</xsl:variable>
