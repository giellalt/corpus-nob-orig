...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=196&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sametinget kjemper for folkeretten - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-196.html" xml:lang="sme"/>
</xsl:variable>
