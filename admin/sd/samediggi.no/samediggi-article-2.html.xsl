...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=2&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sametingsbygningen - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-2.html" xml:lang="sme"/>
</xsl:variable>
