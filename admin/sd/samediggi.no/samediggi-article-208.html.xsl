...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=208&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Forskrift om bruk av det samiske flagget - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-208.html" xml:lang="sme"/>
</xsl:variable>
