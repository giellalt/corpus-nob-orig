...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=224&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Finnmarksloven - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-224.html" xml:lang="sme"/>
</xsl:variable>
