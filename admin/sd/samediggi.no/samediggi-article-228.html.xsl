...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=228&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Samisk kultur  - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-228.html" xml:lang="sme"/>
</xsl:variable>
