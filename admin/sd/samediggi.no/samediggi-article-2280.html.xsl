...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=2280&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sametingsrådets deltakelse ved den samiske nasjonaldagens arrangementer - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-2280.html" xml:lang="sme"/>
</xsl:variable>
