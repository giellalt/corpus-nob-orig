...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=237&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Innbydelse til seminar: Grensehindre på Nordkalotten - Sámediggi Sametinget'"/>
...
<xsl:variable name="para_sme" select="'samediggi-article-237.html'"/>
