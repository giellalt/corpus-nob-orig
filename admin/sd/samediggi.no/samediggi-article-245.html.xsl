...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=245&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Selvbestemmelse og samarbeid - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-245.html" xml:lang="sme"/>
</xsl:variable>
