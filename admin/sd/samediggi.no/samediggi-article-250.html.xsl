...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=250&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Samemanntallet vokser - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-250.html" xml:lang="sme"/>
</xsl:variable>
