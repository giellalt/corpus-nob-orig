...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=262&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Samisk parlamentarisk råd  - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-262.html" xml:lang="sme"/>
</xsl:variable>
