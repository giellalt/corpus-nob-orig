...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=2644&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Frister til sametingsvalget 2009 - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-2644.html" xml:lang="sme"/>
</xsl:variable>
