...
<xsl:variable name="title" select="'Tilgang til eksemplar av Sametingets valgmanntall - S&#3619;&#3585;mediggi Sametinget'"/>
...
<xsl:variable name="para_sme" select="'samediggi-article-2645.html'"/>
