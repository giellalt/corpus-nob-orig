...
<xsl:variable name="title" select="'Samisk barnehage- og skolekonferanse 2008 - S&#3619;&#3585;mediggi Sametinget'"/>
...
<xsl:variable name="para_sme" select="'samediggi-article-2706.html'"/>
