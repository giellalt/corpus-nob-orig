...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=271&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Åpne høringer i Stortinget om Finnmarksloven  - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-271.html" xml:lang="sme"/>
</xsl:variable>
