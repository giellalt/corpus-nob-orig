...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=2730&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'PRM: Pressemelding -Sametingsrådet ønsker Porsanger kommune og Høgskolen i Finnmark til lykke med oppstart av desentralisert sykepleierutdanning - Sámediggi Sametinget'"/>
...
<xsl:variable name="wordcount" select="'100'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-2730.html" xml:lang="sme"/>
</xsl:variable>
