...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=2739&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'På rett vei for samisk institusjonsutvikling - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-2739.html" xml:lang="sme"/>
</xsl:variable>
