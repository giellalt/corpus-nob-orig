...
<xsl:variable name="title" select="'Samisk reiselivskonferanse 7.-8. oktober 2008 - Sรกmediggi Sametinget'"/>
...
<xsl:variable name="para_sme" select="'samediggi-article-2743.html'"/>
