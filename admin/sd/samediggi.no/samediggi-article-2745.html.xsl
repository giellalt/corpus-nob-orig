...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=2745&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Endelig to samiske dagsaviser - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-2745.html" xml:lang="sme"/>
</xsl:variable>
