...
<xsl:variable name="title" select="'Ny felles postadresse til Sametinget - S&#3619;&#3585;mediggi Sametinget'"/>
...
<xsl:variable name="para_sme" select="'samediggi-article-2747.html'"/>
