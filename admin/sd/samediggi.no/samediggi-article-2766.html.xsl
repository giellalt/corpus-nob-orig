...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=2766&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Samisk reiselivskonferanse 2008 - Sámediggi Sametinget'"/>
...
<xsl:variable name="wordcount" select="'77'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-2766.html" xml:lang="sme"/>
</xsl:variable>
