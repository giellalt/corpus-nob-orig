...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=277&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Endring i sameloven - gir Sametinget fire utjevningsmandater.  - Sámediggi Sametinget'"/>
...
<xsl:variable name="wordcount" select="'136'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-277.html" xml:lang="sme"/>
</xsl:variable>
