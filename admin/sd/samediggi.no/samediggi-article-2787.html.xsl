...
<xsl:variable name="title" select="'Sluttdokumentet fra Samisk parlamentarikerkonferanse 2008 - Sรกmediggi Sametinget'"/>
...
<xsl:variable name="para_sme" select="'samediggi-article-2787.html'"/>
