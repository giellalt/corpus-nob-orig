...
<xsl:variable name="title" select="'Tilskudd til informasjonstiltak i forbindelse med stortings- og sametingsvalget 2009 - S&#3619;&#3585;mediggi Sametinget'"/>
...
<xsl:variable name="para_sme" select="'samediggi-article-2797.html'"/>
