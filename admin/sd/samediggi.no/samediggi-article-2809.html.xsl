...
<xsl:variable name="title" select="'PRM: Sametingets tilskuddsstyre: 2,8 mill kr fordelt til duodji - S&#3619;&#3585;mediggi Sametinget'"/>
...
<xsl:variable name="para_sme" select="'samediggi-article-2809.html'"/>
