...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=2812&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'PRM: Enighet om å videreføre arbeidet med Nordisk samekonvensjon - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-2812.html" xml:lang="sme"/>
</xsl:variable>
