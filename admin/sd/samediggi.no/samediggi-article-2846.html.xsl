...
<xsl:variable name="title" select="'Ledige stillinger - desember 2008 - 5 stillinger - Sรกmediggi Sametinget'"/>
...
<xsl:variable name="para_sme" select="'samediggi-article-2846.html'"/>
