...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=285&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Velgere ved sametingsvalget 2005 i Oslo kan avgi stemme i alle byens stemmelokaler - Sámediggi Sametinget'"/>
...
<xsl:variable name="wordcount" select="'103'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-285.html" xml:lang="sme"/>
</xsl:variable>
