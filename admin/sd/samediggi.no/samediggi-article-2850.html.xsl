...
<xsl:variable name="title" select="'PRM: Forhold til samisk kultur skal utredes av klimatilpasningsutvalget - S&#3619;&#3585;mediggi Sametinget'"/>
...
<xsl:variable name="para_sme" select="'samediggi-article-2850.html'"/>
