...
<xsl:variable name="title" select="'Ni registrerte samepolitiske organisasjoner til valget 2009 - Sรกmediggi Sametinget'"/>
...
<xsl:variable name="para_sme" select="'samediggi-article-2852.html'"/>
