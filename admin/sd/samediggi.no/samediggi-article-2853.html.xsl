...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=2853&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Kulturminneregistrering i Troms. - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-2853.html" xml:lang="sme"/>
</xsl:variable>
