...
<xsl:variable name="title" select="'Sametinget har overtatt campingplassen i Neiden - Sรกmediggi Sametinget'"/>
...
<xsl:variable name="para_sme" select="'samediggi-article-2856.html'"/>
