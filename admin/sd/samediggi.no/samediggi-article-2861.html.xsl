...
<xsl:variable name="title" select="'Etiske retningslinjer for Sametingets politikere - S&#3619;&#3585;mediggi Sametinget'"/>
...
<xsl:variable name="para_sme" select="'samediggi-article-2861.html'"/>
