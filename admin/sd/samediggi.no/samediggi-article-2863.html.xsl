...
<xsl:variable name="title" select="'PRM: Over 9 millioner kroner til samisk fiskeri, jordbruk og kultur - S&#3619;&#3585;mediggi Sametinget'"/>
...
<xsl:variable name="para_sme" select="'samediggi-article-2863.html'"/>
