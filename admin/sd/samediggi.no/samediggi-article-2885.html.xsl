...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=2885&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Ny versjon av Divvun-verktøyene klar!  - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-2885.html" xml:lang="sme"/>
</xsl:variable>
