...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=2886&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sametingsvalget 2009 – valglister - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-2886.html" xml:lang="sme"/>
</xsl:variable>
