...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=2888&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sametingets komitémøter i februar 2009 - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-2888.html" xml:lang="sme"/>
</xsl:variable>
