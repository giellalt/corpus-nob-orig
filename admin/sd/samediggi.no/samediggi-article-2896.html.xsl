...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=2896&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sjølakseregulering og avklaringer med Russland og EU - Sámediggi Sametinget'"/>
...
<xsl:variable name="wordcount" select="'91'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-2896.html" xml:lang="sme"/>
</xsl:variable>
