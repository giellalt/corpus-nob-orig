...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=2897&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'PRM: Tana og Varanger museumsiida er etablert - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-2897.html" xml:lang="sme"/>
</xsl:variable>
