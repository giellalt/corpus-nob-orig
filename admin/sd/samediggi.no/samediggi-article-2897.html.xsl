...
<xsl:variable name="title" select="'PRM: Tana og Varanger museumsiida er etablert - S&#3619;&#3585;mediggi Sametinget'"/>
...
<xsl:variable name="para_sme" select="'samediggi-article-2897.html'"/>
