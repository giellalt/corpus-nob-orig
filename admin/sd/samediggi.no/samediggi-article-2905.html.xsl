...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=2905&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'PRM: Sametinget og Innovasjon Norge inngår samarbeidsavtale - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-2905.html" xml:lang="sme"/>
</xsl:variable>
