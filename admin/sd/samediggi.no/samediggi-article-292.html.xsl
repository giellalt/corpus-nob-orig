...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=292&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Krav om støtte for samiske språk innen databehandling - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-292.html" xml:lang="sme"/>
</xsl:variable>
