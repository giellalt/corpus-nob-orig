...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=2934&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'FNs Permanente Forum for Urfolkssaker i Sápmi - Sรกmediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-2934.html" xml:lang="sme"/>
</xsl:variable>
