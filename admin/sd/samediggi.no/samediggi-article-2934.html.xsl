...
<xsl:variable name="title" select="'FNs Permanente Forum for Urfolkssaker i Sรกpmi - Sรกmediggi Sametinget'"/>
...
<xsl:variable name="para_sme" select="'samediggi-article-2934.html'"/>
