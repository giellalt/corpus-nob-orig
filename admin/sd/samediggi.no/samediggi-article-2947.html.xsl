...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=2947&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sametingets årsmelding 2008 - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-2947.html" xml:lang="sme"/>
</xsl:variable>
