...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=2951&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Verdens banken og Permanent Forum inviterer til åpent møte - Sámediggi Sametinget'"/>
...
<xsl:variable name="wordcount" select="'52'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-2951.html" xml:lang="sme"/>
</xsl:variable>
