...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=2955&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'VALG: For partier/lister - Sámediggi Sametinget'"/>
...
<xsl:variable name="wordcount" select="'353'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-2955.html" xml:lang="sme"/>
</xsl:variable>
