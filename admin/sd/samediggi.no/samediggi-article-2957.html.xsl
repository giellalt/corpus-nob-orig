...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=2957&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'PRM: Youtube kampanje for å få flere unge inn i Sametingets valgmanntall - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-2957.html" xml:lang="sme"/>
</xsl:variable>
