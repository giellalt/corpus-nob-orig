...
<xsl:variable name="title" select="'Innsending av listeforslag til Sametinget - Sรกmediggi Sametinget'"/>
...
<xsl:variable name="para_sme" select="'samediggi-article-2961.html'"/>
