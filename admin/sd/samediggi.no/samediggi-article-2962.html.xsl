...
<xsl:variable name="title" select="'Sametingets valgmanntall - endelig oversikt - S&#3619;&#3585;mediggi Sametinget'"/>
...
<xsl:variable name="para_sme" select="'samediggi-article-2962.html'"/>
