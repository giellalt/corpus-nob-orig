...
<xsl:variable name="title" select="'Sametinget og NVE undertegner samarbeidsavtale - Sรกmediggi Sametinget'"/>
...
<xsl:variable name="para_sme" select="'samediggi-article-2965.html'"/>
