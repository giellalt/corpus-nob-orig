...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=2978&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'PRM: ”Drømmejobben – Gollevirgi”  - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-2978.html" xml:lang="sme"/>
</xsl:variable>
