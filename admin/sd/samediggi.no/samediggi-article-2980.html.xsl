...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=2980&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'PRM: Sametinget tildelte 11 879 000 kroner til læremidler - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-2980.html" xml:lang="sme"/>
</xsl:variable>
