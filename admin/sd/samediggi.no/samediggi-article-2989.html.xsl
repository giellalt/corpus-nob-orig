...
<xsl:variable name="title" select="'PRM: 4,5 millioner til prosjekter innenfor helse- og sosial, og kulturminnevern. - S&#3619;&#3585;mediggi Sametinget'"/>
...
<xsl:variable name="para_sme" select="'samediggi-article-2989.html'"/>
