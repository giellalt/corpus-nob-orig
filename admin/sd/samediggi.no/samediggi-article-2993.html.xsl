...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=2993&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sametinget bevilger kr. 520 000 til ungdomsetableringer - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-2993.html" xml:lang="sme"/>
</xsl:variable>
