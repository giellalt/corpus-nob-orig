...
<xsl:variable name="title" select="'Sametinget bevilger kr. 520 000 til ungdomsetableringer - S&#3619;&#3585;mediggi Sametinget'"/>
...
<xsl:variable name="para_sme" select="'samediggi-article-2993.html'"/>
