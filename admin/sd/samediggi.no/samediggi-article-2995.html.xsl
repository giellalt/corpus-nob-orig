...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=2995&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Ledig stilling: Konsulent/førstekonsulent til arkivet - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-2995.html" xml:lang="sme"/>
</xsl:variable>
