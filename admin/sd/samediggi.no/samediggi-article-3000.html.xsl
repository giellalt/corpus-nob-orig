...
<xsl:variable name="title" select="'Konferanse for kommune og fylkeskommune - ledige plasser - Sรกmediggi Sametinget'"/>
...
<xsl:variable name="para_sme" select="'samediggi-article-3000.html'"/>
