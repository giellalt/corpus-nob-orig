...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3021&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sametingets plenumsmøte i mai 2009 - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3021.html" xml:lang="sme"/>
</xsl:variable>
