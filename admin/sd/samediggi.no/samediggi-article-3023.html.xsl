...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3023&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'PRM: Samisk språkforvaltingsområde øker til 9 kommuner - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3023.html" xml:lang="sme"/>
</xsl:variable>
