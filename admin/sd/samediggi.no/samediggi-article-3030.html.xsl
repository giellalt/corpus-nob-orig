...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3030&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'PRM: Markerer 20 års jubileum for Barnekonvensjon  - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3030.html" xml:lang="sme"/>
</xsl:variable>
