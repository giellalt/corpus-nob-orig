...
<xsl:variable name="title" select="'Sametingspresident Egil Olli`s tale til FN`s Permanente Forum i New York - S&#3619;&#3585;mediggi Sametinget'"/>
...
<xsl:variable name="para_sme" select="'samediggi-article-3032.html'"/>
