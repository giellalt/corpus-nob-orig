...
<xsl:variable name="title" select="'Samarbeidsavtale mellom Sametinget og Oppland fylkeskommune 2009-2012 - Sรกmediggi Sametinget'"/>
...
<xsl:variable name="para_sme" select="'samediggi-article-3033.html'"/>
