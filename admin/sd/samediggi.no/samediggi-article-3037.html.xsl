...
<xsl:variable name="title" select="'Seminar om Barnekonvensjonen 27.-28.mai 2009 - Sรกmediggi Sametinget'"/>
...
<xsl:variable name="para_sme" select="'samediggi-article-3037.html'"/>
