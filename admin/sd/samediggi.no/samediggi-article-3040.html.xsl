...
<xsl:variable name="title" select="'PRM: -Godt at Alta tar ansvar for sine samiske elever - S&#3619;&#3585;mediggi Sametinget'"/>
...
<xsl:variable name="para_sme" select="'samediggi-article-3040.html'"/>
