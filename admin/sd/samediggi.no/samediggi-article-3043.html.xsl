...
<xsl:variable name="title" select="'Historiske valgdata om sametingsvalgene 1989-2009 - S&#3619;&#3585;mediggi Sametinget'"/>
...
<xsl:variable name="para_sme" select="'samediggi-article-3043.html'"/>
