...
<xsl:variable name="title" select="'Sametinget lanserer facebookside - Sametingsvalget 2009 - S&#3619;&#3585;mediggi Sametinget'"/>
...
<xsl:variable name="para_sme" select="'samediggi-article-3044.html'"/>
