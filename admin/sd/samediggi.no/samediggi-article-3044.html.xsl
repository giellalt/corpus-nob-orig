...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3044&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sametinget lanserer facebookside - Sametingsvalget 2009 - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3044.html" xml:lang="sme"/>
</xsl:variable>
