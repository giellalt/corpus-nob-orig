...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3045&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Valgkort - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3045.html" xml:lang="sme"/>
</xsl:variable>
