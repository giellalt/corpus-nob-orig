...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3058&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Direktesending fra pressekonferanse onsdag 10.6. - Sámediggi Sametinget'"/>
...
<xsl:variable name="wordcount" select="'82'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3058.html" xml:lang="sme"/>
</xsl:variable>
