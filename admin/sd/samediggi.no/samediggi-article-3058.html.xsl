...
<xsl:variable name="title" select="'Direktesending fra pressekonferanse onsdag 10.6. - S&#3619;&#3585;mediggi Sametinget'"/>
...
<xsl:variable name="para_sme" select="'samediggi-article-3058.html'"/>
