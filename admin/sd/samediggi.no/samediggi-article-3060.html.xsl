...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3060&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'PRM: Sametingsrådet invitasjon til pressekonferanse med tema mineralloven - Sámediggi Sametinget'"/>
...
<xsl:variable name="wordcount" select="'89'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3060.html" xml:lang="sme"/>
</xsl:variable>
