...
<xsl:variable name="title" select="'PRM: Forslag til mineralretningslinjer - Sรกmediggi Sametinget'"/>
...
<xsl:variable name="para_sme" select="'samediggi-article-3065.html'"/>
