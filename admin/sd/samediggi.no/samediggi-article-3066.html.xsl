...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3066&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sametingets tilskuddstyre har tildelt kr. 2,9 millioner til næringsformål på møte i Sørsamisk område. - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3066.html" xml:lang="sme"/>
</xsl:variable>
