...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3072&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sametingsrådet tildeler 1,2 millioner i støtte - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3072.html" xml:lang="sme"/>
</xsl:variable>
