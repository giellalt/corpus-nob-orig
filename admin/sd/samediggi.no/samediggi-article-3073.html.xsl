...
<xsl:variable name="title" select="'Sametinget protesterer mot overgrep i Peru - Sรกmediggi Sametinget'"/>
...
<xsl:variable name="para_sme" select="'samediggi-article-3073.html'"/>
