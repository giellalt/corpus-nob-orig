...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3074&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Marianne Balto er fungerende sametingspresident - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3074.html" xml:lang="sme"/>
</xsl:variable>
