...
<xsl:variable name="title" select="'Marianne Balto er fungerende sametingspresident - S&#3619;&#3585;mediggi Sametinget'"/>
...
<xsl:variable name="para_sme" select="'samediggi-article-3074.html'"/>
