...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3097&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sametingets støtte til musikkutgivelser 2009 - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3097.html" xml:lang="sme"/>
</xsl:variable>
