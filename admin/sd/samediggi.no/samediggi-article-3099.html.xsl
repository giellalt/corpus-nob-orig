...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3099&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Avdeling for kommunikasjon (GUL) - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3099.html" xml:lang="sme"/>
</xsl:variable>
