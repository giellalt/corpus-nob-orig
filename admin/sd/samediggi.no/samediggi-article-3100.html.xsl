...
<xsl:variable name="title" select="'Tilskudd til valgdeltakelse i Sametinget - Sรกmediggi Sametinget'"/>
...
<xsl:variable name="para_sme" select="'samediggi-article-3100.html'"/>
