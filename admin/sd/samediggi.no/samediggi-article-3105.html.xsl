...
<xsl:variable name="title" select="'Sametingets manntallskampanje - bildeutstilling - Sรกmediggi Sametinget'"/>
...
<xsl:variable name="para_sme" select="'samediggi-article-3105.html'"/>
