...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3111&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Ledige stillinger med søknadsfrist 1. juli - Sámediggi Sametinget'"/>
...
<xsl:variable name="wordcount" select="'25'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3111.html" xml:lang="sme"/>
</xsl:variable>
