...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3125&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Åpningen av det nye Sametinget i 2009 - Sámediggi Sametinget'"/>
...
<xsl:variable name="wordcount" select="'35'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3125.html" xml:lang="sme"/>
</xsl:variable>
