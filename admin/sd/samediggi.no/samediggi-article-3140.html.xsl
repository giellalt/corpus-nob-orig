...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3140&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Høring - oppstart av regional plan for kulturminne og kulturmiljø i Finnmark - Sámediggi Sametinget'"/>
...
<xsl:variable name="wordcount" select="'111'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3140.html" xml:lang="sme"/>
</xsl:variable>
