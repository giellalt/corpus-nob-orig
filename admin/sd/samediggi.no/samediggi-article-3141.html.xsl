...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3141&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sametingets valgmanntall er ajourført - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3141.html" xml:lang="sme"/>
</xsl:variable>
