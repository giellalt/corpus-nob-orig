...
<xsl:variable name="title" select="'Sametingspresident Egil Olli`s hilsningstale i Kipparifestivalen - Sรกmediggi Sametinget'"/>
...
<xsl:variable name="para_sme" select="'samediggi-article-3143.html'"/>
