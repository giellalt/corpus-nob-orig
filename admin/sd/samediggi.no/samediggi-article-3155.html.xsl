...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3155&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Skal du stemme ved sametingsvalget i Oslo, Trondheim, Bodø, Narvik, Sortland, Harstad eller Tromsø? - Sámediggi Sametinget'"/>
...
<xsl:variable name="wordcount" select="'96'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3155.html" xml:lang="sme"/>
</xsl:variable>
