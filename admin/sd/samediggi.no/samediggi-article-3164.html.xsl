...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3164&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Redaktørens tillitskrise - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3164.html" xml:lang="sme"/>
</xsl:variable>
