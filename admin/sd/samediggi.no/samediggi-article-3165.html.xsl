...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3165&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'PRM:  Midler til grenseoverskridende skole- og barnehagesamarbeid for å styrke tradisjonelt samisk kunnskap - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3165.html" xml:lang="sme"/>
</xsl:variable>
