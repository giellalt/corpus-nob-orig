...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3168&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Åpning av Sametinget - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3168.html" xml:lang="sme"/>
</xsl:variable>
