...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3171&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'PRM: Sametingsrådet bevilger 250 000 kr til Gáisá næringshage - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3171.html" xml:lang="sme"/>
</xsl:variable>
