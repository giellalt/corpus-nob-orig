...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3179&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Biblioteket: Anbefalinger - Sámedikki girjeradju - Sametingets bilbiotek'"/>
...
<xsl:variable name="wordcount" select="'38'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3179.html" xml:lang="sme"/>
</xsl:variable>
