...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=318&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sametinget støttet enstemmig forslaget til finnmarkslov - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-318.html" xml:lang="sme"/>
</xsl:variable>
