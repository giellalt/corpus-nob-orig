...
<xsl:variable name="title" select="'Brudd i forhandlingene om en ny duodjiavtale for 2010 - Sรกmediggi Sametinget'"/>
...
<xsl:variable name="para_sme" select="'samediggi-article-3185.html'"/>
