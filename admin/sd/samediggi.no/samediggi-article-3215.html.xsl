...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3215&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'PRM: Likestillinga blant samer i fokus - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3215.html" xml:lang="sme"/>
</xsl:variable>
