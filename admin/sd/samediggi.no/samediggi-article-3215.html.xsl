...
<xsl:variable name="title" select="'PRM: Likestillinga blant samer i fokus - S&#3619;&#3585;mediggi Sametinget'"/>
...
<xsl:variable name="para_sme" select="'samediggi-article-3215.html'"/>
