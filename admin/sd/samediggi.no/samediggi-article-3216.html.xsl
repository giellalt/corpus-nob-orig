...
<xsl:variable name="title" select="'PRM: Samiske skoleklasser i alle storbyer i Norge - S&#3619;&#3585;mediggi Sametinget'"/>
...
<xsl:variable name="para_sme" select="'samediggi-article-3216.html'"/>
