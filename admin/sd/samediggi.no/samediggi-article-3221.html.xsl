...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3221&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sametinget fornøyd med valgavviklingen - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3221.html" xml:lang="sme"/>
</xsl:variable>
