...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3232&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Enstemmig Tanautvalg  - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3232.html" xml:lang="sme"/>
</xsl:variable>
