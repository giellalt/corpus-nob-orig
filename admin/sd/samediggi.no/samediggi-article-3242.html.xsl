...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3242&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'For pressen: Akkreditering i forbindelse med åpningen - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3242.html" xml:lang="sme"/>
</xsl:variable>
