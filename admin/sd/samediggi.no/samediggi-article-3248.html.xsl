...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3248&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Samiske tall forteller 2 - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3248.html" xml:lang="sme"/>
</xsl:variable>
