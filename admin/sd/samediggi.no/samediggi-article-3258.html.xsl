...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3258&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Info til pressen - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3258.html" xml:lang="sme"/>
</xsl:variable>
