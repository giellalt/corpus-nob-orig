...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3259&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Her er kongelunsjen - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3259.html" xml:lang="sme"/>
</xsl:variable>
