...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3262&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sametinget 2009 - 2013 - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3262.html" xml:lang="sme"/>
</xsl:variable>
