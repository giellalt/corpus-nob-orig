...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3270&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Invitasjon til nettverksmøte for språkmedarbeidere - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3270.html" xml:lang="sme"/>
</xsl:variable>
