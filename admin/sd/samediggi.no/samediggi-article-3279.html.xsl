...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3279&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Pålogging for ansatte og representanter - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3279.html" xml:lang="sme"/>
</xsl:variable>
