...
<xsl:variable name="title" select="'Marie Therese Aslaksen leder Sametingets tilskuddsstyre  - S&#3619;&#3585;mediggi Sametinget'"/>
...
<xsl:variable name="para_sme" select="'samediggi-article-3280.html'"/>
