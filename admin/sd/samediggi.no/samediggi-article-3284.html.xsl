...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3284&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Ungdom og utdanning for fremtidens Sápmi - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3284.html" xml:lang="sme"/>
</xsl:variable>
