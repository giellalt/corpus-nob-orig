...
<xsl:variable name="title" select="'Ungdom og utdanning for fremtidens Sรกpmi - Sรกmediggi Sametinget'"/>
...
<xsl:variable name="para_sme" select="'samediggi-article-3284.html'"/>
