...
<xsl:variable name="title" select="'PRM: Sametinget vil hindre nedleggelse av samiske grendeskoler - Sรกmediggi Sametinget'"/>
...
<xsl:variable name="para_sme" select="'samediggi-article-3288.html'"/>
