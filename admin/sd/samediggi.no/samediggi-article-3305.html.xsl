...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3305&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Vellykket ungdomskonferanse 2009 - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3305.html" xml:lang="sme"/>
</xsl:variable>
