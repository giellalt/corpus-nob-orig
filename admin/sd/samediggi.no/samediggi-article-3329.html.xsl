...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3329&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sametinget tar opp samiske innsattes soningsforhold - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3329.html" xml:lang="sme"/>
</xsl:variable>
