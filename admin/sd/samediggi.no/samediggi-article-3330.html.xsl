...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3330&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Ønsker dialog og samarbeid med Norges Fiskarlag - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3330.html" xml:lang="sme"/>
</xsl:variable>
