...
<xsl:variable name="title" select="'Fremlegging av rapport fra faglig analysegruppe for samisk statistikk - Sรกmediggi Sametinget'"/>
...
<xsl:variable name="para_sme" select="'samediggi-article-3345.html'"/>
