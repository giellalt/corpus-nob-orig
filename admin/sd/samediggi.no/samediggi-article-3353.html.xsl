...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3353&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Ledig stilling i FN - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3353.html" xml:lang="sme"/>
</xsl:variable>
