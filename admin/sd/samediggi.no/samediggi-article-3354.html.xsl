...
<xsl:variable name="title" select="'Sametinget vil ikke regulere tradisjonell snarefangst  - S&#3619;&#3585;mediggi Sametinget'"/>
...
<xsl:variable name="para_sme" select="'samediggi-article-3354.html'"/>
