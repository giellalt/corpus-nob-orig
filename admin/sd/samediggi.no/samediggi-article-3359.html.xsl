...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3359&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'*Pressemeldinger 2009-2013 - S&#225;mediggi Sametinget'"/>
...
<xsl:variable name="wordcount" select="'3708'"/>
...
<xsl:variable name="para_sme" select="'samediggi-article-3359.html'"/>
...
<xsl:element name="p">
            ...
            <xsl:call-template name="globalTextReplace">
               ...
               <xsl:with-param name="target" select="'01.oktober/kl.13.00/'"/>
               <xsl:with-param name="replacement" select="'01. oktober/kl. 13.00/'"/>
