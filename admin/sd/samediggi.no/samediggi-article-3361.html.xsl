...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3361&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sametinget på facebook - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3361.html" xml:lang="sme"/>
</xsl:variable>
