...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3363&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Klimatoppmøtet i København - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3363.html" xml:lang="sme"/>
</xsl:variable>
