...
<xsl:variable name="title" select="'Sametingets helsepenger gir god effekt - S&#3619;&#3585;mediggi Sametinget'"/>
...
<xsl:variable name="para_sme" select="'samediggi-article-3365.html'"/>
