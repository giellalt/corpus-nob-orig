...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3398&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Søkerbaserte tilskudd - næring  - Sámediggi Sametinget'"/>
...
<xsl:variable name="wordcount" select="'3454'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3398.html" xml:lang="sme"/>
</xsl:variable>
