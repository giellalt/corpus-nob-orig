...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3400&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Søkerbaserte tilskudd - opplæring - Sámediggi Sametinget'"/>
...
<xsl:variable name="wordcount" select="'5119'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3400.html" xml:lang="sme"/>
</xsl:variable>
...
<xsl:element name="p">
            ...
            <xsl:call-template name="globalTextReplace">
               ...
               <xsl:with-param name="target" select="')teknisk/7.års/'"/>
               <xsl:with-param name="replacement" select="') teknisk/7. års/'"/>
