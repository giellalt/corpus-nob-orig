...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3409&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sametinget stengt fra 09. - 11.12.09 - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3409.html" xml:lang="sme"/>
</xsl:variable>
