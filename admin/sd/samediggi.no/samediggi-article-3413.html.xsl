...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3413&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sametingsrådets saksliste 14.-16. desember. - Sámediggi Sametinget'"/>
...
<xsl:variable name="wordcount" select="'26'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3413.html" xml:lang="sme"/>
</xsl:variable>
