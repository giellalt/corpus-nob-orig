...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3453&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sametingspresidentens nyttårstale - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3453.html" xml:lang="sme"/>
</xsl:variable>
