...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3454&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Tanarapporten på høring - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3454.html" xml:lang="sme"/>
</xsl:variable>
