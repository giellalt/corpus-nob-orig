...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3466&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Rådsmøte i Tromsø - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3466.html" xml:lang="sme"/>
</xsl:variable>
