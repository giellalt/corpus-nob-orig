...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3475&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sametinget vil ikke forby bruk av samekofte i retten  - Sámediggi Sametinget'"/>
...
<xsl:variable name="wordcount" select="'104'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3475.html" xml:lang="sme"/>
</xsl:variable>
