...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3495&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sametinget tar opp togpåkjørslene - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3495.html" xml:lang="sme"/>
</xsl:variable>
