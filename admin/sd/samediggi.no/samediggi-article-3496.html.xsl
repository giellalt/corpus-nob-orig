...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3496&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Folkemøte i Kåfjord er avlyst - Sámediggi Sametinget'"/>
...
<xsl:variable name="wordcount" select="'27'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3496.html" xml:lang="sme"/>
</xsl:variable>
