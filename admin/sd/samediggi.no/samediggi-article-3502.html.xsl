...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3502&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sametingets seminar om utmarksnæringer - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3502.html" xml:lang="sme"/>
</xsl:variable>
