...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3510&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Ledig stilling i Sametinget med søknadsfrist: 17.02.10 - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3510.html" xml:lang="sme"/>
</xsl:variable>
