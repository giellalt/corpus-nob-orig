...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3512&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Lykke til med feiringen av 6.februar - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3512.html" xml:lang="sme"/>
</xsl:variable>
