...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3518&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Satser på eldrepolitikk - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3518.html" xml:lang="sme"/>
</xsl:variable>
