...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3533&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Samiske språkrettigheter i hverdagen - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3533.html" xml:lang="sme"/>
</xsl:variable>
