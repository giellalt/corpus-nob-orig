...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3534&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Inviterer til klimadebatt - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3534.html" xml:lang="sme"/>
</xsl:variable>
