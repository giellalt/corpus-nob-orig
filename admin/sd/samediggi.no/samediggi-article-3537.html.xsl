...
<xsl:variable name="title" select="'Sametingets innlegg til Tenkeloftssamlingen  - Sรกmediggi Sametinget'"/>
...
<xsl:variable name="para_sme" select="'samediggi-article-3537.html'"/>
