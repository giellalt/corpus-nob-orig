...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3555&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Klart for de 21. arktiske vinterlekene! - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3555.html" xml:lang="sme"/>
</xsl:variable>
