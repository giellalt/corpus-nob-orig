...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3560&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Har du spørsmål om Sametingets tilskuddsordninger? - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3560.html" xml:lang="sme"/>
</xsl:variable>
