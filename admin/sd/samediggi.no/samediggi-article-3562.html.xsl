...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3562&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Tradisjonell kunnskap og opplæring i reindrift - Sámediggi Sametinget'"/>
...
<xsl:variable name="wordcount" select="'2489'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3562.html" xml:lang="sme"/>
</xsl:variable>
