...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3563&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Rådsmøte i Karasjok - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3563.html" xml:lang="sme"/>
</xsl:variable>
