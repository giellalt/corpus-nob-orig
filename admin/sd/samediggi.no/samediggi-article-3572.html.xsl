...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3572&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sametinget markerer barnehagedagen - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3572.html" xml:lang="sme"/>
</xsl:variable>
