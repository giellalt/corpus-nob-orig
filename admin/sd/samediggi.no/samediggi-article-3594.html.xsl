...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3594&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Åarjelsaemien – et språk i framgang!  - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3594.html" xml:lang="sme"/>
</xsl:variable>
