...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3599&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sametinget ber Norge å hjelpe Mapuchene i Chile. - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3599.html" xml:lang="sme"/>
</xsl:variable>
