...
<xsl:variable name="title" select="'60 studiepoeng med samisk i fagkretsen kan gi 60 000 kroner - Sรกmediggi Sametinget'"/>
...
<xsl:variable name="para_sme" select="'samediggi-article-3612.html'"/>
