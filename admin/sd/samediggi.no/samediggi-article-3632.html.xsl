...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3632&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Lykketreff at FNs spesialrapportør besøker Sápmi nå  - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3632.html" xml:lang="sme"/>
</xsl:variable>
