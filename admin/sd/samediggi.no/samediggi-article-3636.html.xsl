...
<xsl:variable name="title" select="'Utsettelse av studietur om innlandsfiske i Finland - Sรกmediggi Sametinget'"/>
...
<xsl:variable name="para_sme" select="'samediggi-article-3636.html'"/>
