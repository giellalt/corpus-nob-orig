...
<xsl:variable name="title" select="'Sametingspresidenten deltar i FNs urfolksforum - Sรกmediggi Sametinget'"/>
...
<xsl:variable name="para_sme" select="'samediggi-article-3648.html'"/>
