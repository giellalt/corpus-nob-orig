...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3649&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Vinnerne er kåret - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3649.html" xml:lang="sme"/>
</xsl:variable>
