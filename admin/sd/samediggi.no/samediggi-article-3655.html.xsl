...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3655&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Samisk forskning og høyere utdanning skal utredes - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3655.html" xml:lang="sme"/>
</xsl:variable>
