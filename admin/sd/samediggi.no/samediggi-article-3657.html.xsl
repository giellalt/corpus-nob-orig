...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3657&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Møte i Sametingsrådet i Karasjok - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3657.html" xml:lang="sme"/>
</xsl:variable>
