...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3664&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Brosjyrer - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3664.html" xml:lang="sme"/>
</xsl:variable>
