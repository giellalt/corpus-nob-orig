...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3669&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sametingsrådets politiske halvårsregnskap offentliggjort - Sámediggi Sametinget'"/>
...
<xsl:variable name="wordcount" select="'2269'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3669.html" xml:lang="sme"/>
</xsl:variable>
