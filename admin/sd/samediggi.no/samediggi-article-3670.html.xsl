...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3670&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'500 tusen kroner til Elgå skole for å revitalisere sørsamisk språk - Sámediggi Sametinget'"/>
...
<xsl:variable name="wordcount" select="'337'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3670.html" xml:lang="sme"/>
</xsl:variable>
