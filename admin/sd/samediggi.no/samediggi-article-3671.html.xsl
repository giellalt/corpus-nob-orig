...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3671&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Dialogkonferanse på Sametinget - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3671.html" xml:lang="sme"/>
</xsl:variable>
