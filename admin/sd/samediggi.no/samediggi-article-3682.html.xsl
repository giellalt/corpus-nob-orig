...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3682&amp;sprak=Norsk&amp;Print=1'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3682.html" xml:lang="sme"/>
</xsl:variable>
