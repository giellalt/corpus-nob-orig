...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3692&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Tana og Varanger museumssiida er stiftet - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3692.html" xml:lang="sme"/>
</xsl:variable>
