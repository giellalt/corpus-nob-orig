...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3696&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Bolivias president besøker Sametinget - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3696.html" xml:lang="sme"/>
</xsl:variable>
