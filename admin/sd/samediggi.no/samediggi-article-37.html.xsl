...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=37&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'*Politikk og demokrati - Om samene - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-37.html" xml:lang="sme"/>
</xsl:variable>
