...
<xsl:variable name="title" select="'Planer om etablering av bedrift eller bedriftsutvikling? - S&#3619;&#3585;mediggi Sametinget'"/>
...
<xsl:variable name="para_sme" select="'samediggi-article-3724.html'"/>
