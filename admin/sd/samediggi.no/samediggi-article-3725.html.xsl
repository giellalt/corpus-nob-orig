...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3725&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Om de folkevalgte  - Sámediggi Sametinget'"/>
...
<xsl:variable name="wordcount" select="'45'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3725.html" xml:lang="sme"/>
</xsl:variable>
