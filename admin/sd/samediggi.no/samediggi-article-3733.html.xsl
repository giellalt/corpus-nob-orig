...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3733&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Året som samisk veiviser - Et uforglemmelig år! - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3733.html" xml:lang="sme"/>
</xsl:variable>
