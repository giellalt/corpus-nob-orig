...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3738&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sametingets plenumsmøte i juni 2010 - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3738.html" xml:lang="sme"/>
</xsl:variable>
