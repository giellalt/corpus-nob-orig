...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3744&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Endring i sametingsrådets ansvarsområder  - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3744.html" xml:lang="sme"/>
</xsl:variable>
