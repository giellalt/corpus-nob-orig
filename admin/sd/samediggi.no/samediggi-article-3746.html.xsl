...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3746&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sametingsrådet vil løfte den kulturelle verdien av duodji - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3746.html" xml:lang="sme"/>
</xsl:variable>
