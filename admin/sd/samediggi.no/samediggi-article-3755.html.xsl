...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3755&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Vil prioritere arbeidet med forebygging av selvmord - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3755.html" xml:lang="sme"/>
</xsl:variable>
