...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3761&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Samisk opplæring - rettigheter og plikter - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3761.html" xml:lang="sme"/>
</xsl:variable>
