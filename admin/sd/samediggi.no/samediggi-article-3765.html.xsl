...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3765&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Norske Reindriftsamers Landsforbund  bør bruke Sametinget - Sámediggi Sametinget'"/>
...
<xsl:variable name="wordcount" select="'1303'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3765.html" xml:lang="sme"/>
</xsl:variable>
