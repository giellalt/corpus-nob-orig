...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3770&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Glad for langsiktig løsning - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3770.html" xml:lang="sme"/>
</xsl:variable>
