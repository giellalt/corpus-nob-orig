...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3785&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Menneskejerven får støtte fra Sametinget - Sámediggi Sametinget'"/>
...
<xsl:variable name="wordcount" select="'308'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3785.html" xml:lang="sme"/>
</xsl:variable>
