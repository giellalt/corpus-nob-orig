...
<xsl:variable name="title" select="'Bevilger penger til lokalt sel-prosjekt - Sรกmediggi Sametinget'"/>
...
<xsl:variable name="para_sme" select="'samediggi-article-3787.html'"/>
