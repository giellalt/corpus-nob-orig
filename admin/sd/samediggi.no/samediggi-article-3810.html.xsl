...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3810&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Informasjonsfolder om barnehagetilbud - Sámediggi Sametinget'"/>
...
<xsl:variable name="wordcount" select="'61'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3810.html" xml:lang="sme"/>
</xsl:variable>
