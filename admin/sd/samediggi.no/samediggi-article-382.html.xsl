...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=382&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'PRM: Havressurslovutvalget vil frata kystbefolkningen allemannsretten til fiskeressursene - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-382.html" xml:lang="sme"/>
</xsl:variable>
