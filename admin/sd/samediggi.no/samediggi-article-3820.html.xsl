...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3820&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Den norske delegasjonen i møte på ambassaden.  - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3820.html" xml:lang="sme"/>
</xsl:variable>
