...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3822&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Spesialrapportør James Anaya fulgte EMRIPs 3. sesjon - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3822.html" xml:lang="sme"/>
</xsl:variable>
