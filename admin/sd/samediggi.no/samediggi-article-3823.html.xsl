...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3823&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Urfolk og stater diskuterte FNs urfolkserklæring (UNDRIP) - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3823.html" xml:lang="sme"/>
</xsl:variable>
