...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3834&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Støtter etablering av kulturformidlingssenter for nordlige folk i Russland - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3834.html" xml:lang="sme"/>
</xsl:variable>
