...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3840&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Samfunns- og næringsutvikling i samiske kommuner - Sámediggi Sametinget'"/>
...
<xsl:variable name="wordcount" select="'984'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3840.html" xml:lang="sme"/>
</xsl:variable>
