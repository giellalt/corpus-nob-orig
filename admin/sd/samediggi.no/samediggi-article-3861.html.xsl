...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3861&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Skal utrede samisk forskning og utdanning - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3861.html" xml:lang="sme"/>
</xsl:variable>
