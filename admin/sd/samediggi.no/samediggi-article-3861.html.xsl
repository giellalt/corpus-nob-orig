...
<xsl:variable name="title" select="'Skal utrede samisk forskning og utdanning - Sรกmediggi Sametinget'"/>
...
<xsl:variable name="para_sme" select="'samediggi-article-3861.html'"/>
