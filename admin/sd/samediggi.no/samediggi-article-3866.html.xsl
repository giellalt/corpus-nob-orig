...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3866&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Ledig stilling: PROSJEKTLEDER - AREAL- OG KULTURVERNAVDELINGA - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3866.html" xml:lang="sme"/>
</xsl:variable>
