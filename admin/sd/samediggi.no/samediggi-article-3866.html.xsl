...
<xsl:variable name="title" select="'Ledig stilling: PROSJEKTLEDER - AREAL- OG KULTURVERNAVDELINGA - Sรกmediggi Sametinget'"/>
...
<xsl:variable name="para_sme" select="'samediggi-article-3866.html'"/>
