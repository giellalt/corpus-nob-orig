...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3888&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Streaming av Sametingsrådets/plenumsledelsens fremleggelse av saker - Sámediggi Sametinget'"/>
...
<xsl:variable name="wordcount" select="'71'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3888.html" xml:lang="sme"/>
</xsl:variable>
