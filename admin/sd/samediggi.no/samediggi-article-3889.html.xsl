...
<xsl:variable name="title" select="'Streaming: Miniseminar presentasjon av administrasjonen overfor Sametingets representanter - Sรกmediggi Sametinget'"/>
...
<xsl:variable name="para_sme" select="'samediggi-article-3889.html'"/>
