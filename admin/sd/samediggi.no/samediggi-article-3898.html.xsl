...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3898&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Inviterer til dialogmøte om lese- og skrivehjelp til eldre - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3898.html" xml:lang="sme"/>
</xsl:variable>
