...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3905&amp;sprak=Norsk&amp;Print=1'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3905.html" xml:lang="sme"/>
</xsl:variable>
