...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3916&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Vi streamer plenumsmøtet direkte på nett - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3916.html" xml:lang="sme"/>
</xsl:variable>
