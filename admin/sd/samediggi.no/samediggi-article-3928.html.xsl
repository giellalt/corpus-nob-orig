...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3928&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Positivt budsjett, men ikke rom for utvikling - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3928.html" xml:lang="sme"/>
</xsl:variable>
