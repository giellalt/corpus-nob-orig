...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=393&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Valgmateriell - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-393.html" xml:lang="sme"/>
</xsl:variable>
