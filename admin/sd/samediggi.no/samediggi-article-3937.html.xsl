...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3937&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Sametingsrådet fikk gjennomslag for samisk foreldrerepresentant - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3937.html" xml:lang="sme"/>
</xsl:variable>
