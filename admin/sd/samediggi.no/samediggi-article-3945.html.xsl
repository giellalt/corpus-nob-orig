...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3945&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Tar selvmord alvorlig - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3945.html" xml:lang="sme"/>
</xsl:variable>
