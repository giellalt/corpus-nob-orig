...
<xsl:variable name="title" select="'Tilrettelegging for blinde og svaksynte - S&#3619;&#3585;mediggi Sametinget'"/>
...
<xsl:variable name="para_sme" select="'samediggi-article-396.html'"/>
