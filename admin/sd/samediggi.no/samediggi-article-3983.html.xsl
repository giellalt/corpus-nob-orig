...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3983&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Sametingsrådets seminar – Evaluering av tilskudd til samiske barnehager - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3983.html" xml:lang="sme"/>
</xsl:variable>
