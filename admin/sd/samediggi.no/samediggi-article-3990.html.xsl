...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3990&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Gratulerer med språkprisen Gollegiella 2010 - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3990.html" xml:lang="sme"/>
</xsl:variable>
