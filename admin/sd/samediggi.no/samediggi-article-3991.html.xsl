...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=3991&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Rammeavtale om regulering av laksefiske - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-3991.html" xml:lang="sme"/>
</xsl:variable>
