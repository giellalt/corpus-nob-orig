...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=400&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'PRM: Vellykket manntallskampanje - ungdom og kvinner registrerte seg - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-400.html" xml:lang="sme"/>
</xsl:variable>
