...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=4007&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Inviterer til folkemøte i Oslo - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-4007.html" xml:lang="sme"/>
</xsl:variable>
