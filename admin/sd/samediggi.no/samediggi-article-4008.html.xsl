...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=4008&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Sametinget følger opp etablerere i sørsamisk område - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-4008.html" xml:lang="sme"/>
</xsl:variable>
