...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=4019&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Mineralvirksomhet i Bidjovagge – avtale signert mellom Sametinget, Arctic Gold og reinbeitedistrik D-34 og D-30A - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-4019.html" xml:lang="sme"/>
</xsl:variable>
