...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=436&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'PRM: Sametinget bevilger 250.000 kroner til Ája samisk senter - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-436.html" xml:lang="sme"/>
</xsl:variable>
