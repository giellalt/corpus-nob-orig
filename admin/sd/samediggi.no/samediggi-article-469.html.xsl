...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=469&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'PRM: - Samarbeid for å utvikle samiske helse- og sosialtjenester - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-469.html" xml:lang="sme"/>
</xsl:variable>
