...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=48&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Samisk tegnsett for Windows XP - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-48.html" xml:lang="sme"/>
</xsl:variable>
