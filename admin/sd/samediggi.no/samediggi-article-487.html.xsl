...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=487&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Stipend til lærerutdanning og høyere utdanning i samisk - Sámediggi Sametinget'"/>
...
<xsl:variable name="wordcount" select="'54'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-487.html" xml:lang="sme"/>
</xsl:variable>
