...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=528&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'PRM: Sametingsrådet bevilger 50.000 kroner til teaterbygg i Kautokeino - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-528.html" xml:lang="sme"/>
</xsl:variable>
