...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=530&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Samisk skolekonferanse 2005 - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-530.html" xml:lang="sme"/>
</xsl:variable>
