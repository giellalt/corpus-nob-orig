...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=568&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Ungdomskonferanse Gulahallatgo? - Sámediggi Sametinget'"/>
...
<xsl:variable name="wordcount" select="'31'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-568.html" xml:lang="sme"/>
</xsl:variable>
