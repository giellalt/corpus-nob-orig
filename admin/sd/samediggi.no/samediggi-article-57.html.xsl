...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=57&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Om registrering i Sametingets valgmanntall - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-57.html" xml:lang="sme"/>
</xsl:variable>
