...
<xsl:variable name="title" select="'Om registrering i Sametingets valgmanntall - Sรกmediggi Sametinget'"/>
...
<xsl:variable name="para_sme" select="'samediggi-article-57.html'"/>
