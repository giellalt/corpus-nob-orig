...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=601&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'PRM: Fagutvalg utreder valgordningene til sametingsvalget - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-601.html" xml:lang="sme"/>
</xsl:variable>
