...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=607&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Mandat - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-607.html" xml:lang="sme"/>
</xsl:variable>
