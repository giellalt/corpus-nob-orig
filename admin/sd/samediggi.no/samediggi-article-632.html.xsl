...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=632&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'PRM: Tar Bondevik-regjeringens budsjettforslag til etterretning - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-632.html" xml:lang="sme"/>
</xsl:variable>
