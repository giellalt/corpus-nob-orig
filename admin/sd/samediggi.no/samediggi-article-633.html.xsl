...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=633&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'PRM: En anerkjennelse av grenselosenes innsats - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-633.html" xml:lang="sme"/>
</xsl:variable>
