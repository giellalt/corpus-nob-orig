...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=637&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Se åpningen av Sametinget direkte på nett - Sámediggi Sametinget'"/>
...
<xsl:variable name="wordcount" select="'86'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-637.html" xml:lang="sme"/>
</xsl:variable>
