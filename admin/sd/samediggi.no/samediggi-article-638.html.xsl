...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=638&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Bilder fra åpningen av Sametinget - Sámediggi Sametinget'"/>
...
<xsl:variable name="wordcount" select="'107'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-638.html" xml:lang="sme"/>
</xsl:variable>
