...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=65&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Serviceerklæring - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-65.html" xml:lang="sme"/>
</xsl:variable>
