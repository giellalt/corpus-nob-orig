...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=657&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Om representantene - Sámediggi Sametinget'"/>
...
<xsl:variable name="wordcount" select="'957'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-657.html" xml:lang="sme"/>
</xsl:variable>
