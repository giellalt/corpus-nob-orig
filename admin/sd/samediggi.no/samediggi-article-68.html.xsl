...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=68&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Hva gjør du hvis du ikke er fornøyd? - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-68.html" xml:lang="sme"/>
</xsl:variable>
