...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=69&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sametingets tjenester - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-69.html" xml:lang="sme"/>
</xsl:variable>
