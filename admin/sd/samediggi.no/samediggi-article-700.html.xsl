...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=700&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'PRM: Vellykket og verdig  åpning av Sametinget - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-700.html" xml:lang="sme"/>
</xsl:variable>
