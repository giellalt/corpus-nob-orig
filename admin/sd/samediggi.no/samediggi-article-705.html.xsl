...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=705&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'PRM: - Positiv satsing på kultur, men østsamene er glemt - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-705.html" xml:lang="sme"/>
</xsl:variable>
