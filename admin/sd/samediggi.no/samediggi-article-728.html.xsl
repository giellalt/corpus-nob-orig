...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=728&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'PRM: Sametingspresidentene med store forventninger i Helsinki - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-728.html" xml:lang="sme"/>
</xsl:variable>
