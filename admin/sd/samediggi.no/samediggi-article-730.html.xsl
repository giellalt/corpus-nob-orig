...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=730&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'PRM: Næringsavtale for duodji - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-730.html" xml:lang="sme"/>
</xsl:variable>
