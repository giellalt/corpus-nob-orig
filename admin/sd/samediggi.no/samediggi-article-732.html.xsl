...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=732&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Nyhetsovervåking - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-732.html" xml:lang="sme"/>
</xsl:variable>
