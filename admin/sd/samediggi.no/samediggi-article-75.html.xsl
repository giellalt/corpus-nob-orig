...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=75&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Om Sametingets nettsider - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-75.html" xml:lang="sme"/>
</xsl:variable>
