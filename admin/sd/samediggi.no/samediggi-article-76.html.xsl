...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=76&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sametingets nettsider - historikk - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-76.html" xml:lang="sme"/>
</xsl:variable>
