...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=776&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'PRM: Sametinget ber regjeringen om redegjørelse om WTO-forhandlinger - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-776.html" xml:lang="sme"/>
</xsl:variable>
