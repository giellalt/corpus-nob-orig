...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=787&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Avdeling for opplæring, språk og kultur - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-787.html" xml:lang="sme"/>
</xsl:variable>
