...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=79&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Kontrollkomiteen - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-79.html" xml:lang="sme"/>
</xsl:variable>
