...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=81&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Oppvekst- og utdanningskomiteen - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-81.html" xml:lang="sme"/>
</xsl:variable>
