...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=823&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Samisk spesialbibliotek på nett - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-823.html" xml:lang="sme"/>
</xsl:variable>
