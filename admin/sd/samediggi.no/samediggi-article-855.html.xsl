...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=855&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Fag- og timefordelingsoversikter - Sámediggi Sametinget'"/>
...
<xsl:variable name="wordcount" select="'469'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-855.html" xml:lang="sme"/>
</xsl:variable>
