...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=87&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Nettsider for alle - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-87.html" xml:lang="sme"/>
</xsl:variable>
