...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=877&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Tone Finnesen inn i Helse Nord - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-877.html" xml:lang="sme"/>
</xsl:variable>
