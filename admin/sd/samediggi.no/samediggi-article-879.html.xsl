...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=879&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sametingets budsjett 2006 - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-879.html" xml:lang="sme"/>
</xsl:variable>
