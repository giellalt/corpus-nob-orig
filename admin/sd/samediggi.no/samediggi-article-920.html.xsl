...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=920&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Nasjonaldagen - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-920.html" xml:lang="sme"/>
</xsl:variable>
