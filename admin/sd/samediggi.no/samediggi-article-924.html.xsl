...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=924&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Sametingspresidentens hilsen på nasjonaldagen - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-924.html" xml:lang="sme"/>
</xsl:variable>
