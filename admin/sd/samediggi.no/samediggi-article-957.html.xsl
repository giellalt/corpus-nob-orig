...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=957&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Innsynsmodulen åpner i dag - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-957.html" xml:lang="sme"/>
</xsl:variable>
