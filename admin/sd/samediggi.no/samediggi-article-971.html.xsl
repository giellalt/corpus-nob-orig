...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=971&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Ellinor Guttorm Utsi fikk Sametingets likestillingspris - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-971.html" xml:lang="sme"/>
</xsl:variable>
