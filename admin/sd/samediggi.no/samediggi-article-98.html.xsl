...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=98&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Samiske mattradisjoner - Sรกmediggi Sametinget'"/>
...
<xsl:variable name="para_sme" select="'samediggi-article-98.html'"/>
