...
<xsl:variable name="filename" select="'http://samediggi.no/Artikkel.aspx?aid=983&amp;sprak=Norsk&amp;Print=1'"/>
<xsl:variable name="title" select="'Samisk parlamentarisk råd møtes i Levi - Sámediggi Sametinget'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samediggi-article-983.html" xml:lang="sme"/>
</xsl:variable>
