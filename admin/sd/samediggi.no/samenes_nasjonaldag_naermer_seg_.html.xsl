...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/adasa/samenes-nasjonaldag-narmer-seg.28920.aspx?sprak=1'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Samenes nasjonaldag nærmer seg! - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="saemiej_aalmegebiejjie_geatskene_.html"/>
        <parallel_text xml:lang="sme" location="sami_albmotbeaivi_lahkona_.html"/>
        <parallel_text xml:lang="smj" location="samij_almmukbiejvve_lahkan.html"/>
