...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/sametinget-ber-om-hastemote-med-bade-valgdirektoratet-og-skatteetaten.15883.aspx'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sametinget ber om hastemøte med både Valgdirektoratet og Skatteetaten  - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="samediggi_gaibida_hoahppocoahkkima_sihke_valgadirektorahtain_ja_vearroetahtain_.html"/>
