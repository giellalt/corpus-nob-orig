...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/sametinget-og-sno-enige-om-at-reindriften-trenger-flere-rovviltkontakter-og-at-reineiere-skal-fa-opplaring-i-a-dokumentere-kadavre.16172.aspx'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sametinget og SNO enige om at reindriften trenger flere rovviltkontakter og at reineiere skal få opplæring i å dokumentere kadavre - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="samediggi_ja_stahta_luonddubearraigeahccu_soahpan_ahte_boazodoalus_darbbasit_eanet_boraspirebargiid_ja_badjeolbmuide_fallo_gursa_dokumenteret_rappiid_.html"/>
