...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/adasa/sametinget-skal-endre-handlingsplanen-for-laremiddelutvikling.23046.aspx?sprak=1'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sametinget skal endre handlingsplanen for læremiddelutvikling  - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="saemiedigkien_stoerretjaanghkoe_edtja_dahkoesoejkesjem_learoevierhtieevtiedaemman_jarkelidh.html"/>
        <parallel_text xml:lang="sme" location="samediggi_galga_rievdadit_oahpponeavvorahkadeami_doaibmaplana_.html"/>
