...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/saernieh/sametinget-stotter-visit-altas-satsing-pa-samisk-kultur-og-mat-som-reiselivsmal.34897.aspx?sprak=1'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sametinget støtter Visit Altas satsing på samisk kultur og mat som reiselivsmål - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="samediggi_doarju_visit_alta_anggirussama_occodit_sami_kultuvrra_ja_biepmu_matkeealahusmihttun_.html"/>
