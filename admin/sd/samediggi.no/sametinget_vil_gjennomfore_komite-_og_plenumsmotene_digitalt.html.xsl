...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/sametinget-vil-gjennomfore-komite-og-plenumsmotene-digitalt.3630.aspx'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sametinget vil gjennomføre komite- og plenumsmøtene digitalt - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="saemiedigkie_saejhta_moenehtse-_jih_stoerretjaanghkoeh_digitaalelaakan_tjirrehtidh_.html"/>
        <parallel_text xml:lang="sme" location="samediggi_cadaha_digitala_lavdegodde-_ja_dievascoahkkima.html"/>
