...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/adasa/sametinget-vil-ha-et-felles-senter-for-samisk-fjernundervisning.23502.aspx?sprak=1'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sametinget vil ha et felles senter for samisk fjernundervisning  - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="saemiedigkie_ektie_jarngem_saemien_maajhoohpehtaemman_saejhta.html"/>
        <parallel_text xml:lang="sme" location="samediggi_haliida_oktasas_sami_gaiddusoahpahusguovddaza_.html"/>
