...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.sametinget.no/layout/set/print/Valg-og-manntall/Kampanjeside/Valgmanntall/Sametingets-valgmanntall-2005'"/>
    ...
    <parallel_text location="saemiedigkien-veeljemelaahkosne-2005.html" xml:lang="sma"/>
<parallel_text location="samedikki-jienastuslohku-2005.html" xml:lang="sme"/>
</xsl:variable>
