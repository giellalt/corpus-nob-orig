...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/lierehtimmie/mieriedimmieh-jih-laakh-mah-leah-saemien-lierehtimmien-bijre/saemiedigkien-faamoe-learoesoejkesji-avteste/?sprak=1'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sametingets myndighet i forhold til læreplaner - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="saemiedigkien_faamoe_learoesoejkesji_avteste.html"/>
        <parallel_text xml:lang="sme" location="samedikki_valdi_oahppoplanaid_ektui.html"/>
