...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/naring/duodji/sametingsmelding-om-duodji-som-naring/'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sametingsmelding om duodji som næring - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="saemiedigkiebievnese_duedtien_bijre_goh_jieleme.html"/>
        <parallel_text xml:lang="sme" location="samediggediedahus_duoji_birra_ealahussan.html"/>
