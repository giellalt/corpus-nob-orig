...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/vuodoahpadus/avkalasj-ressursa/sametingsmelding-om-opplaring-og-utdanning/?sprak=1'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sametingsmelding om opplæring og utdanning - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="saemiedigkiebievnese_lierehtimmien_jih_oohpehtimmien_bijre.html"/>
        <parallel_text xml:lang="sme" location="samedikki_oahpahusdiedahus.html"/>
