...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/sametingsradet-har-bevilget-kr-300-000-til-samisk-duodji-og-designmarked-og-moteshow.21842.aspx'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sametingsrådet har bevilget kr 300 000 til samisk duodji- og designmarked og moteshow - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="samediggeraddi_juolludii_300_000_ruvnnu_sami_duodje-_ja_designmarkaniid_.html"/>
