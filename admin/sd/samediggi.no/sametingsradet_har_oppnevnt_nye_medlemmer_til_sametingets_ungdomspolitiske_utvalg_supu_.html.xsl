...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/sametingsradet-har-oppnevnt-nye-medlemmer-til-sametingets-ungdomspolitiske-utvalg-supu.19803.aspx'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sametingsrådet har oppnevnt nye medlemmer til Sametingets ungdomspolitiske utvalg (SUPU) - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="samediggi_lea_valljen_odda_lahtuid_samedikki_nuoraidpolitihkalas_lavdegoddai_sanul_.html"/>
