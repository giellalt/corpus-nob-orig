...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/sametingsradet-med-klar-beskjed-vi-lider-under-manglende-kunnskap-i-skolene.19640.aspx'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sametingsrådet med klar beskjed: - Vi lider under manglende kunnskap i skolene - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="samediggeradis_cielga_diehtu:_-_mii_gillat_go_skuvllain_lea_vailevas_mahttu.html"/>
