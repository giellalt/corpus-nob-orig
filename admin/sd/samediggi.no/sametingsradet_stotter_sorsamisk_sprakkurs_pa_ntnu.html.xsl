...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/sametingsradet-stotter-sorsamisk-sprakkurs-pa-ntnu.3170.aspx'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sametingsrådet støtter sørsamisk språkkurs på NTNU - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="saemiedigkie_aarjelsaemien_gielekuvsjem_daarje_ntnu:sne.html"/>
        <parallel_text xml:lang="sme" location="samediggeraddi_doarju_lullisami_giellakurssa_ntnu:s.html"/>
