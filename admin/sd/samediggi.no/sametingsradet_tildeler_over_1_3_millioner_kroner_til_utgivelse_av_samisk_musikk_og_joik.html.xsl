...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/sametingsradet-tildeler-over-1-3-millioner-kroner-til-utgivelse-av-samisk-musikk-og-joik.7216.aspx'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sametingsrådet tildeler over 1,3 millioner kroner til utgivelse av samisk musikk og joik - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="saemiedigkieraerie_1_388_millijovnh_joekede_baejhkoehtaemman_saemien_musihkeste_jih_vueleste.html"/>
        <parallel_text xml:lang="sme" location="samediggeraddi_juolluda_1_388_miljon_ruvnno_sami_musihka_ja_ludiid_almmuheapmai.html"/>
