...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/adasa/sametingsradet-vil-rapportere-fosen-saken-og-elektrifiseringa-av-melkoya-til-ilo.27573.aspx?sprak=1'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sametingsrådet vil rapportere Fosen-saken og elektrifiseringa av Melkøya til ILO - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="samediggeraddi_aigu_raporteret_fovse-assi_ja_muolkkuid_elektrifiserema_ilo:i_.html"/>
