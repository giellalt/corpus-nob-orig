...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:variable name="filename" select="'http://www.sametinget.no/layout/set/print/Valg-og-manntall/Kampanjeside/Info/Sametingsvalget-2013-innkomne-listeforslag'"/>
  ...
  <xsl:variable name="parallels">
    ...
    <parallel_text xml:lang="sma" location="baaeteme-laestoeraeriestimmieh.html"/>
    <parallel_text xml:lang="sme" location="samediggevalga-2013-listoevttohusat-mat-leat-boahtan-midjiide.html"/>
  </xsl:variable>
  <!--
