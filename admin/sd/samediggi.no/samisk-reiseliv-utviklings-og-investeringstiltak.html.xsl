...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.sametinget.no/Tilskudd-og-stipend/Samisk-reiseliv-Utviklings-og-investeringstiltak'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Samisk reiseliv: Utviklings- og investeringstiltak'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="saemien-fealadasse.html"/>
        <parallel_text xml:lang="sme" location="sami-matkeealahusat-ovdanahttin-ja-investerendoaimmat.html"/>
