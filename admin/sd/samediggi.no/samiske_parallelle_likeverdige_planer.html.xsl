...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/grunnopplaring/lareplaner/lareplaner/samiske-parallelle-likeverdige-planer/'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Samiske parallelle likeverdige planer - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="saemien_parallelle_seammavyortegs_soejkesjh.html"/>
        <parallel_text xml:lang="sme" location="sami_parallealla_seammaarvosas_oahppoplanat.html"/>
