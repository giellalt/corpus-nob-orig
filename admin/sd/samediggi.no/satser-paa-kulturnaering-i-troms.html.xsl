...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.sametinget.no/layout/set/print/Naeringer/Kulturnaering/Satser-paa-kulturnaering-i-Troms'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="kultuvrejielemem-tromsesne-daaarjede.html"/>
        <parallel_text xml:lang="sme" location="angirussat-kulturealahusaiguin-romssas.html"/>
