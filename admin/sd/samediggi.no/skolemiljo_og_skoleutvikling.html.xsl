...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/lierehtimmie/skuvlebyjrese-jih-skuvleevtiedimmie/?sprak=1'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Skolemiljø og skoleutvikling - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="skuvlebyjrese_jih_skuvleevtiedimmie.html"/>
        <parallel_text xml:lang="sme" location="skuvlabiras_ja_skuvlaovdaneapmi.html"/>
