...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/oppfolging-av-nou-2016-18-hjertespraket/tiltak-i-giellalokten/innsatsomrade-spraktilbud-for-barn-og-unge/skrive-og-leselystprogram-for-barn-og-unge/'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Skrive- og leselystprogram for barn og unge - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="tjaeleme-_jih_lohkemelastoeprogramme_maanide_jih_noeride.html"/>
        <parallel_text xml:lang="sme" location="callin-_ja_lohkanmoktaprogramma_manaide_ja_nuoraide_.html"/>
