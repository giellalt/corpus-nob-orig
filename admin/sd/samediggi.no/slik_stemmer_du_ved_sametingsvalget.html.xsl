...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/politikk/valg/for-deg-som-skal-stemme/slik-stemmer-du-ved-sametingsvalget/'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Slik stemmer du ved sametingsvalget - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="naemhtie_saemiedigkieveeljemisnie_jienesth.html"/>
        <parallel_text xml:lang="sme" location="na_jienastat_samediggevalggas.html"/>
