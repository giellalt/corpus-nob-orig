...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/saernieh/aarjelsaemien-histovrijem-valdresisnie-vaajnedahta.33573.aspx?sprak=1'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sørsamisk historie i Valdres løftes fram - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="aarjelsaemien_histovrijem_valdresisnie_vaajnedahta.html"/>
        <parallel_text xml:lang="sme" location="lullisami_historja_valdresas_loktejuvvo_.html"/>
