...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/spesialisthelsetjenester-til-den-samiske-befolkningen-med-utgangspunkt-i-retten-til-selvbestemmelse.7793.aspx'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Spesialisthelsetjenester til den samiske befolkningen med utgangspunkt i retten til selvbestemmelse - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="smj" location="sierra-varresvuodadievnastusa_same_almmugij_iesjmierredimriekta_vuodon.html"/>
