...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.sametinget.no/Spraak/Fakta-om-samiske-spraak/Med-samisk-spraak-i-lomma'"/>
    ...
    <parallel_text xml:lang="smj" location="giella_faktadiedut-sami-gielaid-birra_samegiella-lummas.html"/>
