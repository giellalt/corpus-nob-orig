...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.sametinget.no/Spraak/Fakta-om-samiske-spraak/Ny-digital-ordbok-lanseres'"/>
    ...
    <parallel_text xml:lang="smj" location="giella_faktadiedut-sami-gielaid-birra_odda-digitala-satnegirji-almmuhuvvo.html"/>
