...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.sametinget.no/Spraak/Snakk-samisk-te-mae/Snakksamisktemae-produktside'"/>
    ...
    <parallel_text xml:lang="smj" location="giella_samasta-mujna_samastamujna-produktside.html"/>
