...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.sametinget.no/Spraak/Spraakteknologi/Utvikler-talesyntese-for-nordsamisk'"/>
    ...
    <parallel_text xml:lang="smj" location="giella_spraakteknologi_hupmansyntesa-davvisamegillii.html"/>
