...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/politihkka/politihkalasj-organisierim-ja-jadedibme/same-parlamentaralasj-rade/sprs-deltakelse-i-barentssamarbeidet/?sprak=1'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'SPRs deltakelse i Barentssamarbeidet - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="spr_meatan_barentslaavenjostosne_.html"/>
        <parallel_text xml:lang="sme" location="sami_parlamentaralas_radi_searvan_barentsovttasbargui.html"/>
