...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/sterkt-kritisk-til-at-staten-vil-ga-inn-som-partshjelp-for-oyfjellet-wind.20506.aspx'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sterkt kritisk til at staten vil gå inn som partshjelp for Øyfjellet Wind - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="gaajh_laejhtehks_staate_saejhta_paarhteviehkine_arrodh_oyfjellese.html"/>
        <parallel_text xml:lang="sme" location="moaita_garrasit_go_stada_aigu_oasehasveahkkin_oyfjellet_windai.html"/>
