...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.sametinget.no/Tilskudd-og-stipend/Stipend-for-hoeyere-utdanning-Videreutdanning-i-samisk-spraak'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Stipend for høyere utdanning: Videreutdanning i samisk språk'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="stipende-jollebe-oeoehpehtaemman-jaaarhkeoeoehpehtimmie-saemien-gielesne.html"/>
        <parallel_text xml:lang="sme" location="stipeanda-alit-ohppui-lassioahppu-samegielas.html"/>
