...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:variable name="filename" select="'http://www.sametinget.no/Stipend-og-tilskudd/Tidligere-regelverk'"/>
  ...
  <xsl:variable name="parallels">
    ...
    <parallel_text xml:lang="sme" location="stipeanda-ja-doarjja_tidligere-regelverk.html"/>
  </xsl:variable>
  <!--
