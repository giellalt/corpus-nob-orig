...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/stotte-til-etablering-av-kombinasjonsnarings-virksomhet-i-sorsamisk-omrade.8229.aspx'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Støtte til etablering av kombinasjonsnærings-virksomhet i sørsamisk område - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="daarjoe_tseegkemasse_kombinasjovnejieliemijstie_aarjelsaemien_dajvesne.html"/>
