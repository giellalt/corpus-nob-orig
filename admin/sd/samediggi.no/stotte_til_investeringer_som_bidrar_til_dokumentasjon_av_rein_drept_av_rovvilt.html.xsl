...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/oddasat/doarjja-investeremiidda-mat-veahkehit-duodastit-bohccuid-maid-boraspiret-leat-goddan.27298.aspx?sprak=1'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Støtte til investeringer som bidrar til dokumentasjon av rein drept av rovvilt - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="daarjoe_skaarvemidie_mah_viehkiehtieh_bovtsh_vihtiestidh_mah_juvrijste_bavvalgamme.html"/>
        <parallel_text xml:lang="sme" location="doarjja_investeremiidda_mat_veahkehit_duodastit_bohccuid_maid_boraspiret_leat_goddan.html"/>
