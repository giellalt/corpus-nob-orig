...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/stotte-til-utvikling-av-reiselivsprodukt-basert-pa-sorsamisk-kultur.8619.aspx'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Støtte til utvikling av reiselivsprodukt basert på sørsamisk kultur - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="daarjoe_evtiedaemman_fealadassedorjesistie_mij_aarjelsaemien_kultuvrem_vaaroeminie_atna_.html"/>
