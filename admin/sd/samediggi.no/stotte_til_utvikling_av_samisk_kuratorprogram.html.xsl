...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/saernieh/evtiedimmiedaarjoe-saemien-kuratovreprogrammese.23557.aspx?sprak=1'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Støtte til utvikling av samisk kuratorprogram - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="evtiedimmiedaarjoe_saemien_kuratovreprogrammese.html"/>
        <parallel_text xml:lang="sme" location="doarjja_ovdanahttit_sami_kurahtorprogramma_.html"/>
