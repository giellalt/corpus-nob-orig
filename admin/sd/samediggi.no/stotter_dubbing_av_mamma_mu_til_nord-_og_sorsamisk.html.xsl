...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/stotter-dubbing-av-mamma-mu-til-nord-og-sorsamisk.8143.aspx'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Støtter dubbing av Mamma Mu til nord- og sørsamisk - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="dubbadimmiem_daarje_filmeste_mamma_mu_noerhte-_jih_aarjelsaemien_gielese.html"/>
        <parallel_text xml:lang="sme" location="doarju_mamma_mu_dubbema_davvi-_ja_lullisamegillii.html"/>
