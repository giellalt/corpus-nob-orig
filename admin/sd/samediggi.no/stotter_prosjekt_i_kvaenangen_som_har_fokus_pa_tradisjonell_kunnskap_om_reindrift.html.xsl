...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/oddasat/doarju-proseavtta-navuonas-mas-lea-fokus-boazodoalu-arbedihtui.31911.aspx?sprak=1'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Støtter prosjekt i Kvænangen som har fokus på tradisjonell kunnskap om reindrift - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="doarju_proseavtta_navuonas_mas_lea_fokus_boazodoalu_arbedihtui.html"/>
