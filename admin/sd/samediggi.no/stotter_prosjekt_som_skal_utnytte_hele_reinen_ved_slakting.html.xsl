...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/stotter-prosjekt-som-skal-utnytte-hele-reinen-ved-slakting.14480.aspx'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Støtter prosjekt som skal utnytte hele reinen ved slakting - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="prosjektem_daarje_mij_edtja_abpe_bovtsem_leekedimmesne_nuhtedh.html"/>
        <parallel_text xml:lang="sme" location="doarju_proseavtta_mii_avkkastalla_olles_bohcco_.html"/>
