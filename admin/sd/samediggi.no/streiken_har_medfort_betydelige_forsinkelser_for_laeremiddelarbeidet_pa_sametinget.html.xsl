...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/streiken-har-medfort-betydelige-forsinkelser-for-laremiddelarbeidet-pa-sametinget.32748.aspx'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Streiken har medført betydelige forsinkelser for læremiddelarbeidet på Sametinget - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="bargoheaitaga_geazil_lea_samedikki_oahpponeavvobargu_sakka_mangngonan.html"/>
