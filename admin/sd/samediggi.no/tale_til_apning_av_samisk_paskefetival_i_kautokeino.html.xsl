...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/tale-til-apning-av-samisk-paskefetival-i-kautokeino.20363.aspx'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Tale til åpning av samisk påskefetival i Kautokeino - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="haalome_saemien_paaskefeestivalese_guovdageaidnuse.html"/>
        <parallel_text xml:lang="sme" location="rahpansardni_sami_beassasmarkanat_guovdageaidnus.html"/>
