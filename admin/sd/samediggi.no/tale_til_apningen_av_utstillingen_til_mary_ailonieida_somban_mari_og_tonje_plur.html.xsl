...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/politihkka/hala/tale-til-apning-av-utstillinga-til-mary-ailonieida-somban-mari-og-tonje-plur.34657.aspx?sprak=1'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Tale til åpningen av utstillingen til Mary Ailonieida Sombán Mari og Tonje Plur - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="tale_til_apning_av_utstillinga_til_mary_ailonieida_somban_mari_og_tonje_plur.html"/>
