...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/politikk/taler-og-innlegg/tale-ved-nim-sin-lansering-av-rapporten-en-menneskerettighetsbasert-tilnarming-til-samisk-statistikk-i-norge.7912.aspx'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Tale ved NIM sin lansering av rapporten «En menneskerettighetsbasert tilnærming til samisk statistikk i Norge» - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="sardni_go_nim_almmuhii_sami_statistihka_raportta.html"/>
