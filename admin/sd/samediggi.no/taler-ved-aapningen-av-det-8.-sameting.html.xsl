...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.sametinget.no/Nyhetsarkiv/Taler-ved-aapningen-av-det-8.-Sameting'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Taler ved åpningen av det 8. Sameting'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="haaalemh-rihpestimmesne-8.-saemiedigkeste.html"/>
        <parallel_text xml:lang="sme" location="8.-samedikki-rahpama-sartnit.html"/>
