...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/tekstene-til-nasjonalsangen-og-nasjonaljoiken-samlet-i-ett-dokument.23611.aspx'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Tekstene til nasjonalsangen og nasjonaljoiken samlet i ett dokument - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="smj" location="praessadiedadus_juohkusis_same_rijkalasjgavastagajda.html"/>
