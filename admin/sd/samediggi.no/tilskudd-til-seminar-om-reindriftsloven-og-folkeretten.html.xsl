...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <parallel_text location="daaarjoe-seminaarese-baaatsoelaaken-jih-almetjereaktan-bijre.html" xml:lang="sma"/>
<parallel_text location="doarjja-seminarii-boazodoalolaga-ja-albmotrievtti-birra.html" xml:lang="sme"/>
</xsl:variable>
