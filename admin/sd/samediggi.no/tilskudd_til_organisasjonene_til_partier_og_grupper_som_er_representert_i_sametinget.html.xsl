...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/stipeanddat-ja-doarjagat/buot-doarjjaortnegat/doarjja-bellodagaid-ja-joavkkuid-organisasuvnnaide-main-lea-ovddastus-samedikkis/?sprak=1'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Tilskudd til organisasjonene til partier og grupper som er representert i Sametinget - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="doarjja_bellodagaid_ja_joavkkuid_organisasuvnnaide_main_lea_ovddastus_samedikkis.html"/>
