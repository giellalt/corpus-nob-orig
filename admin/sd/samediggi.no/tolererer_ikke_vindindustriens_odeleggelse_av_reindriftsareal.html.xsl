...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/tolererer-ikke-vindindustriens-odeleggelse-av-reindriftsareal.7348.aspx'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Tolererer ikke vindindustriens ødeleggelse av reindriftsareal - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="eat_dohkket_ahte_bieggaindustriija_billista_boazodoalu_arealaid_.html"/>
