...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/samedikki-girjeradju/loga-munnje-giella-alggu-rajes/golbma-ravvaga-lohkanboddui/?sprak=1'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Tre tips til lesestunden - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="golme_raerieh_lohkemestaantese.html"/>
        <parallel_text xml:lang="sme" location="golbma_ravvaga_lohkanboddui.html"/>
