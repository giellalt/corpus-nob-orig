...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/hoyere-utdanning-og-forskning/utdannings-og-forskningsbehov/'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Utdannings- og forskningsbehov - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="oohpehtimmie-_jih_dotkemedaerpiesvoete.html"/>
        <parallel_text xml:lang="sme" location="oahppo-_ja_dutkandarbbut.html"/>
