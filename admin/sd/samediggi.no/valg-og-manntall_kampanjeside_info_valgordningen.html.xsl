...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.sametinget.no/Valg-og-manntall/Kampanjeside/Info/Valgordningen'"/>
    ...
    <parallel_text xml:lang="smj" location="valga-ja-jienastuslohku_kampanjeside_diedut_valgaortnet.html"/>
