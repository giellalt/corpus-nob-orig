...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:variable name="filename" select="'http://www.sametinget.no/Valg-og-manntall/Kampanjeside/Valgmanntall/Sametingets-valgmanntall-2013'"/>
  ...
  <xsl:variable name="parallels">
    ...
    <parallel_text xml:lang="sme" location="valga-ja-jienastuslohku_kampanjeside_jienastuslohku_sametingets-valgmanntall-2013.html"/>
  </xsl:variable>
  <!--
