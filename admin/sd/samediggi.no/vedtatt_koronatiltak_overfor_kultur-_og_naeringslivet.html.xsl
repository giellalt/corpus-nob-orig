...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/vedtatt-koronatiltak-overfor-kultur-og-naringslivet.3421.aspx'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Vedtatt koronatiltak overfor kultur- og næringslivet - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="naennoestamme_koronaraajvarimmieh_kultuvre-_jih_jieliemasse.html"/>
        <parallel_text xml:lang="sme" location="mearridan_koronadoaibmabijuid_kultur-_ja_ealahuseallimii_.html"/>
