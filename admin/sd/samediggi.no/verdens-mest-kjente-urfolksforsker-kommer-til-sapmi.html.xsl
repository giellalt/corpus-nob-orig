...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.sametinget.no/layout/set/print/Opplaering/Forskning-og-hoeyere-utdanning/Verdens-mest-kjente-urfolksforsker-kommer-til-Sapmi'"/>
    ...
    <parallel_text location="mailmmi-eanemus-dovddus-eamialbmotdutki-boahta-sapmai.html" xml:lang="sme"/>
<parallel_text location="veartenen-damtasommes-aalkoealmetjedotkije-saepmien-gaaajkoe-baaata.html" xml:lang="sma"/>
</xsl:variable>
