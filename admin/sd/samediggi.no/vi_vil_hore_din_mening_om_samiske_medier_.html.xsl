...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/oddasat/haliidat-gullat-oaiviliiddat-sami-mediaid-birra.23090.aspx?sprak=1'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Vi vil høre din mening om samiske medier!  - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="sijhtebe_dov_mielem_saemien_mediji_bijre_govledh_.html"/>
        <parallel_text xml:lang="sme" location="haliidat_gullat_oaiviliiddat_sami_mediaid_birra_.html"/>
