...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.sametinget.no/layout/set/print/Naeringer/Jordbruk/Videreforedling-av-produkter-av-lam-og-sau'"/>
    ...
    <parallel_text location="labba-ja-savzabuktagiid-viidaseappot-rahkadeapmi.html" xml:lang="sme"/>
<parallel_text location="jaaarhkeevtiedimmie-dorjesijstie-laampeste-jih-sirveste.html" xml:lang="sma"/>
</xsl:variable>
