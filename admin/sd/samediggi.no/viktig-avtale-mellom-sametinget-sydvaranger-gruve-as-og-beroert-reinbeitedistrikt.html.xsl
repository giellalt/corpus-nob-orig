...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:variable name="filename" select="'http://www.sametinget.no/layout/set/print/Arkiv/Valgperiode-2009-2013/Artikler/Viktig-avtale-mellom-Sametinget-Sydvaranger-Gruve-AS-og-beroert-reinbeitedistrikt'"/>
...
<!--     <parallel_text xml:lang="sme" location="arkiv_valgperiode-2009-2013_artikler_viktig-avtale-mellom-sametinget-sydvaranger-gruve-as-og-beroert-reinbeitedistrikt.html"/> -->
  </xsl:variable>
  <!--
