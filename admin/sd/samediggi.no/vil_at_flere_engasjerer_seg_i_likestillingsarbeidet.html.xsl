...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/vil-at-flere-engasjerer-seg-i-likestillingsarbeidet.8315.aspx'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Vil at flere engasjerer seg i likestillingsarbeidet - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="sijhtebe_jienebh_leah_meatan_mirrestallemebarkosne.html"/>
        <parallel_text xml:lang="sme" location="haliida_ahte_eanebut_anggirusset_dassearvvuin.html"/>
