...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://sametinget.no/aktuelt/vil-ha-forslag-pa-mulige-medlemmer-til-rad-for-samer-med-normbrytende-funksjonsvariasjoner.35053.aspx'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Vil ha forslag på mulige medlemmer til råd for samer med normbrytende funksjonsvariasjoner - Sametinget'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="haliida_evttohusaid_vejolas_lahtuide_raddai_sapmelaccaid_varas_geain_leat_doaibmavariasuvnnat_mat_eai_cuovo_norpmaid.html"/>
