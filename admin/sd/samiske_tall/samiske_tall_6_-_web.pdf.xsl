...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://samediggi.no/content/download/4369/39668/version/1/file/Samiske+tall+6+-+web.pdf'"/>
    ...
    <parallel_text location="samiske_tall_6_-_web.pdf" xml:lang="sme"/>
</xsl:variable>
