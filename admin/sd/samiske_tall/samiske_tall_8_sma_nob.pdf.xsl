...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://samediggi.no/content/download/8525/74879/version/1/file/Samiske+tall+forteller+8+-+norsk+og+samisk.pdf'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text location="samiske_tall_forteller_8_-_norsk_og_samisk.pdf" xml:lang="sma"/>
</xsl:variable>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'1-177, 180, 183-231, 244-345'"/>
