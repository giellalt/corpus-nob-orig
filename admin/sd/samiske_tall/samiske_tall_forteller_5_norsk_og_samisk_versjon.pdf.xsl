...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://samediggi.no/content/download/2261/21529/version/1/file/Samiske+tall+forteller+5_norsk+og+samisk+versjon.pdf'"/>
    ...
    <parallel_text location="samiske_tall_forteller_5_norsk_og_samisk_versjon.pdf" xml:lang="sme"/>
</xsl:variable>
