...
<xsl:variable name="filename" select="'http://samediggi.no/filnedlasting.aspx?FilId=129&amp;ct=.pdf'"/>
<xsl:variable name="title" select="'Samisk er tøft!'"/>
...
<xsl:variable name="wordcount" select="'13254'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="melding_om_samisk_sprak_samisk.pdf" xml:lang="sme"/>
</xsl:variable>
