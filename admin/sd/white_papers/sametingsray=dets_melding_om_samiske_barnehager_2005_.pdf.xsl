...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://samediggi.no/content/download/538/4873/version/1/file/Sametingsr%C3%A5dets+melding+om+samiske+barnehager+%282005%29.pdf'"/>
    ...
    <parallel_text location="sa_medikkera_ai_dieaa_hus_sa_mi_ma_na_idga_rddiid_birra_2005_.pdf" xml:lang="sme"/>
</xsl:variable>
