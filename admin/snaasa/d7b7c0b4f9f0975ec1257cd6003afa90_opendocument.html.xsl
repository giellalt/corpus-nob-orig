...
<xsl:variable name="filename" select="'http://www.snasa.kommune.no/nordtrondelag/snasa/snasak.nsf/print/D7B7C0B4F9F0975EC1257CD6003AFA90?OpenDocument'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="97efa92d433428d5c125759f0041d3eb_opendocument.html" xml:lang="sma"/>
</xsl:variable>
