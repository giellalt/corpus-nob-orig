...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'Downloads/STILLINGSANNONSE Rådmann 2018.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Spennende og viktig topplederstilling i Snåsa kommune som RÅDMANN'"/>
    <!--
    ...
    <xsl:variable name="sub_name" select="'Eva Anette Wilks'"/>
    <xsl:variable name="sub_email" select="'eva.anette.wilks@snasa.kommune.no'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="stillingsannonse_radmann_2018.pdf"/>
