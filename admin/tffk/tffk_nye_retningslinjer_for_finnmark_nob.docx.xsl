...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'/Users/tobiaskvalness/OneDrive - Kvensk institutt/Tekstit_korpukseen/TFFK_Nye retningslinjer_for Finnmark_nob.docx'"/>
    <xsl:variable name="text_encoding" select="'Nye retningslinjer for Finnmark'"/>
    <xsl:variable name="title" select="''"/>
    <!--
        Information of the first author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author1_fn" select="'TFFK'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fkv" location="tffk_nye_retningslinjer_for_finnmark.docx"/>
