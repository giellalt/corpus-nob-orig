...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'https://www.tysfjord.kommune.no/administrasjon.97738.no.html'"/>
    ...
    <parallel_text xml:lang="smj" location="index.php_id-4684299_showtipform-1_cat-97738_gb-.html"/></xsl:variable>
