...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'https://www.tysfjord.kommune.no/barnehager.95864.no.html'"/>
    ...
    <parallel_text xml:lang="smj" location="index.php_id-4743085_showtipform-1_cat-95864_gb-.html"/></xsl:variable>
