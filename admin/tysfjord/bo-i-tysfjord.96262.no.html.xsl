...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'https://www.tysfjord.kommune.no/bo-i-tysfjord.96262.no.html'"/>
    ...
    <parallel_text xml:lang="smj" location="index.php_id-4650687_showtipform-1_cat-96262_gb-.html"/></xsl:variable>
