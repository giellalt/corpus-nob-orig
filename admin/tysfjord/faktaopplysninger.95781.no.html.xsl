...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'https://www.tysfjord.kommune.no/faktaopplysninger.95781.no.html'"/>
    ...
    <parallel_text xml:lang="smj" location="faktadiedo-divtasvuonna-birra.5124836-95781.html"/></xsl:variable>
