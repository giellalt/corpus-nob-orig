...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'https://www.tysfjord.kommune.no/gallivare.95979.no.html'"/>
    ...
    <parallel_text xml:lang="smj" location="jiellevarre.5133255-95979.html"/></xsl:variable>
