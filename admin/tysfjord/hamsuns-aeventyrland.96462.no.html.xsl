...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'https://www.tysfjord.kommune.no/hamsuns-aeventyrland.96462.no.html'"/>
    ...
    <parallel_text xml:lang="smj" location="index.php_id-5126505_showtipform-1_cat-96462_gb-.html"/></xsl:variable>
