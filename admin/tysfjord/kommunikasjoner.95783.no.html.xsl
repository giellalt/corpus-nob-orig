...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'https://www.tysfjord.kommune.no/kommunikasjoner.95783.no.html'"/>
    ...
    <parallel_text xml:lang="smj" location="index.php_id-5126561_showtipform-1_cat-95783_gb-.html"/></xsl:variable>
