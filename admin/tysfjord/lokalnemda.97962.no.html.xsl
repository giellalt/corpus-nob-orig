...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'https://www.tysfjord.kommune.no/lokalnemda.97962.no.html'"/>
    ...
    <parallel_text xml:lang="smj" location="index.php_id-5143063_showtipform-1_cat-97962_gb-.html"/></xsl:variable>
