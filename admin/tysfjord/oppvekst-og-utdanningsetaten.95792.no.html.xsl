...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'https://www.tysfjord.kommune.no/oppvekst-og-utdanningsetaten.95792.no.html'"/>
    ...
    <parallel_text xml:lang="smj" location="kulturskaavlla.5132866-95792.html"/></xsl:variable>
