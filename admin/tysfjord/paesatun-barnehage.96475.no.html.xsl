...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'https://www.tysfjord.kommune.no/paesatun-barnehage.96475.no.html'"/>
    ...
    <parallel_text xml:lang="smj" location="index.php_id-4743268_showtipform-1_cat-96475_gb-.html"/></xsl:variable>
