...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'https://www.tysfjord.kommune.no/prosjekter.96825.no.html'"/>
    ...
    <parallel_text xml:lang="smj" location="index.php_id-5143350_showtipform-1_cat-96825_gb-.html"/></xsl:variable>
