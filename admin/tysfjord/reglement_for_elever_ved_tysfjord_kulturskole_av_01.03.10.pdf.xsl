...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'https://www.tysfjord.kommune.no/getfile.php/1470025.1172.sepvfcycdf/Reglement+for+elever+ved+Tysfjord+kulturskole+av+01.03.10.pdf'"/>
    ...
    <parallel_text xml:lang="smj" location="reglement_samisk.pdf"/></xsl:variable>
