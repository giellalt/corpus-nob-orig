...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'https://www.tysfjord.kommune.no/samisk-kultur.96431.no.html'"/>
    ...
    <parallel_text xml:lang="smj" location="same-kultuvrra.5126489-96431.html"/></xsl:variable>
