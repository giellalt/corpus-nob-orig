...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'https://www.tysfjord.kommune.no/getfile.php/644023.1172.dqcbpqtaca/Soknad+om+plass+i+barnehage.doc.as.pdf'"/>
    ...
    <parallel_text xml:lang="smj" location="soknadskjema_barnehage-samisk.doc.as.pdf"/></xsl:variable>
