...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'https://www.tysfjord.kommune.no/getfile.php/644020.1172.btxdswvpwp/soknadskjema+sfo-norsk.doc.as.pdf'"/>
    ...
    <parallel_text xml:lang="smj" location="soknadskjema_sfo_samisk.doc.as.pdf"/></xsl:variable>
