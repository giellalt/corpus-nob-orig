...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'https://www.tysfjord.kommune.no/stetind.96270.no.html'"/>
    ...
    <parallel_text xml:lang="smj" location="index.php_id-5087311_showtipform-1_cat-96270_gb-.html"/></xsl:variable>
