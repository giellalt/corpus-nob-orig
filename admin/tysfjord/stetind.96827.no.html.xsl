...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'https://www.tysfjord.kommune.no/stetind.96827.no.html'"/>
    ...
    <parallel_text xml:lang="smj" location="index.php_id-5143351_showtipform-1_cat-96827_gb-.html"/></xsl:variable>
