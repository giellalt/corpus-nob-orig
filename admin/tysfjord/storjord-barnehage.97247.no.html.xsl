...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'https://www.tysfjord.kommune.no/storjord-barnehage.97247.no.html'"/>
    ...
    <parallel_text xml:lang="smj" location="stuorgiette-bajassjaddamguovdasj.5140993-97247.html"/></xsl:variable>
