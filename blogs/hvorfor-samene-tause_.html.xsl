...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://nordnorskdebatt.no/article/hvorfor-samene-tause%20'"/>
    ...
    -->
    <xsl:variable name="author1_fn" select="'Anne Lene Turi'"/>
    <xsl:variable name="author1_ln" select="'Dimpas'"/>
    <!-- m, f or unknown -->
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="harjaneame-hupmat-dan-birra-javohisvuoda-kultuvra-rievdame.html"/>
