...
<!-- variable filename contains the original name of the file (from submitter)-->
  <xsl:variable name="filename" select="'Nordområdestrategi06.pdf'"/>
  <xsl:variable name="title" select="'Regjeringens nordområdestrategi'"/>
  <xsl:variable name="author1_fn" select="'Jarle'"/>
  <xsl:variable name="author1_ln" select="'Aarbakke'"/>
  ...
  <xsl:variable name="publisher" select="'Utenriksdepartementet'"/>
