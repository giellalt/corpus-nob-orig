...
<xsl:stylesheet version="1.0" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:variable name="filename" select="'algu_n.htm'"/>
  <xsl:variable name="title" select="'Skoleeventyret fram i lyset'"/>
  ...
  <xsl:variable name="place" select="'http://girji.info/skolehist/algu-n.htm'"/>
