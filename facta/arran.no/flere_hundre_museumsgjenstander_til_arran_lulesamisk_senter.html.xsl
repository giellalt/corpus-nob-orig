...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://arran.no/aktuelt/?Article=198'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'FLERE HUNDRE MUSEUMSGJENSTANDER TIL ÁRRAN LULESAMISK SENTER'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="smj" location="moadda_tjuode_museadavvera_baahti_arran_julevsame_guovdatjij.html"/>
    ...
    -->
    <xsl:variable name="skip_elements" select="'.//body/div/div[1]/div;.//body/div/div[1]/div'"/>
    ...
    <xsl:template match="p[parent::body][not(./em | ./span)][text()]">
        ...
        <xsl:element name="p">
            ...
            <xsl:call-template name="globalTextReplace">
                ...
                <xsl:with-param name="target" select="'Ønsker du å motta nyhetsbrev fra arran?/Registrer inn din epostadresse under. Du kan også kontakte oss pr epost: poassta@arran.no eller telefon/+47 75 77 51 00/Din epost/Ansatte/Intranett/Arrangementer/Besøk Árran/'"/>
