...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.calliidlagadus.org/web/index.php?egavpi=1&amp;girji=125&amp;giella1=nor'"/>
    ...
    <parallel_text xml:lang="smj" location="index.php_egavpi-1_girji-128_giella1-nor.html"/>
