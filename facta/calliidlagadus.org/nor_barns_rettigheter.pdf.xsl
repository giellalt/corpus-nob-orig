...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.calliidlagadus.org/govat/doc/nor_barns_rettigheter.pdf'"/>
    ...
    <parallel_text xml:lang="sme" location="sam_manaid_vuoigatvuohta.pdf"/></xsl:variable>
