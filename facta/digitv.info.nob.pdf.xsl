...
<xsl:variable name="para_sme" select="'digitv.info.sme.pdf'"/>
<xsl:variable name="para_smj" select="'digitv.info.smj.pdf'"/>
...
<xsl:variable name="para_fkv" select="'digitv.info.fkv.pdf'"/>
