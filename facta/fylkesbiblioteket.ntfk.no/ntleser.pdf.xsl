...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://fylkesbiblioteket.ntfk.no/doc.ashx?id=8085'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Folder til utdeling sammen med Den første boka mi'"/>
    ...
    <parallel_text xml:lang="sma" location="ntleser.pdf"/></xsl:variable>
