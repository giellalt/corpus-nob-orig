...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://galdu.custompublish.com/galdu-inviterer-til-mer-dialog.5843887-348866.html'"/>
    ...
    -->
    <xsl:variable name="author1_fn" select="'Brita'"/>
    <xsl:variable name="author1_ln" select="'Norlemann'"/>
    <!-- m, f or unknown -->
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="galdu-bovde-eanet-gulahallamiidda.5843608-348866.html"/>
