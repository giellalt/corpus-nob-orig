...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://galdu.custompublish.com/integrering-av-galdu-i-norges-nasjonale-institusjon-for-menneskerettigheter-vedtatt.5939206-348866.html'"/>
    ...
    -->
    <xsl:variable name="author1_fn" select="'Ante'"/>
    ...
    <xsl:variable name="author1_born" select="'1973'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="galdu-oktiiaskin-norgga-olmmovuoigatvuoaguovddaiin-mearriduvvon.5939211-348866.html"/>
