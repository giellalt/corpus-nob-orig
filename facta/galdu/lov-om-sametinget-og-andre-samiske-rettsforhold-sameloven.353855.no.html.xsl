...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://galdu.custompublish.com/lov-om-sametinget-og-andre-samiske-rettsforhold-sameloven.353855.no.html'"/>
    ...
    -->
    <xsl:variable name="author1_fn" select="'Risten Turi'"/>
    <xsl:variable name="author1_ln" select="'Aleksandersen'"/>
    <!-- m, f or unknown -->
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="the-act-on-the-sami-parliament-and-other-sami-legal-matters-the-sami-act.353855.en.html"/>
        ...
        <parallel_text xml:lang="sme" location="lahka-samedikki-ja-eara-sami-vuoigatvuoaid-birra-samelahka.353855.se.html"/>
