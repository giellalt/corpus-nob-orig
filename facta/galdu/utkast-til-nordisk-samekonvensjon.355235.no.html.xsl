...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://galdu.custompublish.com/utkast-til-nordisk-samekonvensjon.355235.no.html'"/>
    ...
    -->
    <xsl:variable name="author1_fn" select="'Laila Susanne'"/>
    <xsl:variable name="author1_ln" select="'Vars'"/>
    <!-- m, f or unknown -->
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="davviriikala-samekonvenuvdna-evttohus.355235.se.html"/>
