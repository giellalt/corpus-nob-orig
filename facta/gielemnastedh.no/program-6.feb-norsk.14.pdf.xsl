...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://gielemnastedh.no/wp-content/uploads/2014/01/Program-6.feb-norsk.14.pdf'"/>
    ...
    <parallel_text xml:lang="sma" location="programme-saemien-a4.pdf"/></xsl:variable>
