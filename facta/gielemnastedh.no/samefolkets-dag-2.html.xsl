...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://gielemnastedh.no/2014/01/samefolkets-dag-2'"/>
    ...
    <parallel_text xml:lang="sma" location="samefolkets-dag-2.html"/></xsl:variable>
