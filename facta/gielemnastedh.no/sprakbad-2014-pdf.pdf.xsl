...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://gielemnastedh.no/wp-content/uploads/2014/05/Sprakbad-2014-PDF.pdf'"/>
    ...
    <parallel_text xml:lang="sma" location="sprakbad-2014-pdf.pdf"/></xsl:variable>
