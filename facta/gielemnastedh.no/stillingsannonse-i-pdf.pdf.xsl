...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://gielemnastedh.no/wp-content/uploads/2013/12/Stillingsannonse-i-PDF.pdf'"/>
    ...
    <parallel_text xml:lang="sma" location="stillingsannonse-i-pdf.pdf"/></xsl:variable>
