...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="author1_ln" select="'Vassnes'"/>
    <!-- m, f or unknown -->
    ...
    <xsl:variable name="translator_fn" select="'Tor Magne Berg og Rolf Olsen'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="bjorn_vassnes.pdf"/>
    ...
    <xsl:variable name="bottom_margin" select="'1=80, 2;3;4;5;6;7;8=50'"/>
...
<xsl:template match="p[parent::body][not(./em | ./span)][text()]">
        ...
        <xsl:element name="p">
            ...
            <xsl:call-template name="globalTextReplace">
                <xsl:with-param name="inputString" select="$text"/>
                <xsl:with-param name="target" select="'Artikkelforfatter/Oversettere/'"/>
