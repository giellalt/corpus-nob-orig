...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="author1_fn" select="'Britta'"/>
    <xsl:variable name="author1_ln" select="'Marakatt-Labba'"/>
    <!-- m, f or unknown -->
    ...
    <xsl:variable name="translator_fn" select="'Thomas'"/>
    <xsl:variable name="translator_ln" select="'Marainen'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="britta_marakatt_labba.pdf"/>
