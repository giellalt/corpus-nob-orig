...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="author1_fn" select="'Hanna Horsberg'"/>
    ...
    <xsl:variable name="author1_born" select="'19571019'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="hanna_horsberg_hansen.pdf"/>
    ...
    <xsl:variable name="bottom_margin" select="'1=70, 2;3;4;5;6=50'"/>
    ...
    <!--
        ...
        1;3;8=20, 4;5;7=10
    -->
    <xsl:variable name="linespacing" select="'1=5'"/>
