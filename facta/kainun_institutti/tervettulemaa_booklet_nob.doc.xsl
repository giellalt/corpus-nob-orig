...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <language xml:lang="nob"/><language xml:lang="rus"/><language xml:lang="fkv"/></xsl:variable>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fkv" location="tervettulemaa_booklet.doc"/>
        ...
        <parallel_text xml:lang="rus" location="tervettulemaa_booklet_rus.doc"/>
