...
<xsl:variable name="filename" select="'http://www.nav.no/Familie/Barnebidrag/Bidragsforskudd'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="805368912.html" xml:lang="eng"/>
	<parallel_text location="1073749124.html" xml:lang="nno"/>
	<parallel_text location="229452.html" xml:lang="sme"/>
</xsl:variable>
