...
<xsl:variable name="filename" select="'http://www.nav.no/Familie/Svangerskap,+fødsel+og+adopsjon/Foreldrepenger+ved+fødsel'"/>
...
<xsl:variable name="wordcount" select="'1330'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="805369034.html" xml:lang="eng"/>
	<parallel_text location="805322310.html" xml:lang="nno"/>
	<parallel_text location="227984.html" xml:lang="sme"/>
</xsl:variable>
