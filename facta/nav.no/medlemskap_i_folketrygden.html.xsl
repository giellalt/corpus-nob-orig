...
<xsl:variable name="filename" select="'http://www.nav.no/Internasjonalt/Medlemskap+i+folketrygden'"/>
...
<xsl:variable name="publisher" select="'NAV'"/>
<xsl:variable name="publChannel" select="'http://nav.no'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="membership_in_the_national_insurance_scheme.html" xml:lang="eng"/>
	<parallel_text location="220239.html" xml:lang="nno"/>
	<parallel_text location="medlemskap_i_folketrygden.html" xml:lang="sme"/>
</xsl:variable>
