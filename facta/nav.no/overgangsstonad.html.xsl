...
<xsl:variable name="filename" select="'http://www.nav.no/Familie/Enslig+mor+eller+far/Overgangsstønad'"/>
...
<xsl:variable name="wordcount" select="'1047'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="805369198.html" xml:lang="eng"/>
	<parallel_text location="805345251.html" xml:lang="nno"/>
	<parallel_text location="229457.html" xml:lang="sme"/>
</xsl:variable>
