...
<xsl:variable name="filename" select="'http://www.nav.no/Familie/Enslig+mor+eller+far/Oversikt+over+stønader+og+vilkår'"/>
...
<xsl:variable name="wordcount" select="'658'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="805369191.html" xml:lang="eng"/>
	<parallel_text location="805345243.html" xml:lang="nno"/>
	<parallel_text location="235402.html" xml:lang="sme"/>
</xsl:variable>
