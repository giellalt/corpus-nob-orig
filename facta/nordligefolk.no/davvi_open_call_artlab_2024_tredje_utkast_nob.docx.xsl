...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'/Users/tobiaskvalness/OneDrive - Kvensk institutt/Tekstit_korpukseen/Davvi_OPEN_CALL ARTLAB 2024 tredje utkast nob.docx'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Davvi OPEN CALL, ARTLAB'"/>
    <!--
        Information of the first author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author1_fn" select="'Davvi'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fkv" location="davvi_open_call_artlab_2024_tredje_utkast_fkv.docx"/>
