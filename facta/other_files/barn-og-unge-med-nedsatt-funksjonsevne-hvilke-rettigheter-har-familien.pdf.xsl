...
<xsl:variable name="filename" select="'http://helsedirektoratet.no/publikasjoner/barn-og-unge-med-nedsatt-funksjonsevne-hvilke-rettigheter-har-familien/Publikasjoner/barn-og-unge-med-nedsatt-funksjonsevne-hvilke-rettigheter-har-familien.pdf'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Barn og unge med nedsatt funksjonsevne – hvilke rettigheter har familien?'"/>
...
<xsl:variable name="publisher" select="'Helsedirektoratet'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samisk-barn-og-unge-med-nedsatt-funksjonsevne---hvilke-rettigheter-har-familien.pdf" xml:lang="sme"/>
</xsl:variable>
