...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://naturvernforbundet.no/finnmark/informasjon-til-organisasjonen/berit-anne-oskal-kemi-nasjonalpark-i-kautokeino-erfaringer-fra-lokalt-arbeidsutvalg-article23673-2066.html'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Berit Anne Oskal Kemi: Nasjonalpark i Kautokeino - erfaringer fra lokalt arbeidsutvalg'"/>
    <!--
    ...
    <xsl:variable name="author1_born" select="'1953'"/>
    <!--
    ...
    <xsl:variable name="translator_fn" select="'Anne'"/>
    <xsl:variable name="translator_ln" select="'Nesbakken'"/>
    <xsl:variable name="translator_gender" select="'f'"/>
    <xsl:variable name="translator_born" select="'1959'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="berit-anne-oskal-kemi-albmotmeahcci-guovdageainnus-vasahusat-bargolavdegottis-article23672-2066.html"/>
