...
<xsl:variable name="parallels">
	<parallel_text location="digitv.info.sme.pdf" xml:lang="sme"/>
	<parallel_text location="digitv.info.smj.pdf" xml:lang="smj"/>
	<parallel_text location="digitv.info.fkv.pdf" xml:lang="fkv"/>
</xsl:variable>
