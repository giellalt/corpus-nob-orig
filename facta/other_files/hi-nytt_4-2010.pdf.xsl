...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.hi.no/filarkiv/2010/08/hi_nytt_04_web.pdf/nb-no'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="hi-nytt_4-2010_sam.pdf"/>
    ...
    <!--
        ...
        1;3;8=20, 4;5;7=10
    -->
    <xsl:variable name="right_margin" select="'2=23'"/>
    <xsl:variable name="left_margin" select="'2=5'"/>
    <xsl:variable name="top_margin" select="'2=18'"/>
    <xsl:variable name="bottom_margin" select="'1=5'"/>
