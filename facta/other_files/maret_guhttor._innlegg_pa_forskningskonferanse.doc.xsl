...
<!-- Format query results for display --><xsl:stylesheet xmlns:i18n="http://apache.org/cocoon/i18n/2.1" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:variable name="translator_fn" select="'Trond'"/>
  <xsl:variable name="translator_ln" select="'Trosterud'"/>
  ...
  <xsl:variable name="wordcount" select="'1858'"/>
...
<xsl:variable name="note" select="''"/>
  ...
  <xsl:variable name="monolingual" select="'1'"/> <xsl:variable name="mainlang" select="'nob'"/>
