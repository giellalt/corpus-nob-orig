...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://site.uit.no/smartstien/files/2012/02/hefte_norsk_mobile_low.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Margrete Kreutz historie'"/>
    <!--
        Information of the first author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author1_fn" select="'Cathrine'"/>
    <xsl:variable name="author1_ln" select="'Baglo'"/>
    <!-- m, f or unknown -->
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="margrete_kreutz_historie.pdf"/>
        ...
        <parallel_text xml:lang="sma" location="margrete_kreutz_historie.pdf"/>
        <parallel_text xml:lang="sme" location="margrete_kreutz_historie.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'1-4, 8-10'"/>
