...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="title" select="'Samisk statistikk 2006'"/>
    <!--
    ...
    <xsl:variable name="publisher" select="'Statistisk sentralbyrå'"/>
    ...
    <xsl:variable name="place" select="'http://ssb.no/emner/00/00/20/nos_d343/'"/>
    ...
    <xsl:variable name="wordcount" select="'57467'"/>
