...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <language xml:lang="eng"/><language xml:lang="rus"/><language xml:lang="sms"/><language xml:lang="fin"/><language xml:lang="nob"/></xsl:variable>
    ...
    <xsl:variable name="top_margin" select="'1=35, 2=50'"/>
    <xsl:variable name="bottom_margin" select="'1=45, 2=40'"/>
