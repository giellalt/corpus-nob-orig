...
<xsl:variable name="filename" select="'http://skuvla.info/minaigi10-n.htm'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="minaigi10-e.html" xml:lang="eng"/>
	<parallel_text location="minaigi10.html" xml:lang="sme"/>
</xsl:variable>
