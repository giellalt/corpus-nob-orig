...
<xsl:variable name="filename" select="'http://skuvla.info/minaigi12-n.htm'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="minaigi12-e.html" xml:lang="eng"/>
	<parallel_text location="minaigi12.html" xml:lang="sme"/>
</xsl:variable>
