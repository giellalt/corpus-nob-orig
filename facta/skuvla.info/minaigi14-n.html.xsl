...
<xsl:variable name="filename" select="'http://skuvla.info/minaigi14-n.htm'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="minaigi14-e.html" xml:lang="eng"/>
	<parallel_text location="minaigi14.html" xml:lang="sme"/>
</xsl:variable>
