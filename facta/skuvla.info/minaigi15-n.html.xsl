...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://skuvla.info/minaigi15-n.htm'"/>
    ...
    <xsl:variable name="translator_born" select="'1950'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="minaigi15-e.html"/>
        ...
        <parallel_text xml:lang="sme" location="minaigi15.html"/>
