...
<xsl:variable name="filename" select="'http://skuvla.info/minaigi16-n.htm'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="minaigi16-e.html" xml:lang="eng"/>
	<parallel_text location="minaigi16.html" xml:lang="sme"/>
</xsl:variable>
