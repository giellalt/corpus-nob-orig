...
<xsl:variable name="filename" select="'http://skuvla.info/minaigi18-n.htm'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="minaigi18-e.html" xml:lang="eng"/>
	<parallel_text location="minaigi18.html" xml:lang="sme"/>
</xsl:variable>
