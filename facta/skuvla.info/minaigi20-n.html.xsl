...
<xsl:variable name="filename" select="'http://skuvla.info/minaigi20-n.htm'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="minaigi20-e.html" xml:lang="eng"/>
	<parallel_text location="minaigi20.html" xml:lang="sme"/>
</xsl:variable>
