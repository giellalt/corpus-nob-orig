...
<xsl:variable name="filename" select="'http://skuvla.info/minaigi23-n.htm'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="minaigi23-e.html" xml:lang="eng"/>
	<parallel_text location="minaigi23.html" xml:lang="sme"/>
</xsl:variable>
