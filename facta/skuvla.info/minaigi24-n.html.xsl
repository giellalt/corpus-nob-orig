...
<xsl:variable name="filename" select="'http://skuvla.info/minaigi24-n.htm'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="minaigi24-e.html" xml:lang="eng"/>
	<parallel_text location="minaigi24.html" xml:lang="sme"/>
</xsl:variable>
