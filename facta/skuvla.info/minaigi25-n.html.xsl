...
<xsl:variable name="filename" select="'http://skuvla.info/minaigi25-n.htm'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="minaigi25-e.html" xml:lang="eng"/>
	<parallel_text location="minaigi25.html" xml:lang="sme"/>
</xsl:variable>
