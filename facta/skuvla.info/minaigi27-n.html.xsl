...
<xsl:variable name="filename" select="'http://skuvla.info/minaigi27-n.htm'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="minaigi27-e.html" xml:lang="eng"/>
	<parallel_text location="minaigi27.html" xml:lang="sme"/>
</xsl:variable>
