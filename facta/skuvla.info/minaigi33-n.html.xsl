...
<xsl:variable name="filename" select="'http://skuvla.info/minaigi33-n.htm'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="minaigi33-e.html" xml:lang="eng"/>
	<parallel_text location="minaigi33.html" xml:lang="sme"/>
</xsl:variable>
