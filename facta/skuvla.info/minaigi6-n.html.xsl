...
<xsl:variable name="filename" select="'http://skuvla.info/minaigi6-n.htm'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="minaigi6-e.html" xml:lang="eng"/>
	<parallel_text location="minaigi6.html" xml:lang="sme"/>
</xsl:variable>
