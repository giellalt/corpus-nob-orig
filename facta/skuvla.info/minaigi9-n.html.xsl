...
<xsl:variable name="filename" select="'http://skuvla.info/minaigi9-n.htm'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="minaigi9-e.html" xml:lang="eng"/>
	<parallel_text location="minaigi9.html" xml:lang="sme"/>
</xsl:variable>
