...
<!-- Format query results for display --><xsl:stylesheet xmlns:i18n="http://apache.org/cocoon/i18n/2.1" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:variable name="filename" select="'boon_n.htm'"/>
  <xsl:variable name="title" select="'Tospråklig undervisning – for barnets skyld'"/>
  ...
  <xsl:variable name="author1_nat" select="'oth'"/>
  ...
  <xsl:variable name="place" select="'http://girji.info/skolehist/boon-n.htm'"/>
  ...
  <xsl:variable name="wordcount" select="'2520'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="boon_s.html" xml:lang="sme"/>
</xsl:variable>
