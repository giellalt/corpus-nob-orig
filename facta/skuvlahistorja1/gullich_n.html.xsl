...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'gullich_n.htm'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Guhkin davvin dávggaid vuolde - Minner fra Sirma 1953-62'"/>
    <!--
        Information of the first author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author1_fn" select="'Einar'"/>
    <xsl:variable name="author1_ln" select="'Gullichsen'"/>
    <!-- m, f or unknown -->
    ...
    <xsl:variable name="author1_born" select="'1928'"/>
    <!--
    ...
    <xsl:variable name="place" select="'http://girji.info/skolehist/gullich-n.htm'"/>
    ...
    <xsl:variable name="wordcount" select="'3252'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="gullich_s.html"/>
