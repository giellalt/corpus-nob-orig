...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'hatle_n.htm'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Fra utkanten av Sameland i utkanten av Norge'"/>
    <!--
        Information of the first author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author1_fn" select="'Sverre'"/>
    <xsl:variable name="author1_ln" select="'Hatle'"/>
    <!-- m, f or unknown -->
    ...
    <xsl:variable name="author1_born" select="'1942'"/>
    <!--
    ...
    <xsl:variable name="place" select="'http://girji.info/skolehist/hatle-n.htm'"/>
    ...
    <xsl:variable name="wordcount" select="'3856'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="hatle_s.html"/>
