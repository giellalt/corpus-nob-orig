...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'johan_n.htm'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Egenfortelling om å vokse opp uten lese- og skrivekunnskaper'"/>
    <!--
        Information of the first author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author1_fn" select="'Johan'"/>
    <xsl:variable name="author1_ln" select="'Johannesen'"/>
    <!-- m, f or unknown -->
    ...
    <xsl:variable name="author1_born" select="'1931'"/>
    <!--
    ...
    <xsl:variable name="place" select="'http://girji.info/skolehist/johan-n.htm'"/>
    ...
    <xsl:variable name="wordcount" select="'2276'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="johan_s.html"/>
