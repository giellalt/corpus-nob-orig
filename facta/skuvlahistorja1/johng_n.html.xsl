...
<!-- Format query results for display --><xsl:stylesheet xmlns:i18n="http://apache.org/cocoon/i18n/2.1" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:variable name="filename" select="'johng_n.htm'"/>
  <xsl:variable name="title" select="'I Måsøy stammer folk fra Louis Philippe'"/>
  <xsl:variable name="author1_fn" select="'John'"/>
  <xsl:variable name="author1_ln" select="'Gustavsen'"/>
  <xsl:variable name="author1_gender" select="'m'"/>
  <xsl:variable name="author1_born" select="'1943'"/>
  ...
  <xsl:variable name="place" select="'http://girji.info/skolehist/johng-n.htm'"/>
  ...
  <xsl:variable name="wordcount" select="'1472'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="johng_s.html" xml:lang="sme"/>
</xsl:variable>
