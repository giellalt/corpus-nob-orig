...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'lind_n.htm'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Kirkens rolle i samisk opplæring'"/>
    <!--
        Information of the first author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author1_fn" select="'Hans'"/>
    <xsl:variable name="author1_ln" select="'Lindkjølen'"/>
    <!-- m, f or unknown -->
    ...
    <xsl:variable name="author1_born" select="'1923'"/>
    <!--
    ...
    <xsl:variable name="place" select="'http://girji.info/skolehist/lind-n.htm'"/>
    ...
    <xsl:variable name="wordcount" select="'5965'"/>
    ...
    <language xml:lang="sme"/><language xml:lang="dan"/></xsl:variable>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="lind_s.html"/>
