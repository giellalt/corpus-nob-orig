...
<!-- Format query results for display --><xsl:stylesheet xmlns:i18n="http://apache.org/cocoon/i18n/2.1" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:variable name="filename" select="'minde_n.htm'"/>
  <xsl:variable name="title" select="'Fornorskinga av samene - hvorfor, hvordan og hvilke følger?'"/>
  <xsl:variable name="author1_fn" select="'Henry'"/>
  <xsl:variable name="author1_ln" select="'Minde'"/>
  <xsl:variable name="author1_gender" select="'m'"/>
  <xsl:variable name="author1_born" select="'1945'"/>
  ...
  <xsl:variable name="place" select="'http://girji.info/skolehist/minde-n.htm'"/>
  ...
  <xsl:variable name="wordcount" select="'4838'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="minde_s.html" xml:lang="sme"/>
</xsl:variable>
