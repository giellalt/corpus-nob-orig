...
<xsl:stylesheet xmlns:i18n="http://apache.org/cocoon/i18n/2.1" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:variable name="filename" select="'nymo_n.htm'"/>
  <xsl:variable name="title" select="'&quot;Sj&#xF8;l om vi e sama, s&#xE5; duge vi&quot;'"/>
  <xsl:variable name="author1_fn" select="'Randi'"/>
  <xsl:variable name="author1_ln" select="'Nymo'"/>
  ...
  <xsl:variable name="place" select="'http://girji.info/skolehist/nymo-n.htm'"/>
  ...
  <xsl:variable name="wordcount" select="'4116'"/>
...
<xsl:variable name="para_sme" select="'nymo_s.html'"/>
