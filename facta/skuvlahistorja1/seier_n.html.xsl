...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'seier_n.htm'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Fra erstatningslærer til spesiallærer og lærebokforfatter '"/>
    <!--
        Information of the first author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author1_fn" select="'Inger'"/>
    <xsl:variable name="author1_ln" select="'Seierstad'"/>
    <!-- m, f or unknown -->
    ...
    <xsl:variable name="author1_born" select="'1933'"/>
    <!--
    ...
    <xsl:variable name="place" select="'http://girji.info/skolehist/seier-n.htm'"/>
    ...
    <xsl:variable name="wordcount" select="'4376'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="seier_s.html"/>
