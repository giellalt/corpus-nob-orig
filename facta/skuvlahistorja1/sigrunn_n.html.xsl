...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'sigrunn_n.htm'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Tilbakeblikk fra Karasjok Arbeiderpartis virke 1934-83'"/>
    <!--
    ...
    <xsl:variable name="place" select="'http://girji.info/skolehist/sigrunn-n.htm'"/>
    ...
    <xsl:variable name="wordcount" select="'3323'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="sigrunn_s.html"/>
