...
<!-- Format query results for display --><xsl:stylesheet xmlns:i18n="http://apache.org/cocoon/i18n/2.1" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:variable name="filename" select="'somby_n.htm'"/>
  <xsl:variable name="title" select="'Vonde og gode skoleminner'"/>
  <xsl:variable name="author1_fn" select="'Niillas A.'"/>
  ...
  <xsl:variable name="place" select="'http://girji.info/skolehist/somby-n.htm'"/>
  ...
  <xsl:variable name="wordcount" select="'3016'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="somby_s.html" xml:lang="sme"/>
</xsl:variable>
