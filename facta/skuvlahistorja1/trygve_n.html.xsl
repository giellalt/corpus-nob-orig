...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'trygve_n.htm'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Om sameskolen i Norge'"/>
    <!--
        Information of the first author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author1_fn" select="'Odd Mathis'"/>
    ...
    <xsl:variable name="author1_born" select="'1940'"/>
    <!--
    ...
    <xsl:variable name="place" select="'http://girji.info/skolehist/trygve-n.htm'"/>
    ...
    <xsl:variable name="wordcount" select="'1988'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="trygve_s.html"/>
