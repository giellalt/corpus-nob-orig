...
<xsl:variable name="filename" select="'http://skuvla.info/skolehist/enoksen-s.htm'"/>
<xsl:variable name="title" select="'Ufrivillige pionerer i Nordreisa'"/>
<xsl:variable name="author1_fn" select="'Ragnhild'"/>
<xsl:variable name="author1_ln" select="'Enoksen'"/>
...
<xsl:variable name="wordcount" select="'3442'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="enoksen-s.html" xml:lang="sme"/>
</xsl:variable>
