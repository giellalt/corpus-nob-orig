...
<xsl:variable name="filename" select="'http://skuvla.info/skolehist/hansgut-n.htm'"/>
<xsl:variable name="title" select="'Mekaniske fag på 1960-tallet'"/>
...
<xsl:variable name="wordcount" select="'1608'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="hansgut-s.html" xml:lang="sme"/>
</xsl:variable>
