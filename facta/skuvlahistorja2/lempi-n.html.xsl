...
<xsl:variable name="filename" select="'http://skuvla.info/skolehist/lempi-n.htm'"/>
...
<xsl:variable name="wordcount" select="'1622'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="lempi-s.html" xml:lang="sme"/>
</xsl:variable>
