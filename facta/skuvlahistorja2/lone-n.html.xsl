...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://skuvla.info/skolehist/lone-n.htm'"/>
    ...
    -->
    <xsl:variable name="author1_fn" select="'Lone Synnøve'"/>
    <xsl:variable name="author1_ln" select="'Hegg'"/>
    <!-- m, f or unknown -->
    ...
    <xsl:variable name="wordcount" select="'2797'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="lone-s.html"/>
