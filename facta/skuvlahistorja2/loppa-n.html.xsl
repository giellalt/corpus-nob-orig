...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://skuvla.info/skolehist/loppa-n.htm'"/>
    ...
    <xsl:variable name="author1_ln" select="'Samuelsberg'"/>
    <!-- m, f or unknown -->
    ...
    <!--
        ...
        date or year of birth, nationality.
    -->
    <xsl:variable name="author2_fn" select="'Leonhard'"/>
    <xsl:variable name="author2_ln" select="'Gamst'"/>
    ...
    <xsl:variable name="wordcount" select="'3337'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="loppa-s.html"/>
