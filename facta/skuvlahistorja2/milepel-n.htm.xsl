...
<xsl:variable name="filename" select="'http://skuvla.info/skolehist/milepel-n.htm'"/>
...
<xsl:variable name="wordcount" select="'2388'"/>
...
<xsl:variable name="parallel_texts" select="'milepel-n.htm'"/>
...
<xsl:variable name="para_sme" select="'milepel-s.htm'"/>
