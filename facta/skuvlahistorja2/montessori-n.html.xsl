...
<xsl:variable name="filename" select="'http://skuvla.info/skolehist/montessori-n.htm'"/>
...
<xsl:variable name="wordcount" select="'2725'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="montessori-s.html" xml:lang="sme"/>
</xsl:variable>
