...
<xsl:variable name="filename" select="'http://skuvla.info/skolehist/pave-n.htm'"/>
<xsl:variable name="title" select="'Karasjoks lokale pave'"/>
<xsl:variable name="author1_fn" select="'Sigbjørn'"/>
<xsl:variable name="author1_ln" select="'Hølmebakk'"/>
<xsl:variable name="author1_gender" select="'m'"/>
<xsl:variable name="author1_born" select="'1922'"/>
...
<xsl:variable name="wordcount" select="'2053'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="pave-s.html" xml:lang="sme"/>
</xsl:variable>
