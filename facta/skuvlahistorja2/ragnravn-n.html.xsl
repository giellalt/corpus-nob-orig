...
<xsl:variable name="filename" select="'http://skuvla.info/skolehist/ragnravn-n.htm'"/>
<xsl:variable name="title" select="'Minner fra skolen i Tana – med spesiell vekt på samarbeidet med Per Fokstad'"/>
...
<xsl:variable name="wordcount" select="'2702'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="ragnravn-s.html" xml:lang="sme"/>
</xsl:variable>
