...
<xsl:variable name="filename" select="'http://skuvla.info/skolehist/saltbingen-n.htm'"/>
...
<xsl:variable name="wordcount" select="'3041'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="saltbingen-s.html" xml:lang="smj"/>
	</xsl:variable>
