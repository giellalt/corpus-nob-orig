...
<xsl:variable name="filename" select="'http://skuvla.info/skolehist/samgym-n.htm'"/>
<xsl:variable name="title" select="'Glimt fra kampen om samisk gymnas'"/>
<xsl:variable name="author1_fn" select="'Hans J'"/>
<xsl:variable name="author1_ln" select="'Henriksen'"/>
...
<xsl:variable name="wordcount" select="'3910'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samgym-s.html" xml:lang="sme"/>
</xsl:variable>
