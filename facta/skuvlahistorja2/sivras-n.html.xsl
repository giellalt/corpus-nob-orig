...
<xsl:variable name="filename" select="'http://skuvla.info/skolehist/sivras-n.htm'"/>
<xsl:variable name="title" select="'Fra Sør-Varangers samiske skolehistorie'"/>
<xsl:variable name="author1_fn" select="'Siv'"/>
...
<xsl:variable name="wordcount" select="'4972'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="sivras-s.html" xml:lang="sme"/>
</xsl:variable>
