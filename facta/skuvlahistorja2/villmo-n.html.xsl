...
<xsl:variable name="filename" select="'http://skuvla.info/skolehist/villmo-n.htm'"/>
<xsl:variable name="title" select="'Pionerarbeid for reindriftsopplæring'"/>
...
<xsl:variable name="wordcount" select="'2011'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="villmo-s.htm" xml:lang="sma"/>
<parallel_text location="villmo-sn.html" xml:lang="sme"/>
</xsl:variable>
