...
<xsl:variable name="filename" select="'http://skuvla.info/skolehist/anitaravna-n.htm'"/>
<xsl:variable name="title" select="'De «rike» taler flere språk'"/>
<xsl:variable name="author1_fn" select="'Anita'"/>
...
<xsl:variable name="wordcount" select="'2192'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="anitaravna-n.htm" xml:lang="nob"/>
<parallel_text location="anitaravna-s.html" xml:lang="sme"/>
</xsl:variable>
