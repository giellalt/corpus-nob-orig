...
<xsl:variable name="filename" select="'http://skuvla.info/skolehist/edmund-n.htm'"/>
<xsl:variable name="title" select="'Ett års skolestreik for bygdeskole'"/>
...
<xsl:variable name="wordcount" select="'3357'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="edmund-s.html" xml:lang="sme"/>
</xsl:variable>
