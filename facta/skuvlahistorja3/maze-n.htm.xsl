...
<xsl:variable name="filename" select="'http://skuvla.info/skolehist/maze-n.htm'"/>
...
<xsl:variable name="wordcount" select="'2452'"/>
...
<xsl:variable name="para_sme" select="'maze-s.htm'"/>
