...
<xsl:variable name="filename" select="'http://skuvla.info/skolehist/olavisak-n.htm'"/>
...
<xsl:variable name="wordcount" select="'1294'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="olavisak-s.html" xml:lang="sme"/>
</xsl:variable>
