...
<xsl:variable name="filename" select="'http://skuvla.info/skolehist/unni-n.htm'"/>
...
<xsl:variable name="wordcount" select="'1663'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="unni-s.htm" xml:lang="sme"/>
</xsl:variable>
