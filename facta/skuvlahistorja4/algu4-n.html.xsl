...
<xsl:variable name="filename" select="'http://skuvla.info/skolehist/algu4-n.htm'"/>
<xsl:variable name="title" select="'Fra fornorsking til revitalisering'"/>
...
<xsl:variable name="wordcount" select="'995'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="algu4-s.html" xml:lang="sme"/>
</xsl:variable>
