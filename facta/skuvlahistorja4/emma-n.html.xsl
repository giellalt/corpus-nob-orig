...
<xsl:variable name="filename" select="'http://skuvla.info/skolehist/emma-n.htm'"/>
<xsl:variable name="title" select="'– Ungene ville ikke lenger snakke samisk'"/>
<xsl:variable name="author1_fn" select="'Svein'"/>
<xsl:variable name="author1_ln" select="'Lund'"/>
<xsl:variable name="author1_gender" select="'m'"/>
<xsl:variable name="author1_born" select="'1954'"/>
...
<xsl:variable name="translator_born" select="'1954'"/>
...
<xsl:variable name="wordcount" select="'1887'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="emma-s.html" xml:lang="sme"/>
</xsl:variable>
