...
<xsl:variable name="filename" select="'http://skuvla.info/skolehist/mimmi-n.htm'"/>
...
<xsl:variable name="wordcount" select="'4817'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="mimmi-s.html" xml:lang="sme"/>
</xsl:variable>
