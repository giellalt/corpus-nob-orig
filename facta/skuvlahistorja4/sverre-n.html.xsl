...
<xsl:variable name="filename" select="'http://skuvla.info/skolehist/sverre-n.htm'"/>
...
<xsl:variable name="wordcount" select="'2301'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="sverre-s.html" xml:lang="sme"/>
</xsl:variable>
