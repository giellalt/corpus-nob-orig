...
<xsl:variable name="filename" select="'http://skuvla.info/skolehist/anna-n.htm'"/>
...
<xsl:variable name="sub_name" select="'Børre'"/>
<xsl:variable name="sub_email" select="'Gaup'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="anna-s.html" xml:lang="sme"/>
</xsl:variable>
