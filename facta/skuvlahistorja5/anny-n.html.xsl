...
<xsl:variable name="filename" select="'http://skuvla.info/skolehist/anny-n.htm'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Helsefagutdanninga ved samisk videregående skole'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="anny-s.html" xml:lang="sme"/>
</xsl:variable>
