...
<xsl:variable name="filename" select="'http://skuvla.info/skolehist/boazonuorat-n.htm'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Hva reindriftsungdommen må kunne'"/>
<xsl:variable name="author1_fn" select="'Nils M. P.'"/>
<xsl:variable name="author1_ln" select="'Siri'"/>
<xsl:variable name="author1_gender" select="'m'"/>
<xsl:variable name="author1_nat" select="'NO'"/>
<xsl:variable name="author1_born" select="''"/>
<xsl:variable name="author2_fn" select="'Marit Sara'"/>
<xsl:variable name="author2_ln" select="'Eira'"/>
<xsl:variable name="author2_gender" select="'f'"/>
<xsl:variable name="author2_nat" select="'NO'"/>
<xsl:variable name="author2_born" select="''"/>
<xsl:variable name="author3_fn" select="'Johan Mathis'"/>
<xsl:variable name="author3_ln" select="'Eira'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="boazonuorat-s.htm" xml:lang="sme"/>
</xsl:variable>
