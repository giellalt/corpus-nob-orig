...
<xsl:variable name="filename" select="'http://skuvla.info/skolehist/greiner-s.htm'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="''"/>
<xsl:variable name="author1_fn" select="'Robert'"/>
<xsl:variable name="author1_ln" select="'Greiner'"/>
<xsl:variable name="author1_gender" select="'m'"/>
<xsl:variable name="author1_nat" select="'NO'"/>
<xsl:variable name="author1_born" select="'1971'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="greiner-s.html" xml:lang="sme"/>
</xsl:variable>
