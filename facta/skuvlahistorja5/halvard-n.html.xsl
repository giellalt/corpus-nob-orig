...
<xsl:variable name="filename" select="'http://skuvla.info/skolehist/halvard-n.htm'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="''"/>
<xsl:variable name="author1_fn" select="'Ane Helga'"/>
<xsl:variable name="author1_ln" select="'Lykka'"/>
<xsl:variable name="author1_gender" select="'f'"/>
<xsl:variable name="author1_nat" select="'NO'"/>
<xsl:variable name="author1_born" select="'1986'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="halvard-s.html" xml:lang="sme"/>
</xsl:variable>
