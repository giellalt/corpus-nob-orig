...
<xsl:variable name="filename" select="'http://skuvla.info/skolehist/hkvandahl-n.htm'"/>
...
<xsl:variable name="author2_fn" select="'Ingolf'"/>
<xsl:variable name="author2_ln" select="'Kvandahl'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="hkvandahl-s.html" xml:lang="sme"/>
</xsl:variable>
