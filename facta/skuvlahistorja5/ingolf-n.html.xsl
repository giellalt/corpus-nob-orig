...
<xsl:variable name="filename" select="'http://skuvla.info/skolehist/ingolf-n.htm'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="''"/>
<xsl:variable name="author1_fn" select="'Ingolf'"/>
<xsl:variable name="author1_ln" select="'Kvandahl'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="ingolf-s.html" xml:lang="sme"/>
</xsl:variable>
