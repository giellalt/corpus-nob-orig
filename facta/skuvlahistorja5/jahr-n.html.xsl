...
<xsl:variable name="filename" select="'http://skuvla.info/skolehist/jahr-n.htm'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Samiske læreplaner sett fra departementet'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="jahr-s.html" xml:lang="sme"/>
</xsl:variable>
