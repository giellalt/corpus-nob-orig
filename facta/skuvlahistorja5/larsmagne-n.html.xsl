...
<xsl:variable name="filename" select="'http://skuvla.info/skolehist/larsmagne-n.htm'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="''"/>
<xsl:variable name="author1_fn" select="'Lars Magne'"/>
<xsl:variable name="author1_ln" select="'Andreassen'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="larsmagne-s.html" xml:lang="sme"/>
</xsl:variable>
