...
<xsl:variable name="filename" select="'http://skuvla.info/skolehist/magga-n.htm'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Fortelling om problemene med «Det samiske læreplanverket for den 10-årige grunnskolen»'"/>
<xsl:variable name="author1_fn" select="'Ole Henrik'"/>
<xsl:variable name="author1_ln" select="'Magga'"/>
<xsl:variable name="author1_gender" select="'m'"/>
<xsl:variable name="author1_nat" select="'NO'"/>
<xsl:variable name="author1_born" select="'1947'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="magga-s.html" xml:lang="sme"/>
</xsl:variable>
