...
<xsl:variable name="filename" select="'http://skuvla.info/skolehist/marita-n.htm'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="''"/>
<xsl:variable name="author1_fn" select="'Ellen Marita H.'"/>
<xsl:variable name="author1_ln" select="'Sara'"/>
<xsl:variable name="author1_gender" select="'f'"/>
<xsl:variable name="author1_nat" select="'NO'"/>
<xsl:variable name="author1_born" select="'1991'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="marita-s.html" xml:lang="sme"/>
</xsl:variable>
