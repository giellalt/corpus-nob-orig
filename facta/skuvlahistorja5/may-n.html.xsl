...
<xsl:variable name="filename" select="'http://skuvla.info/skolehist/may-n.htm'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Med på å påvirke det samiske språkets framtid?'"/>
<xsl:variable name="author1_fn" select="'May-Synnøve'"/>
<xsl:variable name="author1_ln" select="'Trosten'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="may-s.html" xml:lang="sme"/>
</xsl:variable>
