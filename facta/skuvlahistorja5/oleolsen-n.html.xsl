...
<xsl:variable name="filename" select="'http://skuvla.info/skolehist/oleolsen-n.htm'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="''"/>
<xsl:variable name="author1_fn" select="'Ole'"/>
<xsl:variable name="author1_ln" select="'Olsen'"/>
<xsl:variable name="author1_gender" select="'m'"/>
<xsl:variable name="author1_nat" select="'NO'"/>
<xsl:variable name="author1_born" select="'1886'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="oleolsen-s.html" xml:lang="sme"/>
</xsl:variable>
