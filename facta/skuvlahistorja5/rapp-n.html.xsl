...
<xsl:variable name="filename" select="'http://skuvla.info/skolehist/rapp-n.htm'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Små ord skaper stor strid i Tana'"/>
<xsl:variable name="author1_fn" select="'Ole Magnus'"/>
<xsl:variable name="author1_ln" select="'Rapp'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="rapp-s.html" xml:lang="sme"/>
</xsl:variable>
