...
<xsl:variable name="filename" select="'http://skuvla.info/skolehist/reisavgs-s.htm'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Samisk ved Nordreisa videregående skole'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="reisavgs-s.html" xml:lang="sme"/>
</xsl:variable>
