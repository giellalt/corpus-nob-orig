...
<xsl:variable name="filename" select="'http://skuvla.info/skolehist/siri97-n.htm'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Den hete høsten – læreplanmotstanden i 1997'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="siri97-s.html" xml:lang="sme"/>
</xsl:variable>
