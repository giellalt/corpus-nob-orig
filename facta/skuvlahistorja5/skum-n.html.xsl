...
<xsl:variable name="filename" select="'http://skuvla.info/skolehist/skum-n.htm'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="skum-n.htm" xml:lang="nob"/>
<parallel_text location="skum-s.html" xml:lang="sme"/>
</xsl:variable>
