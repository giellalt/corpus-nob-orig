...
<xsl:variable name="filename" select="'http://skuvla.info/skolehist/algu6-n.htm'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Samisk skolehistorie i mål?'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="algu6-s.html" xml:lang="sme"/>
</xsl:variable>
