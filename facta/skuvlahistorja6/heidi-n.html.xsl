...
<xsl:variable name="filename" select="'http://skuvla.info/skolehist/heidi-n.htm'"/>
...
<xsl:variable name="author1_born" select="'1963'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="heidi-s.html" xml:lang="sme"/>
</xsl:variable>
