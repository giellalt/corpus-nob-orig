...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.ssb.no/befolkning/artikler-og-publikasjoner/_attachment/254599?_ts=152a1b77d58'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Samisk statistikk 2016'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="sami_statistihkka_2016.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'1-4, 7-8, 20-154'"/>
    ...
    <xsl:variable name="top_margin" select="'all=6, 11=58, 15=48, 16=83, 18=73'"/>
    <xsl:variable name="bottom_margin" select="'all=6, 17=89'"/>
