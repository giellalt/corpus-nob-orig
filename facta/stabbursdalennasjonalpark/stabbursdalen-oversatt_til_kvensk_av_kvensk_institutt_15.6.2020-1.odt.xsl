...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'/Users/aili/Desktop/Stabbursdalen–oversatt til kvensk av Kvensk institutt, 15.6.2020-1.docx'"/>
    ...
    <language xml:lang="fkv"/><language xml:lang="nob"/></xsl:variable>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fkv" location="stabbursdalen-oversatt_til_kvensk_av_kvensk_institutt_15.6.2020-1.odt"/>
