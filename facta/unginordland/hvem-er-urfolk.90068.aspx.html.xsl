...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.unginordland.no/infonuorra-2/norsk/rettigheter/hvem-er-urfolk.90068.aspx'"/>
    ...
    <parallel_text xml:lang="sme" location="geat-leat-algoalbmogat-ns.90555.aspx.html"/></xsl:variable>
