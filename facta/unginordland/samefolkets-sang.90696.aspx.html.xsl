...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.unginordland.no/infonuorra-2/norsk/kultur/samefolkets-sang.90696.aspx'"/>
    ...
    <parallel_text xml:lang="sme" location="sami-albmotlavlla-ns.90547.aspx.html"/></xsl:variable>
