...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.vaajma.com/jscripts/tiny_mce/plugins/filemanager/files/Tidningen_Vaajma/Nr_4_2013.pdf'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="nr_4_2013.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'1-14, 16-19'"/>
    ...
    <!--
        ...
        1;3;8=20, 4;5;7=10
    -->
    <xsl:variable name="right_margin" select="'all=3, 15=50'"/>
    <xsl:variable name="left_margin" select="'all=3'"/>
    <xsl:variable name="top_margin" select="'all=7, 15=25'"/>
