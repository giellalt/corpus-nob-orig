...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.visitstetind.no/no/klatring_turer/52-filmer.html'"/>
    ...
    <parallel_text xml:lang="smj" location="52-filmer.html"/></xsl:variable>
