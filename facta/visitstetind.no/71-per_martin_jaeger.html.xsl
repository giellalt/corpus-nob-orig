...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.visitstetind.no/no/kunst_kultur/71-per_martin_jæger.html'"/>
    ...
    <parallel_text xml:lang="smj" location="71-per_martin_jaeger.html"/></xsl:variable>
