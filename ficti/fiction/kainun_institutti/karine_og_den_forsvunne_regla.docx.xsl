...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'/Users/thomas/Desktop/karine_og_den_forsvunne_regla.docx'"/>
    ...
    -->
    <xsl:variable name="author1_fn" select="'Anstein'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fkv" location="karine_ja_kadonu_loru.docx"/>
