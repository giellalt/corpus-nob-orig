...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'nob-006-asbjmoe.correct.txt.xsl'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Asbjørnsen og Moe'"/>
    <!--
    ...
    <xsl:variable name="publChannel" select="'http://www.essay.org/school/norwegian/asbmoe.doc'"/>
    <!-- Publication year -->
    ...
    <language xml:lang="dan"/><language xml:lang="nob"/></xsl:variable>
