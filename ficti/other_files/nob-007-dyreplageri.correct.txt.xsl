...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'nob-007-dyreplageri.correct.txt.xsl'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Dyreplageri - moralsk forkastelig og moralsk forsvarlig'"/>
    <!--
        Information of the first author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author1_fn" select="'Lian'"/>
    <xsl:variable name="author1_ln" select="'Marius'"/>
    <!-- m, f or unknown -->
    ...
    <xsl:variable name="publChannel" select="'http://www.propaganda.net/skoleside/?stil=9126'"/>
    <!-- Publication year -->
