...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'/Users/thomasbk/Desktop/pappa_i_storm_og_stilla_2.docx'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Han pappa i storm og stilla, del 2'"/>
    <!--
        Information of the first author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author1_fn" select="'Arne'"/>
    <xsl:variable name="author1_ln" select="'Hauge'"/>
    <!-- m, f or unknown -->
    ...
    <!--
        ...
        date or year of birth, nationality.
    -->
    <xsl:variable name="author2_fn" select="'Maureen'"/>
    <xsl:variable name="author2_ln" select="'Bjerkan Olsen'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fkv" location="pappa_myrskyssa_ja_tyvenessa_2.docx"/>
