...
<xsl:variable name="filename" select="'nob-009-ekkolodd.correct.txt.xsl'"/>
<xsl:variable name="title" select="'nob-009-Flak-ekkolodd-bruksanvisning'"/>
<xsl:variable name="author1_fn" select="'Flak'"/>
<xsl:variable name="author1_ln" select="'Bruksanvisninger'"/>
...
<xsl:variable name="publChannel" select="'http://webserver.flak.no/vbilder/12801.pdf'"/>
