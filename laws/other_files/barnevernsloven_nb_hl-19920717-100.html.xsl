...
<xsl:variable name="text_encoding" select="'LOV 1992-07-17 nr 100: Lov om barneverntjenester (barnevernloven).'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="barnevernloven_samisk_10.doc" xml:lang="sme"/>
</xsl:variable>
