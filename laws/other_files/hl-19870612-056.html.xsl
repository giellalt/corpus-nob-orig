...
<xsl:variable name="filename" select="'http://www.lovdata.no/all/hl-19870612-056.html'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'LOV 1987-06-12 nr 56: Lov om Sametinget og andre samiske rettsforhold (sameloven).'"/>
...
<xsl:variable name="para_eng" select="'the-sami-act-.html_id=449701'"/>
...
<xsl:variable name="para_sme" select="'lahka-geassemanu-12-b-1987-nr-56-samedik.html_id=449701'"/>
