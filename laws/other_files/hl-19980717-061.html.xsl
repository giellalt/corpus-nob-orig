...
<xsl:variable name="filename" select="'http://www.lovdata.no/all/hl-19980717-061.html'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'LOV 1998-07-17 nr 61: Lov om grunnskolen og den vidaregåande opplæringa (opplæringslova).'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="opplaringsloven_samisk_20090421.doc" xml:lang="sme"/>
</xsl:variable>
