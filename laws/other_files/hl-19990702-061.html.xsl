...
<xsl:variable name="filename" select="'http://lovdata.no/all/hl-19990702-061.html'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'LOV 1999-07-02 nr 61: Lov om spesialisthelsetjenesten m.m. (spesialisthelsetjenesteloven).'"/>
...
<xsl:variable name="para_sme" select="'lahka-spesialistadearvvavuoabalvalusa-jn.html_id=516848'"/>
