...
<xsl:variable name="filename" select="'http://lovdata.no/all/hl-20050617-085.html'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'LOV 2005-06-17 nr 85: Lov om rettsforhold og forvaltning av grunn og naturressurser i Finnmark fylke (finnmarksloven).'"/>
...
<xsl:variable name="para_sme" select="'finnmarkkulahka.html_id=515308'"/>
