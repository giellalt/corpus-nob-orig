...
<xsl:variable name="filename" select="'http://lovdata.no/all/hl-20080606-037.html'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'LOV 2008-06-06 nr 37: Lov om forvaltning av viltlevande marine ressursar (havressurslova)'"/>
...
<xsl:variable name="mainlang" select="'1'"/>
...
<xsl:variable name="para_sme" select="'mearraresursalahka.html_id=536824'"/>
