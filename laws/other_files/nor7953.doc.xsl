...
<xsl:variable name="filename" select="'http://faolex.fao.org/docs/texts/nor7953.doc'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'LOV 1983-06-03 nr 40: Lov om saltvannsfiske m.v.'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="lov_om_saltvannsfiske_sme.doc" xml:lang="sme"/>
</xsl:variable>
