...
<xsl:variable name="filename" select="'http://www.lovdata.no/all/hl-19990702-063.html'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'LOV 1999-07-02 nr 63: Lov om pasient- og brukerrettigheter (pasient- og brukerrettighetsloven) [pasientrettighetsloven].'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="pasientrettighetsloven_samisk.doc" xml:lang="sme"/>
</xsl:variable>
