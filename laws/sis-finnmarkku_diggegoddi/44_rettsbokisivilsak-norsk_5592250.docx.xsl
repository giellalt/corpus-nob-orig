...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'44_Rettsbokisivilsak-norsk_5592250.docx'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Saksnr: 14-106945TVI-INFI'"/>
    <!--
    ...
    <xsl:variable name="publisher" select="'Sis-Finnmárkku diggegoddi/Indre Finnmark tingrett'"/>
    ...
    <xsl:variable name="sub_name" select="'Finn-Arne Schanche Selfors'"/>
    <xsl:variable name="sub_email" select="'Finn.Arne.Selfors@domstol.no'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="50_rettsbokisivilsak-samisk_73478168.docx"/>
