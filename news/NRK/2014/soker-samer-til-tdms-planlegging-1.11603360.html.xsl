...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.nrk.no/sapmi/soker-samer-til-tdms-planlegging-1.11603360'"/>
    ...
    <parallel_text xml:lang="smj" location="same-ajrrasa-galggi-nammaduvvat-1.11603180.html"/></xsl:variable>
