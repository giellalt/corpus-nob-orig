...
<xsl:variable name="filename" select="'http://www.nord-salten.no/no/nyheter/kultur/arer-sine-formodre-med-egen-lavvo-patent.8946'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Ærer sine formødre med egen lavvo-patent'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samisk_091211.pdf" xml:lang="smj"/>
</xsl:variable>
