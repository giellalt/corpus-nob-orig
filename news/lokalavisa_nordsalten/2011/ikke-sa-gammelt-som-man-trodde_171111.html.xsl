...
<xsl:variable name="filename" select="'http://www.nord-salten.no/no/nyheter/kultur/ikke-sa-gammelt-som-man-trodde.8770'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Ikke så gammelt som man trodde'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samisk_041111.pdf" xml:lang="smj"/>
</xsl:variable>
