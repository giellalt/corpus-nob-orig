...
<xsl:variable name="filename" select="'http://www.nord-salten.no/no/nyheter/kultur/duodji-utstilling-i-russland.10315'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Duodji-utstilling i Russland'"/>
...
<xsl:variable name="sub_email" select="'ingal.mikkelsen@uti.no'"/>
...
<xsl:variable name="note" select="'Parallelfila innholder to artikler'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samisk_261012.pdf" xml:lang="smj"/>
</xsl:variable>
