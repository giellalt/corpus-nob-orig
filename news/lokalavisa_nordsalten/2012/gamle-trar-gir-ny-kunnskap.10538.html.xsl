...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.nord-salten.no/no/nyheter/samisk/gamle-trar-gir-ny-kunnskap.10538'"/>
    ...
    <parallel_text xml:lang="smj" location="samisk_211212.pdf"/></xsl:variable>
