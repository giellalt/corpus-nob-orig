...
<xsl:variable name="filename" select="'http://www.nord-salten.no/no/nyheter/skole/lav-deltakelse-pa-sprakkursene.9821'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Lav deltakelse på språkkursene'"/>
...
<xsl:variable name="sub_email" select="'inga.l.mikkkelsen@uit.no'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samisk_010612.pdf" xml:lang="smj"/>
</xsl:variable>
