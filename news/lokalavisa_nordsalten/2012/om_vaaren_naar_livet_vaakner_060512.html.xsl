...
<xsl:variable name="filename" select="'http://www.nord-salten.no/no/nyheter/kultur/om-varen-nar-livet-vakner-.9713'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Om våren når livet våkner'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samisk_040512.pdf" xml:lang="smj"/>
</xsl:variable>
