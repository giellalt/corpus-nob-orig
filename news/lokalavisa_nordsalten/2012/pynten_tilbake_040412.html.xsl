...
<xsl:variable name="filename" select="'http://www.nord-salten.no/no/nyheter/kultur/pynten-tilbake-.9572'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Pynten tilbake'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samisk_300312.pdf" xml:lang="smj"/>
</xsl:variable>
