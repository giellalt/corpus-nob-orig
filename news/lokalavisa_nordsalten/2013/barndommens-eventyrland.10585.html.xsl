...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.nord-salten.no/no/barndommens-eventyrland.10585'"/>
    ...
    <parallel_text xml:lang="smj" location="m-nn-vuoda-subtsasrijkka_080113.html"/></xsl:variable>
