...
<xsl:variable name="filename" select="'http://www.nord-salten.no/no/nyheter/samisk/detforstelulesamisketegneseriehefte.50501'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'￼Det første lulesamiske tegneseriehefte'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="samisk_291113.pdf" xml:lang="smj"/>
</xsl:variable>
