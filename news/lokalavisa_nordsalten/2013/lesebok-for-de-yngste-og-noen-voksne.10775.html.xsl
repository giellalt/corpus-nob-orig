...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.nord-salten.no/no/nyheter/diverse/lesebok-for-de-yngste-og-noen-voksne.10775'"/>
    ...
    <parallel_text xml:lang="smj" location="samisk_15022013.pdf"/></xsl:variable>
