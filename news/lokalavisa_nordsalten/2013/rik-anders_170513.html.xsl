...
<xsl:variable name="filename" select="'http://www.nord-salten.no/no/nyheter/samisk/rik-anders.11165'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Rik-Anders'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="boand-s-anders_160513.html" xml:lang="smj"/>
</xsl:variable>
