...
<xsl:variable name="filename" select="'http://www.nord-salten.no/no/nyheter/reiseliv/utviklersamiskreiselivinord.50541'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Utvikler samisk reiseliv i nord'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="avdedimesmemannoaldusvnuorttan_061213.html" xml:lang="smj"/>
</xsl:variable>
