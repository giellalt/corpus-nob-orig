...
<xsl:variable name="filename" select="'nob-008-slapphet.correct.txt.xsl'"/>
<xsl:variable name="title" select="'Slapphet'"/>
<xsl:variable name="author1_fn" select="'Gutt 18år'"/>
...
<xsl:variable name="publChannel" select="'http://www.klara-klok.no/wips/722538495/caseId/398505412/%20av%20Gutt%2018%C3%A5r'"/>
