...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'/Users/thomas/Desktop/på_besok.docx'"/>
    ...
    -->
    <xsl:variable name="author1_fn" select="'Maureen'"/>
    <xsl:variable name="author1_ln" select="'Bjerkan Olsen'"/>
    <!-- m, f or unknown -->
    ...
    <!--
        ...
        date or year of birth, nationality.
    -->
    <xsl:variable name="author2_fn" select="'Arne'"/>
    <xsl:variable name="author2_ln" select="'Hauge'"/>
    ...
    <xsl:variable name="translator_fn" select="'Eira'"/>
    <xsl:variable name="translator_ln" select="'Söderholm'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fkv" location="kylastellyy.docx"/>
