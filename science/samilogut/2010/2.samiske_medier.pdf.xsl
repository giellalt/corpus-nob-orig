...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="2.sami_mediat.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'28'"/>
    ...
    <xsl:variable name="top_margin" select="'16=16'"/>
    <xsl:variable name="bottom_margin" select="'12=55, 15=50, 19=36, 23=58'"/>
