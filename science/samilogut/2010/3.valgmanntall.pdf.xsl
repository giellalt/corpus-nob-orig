...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="title" select="'Valgmanntall og valgdeltakelse ved sametingsvalgene i Norge 1989– 2009'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="3._jienastuslohku_ja_valga.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'48-52, 54-55, 8, 13, 19, 24'"/>
    ...
    <xsl:variable name="top_margin" select="'10=44, 20=78, 29=33, 34=44, 35=44, 36=44, 40=44, 41=47, 42=44, 44=44'"/>
    <xsl:variable name="bottom_margin" select="'6=60, 27=49, 28=56, 39=18, 40=15, 42=15, 43=54'"/>
    ...
    <!--
        ...
        must be defined.
    -->
    <xsl:variable name="inner_right_margin" select="'7=7, 9=7, 12=7, 14=7, 17=7, 22=7, 23=7, 27=7, 30=7, 31=7, 32=7, 33=7, 37=7, 45=7'"/>
    <xsl:variable name="inner_left_margin" select="'7=7, 9=7, 12=7, 14=7, 17=7, 22=7, 23=7, 27=7, 30=7, 31=7, 32=7, 33=7, 37=7, 45=7'"/>
    <xsl:variable name="inner_top_margin" select="'7=17, 9=33, 12=40, 14=50, 17=47, 22=15, 23=20, 27=28, 30=15, 31=20, 32=60, 33=22, 37=49, 45=41'"/>
    <xsl:variable name="inner_bottom_margin" select="'7=60, 9=31, 12=43, 14=20, 17=20, 22=56, 23=40, 27=56, 30=34, 31=29, 32=16, 33=42, 37=15, 45=20'"/>
