...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="title" select="'Uføretrygd og sosialhjelp'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="4.bargonavccahisvuodaoadju.pdf"/>
    ...
    <xsl:variable name="top_margin" select="'6=70, 9=45, 10=66, 12=53, 14=60, 15=70'"/>
    <xsl:variable name="bottom_margin" select="'7=82, 8=60, 17=75, 19=75'"/>
    ...
    <xsl:variable name="inner_top_margin" select="'16=19'"/>
    <xsl:variable name="inner_bottom_margin" select="'16=15'"/>
