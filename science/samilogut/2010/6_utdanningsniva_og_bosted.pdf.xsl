...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="title" select="'Utdanningsnivå og bosted'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="6.oahppodassi_ja_assanbaiki.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'8'"/>
    ...
    <xsl:variable name="top_margin" select="'3=64, 5=61'"/>
    <xsl:variable name="bottom_margin" select="'11=80'"/>
    ...
    <xsl:variable name="inner_top_margin" select="'9=13'"/>
    <xsl:variable name="inner_bottom_margin" select="'9=20'"/>
