...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="3.birashalddaseapmi.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'26-30'"/>
    ...
    <xsl:variable name="top_margin" select="'8=50, 16=39, 17=46'"/>
    <xsl:variable name="bottom_margin" select="'all=12, 2=20, 4=20, 7=20, 8=25, 12=20, 14=47, 15=25, 17=7, 23=58, 24=7, 3=5'"/>
    ...
    <!--
        ...
        must be defined.
    -->
    <xsl:variable name="inner_right_margin" select="'6=7, 7=7, 22=7'"/>
    <xsl:variable name="inner_left_margin" select="'6=7, 7=7, 22=7'"/>
    <xsl:variable name="inner_top_margin" select="'6=30, 7=11, 22=12'"/>
    <xsl:variable name="inner_bottom_margin" select="'6=30, 7=53, 22=63'"/>
