...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://samilogutmuitalit.no/sites/default/files/publications/kapittel4.den_samiskrelaterte_doktorgradsproduksjonen_ved_universitetet_i_tromso.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Den samiskrelaterte doktorgradsproduksjonen ved Universitetet i Tromsø'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="4.doavttergradabuvttadeapmi.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'11'"/>
    ...
    <xsl:variable name="top_margin" select="'7=60'"/>
    <xsl:variable name="bottom_margin" select="'all=14, 3=22, 5=20, 9=6, 10=6, 12=6, 15=69'"/>
    ...
    <!--
        ...
        must be defined.
    -->
    <xsl:variable name="inner_right_margin" select="'6=7, 10=7'"/>
    <xsl:variable name="inner_left_margin" select="'6=7, 10=7'"/>
    <xsl:variable name="inner_top_margin" select="'6=22, 10=22'"/>
    <xsl:variable name="inner_bottom_margin" select="'6=40, 10=33'"/>
