...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://samilogutmuitalit.no/sites/default/files/publications/kapittel5.likestilling.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Kjønnsperspektiv i samisk statistikk'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="5.sohkabeal.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'8, 12, 19-20'"/>
    ...
    <xsl:variable name="top_margin" select="'4=70, 10=42, 15=30, 24=47, 25=52, 26=47'"/>
    <xsl:variable name="bottom_margin" select="'7=32, 10=19, 13=50, 14=20, 16=31, 18=32, 21=52, 22=80, 26=29'"/>
    ...
    <!--
        ...
        must be defined.
    -->
    <xsl:variable name="inner_right_margin" select="'5=7, 6=7, 7=7, 17=7'"/>
    <xsl:variable name="inner_left_margin" select="'5=7, 6=7, 7=7, 17=7'"/>
    <xsl:variable name="inner_top_margin" select="'5=20, 6=47, 7=32, 17=40'"/>
    <xsl:variable name="inner_bottom_margin" select="'5=60, 6=16, 7=49, 17=32'"/>
