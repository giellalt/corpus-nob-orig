...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="6.samedikki_juolludeamit.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'4, 6-7'"/>
    ...
    <xsl:variable name="top_margin" select="'3=52'"/>
    ...
    <!--
        ...
        must be defined.
    -->
    <xsl:variable name="inner_right_margin" select="'2=7, 5=7'"/>
    <xsl:variable name="inner_left_margin" select="'2=7, 5=7'"/>
    <xsl:variable name="inner_top_margin" select="'2=30, 5=20'"/>
    <xsl:variable name="inner_bottom_margin" select="'2=34, 5=40'"/>
