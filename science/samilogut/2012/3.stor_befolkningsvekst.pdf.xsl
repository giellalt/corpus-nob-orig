...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://samilogutmuitalit.no/sites/default/files/publications/3_norge_5_millionerl.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Stor befolkningsvekst, men hvordan fordeler den seg?'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="3.albmotlohku_lassana_ollu.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'8, 22'"/>
    ...
    <xsl:variable name="top_margin" select="'3=47, 9=50, 15=45, 16=33, 18=42'"/>
    <xsl:variable name="bottom_margin" select="'16=44'"/>
