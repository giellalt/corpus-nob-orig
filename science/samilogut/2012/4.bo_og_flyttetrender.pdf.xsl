...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="4.orrun_ja_farrentreanddat.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'5-6, 12, 23'"/>
    ...
    <xsl:variable name="left_margin" select="'3=30'"/>
    <xsl:variable name="top_margin" select="'3=18, 8=43, 19=53'"/>
    <xsl:variable name="bottom_margin" select="'4=63, 8=40, 17=63'"/>
    ...
    <!--
        ...
        must be defined.
    -->
    <xsl:variable name="inner_right_margin" select="'7=7, 10=7, 11=7, 16=7'"/>
    <xsl:variable name="inner_left_margin" select="'7=7, 10=7, 11=7, 16=7'"/>
    <xsl:variable name="inner_top_margin" select="'7=33, 10=15, 11=15, 16=35'"/>
    <xsl:variable name="inner_bottom_margin" select="'7=25, 10=40, 11=35, 16=26'"/>
