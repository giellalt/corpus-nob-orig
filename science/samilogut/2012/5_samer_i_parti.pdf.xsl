...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://samilogutmuitalit.no/sites/default/files/publications/5._samer_i_parti_og_valg.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Samer i parti og valg'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="5_sapmelaccat_bellodagain.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'22, 32'"/>
    ...
    <xsl:variable name="top_margin" select="'17=33, 23=60, 27=55'"/>
    <xsl:variable name="bottom_margin" select="'5=25, 6=15, 7=18, 8=25, 9=55, 10=33, 12=30, 13=30, 14=55, 17=22, 20=14, 21=20, 25=50, 27=16, 29=16, 31=54'"/>
    ...
    <!--
        ...
        must be defined.
    -->
    <xsl:variable name="inner_right_margin" select="'18=7, 20=7, 24=7, 28=7'"/>
    <xsl:variable name="inner_left_margin" select="'18=7, 20=7, 24=7, 28=7'"/>
    <xsl:variable name="inner_top_margin" select="'18=28, 20=20, 24=29, 28=42'"/>
    <xsl:variable name="inner_bottom_margin" select="'18=23, 20=46, 24=36, 28=16'"/>
