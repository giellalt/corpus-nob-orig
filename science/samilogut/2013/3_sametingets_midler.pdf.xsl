...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="3_samedikki_doarjjaortnegat.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'23-24'"/>
    ...
    <xsl:variable name="top_margin" select="'5=70, 10=41, 14=25'"/>
    ...
    <!--
        ...
        must be defined.
    -->
    <xsl:variable name="inner_right_margin" select="'8=7, 10=7, 11=7, 16=7, 20=7'"/>
    <xsl:variable name="inner_left_margin" select="'8=7, 10=7, 11=7, 16=7, 20=7'"/>
    <xsl:variable name="inner_top_margin" select="'8=44, 10=57, 11=23, 16=57, 20=24'"/>
    <xsl:variable name="inner_bottom_margin" select="'8=17, 10=24, 11=53, 16=16, 20=58'"/>
