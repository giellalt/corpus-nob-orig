...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://samilogutmuitalit.no/sites/default/files/publications/4studiepoengproduksjon_i_samisk_i_hogere_utdanning.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Studiepoengproduksjon i samisk i høgere utdanning'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="4_studijepoengedorjemasse.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'14'"/>
    ...
    <xsl:variable name="top_margin" select="'6=42, 9=67'"/>
    <xsl:variable name="bottom_margin" select="'1=24, 2=20, 3=17, 4=18, 7=14, 9=12, 10=33, 11=15, 12=16, 13=18'"/>
    ...
    <!--
        ...
        must be defined.
    -->
    <xsl:variable name="inner_right_margin" select="'4=7, 5=7, 6=7, 7=7, 10=7, 11=7'"/>
    <xsl:variable name="inner_left_margin" select="'4=7, 5=7, 6=7, 7=7, 10=7, 11=7'"/>
    <xsl:variable name="inner_top_margin" select="'4=57, 5=65, 6=55, 7=42, 10=37, 11=43'"/>
    <xsl:variable name="inner_bottom_margin" select="'4=23, 5=22, 6=25, 7=28, 10=47, 11=41'"/>
