...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="5_galbbaid_giellaatnu.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'9, 29, 36'"/>
    ...
    <xsl:variable name="top_margin" select="'17=38, 21=30, 24=33, 30=33'"/>
    <xsl:variable name="bottom_margin" select="'8=24, 10=22, 11=35, 15=14, 35=80'"/>
    ...
    <!--
        ...
        must be defined.
    -->
    <xsl:variable name="inner_right_margin" select="'12=7, 13=7, 19=7, 22=7, 24=7, 25=7, 26=7, 27=7, 28=7'"/>
    <xsl:variable name="inner_left_margin" select="'12=7, 13=7, 19=7, 22=7, 24=7, 25=7, 26=7, 27=7, 28=7'"/>
    <xsl:variable name="inner_top_margin" select="'12=60, 13=50, 19=36, 22=35, 24=62, 25=33, 26=30, 27=17, 28=18'"/>
    <xsl:variable name="inner_bottom_margin" select="'12=25, 13=22, 19=37, 22=25, 24=20, 25=26, 26=42, 27=48, 28=48'"/>
