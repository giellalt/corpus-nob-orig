...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://samilogutmuitalit.no/sites/default/files/publications/6mattrygghet_i_nord.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Mattrygghet i nord'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="6_biebmodorvvolasvuohta_davvin.pdf"/>
    ...
    <xsl:variable name="top_margin" select="'8=42, 9=79, 10=40, 11=37'"/>
    <xsl:variable name="bottom_margin" select="'4=50'"/>
    ...
    <!--
        ...
        must be defined.
    -->
    <xsl:variable name="inner_right_margin" select="'7=7'"/>
    <xsl:variable name="inner_left_margin" select="'7=7'"/>
    <xsl:variable name="inner_top_margin" select="'7=23'"/>
    <xsl:variable name="inner_bottom_margin" select="'7=40'"/>
