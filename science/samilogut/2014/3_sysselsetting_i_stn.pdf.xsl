...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://samilogutmuitalit.no/sites/default/files/publications/3.sysselsetting_i_stn-omraadet.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sysselsetting i STN-området'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="3_fasseldimmie_sdj_dajvesne.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'7'"/>
    ...
    <xsl:variable name="top_margin" select="'3=38, 8=50'"/>
    <xsl:variable name="bottom_margin" select="'2=44, 4=65'"/>
    ...
    <!--
        ...
        must be defined.
    -->
    <xsl:variable name="inner_right_margin" select="'3=7, 5=7, 6=7'"/>
    <xsl:variable name="inner_left_margin" select="'3=7, 5=7, 6=7'"/>
    <xsl:variable name="inner_top_margin" select="'3=54, 5=45, 6=18'"/>
    <xsl:variable name="inner_bottom_margin" select="'3=13, 5=27, 6=50'"/>
