...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://samilogutmuitalit.no/sites/default/files/publications/4.barekraftig_reindrift_final_1.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Ei bærekraftig reindrift?'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="4_ceavzilis_boazoealahus.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'9-10, 14-33, 48-49'"/>
    ...
    <xsl:variable name="top_margin" select="'11=25'"/>
    <xsl:variable name="bottom_margin" select="'3=18, 6=56, 8=60, 11=12, 12=15, 13=70, 34=15, 41=15, 47=53'"/>
    ...
    <!--
        ...
        must be defined.
    -->
    <xsl:variable name="inner_right_margin" select="'3=7, 34=7'"/>
    <xsl:variable name="inner_left_margin" select="'3=7, 34=7'"/>
    <xsl:variable name="inner_top_margin" select="'3=55, 34=37'"/>
    <xsl:variable name="inner_bottom_margin" select="'3=33, 34=36'"/>
