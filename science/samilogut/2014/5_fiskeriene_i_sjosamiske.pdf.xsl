...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://samilogutmuitalit.no/sites/default/files/publications/5.hva_skjer_med_fiskeriene_i_de_sjafsamisk.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Hva skjer med fiskeriene i de sjøsamiske fjordene?'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="5_mearrasamiguovlluid_guolastusat.pdf"/>
    ...
    <xsl:variable name="top_margin" select="'10=60, 13=33, 15=50'"/>
    <xsl:variable name="bottom_margin" select="'1=13, 2=12, 3=18, 6=33, 7=17, 9=69, 13=50, 16=13, 18=53'"/>
    ...
    <!--
        ...
        must be defined.
    -->
    <xsl:variable name="inner_right_margin" select="'4=7, 7=7, 8=7, 11=7, 12=7'"/>
    <xsl:variable name="inner_left_margin" select="'4=7, 7=7, 8=7, 11=7, 12=7'"/>
    <xsl:variable name="inner_top_margin" select="'4=30, 7=33, 8=45, 11=25, 12=33'"/>
    <xsl:variable name="inner_bottom_margin" select="'4=46, 7=38, 8=30, 11=37, 12=40'"/>
