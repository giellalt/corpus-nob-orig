...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="2_samegiella_vuoddoskuvllas.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'12, 14, 24-25'"/>
    ...
    <xsl:variable name="top_margin" select="'4=25, 5=30, 6=47, 8=32, 15=77'"/>
    <xsl:variable name="bottom_margin" select="'2=12, 5=15, 6=37, 8=47, 11=80, 16=28, 23=40'"/>
    ...
    <!--
        ...
        must be defined.
    -->
    <xsl:variable name="inner_right_margin" select="'4=7, 5=7, 7=7, 9=7, 10=7'"/>
    <xsl:variable name="inner_left_margin" select="'4=7, 5=7, 7=7, 9=7, 10=7'"/>
    <xsl:variable name="inner_top_margin" select="'4=62, 5=57, 7=28, 9=35, 10=22'"/>
    <xsl:variable name="inner_bottom_margin" select="'4=30, 5=25, 7=35, 9=25, 10=20'"/>
