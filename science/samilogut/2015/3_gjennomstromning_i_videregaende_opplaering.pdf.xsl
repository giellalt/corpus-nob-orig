...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="3_joatkkaskuvla_oahpu_cadaheapmi.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'6, 8, 13'"/>
    ...
    <xsl:variable name="top_margin" select="'14=20'"/>
    <xsl:variable name="bottom_margin" select="'1=17, 3=46, 4=83, 9=63, 10=74, 11=13, 15=83'"/>
    ...
    <!--
        ...
        must be defined.
    -->
    <xsl:variable name="inner_right_margin" select="'5=7, 7=7, 11=7, 12=7, 14=7'"/>
    <xsl:variable name="inner_left_margin" select="'5=7, 7=7, 11=7, 12=7, 14=7'"/>
    <xsl:variable name="inner_top_margin" select="'5=25, 7=20, 11=25, 12=30, 14=40'"/>
    <xsl:variable name="inner_bottom_margin" select="'5=43, 7=45, 11=68, 12=37, 14=45'"/>
