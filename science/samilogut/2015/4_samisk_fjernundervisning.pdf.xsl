...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://samilogutmuitalit.no/sites/default/files/publications/4_samisk_fjernundervisning_.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Samisk fjernundervisning'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="4_saemien_maajhoohpehtimmie.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'9-10'"/>
    ...
    <xsl:variable name="top_margin" select="'4=65, 6=30, 8=52, 11=66'"/>
    <xsl:variable name="bottom_margin" select="'2=20, 3=20, 4=17, 5=17, 6=17, 7=80, 8=30, 11=12, 12=50'"/>
