...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://samilogutmuitalit.no/sites/default/files/publications/5._spraksentervoksenopplaring.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Språksentrenes voksenopplæring'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="5_giellaguovddaziid_ravesolbmuid.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'13-14'"/>
    ...
    <xsl:variable name="top_margin" select="'9=45'"/>
    <xsl:variable name="bottom_margin" select="'2=16, 4=70, 6=12, 7=82, 9=17, 10=12'"/>
    ...
    <!--
        ...
        must be defined.
    -->
    <xsl:variable name="inner_right_margin" select="'2=7'"/>
    <xsl:variable name="inner_left_margin" select="'2=7'"/>
    <xsl:variable name="inner_top_margin" select="'2=25'"/>
    <xsl:variable name="inner_bottom_margin" select="'2=34'"/>
