...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://samilogutmuitalit.no/sites/default/files/publications/6.forskningsprogram2015.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Forskningsrådene – 40 år for samisk forskning'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="6_dutkanradit_40_jagi.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'5, 13-15, 18-19'"/>
    ...
    <xsl:variable name="top_margin" select="'6=70, 8=65, 16=57, 20=70'"/>
    <xsl:variable name="bottom_margin" select="'2=23, 3=25, 4=20, 6=18, 9=20, 10=12, 11=12, 12=20, 16=15, 17=12, 20=13, 21=50, 22=23, 24=15, 26=12, 27=45, 28=55, 29=15, 30=11, 32=17, 33=33'"/>
    ...
    <!--
        ...
        must be defined.
    -->
    <xsl:variable name="inner_right_margin" select="'22=7'"/>
    <xsl:variable name="inner_left_margin" select="'22=7'"/>
    <xsl:variable name="inner_top_margin" select="'22=24'"/>
    <xsl:variable name="inner_bottom_margin" select="'22=50'"/>
