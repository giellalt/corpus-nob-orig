...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://samilogutmuitalit.no/sites/default/files/publications/7.statistikkartikkel.tore_johnsen_1.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Samisk språk i Den norske kirke'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="7_samegiella_norgga_girkus.pdf"/>
    ...
    <xsl:variable name="bottom_margin" select="'2=15, 3=15, 4=12, 6=11, 9=15, 12=13, 14=12, 16=73, 20=12, 22=12, 23=27, 26=18'"/>
    ...
    <!--
        ...
        must be defined.
    -->
    <xsl:variable name="inner_right_margin" select="'13=7, 15=7, 22=7'"/>
    <xsl:variable name="inner_left_margin" select="'13=7, 15=7, 22=7'"/>
    <xsl:variable name="inner_top_margin" select="'13=20, 15=14, 22=15'"/>
    <xsl:variable name="inner_bottom_margin" select="'13=48, 15=65, 22=25'"/>
