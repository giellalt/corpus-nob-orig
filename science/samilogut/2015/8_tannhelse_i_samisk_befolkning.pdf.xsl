...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://samilogutmuitalit.no/sites/default/files/publications/8.revsamisk_tall_forteller_tannhelse.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Tannhelse i samisk befolkning i Finnmark'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="8_batnedearvvasvuohta_sami_albmogis.pdf"/>
    ...
    <xsl:variable name="top_margin" select="'5=43, 6=40, 7=40, 8=47'"/>
    <xsl:variable name="bottom_margin" select="'10=14, 11=45'"/>
    ...
    <xsl:variable name="inner_top_margin" select="'9=30'"/>
    <xsl:variable name="inner_bottom_margin" select="'9=34'"/>
