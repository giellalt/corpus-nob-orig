...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://samilogutmuitalit.no/sites/default/files/publications/kapittel_2_fritidsaktiviteter_midlertidig21_10_2016.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Bruk av fritidsarenaer og deltakelse i fritidsaktiviteter blant samisk- og norsktalende ungdom i Finnmark'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="2_friddjaaiggearenaid_geavaheapmi.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'10-12, 24'"/>
    ...
    <xsl:variable name="top_margin" select="'17=75, 20=72'"/>
    <xsl:variable name="bottom_margin" select="'5=17, 13=60, 14=35, 15=40, 16=53, 18=30, 19=63, 23=28'"/>
    ...
    <!--
        ...
        must be defined.
    -->
    <xsl:variable name="inner_right_margin" select="'7=7, 8=7, 14=7, 15=7, 16=7, 18=7'"/>
    <xsl:variable name="inner_left_margin" select="'7=7, 8=7, 14=7, 15=7, 16=7, 18=7'"/>
    <xsl:variable name="inner_top_margin" select="'7=50, 8=47, 14=27, 15=32, 16=14, 18=24'"/>
    <xsl:variable name="inner_bottom_margin" select="'7=22, 8=22, 14=53, 15=50, 16=65, 18=53'"/>
