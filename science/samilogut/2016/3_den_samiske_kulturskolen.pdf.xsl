...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://samilogutmuitalit.no/sites/default/files/publications/kapittel_3._ferdig_artikkel.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Den samiske kulturskolen'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="3_sami_kulturskuvla.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'3-4, 20'"/>
    ...
    <xsl:variable name="top_margin" select="'5=66'"/>
    <xsl:variable name="bottom_margin" select="'7=77, 8=77, 10=27, 19=35'"/>
    ...
    <!--
        ...
        must be defined.
    -->
    <xsl:variable name="inner_right_margin" select="'6=7, 10=7, 14=7, 17=7'"/>
    <xsl:variable name="inner_left_margin" select="'6=7, 10=7, 14=7, 17=7'"/>
    <xsl:variable name="inner_top_margin" select="'6=14, 10=13, 14=55, 17=30'"/>
    <xsl:variable name="inner_bottom_margin" select="'6=50, 10=55, 14=14, 17=34'"/>
