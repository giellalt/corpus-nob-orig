...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://samilogutmuitalit.no/sites/default/files/publications/kapittel_4._festivaler_med_samisk_innhold.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Festivaler med samisk innhold'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="4_festivalat_main_lea_sami_sisdoallu.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'18-19'"/>
    ...
    <xsl:variable name="top_margin" select="'9=77'"/>
    <xsl:variable name="bottom_margin" select="'17=43'"/>
    ...
    <!--
        ...
        must be defined.
    -->
    <xsl:variable name="inner_right_margin" select="'3=7, 4=7, 5=7, 6=7, 8=7'"/>
    <xsl:variable name="inner_left_margin" select="'3=7, 4=7, 5=7, 6=7, 8=7'"/>
    <xsl:variable name="inner_top_margin" select="'3=50, 4=35, 5=27, 6=50, 8=19'"/>
    <xsl:variable name="inner_bottom_margin" select="'3=22, 4=31, 5=38, 6=19, 8=50'"/>
