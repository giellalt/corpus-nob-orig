...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://samilogutmuitalit.no/sites/default/files/publications/kapittel_5._laerertetthet_ok.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Samisk lærertetthet'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="8_sami_student_teacher_ratio.pdf"/>
        ...
        <parallel_text xml:lang="sma" location="5_saemien_lohkehtaejjaveahka.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'10, 13, 19'"/>
    ...
    <xsl:variable name="top_margin" select="'5=65, 14=65'"/>
    <xsl:variable name="bottom_margin" select="'2=18, 4=18, 5=18, 6=16, 9=82, 11=12, 12=57, 14=12, 15=18, 16=12'"/>
    ...
    <!--
        ...
        must be defined.
    -->
    <xsl:variable name="inner_right_margin" select="'7=7, 8=7'"/>
    <xsl:variable name="inner_left_margin" select="'7=7, 8=7'"/>
    <xsl:variable name="inner_top_margin" select="'7=42, 8=22'"/>
    <xsl:variable name="inner_bottom_margin" select="'7=18, 8=43'"/>
