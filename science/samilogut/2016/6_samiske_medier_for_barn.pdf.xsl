...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://samilogutmuitalit.no/sites/default/files/publications/kapittel_6._medier_ok_27.10.2016.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Samiske medier for barn og ￼ungdom'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="6_sami_mediat_manaide.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'22, 25-26'"/>
    ...
    <xsl:variable name="top_margin" select="'7=33, 9=35'"/>
    <xsl:variable name="bottom_margin" select="'4=13, 6=17, 20=32, 21=53, 24=52'"/>
    ...
    <!--
        ...
        must be defined.
    -->
    <xsl:variable name="inner_right_margin" select="'4=7, 19=7, 20=7'"/>
    <xsl:variable name="inner_left_margin" select="'4=7, 19=7, 20=7'"/>
    <xsl:variable name="inner_top_margin" select="'4=52, 19=33, 20=17'"/>
    <xsl:variable name="inner_bottom_margin" select="'4=20, 19=16, 20=64'"/>
