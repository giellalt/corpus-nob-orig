...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://samilogutmuitalit.no/sites/default/files/publications/kapittel_7._diskriminering_ketil_03.nov_2016.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Selvopplevd diskriminering av samer i Norge'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="9_self_reported_discrimination.pdf"/>
        ...
        <parallel_text xml:lang="sme" location="7_vasihan_vealaheapmi.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'8, 13, 16, 19, 24-25'"/>
    ...
    <xsl:variable name="top_margin" select="'5=60, 9=47, 20=13, 21=77'"/>
    <xsl:variable name="bottom_margin" select="'11=85, 23=60'"/>
    ...
    <!--
        ...
        must be defined.
    -->
    <xsl:variable name="inner_right_margin" select="'10=7'"/>
    <xsl:variable name="inner_left_margin" select="'10=7'"/>
    <xsl:variable name="inner_top_margin" select="'10=14'"/>
    <xsl:variable name="inner_bottom_margin" select="'10=24'"/>
