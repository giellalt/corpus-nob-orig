...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://samilogutmuitalit.no/sites/default/files/publications/2._statistikk_samisk_ok.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Samisk musikk – livskraftig tradisjon og spennende fornying'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="2_sami_musihkka.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'4-8, 12, 22'"/>
    ...
    <xsl:variable name="top_margin" select="'9=40, 13=12, 17=40'"/>
    <xsl:variable name="bottom_margin" select="'1=22, 2=16, 3=18, 9=13, 11=18, 14=20, 15=45, 16=20, 18=42, 19=20, 20=12'"/>
    ...
    <!--
        ...
        must be defined.
    -->
    <xsl:variable name="inner_right_margin" select="'14=7, 18=7, 19=7'"/>
    <xsl:variable name="inner_left_margin" select="'14=7, 18=7, 19=7'"/>
    <xsl:variable name="inner_top_margin" select="'14=28, 18=18, 19=21'"/>
    <xsl:variable name="inner_bottom_margin" select="'14=37, 18=53, 19=42'"/>
