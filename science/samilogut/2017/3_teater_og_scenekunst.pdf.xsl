...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://samilogutmuitalit.no/sites/default/files/publications/3._teater_2017-rettetaudsoyland_ny_2_05.10.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Teater og scenekunst som aktører i identitets- og nasjonsbygging'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="3_teatere_jih_scenetjeahpoe.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'6-7, 15-16, 26'"/>
    ...
    <xsl:variable name="top_margin" select="'1=22, 8=65, 17=29'"/>
    <xsl:variable name="bottom_margin" select="'3=13, 5=50, 9=25, 12=17, 13=12, 14=70, 17=12, 18=23, 20=12, 21=20, 22=12, 25=36'"/>
    ...
    <!--
        ...
        must be defined.
    -->
    <xsl:variable name="inner_right_margin" select="'10=7, 18=7'"/>
    <xsl:variable name="inner_left_margin" select="'10=7, 18=7'"/>
    <xsl:variable name="inner_top_margin" select="'10=39, 18=20'"/>
    <xsl:variable name="inner_bottom_margin" select="'10=40, 18=49'"/>
