...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="4_samegiella_nubbingiellan.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'8, 14-15'"/>
    ...
    <xsl:variable name="top_margin" select="'9=25, 12=60, 16=33, 17=30'"/>
    <xsl:variable name="bottom_margin" select="'2=17, 3=18, 4=14, 5=13, 7=54, 9=20, 10=13, 11=69, 13=17, 16=13, 17=12, 18=13, 19=15, 20=18, 21=13, 22=70'"/>
