...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://samilogutmuitalit.no/sites/default/files/publications/5.samisketallforteller10_ketillenerthansen2-03.11.2017_ok.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Diskriminering av samer med funksjonsnedsettelse'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="5_vealaheapmi_sapmelaccain.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'19-20'"/>
    ...
    <xsl:variable name="top_margin" select="'13=55'"/>
    <xsl:variable name="bottom_margin" select="'4=12, 7=15, 8=13, 9=15, 18=68, 15=70'"/>
    ...
    <!--
        ...
        must be defined.
    -->
    <xsl:variable name="inner_right_margin" select="'16=7'"/>
    <xsl:variable name="inner_left_margin" select="'16=7'"/>
    <xsl:variable name="inner_top_margin" select="'16=47'"/>
    <xsl:variable name="inner_bottom_margin" select="'16=18'"/>
