...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://samilogutmuitalit.no/sites/default/files/publications/6.kapittel_om_jordbruk_06.11.2017-1.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Utviklingen innen jordbruk i samiske bosetningsområder'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="6_eanandoalu_ovdaneapmi.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'3, 6, 11, 14'"/>
    ...
    <xsl:variable name="top_margin" select="'4=70, 7=50, 8=26, 12=35, 15=83, 17=48, 18=45'"/>
    <xsl:variable name="bottom_margin" select="'1=13, 2=30, 7=15, 8=14, 9=18, 10=60, 13=13, 17=25, 22=65'"/>
    ...
    <!--
        ...
        must be defined.
    -->
    <xsl:variable name="inner_right_margin" select="'5=7, 8=7, 9=7, 12=7, 13=7, 16=7, 20=7'"/>
    <xsl:variable name="inner_left_margin" select="'5=7, 8=7, 9=7, 12=7, 13=7, 16=7, 20=7'"/>
    <xsl:variable name="inner_top_margin" select="'5=22, 8=42, 9=26, 12=43, 13=15, 16=16, 20=20'"/>
    <xsl:variable name="inner_bottom_margin" select="'5=42, 8=31, 9=50, 12=14, 13=48, 16=31, 20=63'"/>
