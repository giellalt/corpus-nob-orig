...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://samilogutmuitalit.no/sites/default/files/2._oppslutning.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Oppslutningen om Ap, H, Sp og FrP ved sametingsvalg sammenliknet med stortingsvalg 1989–2017: Er det nasjonale valgvinder eller samepolitikken som teller?'"/>
    <!--
        Information of the first author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author1_fn" select="'Marcus'"/>
    <xsl:variable name="author1_ln" select="'Buck'"/>
    <!-- m, f or unknown -->
    ...
    <!--
        ...
        date or year of birth, nationality.
    -->
    <xsl:variable name="author2_fn" select="'Kristian H.'"/>
    <xsl:variable name="author2_ln" select="'Haugen'"/>
    ...
    <!--
        ...
        date or year of birth, nationality.
    -->
    <xsl:variable name="author3_fn" select="'Jonas'"/>
    <xsl:variable name="author3_ln" select="'Stein'"/>
    ...
    <!--
        ...
        date or year of birth, nationality.
    -->
    <xsl:variable name="author4_fn" select="'Sigbjørn'"/>
    <xsl:variable name="author4_ln" select="'Svalestuen'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="2_guorraseapmi_bellodagaide_bb.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'16-17'"/>
    ...
    <xsl:variable name="bottom_margin" select="'1=12, 2=15, 4=17, 7=20, 10=20, 12=18'"/>
