...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="author1_ln" select="'Tovmo'"/>
    <!-- m, f or unknown -->
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="3_arvohahkan_sed_guovllus.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'12-13'"/>
    ...
    <xsl:variable name="top_margin" select="'6=77, 8=48, 10=80'"/>
    <xsl:variable name="bottom_margin" select="'1=15, 2=16, 3=13, 4=13'"/>
    ...
    <!--
        ...
        must be defined.
    -->
    <xsl:variable name="inner_right_margin" select="'4=7'"/>
    <xsl:variable name="inner_left_margin" select="'4=7'"/>
    <xsl:variable name="inner_top_margin" select="'4=50'"/>
    <xsl:variable name="inner_bottom_margin" select="'4=24'"/>
