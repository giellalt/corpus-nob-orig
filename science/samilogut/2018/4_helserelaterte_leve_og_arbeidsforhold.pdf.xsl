...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="author1_fn" select="'Snefrid'"/>
    <xsl:variable name="author1_ln" select="'Møllersen'"/>
    <!-- m, f or unknown -->
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="4_healsoeektiedamme_jielede_jih_barkoetsiehkieh_baatsoesaemien.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'25-27'"/>
    ...
    <xsl:variable name="top_margin" select="'6=60, 10=45, 11=45, 14=47, 15=53, 18=43'"/>
    <xsl:variable name="bottom_margin" select="'all=10, 2=14, 4=15, 7=17, 8=13, 9=53, 10=7, 12=13, 19=12, 24=69'"/>
    ...
    <!--
        ...
        must be defined.
    -->
    <xsl:variable name="inner_right_margin" select="'8=7, 12=7, 13=7, 16=7, 17=7, 19=7, 20=7, 21=7'"/>
    <xsl:variable name="inner_left_margin" select="'8=7, 12=7, 13=7, 16=7, 17=7, 19=7, 20=7, 21=7'"/>
    <xsl:variable name="inner_top_margin" select="'8=19, 12=18, 13=15, 16=49, 17=20, 19=24, 20=23, 21=36'"/>
    <xsl:variable name="inner_bottom_margin" select="'8=49, 12=51, 13=63, 16=14, 17=63, 19=39, 20=38, 21=38'"/>
