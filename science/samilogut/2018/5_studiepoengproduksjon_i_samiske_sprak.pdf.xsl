...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://samilogutmuitalit.no/sites/default/files/5.studiepoengproduksjon_i_samisk_sprak_2018_ok_1.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Studiepoengproduksjon i samiske språk'"/>
    <!--
        Information of the first author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author1_fn" select="'Kevin'"/>
    <xsl:variable name="author1_ln" select="'Johansen'"/>
    <!-- m, f or unknown -->
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="5_oahppocuoggaid_buvttadeapmi_samegielas.pdf"/>
    ...
    <xsl:variable name="top_margin" select="'12=53'"/>
    <xsl:variable name="bottom_margin" select="'2=20, 3=28, 4=20, 5=20, 6=82, 8=16, 10=15, 11=71, 12=13, 13=72, 14=19, 15=19, 16=78'"/>
    ...
    <!--
        ...
        must be defined.
    -->
    <xsl:variable name="inner_right_margin" select="'8=7, 10=7'"/>
    <xsl:variable name="inner_left_margin" select="'8=7, 10=7'"/>
    <xsl:variable name="inner_top_margin" select="'8=17, 10=18'"/>
    <xsl:variable name="inner_bottom_margin" select="'8=24, 10=28'"/>
