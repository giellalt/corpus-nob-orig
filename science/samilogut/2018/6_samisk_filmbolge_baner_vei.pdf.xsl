...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://samilogutmuitalit.no/sites/default/files/6_samisk_filmbolge_viser_vei_ok_endringer_godtattmecsei.docx.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Samisk filmbølge baner vei'"/>
    <!--
        Information of the first author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author1_fn" select="'Monica'"/>
    <xsl:variable name="author1_ln" select="'Mecsei'"/>
    <!-- m, f or unknown -->
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="6_sami_filbmabarru_laidesta.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'4, 6, 20'"/>
    ...
    <xsl:variable name="top_margin" select="'7=32, 9=53, 12=80, 14=58, 15=38'"/>
    <xsl:variable name="bottom_margin" select="'all=13, 1=20, 3=20, 5=20, 7=28, 9=18, 10=63, 13=86, 16=16, 19=50'"/>
    ...
    <!--
        ...
        must be defined.
    -->
    <xsl:variable name="inner_right_margin" select="'16=7, 18=7'"/>
    <xsl:variable name="inner_left_margin" select="'16=7, 18=7'"/>
    <xsl:variable name="inner_top_margin" select="'16=25, 18=42'"/>
    <xsl:variable name="inner_bottom_margin" select="'16=42, 18=25'"/>
