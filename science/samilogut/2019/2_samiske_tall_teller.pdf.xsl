...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://samilogutmuitalit.no/sites/default/files/publications/2.samiske_tall_teller_-_matematikk_i_en_kulturell_kontekst_-_versjon_2_ok-2.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Samiske tall teller. Matematikk og matematikkundervisning i en kulturell kontekst'"/>
    <!--
        Information of the first author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author1_fn" select="'Per'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="2_sami_logut_lohkkojit.pdf"/>
    ...
    <xsl:variable name="bottom_margin" select="'4=14, 5=18, 6=60, 8=13, 9=14, 10=65'"/>
    ...
    <!--
        ...
        must be defined.
    -->
    <xsl:variable name="inner_right_margin" select="'9=7'"/>
    <xsl:variable name="inner_left_margin" select="'9=7'"/>
    <xsl:variable name="inner_top_margin" select="'9=50'"/>
    <xsl:variable name="inner_bottom_margin" select="'9=40'"/>
