...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://samilogutmuitalit.no/sites/default/files/publications/4_fysiske_inngrep_i_samiske_reinny15.09.2019_ok_2_1.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Fysiske inngrep i samiske reinbeiteområder: Beregning av påvirkningssoner'"/>
    <!--
        Information of the first author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author1_fn" select="'Erik'"/>
    <xsl:variable name="author1_ln" select="'Engelien'"/>
    <!-- m, f or unknown -->
    ...
    <!--
        ...
        date or year of birth, nationality.
    -->
    <xsl:variable name="author2_fn" select="'Julie'"/>
    <xsl:variable name="author2_ln" select="'Aslaksen'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="4_fysiske_skilkemedahkoeh_saemien_baatsoedajvine.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'14-15, 19, 24-25'"/>
    ...
    <xsl:variable name="top_margin" select="'all=4, 12=38, 18=47'"/>
    <xsl:variable name="bottom_margin" select="'2=14, 3=14, 7=19, 11=72, 12=42, 18=18, 20=18, 21=15, 23=74'"/>
