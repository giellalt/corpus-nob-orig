...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="4samegielfalaldat_manaidgarddis.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'1, 17'"/>
    ...
    <xsl:variable name="top_margin" select="'9=65'"/>
    <xsl:variable name="bottom_margin" select="'3;8=15, 4;5;6;7;15=18'"/>
    ...
    <!--
        ...
        must be defined.
    -->
    <xsl:variable name="inner_right_margin" select="'11=7'"/>
    <xsl:variable name="inner_left_margin" select="'11=7'"/>
    <xsl:variable name="inner_top_margin" select="'11=15'"/>
    <xsl:variable name="inner_bottom_margin" select="'11=20'"/>
