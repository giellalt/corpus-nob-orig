...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="digiartikkelsme.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'28-29'"/>
    ...
    <xsl:variable name="top_margin" select="'14=30, 11=35, 22=45'"/>
    <xsl:variable name="bottom_margin" select="'9=30, 8=25, 10;11;13=20, 7;12;14;15;16;17;20;22;23;24=15, 27=83'"/>
    ...
    <!--
        ...
        must be defined.
    -->
    <xsl:variable name="inner_right_margin" select="'12;17;18;20=7'"/>
    <xsl:variable name="inner_left_margin" select="'12;17;18;20=7'"/>
    <xsl:variable name="inner_top_margin" select="'12=53, 17=50, 18=30, 20=18'"/>
    <xsl:variable name="inner_bottom_margin" select="'12;17=25, 18=47, 20=70'"/>
