...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://munin.uit.no/bitstream/handle/10037/15702/thesis.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Å møte naturfaglige begreper med to språk'"/>
    <!--
        Information of the first author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author1_fn" select="'Kari Marlene'"/>
    <xsl:variable name="author1_ln" select="'Mulder'"/>
    <!-- m, f or unknown -->
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="kari_marlene_mulder_eng.pdf"/>
        ...
        <parallel_text xml:lang="sme" location="kari_marlene_mulder.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'1-4, 6-79'"/>
    ...
    <xsl:variable name="bottom_margin" select="'5=40'"/>
