...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'orig/sme/science/uit/phd/mikkel_sara.pdf'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="mikkel_sara.pdf"/>
        ...
        <parallel_text xml:lang="sme" location="mikkel_sara.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'1-7, 9-10, 13-14, 17-216'"/>
    ...
    <xsl:variable name="top_margin" select="'8=15, 11=66, 15=48'"/>
